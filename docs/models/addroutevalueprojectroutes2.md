...
```typescript
import { AddRouteValueProjectRoutes2 } from "@vercel/sdk/models/addrouteop.js";

let value: AddRouteValueProjectRoutes2 = {};
```
...
| ------------------------------------- | ------------------------------------- | ------------------------------------- | ------------------------------------- |
| `eq`                                  | *models.AddRouteValueProjectRoutesEq* | :heavy_minus_sign:                    | N/A                                   |
