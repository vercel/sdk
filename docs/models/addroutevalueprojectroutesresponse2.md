...
```typescript
import { AddRouteValueProjectRoutesResponse2 } from "@vercel/sdk/models/addrouteop.js";

let value: AddRouteValueProjectRoutesResponse2 = {};
```
...
| --------------------------------------------- | --------------------------------------------- | --------------------------------------------- | --------------------------------------------- |
| `eq`                                          | *models.AddRouteValueProjectRoutesResponseEq* | :heavy_minus_sign:                            | N/A                                           |
