...
```typescript
import { AddRouteValueProjectRoutesResponse2002 } from "@vercel/sdk/models/addrouteop.js";

let value: AddRouteValueProjectRoutesResponse2002 = {};
```
...
| ------------------------------------------------ | ------------------------------------------------ | ------------------------------------------------ | ------------------------------------------------ |
| `eq`                                             | *models.AddRouteValueProjectRoutesResponse200Eq* | :heavy_minus_sign:                               | N/A                                              |
