...
| `machineSelectionType`                                                                                            | [models.MachineSelectionType](../models/machineselectiontype.md)                                                  | :heavy_minus_sign:                                                                                                | An object containing infomation related to the amount of platform resources may be allocated to the User account. |