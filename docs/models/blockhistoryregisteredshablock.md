...
```typescript
import { BlockHistoryRegisteredShaBlock } from "@vercel/sdk/models/createprojectcontenthint8.js";

let value: BlockHistoryRegisteredShaBlock = {
  createdAt: "1730192187508",
  createdBy: "<value>",
  sha: "<value>",
};
```
