...
```typescript
import { BudgetItem } from "@vercel/sdk/models/twohundredandthirty.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload267Type](../models/usereventpayload267type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
