...
```typescript
import { BudgetItem } from "@vercel/sdk/models/twohundredandeighty.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload305Type](../models/usereventpayload305type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
