...
```typescript
import { BudgetItem } from "@vercel/sdk/models/twohundredandninetynine.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload320Type](../models/usereventpayload320type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
