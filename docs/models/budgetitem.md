...
```typescript
import { BudgetItem } from "@vercel/sdk/models/usereventpayload340budget.js";
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [models.UserEventPayload340Type](../models/usereventpayload340type.md)               | :heavy_check_mark:                                                                   | The budget type                                                                      |
...
| `pricingPlan`                                                                        | [models.UserEventPayload340PricingPlan](../models/usereventpayload340pricingplan.md) | :heavy_minus_sign:                                                                   | The acive pricing plan the team is billed with                                       |
