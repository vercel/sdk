...
```typescript
import { BudgetItem } from "@vercel/sdk/models/twohundredandeightyfour.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload309Type](../models/usereventpayload309type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
