...
```typescript
import { BudgetItem } from "@vercel/sdk/models/usereventpayload227next.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload257Type](../models/usereventpayload257type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
