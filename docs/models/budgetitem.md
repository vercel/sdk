...
```typescript
import { BudgetItem } from "@vercel/sdk/models/usereventpayload335budget.js";
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `type`                                                                               | [models.UserEventPayload335Type](../models/usereventpayload335type.md)               | :heavy_check_mark:                                                                   | The budget type                                                                      |
...
| `pricingPlan`                                                                        | [models.UserEventPayload335PricingPlan](../models/usereventpayload335pricingplan.md) | :heavy_minus_sign:                                                                   | The acive pricing plan the team is billed with                                       |
