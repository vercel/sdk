...
```typescript
import { BudgetItem } from "@vercel/sdk/models/ssoprotectiondeploymenttype.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload314Type](../models/usereventpayload314type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
