...
| `pricingSource`                                                                                                                   | [models.BuyCreditsConfigurationBillingPricingSource](../models/buycreditsconfigurationbillingpricingsource.md)                    | :heavy_check_mark:                                                                                                                | The source used as the authoritative price for this intent.                                                                       |
