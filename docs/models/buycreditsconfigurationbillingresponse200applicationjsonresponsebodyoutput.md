...
| `changedResources`                                                                                                                | *models.BuyCreditsConfigurationBillingChangedResources*[]                                                                         | :heavy_minus_sign:                                                                                                                | Resources that were changed as part of this intent. Tracks all logical changes including the primary change and any side effects. |
