...
| --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `effectiveBehavior`                                                                                                               | [models.EffectiveBehavior](../models/effectivebehavior.md)                                                                        | :heavy_check_mark:                                                                                                                | When the subscription change should take effect.                                                                                  |
| `orbPriceId`                                                                                                                      | *string*                                                                                                                          | :heavy_check_mark:                                                                                                                | The Orb price ID for the subscription item being modified.                                                                        |
| `pricingSource`                                                                                                                   | [models.PricingSource](../models/pricingsource.md)                                                                                | :heavy_check_mark:                                                                                                                | The source used as the authoritative price for this intent.                                                                       |
| `productId`                                                                                                                       | *string*                                                                                                                          | :heavy_check_mark:                                                                                                                | The product ID associated with this intent.                                                                                       |
| `changedResources`                                                                                                                | [models.ChangedResources](../models/changedresources.md)[]                                                                        | :heavy_minus_sign:                                                                                                                | Resources that were changed as part of this intent. Tracks all logical changes including the primary change and any side effects. |
