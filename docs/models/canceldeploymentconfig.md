...
| `resourceConfig`                                                                             | [models.CancelDeploymentResourceConfig](../models/canceldeploymentresourceconfig.md)         | :heavy_minus_sign:                                                                           | Build resource configuration snapshot for this deployment.                                   |