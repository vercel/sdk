...
```typescript
import { CancelDeploymentServicesDeploymentsProjectSettings } from "@vercel/sdk/models/canceldeploymentgitrepodeploymentsresponseownertype.js";

let value: CancelDeploymentServicesDeploymentsProjectSettings = {};
```
