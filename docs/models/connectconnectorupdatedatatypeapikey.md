...
| `instructions`                                                                                                            | *string*                                                                                                                  | :heavy_minus_sign:                                                                                                        | Markdown instructions shown to each user on the authorization screen, explaining how to obtain the key they should paste. |