...
```typescript
import { ConnectCreateConnectorRequestTriggerDestinationBranch } from "@vercel/sdk/models/connectcreateconnectorrequest.js";

let value: ConnectCreateConnectorRequestTriggerDestinationBranch = {
  branch: "<value>",
};
```
