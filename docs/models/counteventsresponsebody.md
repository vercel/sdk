...
let value: CountEventsResponseBody = {
  ...
  data: {
    ...
    requestId: "<id>",
    requestApi: "<value>",
    referrerUrl: "https://nifty-cop-out.net",
    ...
    messageId: "<id>",
    eventType: "<value>",
    notificationUrl: "https://orderly-councilman.com",
    sandboxSessionId: "<id>",
    sandboxName: "<value>",
    workflowRunId: "<id>",
    workflowName: "<value>",
...
| `data`                                                   | [models.CountEventsData](../models/counteventsdata.md)   | :heavy_check_mark:                                       | N/A                                                      |