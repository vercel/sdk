...
```typescript
import { CountPageviewsData } from "@vercel/sdk/models/countpageviewsop.js";

let value: CountPageviewsData = {
  projectId: "<id>",
  country: "France",
  deviceType: "<value>",
  environment: "<value>",
  ...
  requestId: "<id>",
  requestApi: "<value>",
  referrerUrl: "https://handsome-zebra.net",
  ...
  messageId: "<id>",
  eventType: "<value>",
  notificationUrl: "https://rotating-birdcage.biz/",
  sandboxSessionId: "<id>",
  sandboxName: "<value>",
  workflowRunId: "<id>",
  workflowName: "<value>",
