...
```typescript
import { CountPageviewsData1 } from "@vercel/sdk/models/countpageviewsop.js";

let value: CountPageviewsData1 = {
  ...
  notificationUrl: "https://big-platypus.name",
  ...
  referrerUrl: "https://bare-extension.org",
  region: "<value>",
