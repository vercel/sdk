...
| `branchMatcher`                                                                                  | [models.CreateCustomEnvironmentBranchMatcher](../models/createcustomenvironmentbranchmatcher.md) | :heavy_minus_sign:                                                                               | How we want to determine a matching branch. This is optional.                                    |
