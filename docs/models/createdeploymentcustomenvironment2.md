...
```typescript
import { CreateDeploymentCustomEnvironment2 } from "@vercel/sdk/models/createdeploymentresponsebodydeploymentsstatus.js";

let value: CreateDeploymentCustomEnvironment2 = {
  id: "<id>",
};
```
