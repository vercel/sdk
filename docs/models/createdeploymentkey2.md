...
```typescript
import { CreateDeploymentKey2 } from "@vercel/sdk/models/createdeploymentvaluedeploymentsresponse200applicationjsonresponsebody2services2redirectsmissing2.js";

let value: CreateDeploymentKey2 = {};
```
...
| ------------------------------ | ------------------------------ | ------------------------------ | ------------------------------ |
| `eq`                           | *models.CreateDeploymentKeyEq* | :heavy_minus_sign:             | N/A                            |
