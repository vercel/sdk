...
```typescript
import { CreateDeploymentServicesProjectSettings } from "@vercel/sdk/models/createdeploymentrouteslocale.js";

let value: CreateDeploymentServicesProjectSettings = {};
```
