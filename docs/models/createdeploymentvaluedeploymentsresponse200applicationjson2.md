...
```typescript
import { CreateDeploymentValueDeploymentsResponse200ApplicationJson2 } from "@vercel/sdk/models/createdeploymentrouteslocale.js";
...
| ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| `eq`                                                   | *models.CreateDeploymentValueDeploymentsResponse200Eq* | :heavy_minus_sign:                                     | N/A                                                    |
