...
```typescript
import { CreateIntegrationStoreDirectFramework } from "@vercel/sdk/models/createintegrationstoredirecthiddenintegrations1.js";

let value: CreateIntegrationStoreDirectFramework = "redwoodjs";
```
