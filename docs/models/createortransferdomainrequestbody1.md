...
| `cdnEnabled`                                                                    | *boolean*                                                                       | :heavy_minus_sign:                                                              | Whether the domain has the Vercel CDN enabled or not.                           | true                                                                            |
| `zone`                                                                          | *boolean*                                                                       | :heavy_minus_sign:                                                              | Whether to create a DNS zone on Vercel. Set `true` if using Vercel nameservers. |                                                                                 |
