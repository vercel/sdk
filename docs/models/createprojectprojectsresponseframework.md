...
```typescript
import { CreateProjectProjectsResponseFramework } from "@vercel/sdk/models/createprojectprojectsto.js";

let value: CreateProjectProjectsResponseFramework = "gatsby";
```
