...
```typescript
import { CreateProjectProjectsResponseFramework } from "@vercel/sdk/models/createprojectapril2026securityincidentmigrationappliedfrom.js";

let value: CreateProjectProjectsResponseFramework = "fastify";
```
