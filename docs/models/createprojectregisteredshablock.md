...
```typescript
import { CreateProjectRegisteredShaBlock } from "@vercel/sdk/models/createprojectcontenthint4.js";

let value: CreateProjectRegisteredShaBlock = {
  createdAt: "1726374858034",
  createdBy: "<value>",
  sha: "<value>",
};
```
