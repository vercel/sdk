...
```typescript
import { CreateProjectVia2 } from "@vercel/sdk/models/createprojectbuildmachineselection.js";

let value: CreateProjectVia2 = {
  type: "integration",
  integration: {
    integrationId: "<id>",
    configurationId: "<id>",
...
| `integration`                                        | [models.ViaIntegration](../models/viaintegration.md) | :heavy_check_mark:                                   | N/A                                                  |