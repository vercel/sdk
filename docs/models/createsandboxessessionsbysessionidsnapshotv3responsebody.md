...
```typescript
import { CreateSandboxesSessionsBySessionIdSnapshotV3ResponseBody } from "@vercel/sdk/models/createsandboxessessionsbysessionidsnapshotv3op.js";

let value: CreateSandboxesSessionsBySessionIdSnapshotV3ResponseBody = {
  snapshot: {
