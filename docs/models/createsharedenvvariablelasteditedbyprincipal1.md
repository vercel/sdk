...
```typescript
import { CreateSharedEnvVariableLastEditedByPrincipal1 } from "@vercel/sdk/models/createsharedenvvariableop.js";

let value: CreateSharedEnvVariableLastEditedByPrincipal1 = {
  id: "<id>",
  type: "user",
  username: "Corine.Turcotte",
};
```
