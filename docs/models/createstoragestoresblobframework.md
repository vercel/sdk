# CreateStorageStoresBlobFramework

## Example Usage

```typescript
import { CreateStorageStoresBlobFramework } from "@vercel/sdk/models/createstoragestoresblobop.js";

let value: CreateStorageStoresBlobFramework = "eve";
```
