...
```typescript
import { Definitions } from "@vercel/sdk/models/createprojectop.js";
...
| `source`                                                                                                                       | [models.CreateProjectSource](../models/createprojectsource.md)                                                                 | :heavy_minus_sign:                                                                                                             | The origin of this definition. 'api' means created via the API. Undefined means it originated from a deployment (vercel.json). |                                                                                                                                |