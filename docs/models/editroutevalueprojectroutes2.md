...
```typescript
import { EditRouteValueProjectRoutes2 } from "@vercel/sdk/models/editrouteop.js";

let value: EditRouteValueProjectRoutes2 = {};
```
...
| -------------------------------------- | -------------------------------------- | -------------------------------------- | -------------------------------------- |
| `eq`                                   | *models.EditRouteValueProjectRoutesEq* | :heavy_minus_sign:                     | N/A                                    |
