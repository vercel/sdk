...
```typescript
import { EditRouteValueProjectRoutesResponse2 } from "@vercel/sdk/models/editrouteop.js";

let value: EditRouteValueProjectRoutesResponse2 = {};
```
...
| ---------------------------------------------- | ---------------------------------------------- | ---------------------------------------------- | ---------------------------------------------- |
| `eq`                                           | *models.EditRouteValueProjectRoutesResponseEq* | :heavy_minus_sign:                             | N/A                                            |
