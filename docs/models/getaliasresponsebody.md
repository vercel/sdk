...
| `creator`                                                                                     | [models.GetAliasCreator](../models/getaliascreator.md)                                        | :heavy_minus_sign:                                                                            | Information of the user who created the alias                                                 |                                                                                               |
| `deletedAt`                                                                                   | *number*                                                                                      | :heavy_minus_sign:                                                                            | The date when the alias was deleted in milliseconds since the UNIX epoch                      | 1540095775941                                                                                 |
| `deployment`                                                                                  | [models.GetAliasDeployment](../models/getaliasdeployment.md)                                  | :heavy_minus_sign:                                                                            | A map with the deployment ID, URL and metadata                                                |                                                                                               |
...
| `protectionBypass`                                                                            | Record<string, *models.GetAliasProtectionBypass*>                                             | :heavy_minus_sign:                                                                            | The protection bypass for the alias                                                           |                                                                                               |
| `microfrontends`                                                                              | [models.GetAliasMicrofrontends](../models/getaliasmicrofrontends.md)                          | :heavy_minus_sign:                                                                            | The microfrontends for the alias including the routing configuration                          |                                                                                               |