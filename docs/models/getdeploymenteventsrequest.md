...
| `direction`                                                                    | [models.QueryParamDirection](../models/queryparamdirection.md)                 | :heavy_minus_sign:                                                             | Order of the returned events based on the timestamp.                           | backward                                                                       |
...
| `statusCode`                                                                   | *models.QueryParamStatusCode*                                                  | :heavy_minus_sign:                                                             | HTTP status code range to filter events by.                                    | 5xx                                                                            |
