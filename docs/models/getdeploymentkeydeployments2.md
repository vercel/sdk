...
```typescript
import { GetDeploymentKeyDeployments2 } from "@vercel/sdk/models/getdeploymentresponsebodydeploymentsduration.js";

let value: GetDeploymentKeyDeployments2 = {};
```
...
| -------------------------------------- | -------------------------------------- | -------------------------------------- | -------------------------------------- |
| `eq`                                   | *models.GetDeploymentKeyDeploymentsEq* | :heavy_minus_sign:                     | N/A                                    |
