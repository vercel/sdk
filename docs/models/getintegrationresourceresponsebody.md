...
| `customClaims`                                                                                | [models.GetIntegrationResourceCustomClaims](../models/getintegrationresourcecustomclaims.md)  | :heavy_minus_sign:                                                                            | The roles and claim rules Vercel resolves into the resource tokens it mints for this resource |
