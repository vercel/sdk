...
```typescript
import { GetMicrofrontendsInGroupAnalytics } from "@vercel/sdk/models/getmicrofrontendsingroupmicrofrontendsresponse200applicationjsontype.js";

let value: GetMicrofrontendsInGroupAnalytics = {
  id: "<id>",
  disabledAt: 5931.63,
  enabledAt: 5328.15,
};
