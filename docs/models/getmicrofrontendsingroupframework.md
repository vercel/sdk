...
```typescript
import { GetMicrofrontendsInGroupFramework } from "@vercel/sdk/models/getmicrofrontendsingrouptomicrofrontends1.js";

let value: GetMicrofrontendsInGroupFramework = "fasthtml";
```
