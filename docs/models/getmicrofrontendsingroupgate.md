...
```typescript
import { GetMicrofrontendsInGroupGate } from "@vercel/sdk/models/getmicrofrontendsingroupbuildmachinetype.js";
...
| `checks`                                                                                                                                                             | [models.GetMicrofrontendsInGroupChecks](../models/getmicrofrontendsingroupchecks.md)[]                                                                               | :heavy_check_mark:                                                                                                                                                   | The checks to evaluate. An empty array means nothing is evaluated.                                                                                                   |                                                                                                                                                                      |
...
| `action`                                                                                                                                                             | [models.GetMicrofrontendsInGroupMicrofrontendsResponse200ApplicationJSONAction](../models/getmicrofrontendsingroupmicrofrontendsresponse200applicationjsonaction.md) | :heavy_check_mark:                                                                                                                                                   | What to do when the gate trips: pause the rollout, or roll it back.                                                                                                  |                                                                                                                                                                      |
