...
```typescript
import { GetMicrofrontendsInGroupMicrofrontendsFramework } from "@vercel/sdk/models/getmicrofrontendsingroupcve55182migrationappliedfrom.js";

let value: GetMicrofrontendsInGroupMicrofrontendsFramework = "gridsome";
```
