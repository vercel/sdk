...
```typescript
import { GetMicrofrontendsInGroupMicrofrontendsSources } from "@vercel/sdk/models/getmicrofrontendsingroupresponsebody.js";

let value: GetMicrofrontendsInGroupMicrofrontendsSources = "integration";
```

## Values

```typescript
"cli" | "deploy-hook" | "git" | "integration" | "rest-api"
```