...
```typescript
import { GetMicrofrontendsInGroupPublicDeployments } from "@vercel/sdk/models/getmicrofrontendsingroupresponsebody.js";

let value: GetMicrofrontendsInGroupPublicDeployments = {
