...
```typescript
import { GetMicrofrontendsInGroupRegisteredShaBlock } from "@vercel/sdk/models/getmicrofrontendsingroupgitprovideroptions.js";

let value: GetMicrofrontendsInGroupRegisteredShaBlock = {
  createdAt: "1735404945122",
  createdBy: "<value>",
  sha: "<value>",
};
```
