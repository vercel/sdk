...
```typescript
import { GetMicrofrontendsInGroupRollbackDescription } from "@vercel/sdk/models/getmicrofrontendsingroupfrommicrofrontendspreset.js";

let value: GetMicrofrontendsInGroupRollbackDescription = {
  createdAt: 6819.98,
  description: "gurn recede agreeable misreport",
  userId: "<id>",
  username: "Reagan_MacGyver",
};
```
