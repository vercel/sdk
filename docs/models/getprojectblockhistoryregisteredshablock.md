...
```typescript
import { GetProjectBlockHistoryRegisteredShaBlock } from "@vercel/sdk/models/getprojectgitprovideroptions.js";

let value: GetProjectBlockHistoryRegisteredShaBlock = {
  createdAt: "1727208642656",
  createdBy: "<value>",
  sha: "<value>",
};
```
