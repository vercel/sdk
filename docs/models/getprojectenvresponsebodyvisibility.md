# GetProjectEnvResponseBodyVisibility
...
```typescript
import { GetProjectEnvResponseBodyVisibility } from "@vercel/sdk/models/getprojectenvop.js";

let value: GetProjectEnvResponseBodyVisibility = "config";
```
