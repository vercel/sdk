...
```typescript
import { GetProjectProjectsBuildMachineElasticReason } from "@vercel/sdk/models/getprojectinternalroutesmitigate.js";

let value: GetProjectProjectsBuildMachineElasticReason = "oom-failure";
```
