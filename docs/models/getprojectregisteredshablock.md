...
```typescript
import { GetProjectRegisteredShaBlock } from "@vercel/sdk/models/getprojectgitprovideroptions.js";

let value: GetProjectRegisteredShaBlock = {
  createdAt: "1706433588459",
  createdBy: "<value>",
  sha: "<value>",
};
```
