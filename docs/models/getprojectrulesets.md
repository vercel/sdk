...
```typescript
import { GetProjectRulesets } from "@vercel/sdk/models/getprojectinternalroutesmitigate.js";
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| `action`                                                                 | [models.GetProjectProjectsAction](../models/getprojectprojectsaction.md) | :heavy_check_mark:                                                       | N/A                                                                      |
