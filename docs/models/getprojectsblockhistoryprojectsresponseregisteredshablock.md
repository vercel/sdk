...
```typescript
import { GetProjectsBlockHistoryProjectsResponseRegisteredShaBlock } from "@vercel/sdk/models/getprojectsresponsebodyprojectsframework.js";

let value: GetProjectsBlockHistoryProjectsResponseRegisteredShaBlock = {
  createdAt: "1723054089252",
  createdBy: "<value>",
  sha: "<value>",
};
```
