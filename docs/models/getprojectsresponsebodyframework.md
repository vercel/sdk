...
```typescript
import { GetProjectsResponseBodyFramework } from "@vercel/sdk/models/getprojectstoprojectsresponse200applicationjsonresponsebody1.js";

let value: GetProjectsResponseBodyFramework = "dojo";
```
