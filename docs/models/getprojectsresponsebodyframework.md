...
```typescript
import { GetProjectsResponseBodyFramework } from "@vercel/sdk/models/getprojectsresponsebodyprojectsresponse200applicationjsoncreator.js";

let value: GetProjectsResponseBodyFramework = "ember";
```
