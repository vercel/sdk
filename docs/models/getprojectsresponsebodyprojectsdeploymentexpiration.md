...
```typescript
import { GetProjectsResponseBodyProjectsDeploymentExpiration } from "@vercel/sdk/models/getprojectsresponsebodyprojectssecurityplusmetadata.js";

let value: GetProjectsResponseBodyProjectsDeploymentExpiration = {};
```
