...
```typescript
import { GetProjectsResponseBodyProjectsFramework } from "@vercel/sdk/models/getprojectsresponsebodyprojectsaibots.js";

let value: GetProjectsResponseBodyProjectsFramework = "sapper";
```
