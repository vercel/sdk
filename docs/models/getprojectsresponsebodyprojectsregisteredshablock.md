...
```typescript
import { GetProjectsResponseBodyProjectsRegisteredShaBlock } from "@vercel/sdk/models/getprojectsresponsebodyprojectsframework.js";

let value: GetProjectsResponseBodyProjectsRegisteredShaBlock = {
  createdAt: "1711183205503",
  createdBy: "<value>",
  sha: "<value>",
};
```
