...
```typescript
import { GetProjectsResponseBodySources } from "@vercel/sdk/models/getprojectsresponsebodyfunctiondefaultmemorytype.js";

let value: GetProjectsResponseBodySources = "integration";
```
