...
```typescript
import { GetProjectsValueProjectsResponse2 } from "@vercel/sdk/models/getprojectshasprojectsresponse200applicationjsonresponsebody2projectsabuseblockhistoryvalue.js";

let value: GetProjectsValueProjectsResponse2 = {};
```
