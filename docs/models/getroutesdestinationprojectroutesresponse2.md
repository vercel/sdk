...
| `type`                                                                                                                        | [models.GetRoutesDestinationProjectRoutesResponseType](../models/getroutesdestinationprojectroutesresponsetype.md)            | :heavy_minus_sign:                                                                                                            | Optional explicit format marker. The destination is identified by the presence of `service`, so `type` is no longer required. |