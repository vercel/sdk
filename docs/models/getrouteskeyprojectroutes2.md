...
```typescript
import { GetRoutesKeyProjectRoutes2 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesKeyProjectRoutes2 = {};
```
...
| ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| `eq`                                 | *models.GetRoutesKeyProjectRoutesEq* | :heavy_minus_sign:                   | N/A                                  |
