...
```typescript
import { GetRoutesKeyProjectRoutesResponse2 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesKeyProjectRoutesResponse2 = {};
```
...
| -------------------------------------------- | -------------------------------------------- | -------------------------------------------- | -------------------------------------------- |
| `eq`                                         | *models.GetRoutesKeyProjectRoutesResponseEq* | :heavy_minus_sign:                           | N/A                                          |
