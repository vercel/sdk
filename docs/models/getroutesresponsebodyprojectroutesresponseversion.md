...
```typescript
import { GetRoutesResponseBodyProjectRoutesResponseVersion } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesResponseBodyProjectRoutesResponseVersion = {
  id: "<id>",
  s3Key: "<value>",
  lastModified: 5036.3,
  createdBy: "<value>",
