...
```typescript
import { GetRoutesValueProjectRoutes2 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesValueProjectRoutes2 = {};
```
...
| -------------------------------------- | -------------------------------------- | -------------------------------------- | -------------------------------------- |
| `eq`                                   | *models.GetRoutesValueProjectRoutesEq* | :heavy_minus_sign:                     | N/A                                    |
