...
```typescript
import { GetRoutesValueProjectRoutesResponse2002 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesValueProjectRoutesResponse2002 = {};
```
...
| ------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
| `eq`                                              | *models.GetRoutesValueProjectRoutesResponse200Eq* | :heavy_minus_sign:                                | N/A                                               |
