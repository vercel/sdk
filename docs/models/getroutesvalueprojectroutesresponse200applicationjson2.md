...
```typescript
import { GetRoutesValueProjectRoutesResponse200ApplicationJson2 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesValueProjectRoutesResponse200ApplicationJson2 = {};
```
...
| ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| `eq`                                                             | *models.GetRoutesValueProjectRoutesResponse200ApplicationJSONEq* | :heavy_minus_sign:                                               | N/A                                                              |
