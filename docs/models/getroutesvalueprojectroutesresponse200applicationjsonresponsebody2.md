...
```typescript
import { GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBody2 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBody2 =
  {};
```
...
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `eq`                                                                         | *models.GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBodyEq* | :heavy_minus_sign:                                                           | N/A                                                                          |
