...
```typescript
import { GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBody32 } from "@vercel/sdk/models/getroutesop.js";

let value: GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBody32 =
  {};
```
...
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| `eq`                                                                          | *models.GetRoutesValueProjectRoutesResponse200ApplicationJSONResponseBody3Eq* | :heavy_minus_sign:                                                            | N/A                                                                           |
