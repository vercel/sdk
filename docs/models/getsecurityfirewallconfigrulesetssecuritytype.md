...
```typescript
import { GetSecurityFirewallConfigRulesetsSecurityType } from "@vercel/sdk/models/getsecurityfirewallconfigrulesetssecurityresponse200action.js";

let value: GetSecurityFirewallConfigRulesetsSecurityType = "header";
```
