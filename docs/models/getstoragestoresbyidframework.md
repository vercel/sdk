# GetStorageStoresByIdFramework

## Example Usage

```typescript
import { GetStorageStoresByIdFramework } from "@vercel/sdk/models/getstoragestoresbyidop.js";

let value: GetStorageStoresByIdFramework = "blitzjs";
```
