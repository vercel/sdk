...
```typescript
import { HeadByTeamSlugByProjectSlugByRepositoryNameBlobsByDigestRequest } from "@vercel/sdk/models/headbyteamslugbyprojectslugbyrepositorynameblobsbydigestop.js";

let value: HeadByTeamSlugByProjectSlugByRepositoryNameBlobsByDigestRequest = {
  teamSlug: "team-slug",
