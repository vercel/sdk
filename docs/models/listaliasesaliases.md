...
| `microfrontends`                                                                              | [models.ListAliasesMicrofrontends](../models/listaliasesmicrofrontends.md)                    | :heavy_minus_sign:                                                                            | The microfrontends for the alias including the routing configuration                          |                                                                                               |