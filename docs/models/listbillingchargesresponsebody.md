...
let value: ListBillingChargesResponseBody = {
  ...
  consumedQuantity: 8630.21,
  consumedUnit: "<value>",
  effectiveCost: 2250.61,
  serviceName: "<value>",
...
| `consumedQuantity`                                                                                | *number*                                                                                          | :heavy_check_mark:                                                                                | Volume of resource consumed. Null when a charge does not involve measurable consumption quantity. |
| `consumedUnit`                                                                                    | *string*                                                                                          | :heavy_check_mark:                                                                                | Unit of measurement for consumed quantity. Null when the charge is not measured in units.         |
...
| `tags`                                                                                            | Record<string, *string*>                                                                          | :heavy_check_mark:                                                                                | Charge metadata including the Vercel ProjectId and ProjectName information                        |
