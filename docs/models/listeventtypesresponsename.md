# ListEventTypesResponseName

## Example Usage

```typescript
import { ListEventTypesResponseName } from "@vercel/sdk/models/listeventtypesresponse.js";

let value: ListEventTypesResponseName = "ai-gateway";
```
