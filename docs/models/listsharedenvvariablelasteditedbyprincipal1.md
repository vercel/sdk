...
```typescript
import { ListSharedEnvVariableLastEditedByPrincipal1 } from "@vercel/sdk/models/listsharedenvvariableop.js";

let value: ListSharedEnvVariableLastEditedByPrincipal1 = {
  id: "<id>",
  type: "user",
  username: "Koby81",
};
