...
```typescript
import { ListSharedEnvVariableLastEditedByPrincipal2 } from "@vercel/sdk/models/listsharedenvvariableop.js";

let value: ListSharedEnvVariableLastEditedByPrincipal2 = {
  id: "<id>",
  name: "<value>",
  type: "app",
};
