...
| `keepLastSnapshots`                                                                 | [models.KeepLastSnapshots](../models/keeplastsnapshots.md)                          | :heavy_minus_sign:                                                                  | Keep-last snapshot configuration.                                                   |                                                                                     |
...
| `mounts`                                                                            | Record<string, [models.Mounts](../models/mounts.md)>                                | :heavy_minus_sign:                                                                  | Key-value pairs of mount path and volume.                                           |                                                                                     |
