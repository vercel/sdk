...
```typescript
import { OneHundredAndSeventeen } from "@vercel/sdk/models/ninetythree.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `team`                                                                 | [models.UserEventPayload117Team](../models/usereventpayload117team.md) | :heavy_check_mark:                                                     | N/A                                                                    |
