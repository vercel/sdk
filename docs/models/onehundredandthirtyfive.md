...
```typescript
import { OneHundredAndThirtyFive } from "@vercel/sdk/models/usereventpayload90project.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `team`                                                                 | [models.UserEventPayload135Team](../models/usereventpayload135team.md) | :heavy_check_mark:                                                     | N/A                                                                    |
