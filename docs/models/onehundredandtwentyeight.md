...
```typescript
import { OneHundredAndTwentyEight } from "@vercel/sdk/models/onehundredandtwenty.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `team`                                                                 | [models.UserEventPayload128Team](../models/usereventpayload128team.md) | :heavy_check_mark:                                                     | N/A                                                                    |
