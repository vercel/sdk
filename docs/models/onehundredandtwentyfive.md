...
```typescript
import { OneHundredAndTwentyFive } from "@vercel/sdk/models/onehundredandfifteen.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `team`                                                                 | [models.UserEventPayload125Team](../models/usereventpayload125team.md) | :heavy_check_mark:                                                     | N/A                                                                    |
