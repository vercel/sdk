...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandeight.js";
...
| `resources`                                                                                | [models.UserEventPayload447AfterResources](../models/usereventpayload447afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
