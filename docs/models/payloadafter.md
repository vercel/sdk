...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/threehundredandninetyfive.js";
...
| `resources`                                                                                | [models.UserEventPayload434AfterResources](../models/usereventpayload434afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
