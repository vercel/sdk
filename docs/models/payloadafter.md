...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandnine.js";
...
| `resources`                                                                                | [models.UserEventPayload448AfterResources](../models/usereventpayload448afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
