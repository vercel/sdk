...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/threehundredandninetytwo.js";
...
| `resources`                                                                                | [models.UserEventPayload431AfterResources](../models/usereventpayload431afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
