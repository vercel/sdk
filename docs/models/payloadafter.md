...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/threehundredandninetyseven.js";
...
| `resources`                                                                                | [models.UserEventPayload436AfterResources](../models/usereventpayload436afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
