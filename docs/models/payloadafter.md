...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandfourteen.js";
...
| `resources`                                                                      | [models.UserEventPayload466Resources](../models/usereventpayload466resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
