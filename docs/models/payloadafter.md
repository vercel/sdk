...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandtwo.js";
...
| `resources`                                                                                | [models.UserEventPayload441AfterResources](../models/usereventpayload441afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
