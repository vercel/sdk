...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/threehundredandsixtyseven.js";
...
| `resources`                                                                                | [models.UserEventPayload410AfterResources](../models/usereventpayload410afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
