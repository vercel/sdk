...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandsix.js";
...
| `resources`                                                                                | [models.UserEventPayload445AfterResources](../models/usereventpayload445afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
