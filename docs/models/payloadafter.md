...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandseven.js";
...
| `resources`                                                                                | [models.UserEventPayload446AfterResources](../models/usereventpayload446afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
