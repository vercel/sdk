...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandthree.js";
...
| `resources`                                                                                | [models.UserEventPayload442AfterResources](../models/usereventpayload442afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
