...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandthirteen.js";
...
| `resources`                                                                      | [models.UserEventPayload465Resources](../models/usereventpayload465resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
