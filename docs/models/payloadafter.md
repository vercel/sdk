...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/threehundredandninetysix.js";
...
| `resources`                                                                                | [models.UserEventPayload435AfterResources](../models/usereventpayload435afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
