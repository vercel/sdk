...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/usereventpayload372previous.js";
...
| `resources`                                                                                | [models.UserEventPayload417AfterResources](../models/usereventpayload417afterresources.md) | :heavy_check_mark:                                                                         | Resource boundary, or `null` when the policy has none.                                     |
