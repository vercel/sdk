...
```typescript
import { PayloadAfter } from "@vercel/sdk/models/fourhundredandeleven.js";
...
| `resources`                                                                      | [models.UserEventPayload463Resources](../models/usereventpayload463resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
