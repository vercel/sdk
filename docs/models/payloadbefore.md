...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandthree.js";
...
| `resources`                                                                      | [models.UserEventPayload442Resources](../models/usereventpayload442resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
