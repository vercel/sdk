...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandfourteen.js";
...
| `resources`                                                                                  | [models.UserEventPayload466BeforeResources](../models/usereventpayload466beforeresources.md) | :heavy_check_mark:                                                                           | Resource boundary, or `null` when the policy has none.                                       |
