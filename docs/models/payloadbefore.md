...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandninetyfive.js";
...
| `resources`                                                                      | [models.UserEventPayload434Resources](../models/usereventpayload434resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
