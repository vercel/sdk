...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/usereventpayload375previous.js";
...
| `resources`                                                                      | [models.UserEventPayload420Resources](../models/usereventpayload420resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
