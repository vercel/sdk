...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandninetysix.js";
...
| `resources`                                                                      | [models.UserEventPayload435Resources](../models/usereventpayload435resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
