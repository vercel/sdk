...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandthirteen.js";
...
| `resources`                                                                                  | [models.UserEventPayload465BeforeResources](../models/usereventpayload465beforeresources.md) | :heavy_check_mark:                                                                           | Resource boundary, or `null` when the policy has none.                                       |
