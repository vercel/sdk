...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandninetynine.js";
...
| `resources`                                                                                  | [models.UserEventPayload451BeforeResources](../models/usereventpayload451beforeresources.md) | :heavy_check_mark:                                                                           | Resource boundary, or `null` when the policy has none.                                       |
