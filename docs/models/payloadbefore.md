...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandtwo.js";
...
| `resources`                                                                      | [models.UserEventPayload441Resources](../models/usereventpayload441resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
