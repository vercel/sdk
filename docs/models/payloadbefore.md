...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundred.js";
...
| `resources`                                                                      | [models.UserEventPayload439Resources](../models/usereventpayload439resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
