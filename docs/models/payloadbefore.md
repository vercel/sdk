...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandsixty.js";
...
| `resources`                                                                      | [models.UserEventPayload402Resources](../models/usereventpayload402resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
