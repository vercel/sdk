...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandnine.js";
...
| `resources`                                                                      | [models.UserEventPayload448Resources](../models/usereventpayload448resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
