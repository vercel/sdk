...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandfour.js";
...
| `resources`                                                                      | [models.UserEventPayload443Resources](../models/usereventpayload443resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
