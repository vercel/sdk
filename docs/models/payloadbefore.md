...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandninetytwo.js";
...
| `resources`                                                                      | [models.UserEventPayload431Resources](../models/usereventpayload431resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
