...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandeleven.js";
...
| `resources`                                                                                  | [models.UserEventPayload463BeforeResources](../models/usereventpayload463beforeresources.md) | :heavy_check_mark:                                                                           | Resource boundary, or `null` when the policy has none.                                       |
