...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/fourhundredandseven.js";
...
| `resources`                                                                      | [models.UserEventPayload446Resources](../models/usereventpayload446resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
