...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandninetyseven.js";
...
| `resources`                                                                      | [models.UserEventPayload436Resources](../models/usereventpayload436resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
