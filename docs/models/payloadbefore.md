...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/usereventpayload373previous.js";
...
| `resources`                                                                      | [models.UserEventPayload418Resources](../models/usereventpayload418resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
