...
```typescript
import { PayloadBefore } from "@vercel/sdk/models/threehundredandsixtytwo.js";
...
| `resources`                                                                      | [models.UserEventPayload404Resources](../models/usereventpayload404resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
