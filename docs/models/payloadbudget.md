...
```typescript
import { PayloadBudget } from "@vercel/sdk/models/twohundredandfourteen.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload220Type](../models/usereventpayload220type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
