...
```typescript
import { PayloadBudget } from "@vercel/sdk/models/onehundredandninetytwo.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload241Type](../models/usereventpayload241type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
