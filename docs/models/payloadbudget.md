...
```typescript
import { PayloadBudget } from "@vercel/sdk/models/twohundredandthirtyone.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload232Type](../models/usereventpayload232type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
