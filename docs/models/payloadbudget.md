...
```typescript
import { PayloadBudget } from "@vercel/sdk/models/twohundredandthirtysix.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload237Type](../models/usereventpayload237type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
