...
```typescript
import { PayloadProjectIds } from "@vercel/sdk/models/payloadbudget.js";
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `type`                                                               | [models.UserEventPayload51Type](../models/usereventpayload51type.md) | :heavy_check_mark:                                                   | N/A                                                                  |
