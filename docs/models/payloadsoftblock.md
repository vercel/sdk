...
```typescript
import { PayloadSoftBlock } from "@vercel/sdk/models/bandwidth.js";
...
| `reason`                                                                                                                        | [models.UserEventPayload167Reason](../models/usereventpayload167reason.md)                                                      | :heavy_check_mark:                                                                                                              | N/A                                                                                                                             |
