...
```typescript
import { PayloadSoftBlock } from "@vercel/sdk/models/fastorigintransfer.js";
...
| `reason`                                                                                                                        | [models.UserEventPayload159Reason](../models/usereventpayload159reason.md)                                                      | :heavy_check_mark:                                                                                                              | N/A                                                                                                                             |
