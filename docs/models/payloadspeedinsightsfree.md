...
```typescript
import { PayloadSpeedInsightsFree } from "@vercel/sdk/models/previousrule.js";
...
| `blockReason`                                                                                                                                                    | [models.UserEventPayload165NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason](../models/usereventpayload165newownerfeatureblocksspeedinsightsfreeblockreason.md) | :heavy_check_mark:                                                                                                                                               | N/A                                                                                                                                                              |