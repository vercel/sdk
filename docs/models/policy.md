...
```typescript
import { Policy } from "@vercel/sdk/models/usereventpayload372previous.js";
...
| `resources`                                                                      | [models.UserEventPayload416Resources](../models/usereventpayload416resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
