...
```typescript
import { Policy } from "@vercel/sdk/models/fourhundredandsix.js";
...
| `resources`                                                                      | [models.UserEventPayload444Resources](../models/usereventpayload444resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
