...
```typescript
import { Policy } from "@vercel/sdk/models/threehundredandninetytwo.js";
...
| `resources`                                                                      | [models.UserEventPayload430Resources](../models/usereventpayload430resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
