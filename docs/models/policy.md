...
```typescript
import { Policy } from "@vercel/sdk/models/fourhundredandseven.js";
...
| `resources`                                                                      | [models.UserEventPayload445Resources](../models/usereventpayload445resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
