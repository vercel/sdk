...
```typescript
import { Policy } from "@vercel/sdk/models/threehundredandsixtytwo.js";
...
| `resources`                                                                      | [models.UserEventPayload403Resources](../models/usereventpayload403resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
