...
```typescript
import { Policy } from "@vercel/sdk/models/threehundredandninetyfive.js";
...
| `resources`                                                                      | [models.UserEventPayload433Resources](../models/usereventpayload433resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
