...
```typescript
import { Policy } from "@vercel/sdk/models/fourhundred.js";
...
| `resources`                                                                      | [models.UserEventPayload438Resources](../models/usereventpayload438resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
