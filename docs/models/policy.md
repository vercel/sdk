...
```typescript
import { Policy } from "@vercel/sdk/models/fourhundredandthirteen.js";
...
| `resources`                                                                      | [models.UserEventPayload464Resources](../models/usereventpayload464resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
