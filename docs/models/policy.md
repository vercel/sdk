...
```typescript
import { Policy } from "@vercel/sdk/models/threehundredandsixtyseven.js";
...
| `resources`                                                                      | [models.UserEventPayload409Resources](../models/usereventpayload409resources.md) | :heavy_check_mark:                                                               | Resource boundary, or `null` when the policy has none.                           |
