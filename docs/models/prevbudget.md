...
```typescript
import { PrevBudget } from "@vercel/sdk/models/usereventpayload334budget.js";
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `type`                                                                                     | [models.UserEventPayload337PrevBudgetType](../models/usereventpayload337prevbudgettype.md) | :heavy_check_mark:                                                                         | The budget type                                                                            |
...
| `pricingPlan`                                                                              | [models.UserEventPayload337PricingPlan](../models/usereventpayload337pricingplan.md)       | :heavy_minus_sign:                                                                         | The acive pricing plan the team is billed with                                             |
