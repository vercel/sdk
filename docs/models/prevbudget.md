...
```typescript
import { PrevBudget } from "@vercel/sdk/models/usereventpayload336budget.js";
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `type`                                                                                     | [models.UserEventPayload339PrevBudgetType](../models/usereventpayload339prevbudgettype.md) | :heavy_check_mark:                                                                         | The budget type                                                                            |
...
| `pricingPlan`                                                                              | [models.UserEventPayload339PricingPlan](../models/usereventpayload339pricingplan.md)       | :heavy_minus_sign:                                                                         | The acive pricing plan the team is billed with                                             |
