...
```typescript
import { PrevBudget } from "@vercel/sdk/models/usereventpayload335budget.js";
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `type`                                                                                     | [models.UserEventPayload338PrevBudgetType](../models/usereventpayload338prevbudgettype.md) | :heavy_check_mark:                                                                         | The budget type                                                                            |
...
| `pricingPlan`                                                                              | [models.UserEventPayload338PricingPlan](../models/usereventpayload338pricingplan.md)       | :heavy_minus_sign:                                                                         | The acive pricing plan the team is billed with                                             |
