...
```typescript
import { PrevBudget } from "@vercel/sdk/models/usereventpayload333budget.js";
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `type`                                                                                     | [models.UserEventPayload336PrevBudgetType](../models/usereventpayload336prevbudgettype.md) | :heavy_check_mark:                                                                         | The budget type                                                                            |
...
| `pricingPlan`                                                                              | [models.UserEventPayload336PricingPlan](../models/usereventpayload336pricingplan.md)       | :heavy_minus_sign:                                                                         | The acive pricing plan the team is billed with                                             |
