# PutFirewallConfigRulesetsType

## Example Usage

```typescript
import { PutFirewallConfigRulesetsType } from "@vercel/sdk/models/putfirewallconfigop.js";

let value: PutFirewallConfigRulesetsType = "traffic_source";
```
