...
```typescript
import { ResponseBodyCveVulnerabilities } from "@vercel/sdk/models/getdeploymentop.js";

let value: ResponseBodyCveVulnerabilities = {
  packageName: "<value>",
...
| `cve`                                                  | [models.ResponseBodyCve](../models/responsebodycve.md) | :heavy_check_mark:                                     | N/A                                                    |