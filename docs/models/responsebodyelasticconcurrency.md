# ResponseBodyElasticConcurrency
...
```typescript
import { ResponseBodyElasticConcurrency } from "@vercel/sdk/models/createdeploymentresponsebodydeploymentsstatus.js";

let value: ResponseBodyElasticConcurrency = "PROJECT_SETTING";
```
