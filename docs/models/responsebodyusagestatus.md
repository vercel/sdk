...
```typescript
import { ResponseBodyUsageStatus } from "@vercel/sdk/models/getprojectsop.js";
...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `kind`                                                                              | [models.ResponseBodyKind](../models/responsebodykind.md)                            | :heavy_check_mark:                                                                  | Billing mode. Always 'flat' for flat-rate projects.                                 |
