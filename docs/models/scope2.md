...
| `access`                                                                                       | [models.PatchUrlProtectionBypassScopeAccess](../models/patchurlprotectionbypassscopeaccess.md) | :heavy_check_mark:                                                                             | Invitation status for the user scoped bypass.                                                  |