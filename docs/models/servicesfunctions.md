...
```typescript
import { ServicesFunctions } from "@vercel/sdk/models/canceldeploymentdestinationdeploymentstype.js";
...
| ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- | ---------------------------------------------------------------- |
| `affinity`                                                       | [models.ServicesAffinity](../models/servicesaffinity.md)         | :heavy_minus_sign:                                               | N/A                                                              |
