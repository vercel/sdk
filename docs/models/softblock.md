...
| `hobbyAllocationPause`                                                                                                          | [models.HobbyAllocationPause](../models/hobbyallocationpause.md)                                                                | :heavy_minus_sign:                                                                                                              | Present only when `reason` is `HOBBY_ALLOCATION_PAUSED`. Makes the pause self-describing for support without a separate lookup. |