...
```typescript
import { TwoHundredAndSixtySix } from "@vercel/sdk/models/twohundredandthirty.js";

let value: TwoHundredAndSixtySix = {
  sampleRatePercent: 7515.27,
  spendLimitInDollars: 4170.02,
  previous: {
    sampleRatePercent: 8320.81,
    spendLimitInDollars: 6437.28,
  },
};
```
