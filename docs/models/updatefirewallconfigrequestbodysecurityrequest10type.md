# UpdateFirewallConfigRequestBodySecurityRequest10Type

## Example Usage

```typescript
import { UpdateFirewallConfigRequestBodySecurityRequest10Type } from "@vercel/sdk/models/updatefirewallconfigop.js";

let value: UpdateFirewallConfigRequestBodySecurityRequest10Type =
  "bot_category";
```
