# UpdateFirewallConfigRequestBodySecurityRequest5Type

## Example Usage

```typescript
import { UpdateFirewallConfigRequestBodySecurityRequest5Type } from "@vercel/sdk/models/updatefirewallconfigop.js";

let value: UpdateFirewallConfigRequestBodySecurityRequest5Type = "bot_status";
```
