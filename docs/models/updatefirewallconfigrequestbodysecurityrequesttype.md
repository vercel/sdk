# UpdateFirewallConfigRequestBodySecurityRequestType

## Example Usage

```typescript
import { UpdateFirewallConfigRequestBodySecurityRequestType } from "@vercel/sdk/models/updatefirewallconfigop.js";

let value: UpdateFirewallConfigRequestBodySecurityRequestType = "raw_path";
```
