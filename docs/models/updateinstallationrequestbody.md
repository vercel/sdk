...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `status`                                                                                   | [models.UpdateInstallationStatus](../models/updateinstallationstatus.md)                   | :heavy_minus_sign:                                                                         | N/A                                                                                        |
| `externalId`                                                                               | *string*                                                                                   | :heavy_minus_sign:                                                                         | N/A                                                                                        |
| `billingPlan`                                                                              | [models.UpdateInstallationBillingPlan](../models/updateinstallationbillingplan.md)         | :heavy_minus_sign:                                                                         | N/A                                                                                        |
