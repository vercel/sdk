...
```typescript
import { UpdateMicrofrontendsBlockHistoryRegisteredShaBlock } from "@vercel/sdk/models/updatemicrofrontendscreatedeployments.js";

let value: UpdateMicrofrontendsBlockHistoryRegisteredShaBlock = {
  createdAt: "1725617168006",
  createdBy: "<value>",
  sha: "<value>",
};
```
