...
```typescript
import { UpdateMicrofrontendsCreatorApp } from "@vercel/sdk/models/updatemicrofrontendsprojectsfunctiondefaultmemorytype.js";

let value: UpdateMicrofrontendsCreatorApp = {
  id: "<id>",
};
```
