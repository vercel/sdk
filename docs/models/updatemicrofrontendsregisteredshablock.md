...
```typescript
import { UpdateMicrofrontendsRegisteredShaBlock } from "@vercel/sdk/models/updatemicrofrontendscreatedeployments.js";

let value: UpdateMicrofrontendsRegisteredShaBlock = {
  createdAt: "1732341123192",
  createdBy: "<value>",
  sha: "<value>",
};
```
