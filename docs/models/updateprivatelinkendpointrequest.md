...
```typescript
import { UpdatePrivateLinkEndpointRequest } from "@vercel/sdk/models/updateprivatelinkendpointop.js";

let value: UpdatePrivateLinkEndpointRequest = {
...
| `requestBody`                                                                                    | [models.UpdatePrivateLinkEndpointRequestBody](../models/updateprivatelinkendpointrequestbody.md) | :heavy_minus_sign:                                                                               | N/A                                                                                              |                                                                                                  |