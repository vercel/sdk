...
```typescript
import { UpdateProjectDataCacheInternalContentHint } from "@vercel/sdk/models/updateprojectdatacacheop.js";

let value: UpdateProjectDataCacheInternalContentHint = {
  type: "flags-secret",
