...
```typescript
import { UpdateProjectEnvironmentsProjectsResponse2001 } from "@vercel/sdk/models/updateprojectprojectsresponsebuildmachineelastictransition.js";

let value: UpdateProjectEnvironmentsProjectsResponse2001 = {
  target: "production",
  type: "system",
};
```
