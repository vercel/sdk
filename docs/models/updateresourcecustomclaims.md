...
```typescript
import { UpdateResourceCustomClaims } from "@vercel/sdk/models/updateresourceop.js";

let value: UpdateResourceCustomClaims = {};
```
...
| `claimRules`                                                                                    | [models.UpdateResourceClaimRules](../models/updateresourceclaimrules.md)[]                      | :heavy_minus_sign:                                                                              | Ordered rules resolved at mint time. Later rules win and shallow-merge over earlier ones.       |