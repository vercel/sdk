...
| `notification`                                                                | *models.UpdateResourceNotification*                                           | :heavy_minus_sign:                                                            | N/A                                                                           |
| `extras`                                                                      | Record<string, *any*>                                                         | :heavy_minus_sign:                                                            | N/A                                                                           |
| `secrets`                                                                     | *models.UpdateResourceSecrets*                                                | :heavy_minus_sign:                                                            | N/A                                                                           |
| `customClaims`                                                                | [models.UpdateResourceCustomClaims](../models/updateresourcecustomclaims.md)  | :heavy_minus_sign:                                                            | Custom claims embedded in the resource tokens Vercel mints for this resource. |