...
```typescript
import { UpdateSandboxNetworkPolicySandboxesV2BetaValue } from "@vercel/sdk/models/updatesandboxop.js";

let value: UpdateSandboxNetworkPolicySandboxesV2BetaValue = {};
```
