...
```typescript
import { UpdateSessionNetworkPolicyAllowSandboxesKey } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyAllowSandboxesKey = {};
```
