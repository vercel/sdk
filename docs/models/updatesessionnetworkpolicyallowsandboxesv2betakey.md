...
```typescript
import { UpdateSessionNetworkPolicyAllowSandboxesV2BetaKey } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyAllowSandboxesV2BetaKey = {};
```
