...
```typescript
import { UpdateSessionNetworkPolicyRequestBodyKey } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyRequestBodyKey = {};
```
