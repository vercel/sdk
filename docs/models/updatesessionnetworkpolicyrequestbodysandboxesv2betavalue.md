...
```typescript
import { UpdateSessionNetworkPolicyRequestBodySandboxesV2BetaValue } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyRequestBodySandboxesV2BetaValue = {};
```
