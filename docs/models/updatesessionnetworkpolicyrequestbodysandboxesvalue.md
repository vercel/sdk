...
```typescript
import { UpdateSessionNetworkPolicyRequestBodySandboxesValue } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyRequestBodySandboxesValue = {};
```
