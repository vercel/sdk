...
```typescript
import { UpdateSessionNetworkPolicyRequestBodyValue } from "@vercel/sdk/models/updatesessionnetworkpolicyop.js";

let value: UpdateSessionNetworkPolicyRequestBodyValue = {};
```
