...
```typescript
import { UpdateSharedEnvVariableUpdates } from "@vercel/sdk/models/updatesharedenvvariableop.js";

let value: UpdateSharedEnvVariableUpdates = {
  key: "API_URL",
...
| `projectIdUpdates`                                                                   | [models.ProjectIdUpdates](../models/projectidupdates.md)                             | :heavy_minus_sign:                                                                   | Incrementally update project linking without specifying the full list                |                                                                                      |
