...
```typescript
import { UploadProjectAvatarBlockHistoryRegisteredShaBlock } from "@vercel/sdk/models/uploadprojectavatargitprovideroptions.js";

let value: UploadProjectAvatarBlockHistoryRegisteredShaBlock = {
  createdAt: "1726834837513",
  createdBy: "<value>",
  sha: "<value>",
};
```
