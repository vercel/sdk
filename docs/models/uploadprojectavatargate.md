...
```typescript
import { UploadProjectAvatarGate } from "@vercel/sdk/models/uploadprojectavatarprojectsbuildmachineelasticreason.js";
...
| `checks`                                                                                                                                       | [models.UploadProjectAvatarChecks](../models/uploadprojectavatarchecks.md)[]                                                                   | :heavy_check_mark:                                                                                                                             | The checks to evaluate. An empty array means nothing is evaluated.                                                                             |                                                                                                                                                |
...
| `action`                                                                                                                                       | [models.UploadProjectAvatarProjectsResponse200ApplicationJSONAction](../models/uploadprojectavatarprojectsresponse200applicationjsonaction.md) | :heavy_check_mark:                                                                                                                             | What to do when the gate trips: pause the rollout, or roll it back.                                                                            |                                                                                                                                                |
