...
```typescript
import { UploadProjectAvatarRegisteredShaBlock } from "@vercel/sdk/models/uploadprojectavatargitprovideroptions.js";

let value: UploadProjectAvatarRegisteredShaBlock = {
  createdAt: "1711873169515",
  createdBy: "<value>",
  sha: "<value>",
};
```
