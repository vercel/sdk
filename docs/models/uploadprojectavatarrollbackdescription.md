...
```typescript
import { UploadProjectAvatarRollbackDescription } from "@vercel/sdk/models/uploadprojectavatartoprojectsresponse200preset.js";

let value: UploadProjectAvatarRollbackDescription = {
  createdAt: 7306.21,
  description: "yippee common forenenst",
  userId: "<id>",
  username: "Jonas_Adams",
};
```
