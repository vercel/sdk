# UserEventJobPayload101CommitVerification
...
```typescript
import { UserEventJobPayload101CommitVerification } from "@vercel/sdk/models/usereventpayloadteam.js";

let value: UserEventJobPayload101CommitVerification = "unverified";
```
