# UserEventJobPayload106CommitVerification
...
```typescript
import { UserEventJobPayload106CommitVerification } from "@vercel/sdk/models/gitcredentialsource.js";

let value: UserEventJobPayload106CommitVerification = "verified";
```
