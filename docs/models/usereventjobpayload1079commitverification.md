# UserEventJobPayload1079CommitVerification
...
```typescript
import { UserEventJobPayload1079CommitVerification } from "@vercel/sdk/models/commitverification.js";

let value: UserEventJobPayload1079CommitVerification = "unknown";
```
