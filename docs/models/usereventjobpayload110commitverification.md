# UserEventJobPayload110CommitVerification
...
```typescript
import { UserEventJobPayload110CommitVerification } from "@vercel/sdk/models/usereventjobpayloadprovider.js";

let value: UserEventJobPayload110CommitVerification = "unknown";
```
