# UserEventJobPayload67CommitVerification
...
```typescript
import { UserEventJobPayload67CommitVerification } from "@vercel/sdk/models/usereventpayload38action.js";

let value: UserEventJobPayload67CommitVerification = "unverified";
```
