# UserEventJobPayload68CommitVerification
...
```typescript
import { UserEventJobPayload68CommitVerification } from "@vercel/sdk/models/usereventpayloadproject.js";

let value: UserEventJobPayload68CommitVerification = "verified";
```
