# UserEventJobPayload69CommitVerification
...
```typescript
import { UserEventJobPayload69CommitVerification } from "@vercel/sdk/models/payloadoldteam.js";

let value: UserEventJobPayload69CommitVerification = "unknown";
```
