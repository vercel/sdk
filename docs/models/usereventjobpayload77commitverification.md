# UserEventJobPayload77CommitVerification
...
```typescript
import { UserEventJobPayload77CommitVerification } from "@vercel/sdk/models/thirtyfive.js";

let value: UserEventJobPayload77CommitVerification = "verified";
```
