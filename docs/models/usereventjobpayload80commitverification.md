# UserEventJobPayload80CommitVerification
...
```typescript
import { UserEventJobPayload80CommitVerification } from "@vercel/sdk/models/fortyseven.js";

let value: UserEventJobPayload80CommitVerification = "verified";
```
