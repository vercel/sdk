...
```typescript
import { UserEventJobPayload979CommitVerification } from "@vercel/sdk/models/usereventjobpayload979nsnbsideeffect.js";

let value: UserEventJobPayload979CommitVerification = "verified";
```
