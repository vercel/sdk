# UserEventJobPayload989CommitVerification
...
```typescript
import { UserEventJobPayload989CommitVerification } from "@vercel/sdk/models/fiftyseven.js";

let value: UserEventJobPayload989CommitVerification = "unverified";
```
