# UserEventJobPayload98CommitVerification
...
```typescript
import { UserEventJobPayload98CommitVerification } from "@vercel/sdk/models/fiftyseven.js";

let value: UserEventJobPayload98CommitVerification = "unverified";
```
