# UserEventJobPayload999CommitVerification
...
```typescript
import { UserEventJobPayload999CommitVerification } from "@vercel/sdk/models/usereventpayload80configuration.js";

let value: UserEventJobPayload999CommitVerification = "unknown";
```
