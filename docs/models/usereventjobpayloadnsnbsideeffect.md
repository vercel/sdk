...
```typescript
import { UserEventJobPayloadNsnbSideEffect } from "@vercel/sdk/models/fiftyfive.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `action`                                                                       | [models.UserEventJobPayload97Action](../models/usereventjobpayload97action.md) | :heavy_check_mark:                                                             | N/A                                                                            |
