...
```typescript
import { UserEventJobPayloadNsnbSideEffect } from "@vercel/sdk/models/payloadoldteam.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `action`                                                                       | [models.UserEventJobPayload69Action](../models/usereventjobpayload69action.md) | :heavy_check_mark:                                                             | N/A                                                                            |
