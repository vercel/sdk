...
```typescript
import { UserEventJobPayloadNsnbSideEffect } from "@vercel/sdk/models/fortyseven.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `action`                                                                       | [models.UserEventJobPayload80Action](../models/usereventjobpayload80action.md) | :heavy_check_mark:                                                             | N/A                                                                            |
