...
```typescript
import { UserEventJobPayloadNsnbSideEffect } from "@vercel/sdk/models/onehundredandthree.js";
...
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `action`                                                                         | [models.UserEventJobPayload105Action](../models/usereventjobpayload105action.md) | :heavy_check_mark:                                                               | N/A                                                                              |
