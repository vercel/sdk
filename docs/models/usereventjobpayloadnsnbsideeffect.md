...
```typescript
import { UserEventJobPayloadNsnbSideEffect } from "@vercel/sdk/models/commitverification.js";
...
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `action`                                                                         | [models.UserEventJobPayload107Action](../models/usereventjobpayload107action.md) | :heavy_check_mark:                                                               | N/A                                                                              |
