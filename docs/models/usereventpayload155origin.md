# UserEventPayload155Origin

## Example Usage

```typescript
import { UserEventPayload155Origin } from "@vercel/sdk/models/usereventpayload155newownerfeatureblocksworkfloweventsblockreason.js";

let value: UserEventPayload155Origin = "nsnb-hobby-upgrade";
```
