...
```typescript
import { UserEventPayload159Method } from "@vercel/sdk/models/onehundredandtwentyseven.js";

let value: UserEventPayload159Method = "unknown";
```
