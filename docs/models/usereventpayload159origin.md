# UserEventPayload159Origin

## Example Usage

```typescript
import { UserEventPayload159Origin } from "@vercel/sdk/models/fastorigintransfer.js";

let value: UserEventPayload159Origin = "nsnb-auto-approve";
```
