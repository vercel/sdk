# UserEventPayload159Reason

## Example Usage

```typescript
import { UserEventPayload159Reason } from "@vercel/sdk/models/fastorigintransfer.js";

let value: UserEventPayload159Reason = "DOMAIN_OWNER_DELETION_REQUEST";
```
