...
```typescript
import { UserEventPayload162Method } from "@vercel/sdk/models/onehundredandthirtyfour.js";

let value: UserEventPayload162Method = "passkey";
```
