# UserEventPayload162Reason

## Example Usage

```typescript
import { UserEventPayload162Reason } from "@vercel/sdk/models/edgemiddlewareinvocations.js";

let value: UserEventPayload162Reason = "DOMAIN_OWNER_DELETION_REQUEST";
```
