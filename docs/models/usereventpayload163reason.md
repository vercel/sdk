# UserEventPayload163Reason

## Example Usage

```typescript
import { UserEventPayload163Reason } from "@vercel/sdk/models/edgemiddlewareinvocations.js";

let value: UserEventPayload163Reason = "ENTERPRISE_TRIAL_ENDED";
```
