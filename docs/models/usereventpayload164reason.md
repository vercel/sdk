# UserEventPayload164Reason

## Example Usage

```typescript
import { UserEventPayload164Reason } from "@vercel/sdk/models/datacachewrite.js";

let value: UserEventPayload164Reason = "EXPOSURE_CAP_EXCEEDED";
```
