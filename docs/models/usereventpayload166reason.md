# UserEventPayload166Reason

## Example Usage

```typescript
import { UserEventPayload166Reason } from "@vercel/sdk/models/bandwidth.js";

let value: UserEventPayload166Reason = "DOMAIN_OWNER_DELETION_REQUEST";
```
