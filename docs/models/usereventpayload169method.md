...
```typescript
import { UserEventPayload169Method } from "@vercel/sdk/models/onehundredandfortynine.js";

let value: UserEventPayload169Method = "self_serve_recovery";
```
