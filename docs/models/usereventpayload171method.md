...
```typescript
import { UserEventPayload171Method } from "@vercel/sdk/models/onehundredandfortyeight.js";

let value: UserEventPayload171Method = "unknown";
```
