...
```typescript
import { UserEventPayload176Method } from "@vercel/sdk/models/lasteditedbyprincipal2.js";

let value: UserEventPayload176Method = "user_disabled";
```
