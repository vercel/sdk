# UserEventPayload215Origin

## Example Usage

```typescript
import { UserEventPayload215Origin } from "@vercel/sdk/models/microfrontends1.js";

let value: UserEventPayload215Origin = "nsnb-redeploy-attribution-card";
```
