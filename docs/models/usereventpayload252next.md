...
```typescript
import { UserEventPayload252Next } from "@vercel/sdk/models/twohundredandfortyseven.js";
...
| `scope`                                                                                                              | [models.UserEventPayload252Scope](../models/usereventpayload252scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
