...
```typescript
import { UserEventPayload261Next } from "@vercel/sdk/models/oldoptionsallowlist.js";

let value: UserEventPayload261Next = {
  enabled: true,
...
| `scope`                                                                                                              | [models.UserEventPayload261Scope](../models/usereventpayload261scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
