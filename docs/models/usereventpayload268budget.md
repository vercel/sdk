...
```typescript
import { UserEventPayload268Budget } from "@vercel/sdk/models/twohundredandthirty.js";

let value: UserEventPayload268Budget = {
  type: "fixed",
  fixedBudget: 2248.53,
  previousSpend: [],
  notifiedAt: [
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload268Type](../models/usereventpayload268type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
