...
```typescript
import { UserEventPayload270Budget } from "@vercel/sdk/models/twohundredandthirtyone.js";

let value: UserEventPayload270Budget = {
  type: "fixed",
  fixedBudget: 6360.25,
  previousSpend: [
    3778.51,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload270Type](../models/usereventpayload270type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
