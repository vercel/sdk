...
```typescript
import { UserEventPayload271Next } from "@vercel/sdk/models/twohundredandtwentysix.js";
...
| `scope`                                                                                                              | [models.UserEventPayload271Scope](../models/usereventpayload271scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
