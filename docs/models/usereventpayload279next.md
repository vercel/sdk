...
```typescript
import { UserEventPayload279Next } from "@vercel/sdk/models/twohundredandthirty.js";

let value: UserEventPayload279Next = {
  enabled: false,
  scope: "private",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload279Scope](../models/usereventpayload279scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
