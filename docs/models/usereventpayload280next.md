...
```typescript
import { UserEventPayload280Next } from "@vercel/sdk/models/twohundredandthirtyone.js";
...
| `scope`                                                                                                              | [models.UserEventPayload280Scope](../models/usereventpayload280scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
