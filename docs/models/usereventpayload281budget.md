...
```typescript
import { UserEventPayload281Budget } from "@vercel/sdk/models/reasoncode.js";

let value: UserEventPayload281Budget = {
  type: "fixed",
  fixedBudget: 4404.99,
  previousSpend: [
    5348.34,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload281Type](../models/usereventpayload281type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
