...
```typescript
import { UserEventPayload283Budget } from "@vercel/sdk/models/consent.js";

let value: UserEventPayload283Budget = {
  type: "fixed",
  fixedBudget: 1205.7,
  previousSpend: [
    7553.01,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload283Type](../models/usereventpayload283type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
