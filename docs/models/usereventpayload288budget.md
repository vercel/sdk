...
```typescript
import { UserEventPayload288Budget } from "@vercel/sdk/models/rollbackdescription.js";

let value: UserEventPayload288Budget = {
  type: "fixed",
  fixedBudget: 816.77,
  previousSpend: [
    7760.11,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload288Type](../models/usereventpayload288type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
