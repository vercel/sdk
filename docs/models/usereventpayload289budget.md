...
```typescript
import { UserEventPayload289Budget } from "@vercel/sdk/models/rollbackdescription.js";

let value: UserEventPayload289Budget = {
  type: "fixed",
  fixedBudget: 2036.1,
  previousSpend: [
    4416.4,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload289Type](../models/usereventpayload289type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
