...
```typescript
import { UserEventPayload290Budget } from "@vercel/sdk/models/twohundredandfiftysix.js";

let value: UserEventPayload290Budget = {
  type: "fixed",
  fixedBudget: 403.51,
  previousSpend: [
    8842.15,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload290Type](../models/usereventpayload290type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
