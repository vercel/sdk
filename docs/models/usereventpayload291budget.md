...
```typescript
import { UserEventPayload291Budget } from "@vercel/sdk/models/twohundredandfiftyeight.js";

let value: UserEventPayload291Budget = {
  type: "fixed",
  fixedBudget: 2044.84,
  previousSpend: [
    3521.72,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload291Type](../models/usereventpayload291type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
