...
```typescript
import { UserEventPayload292Next } from "@vercel/sdk/models/reasoncode.js";
...
| `scope`                                                                                                              | [models.UserEventPayload292Scope](../models/usereventpayload292scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
