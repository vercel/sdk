...
```typescript
import { UserEventPayload293Next } from "@vercel/sdk/models/consent.js";

let value: UserEventPayload293Next = {
  enabled: false,
  scope: "private",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload293Scope](../models/usereventpayload293scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
