...
```typescript
import { UserEventPayload294Next } from "@vercel/sdk/models/consent.js";

let value: UserEventPayload294Next = {
  enabled: true,
  scope: "all",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload294Scope](../models/usereventpayload294scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
