...
```typescript
import { UserEventPayload295Next } from "@vercel/sdk/models/rollbackdescription.js";
...
| `scope`                                                                                                              | [models.UserEventPayload295Scope](../models/usereventpayload295scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
