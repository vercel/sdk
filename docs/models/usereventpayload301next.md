...
```typescript
import { UserEventPayload301Next } from "@vercel/sdk/models/twohundredandfiftysix.js";
...
| `scope`                                                                                                              | [models.UserEventPayload301Scope](../models/usereventpayload301scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
