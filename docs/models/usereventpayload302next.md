...
```typescript
import { UserEventPayload302Next } from "@vercel/sdk/models/twohundredandfiftyeight.js";

let value: UserEventPayload302Next = {
  enabled: false,
...
| `scope`                                                                                                              | [models.UserEventPayload302Scope](../models/usereventpayload302scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
