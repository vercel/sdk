...
```typescript
import { UserEventPayload307Budget } from "@vercel/sdk/models/twohundredandeighty.js";

let value: UserEventPayload307Budget = {
  type: "fixed",
  fixedBudget: 3497.37,
  previousSpend: [
    6959.81,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload307Type](../models/usereventpayload307type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
