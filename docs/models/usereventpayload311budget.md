...
```typescript
import { UserEventPayload311Budget } from "@vercel/sdk/models/twohundredandeightyfour.js";

let value: UserEventPayload311Budget = {
  type: "fixed",
  fixedBudget: 2467.26,
  previousSpend: [],
  notifiedAt: [
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload311Type](../models/usereventpayload311type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
