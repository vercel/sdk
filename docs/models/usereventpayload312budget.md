...
```typescript
import { UserEventPayload312Budget } from "@vercel/sdk/models/twohundredandeightysix.js";

let value: UserEventPayload312Budget = {
  type: "fixed",
  fixedBudget: 1533.54,
  previousSpend: [
    1107,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload312Type](../models/usereventpayload312type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
