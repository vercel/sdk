...
```typescript
import { UserEventPayload316Budget } from "@vercel/sdk/models/ssoprotectiondeploymenttype.js";

let value: UserEventPayload316Budget = {
  type: "fixed",
  fixedBudget: 5290.36,
  previousSpend: [],
  notifiedAt: [
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload316Type](../models/usereventpayload316type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
