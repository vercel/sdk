...
```typescript
import { UserEventPayload317Budget } from "@vercel/sdk/models/ssoprotection2.js";

let value: UserEventPayload317Budget = {
  type: "fixed",
  fixedBudget: 5271.3,
  previousSpend: [
    9888.58,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload317Type](../models/usereventpayload317type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
