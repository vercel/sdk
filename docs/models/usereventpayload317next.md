...
```typescript
import { UserEventPayload317Next } from "@vercel/sdk/models/twohundredandeighty.js";

let value: UserEventPayload317Next = {
  enabled: true,
  scope: "private",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload317Scope](../models/usereventpayload317scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
