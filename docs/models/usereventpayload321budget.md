...
```typescript
import { UserEventPayload321Budget } from "@vercel/sdk/models/twohundredandninetynine.js";

let value: UserEventPayload321Budget = {
  type: "fixed",
  fixedBudget: 3451.66,
  previousSpend: [],
  notifiedAt: [
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload321Type](../models/usereventpayload321type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
