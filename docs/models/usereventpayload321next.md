...
```typescript
import { UserEventPayload321Next } from "@vercel/sdk/models/twohundredandeightyfive.js";

let value: UserEventPayload321Next = {
  enabled: false,
...
| `scope`                                                                                                              | [models.UserEventPayload321Scope](../models/usereventpayload321scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
