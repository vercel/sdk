...
```typescript
import { UserEventPayload322Budget } from "@vercel/sdk/models/twohundredandninetynine.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload322Type](../models/usereventpayload322type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
