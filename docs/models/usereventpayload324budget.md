...
```typescript
import { UserEventPayload324Budget } from "@vercel/sdk/models/removedprojects.js";

let value: UserEventPayload324Budget = {
  type: "fixed",
  fixedBudget: 8709.52,
  previousSpend: [],
  notifiedAt: [
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload324Type](../models/usereventpayload324type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
