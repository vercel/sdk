...
```typescript
import { UserEventPayload326Budget } from "@vercel/sdk/models/addedprojects.js";

let value: UserEventPayload326Budget = {
  type: "fixed",
  fixedBudget: 7454.85,
  previousSpend: [
    5721.91,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload326Type](../models/usereventpayload326type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
