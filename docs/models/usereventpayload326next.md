...
```typescript
import { UserEventPayload326Next } from "@vercel/sdk/models/ssoprotectiondeploymenttype.js";
...
| `scope`                                                                                                              | [models.UserEventPayload326Scope](../models/usereventpayload326scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
