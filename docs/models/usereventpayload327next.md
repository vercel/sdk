...
```typescript
import { UserEventPayload327Next } from "@vercel/sdk/models/ssoprotection2.js";

let value: UserEventPayload327Next = {
  enabled: false,
...
| `scope`                                                                                                              | [models.UserEventPayload327Scope](../models/usereventpayload327scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
