...
```typescript
import { UserEventPayload330Budget } from "@vercel/sdk/models/usereventpayload323geolocationmostspecificsubdivisionnames.js";

let value: UserEventPayload330Budget = {
  type: "fixed",
  fixedBudget: 3816.24,
  previousSpend: [
    9633.97,
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload330Type](../models/usereventpayload330type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
