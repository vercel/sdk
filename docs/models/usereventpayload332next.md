...
```typescript
import { UserEventPayload332Next } from "@vercel/sdk/models/twohundredandninetynine.js";
...
| `scope`                                                                                                              | [models.UserEventPayload332Scope](../models/usereventpayload332scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
