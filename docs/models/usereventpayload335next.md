...
```typescript
import { UserEventPayload335Next } from "@vercel/sdk/models/removedprojects.js";
...
| `scope`                                                                                                              | [models.UserEventPayload335Scope](../models/usereventpayload335scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
