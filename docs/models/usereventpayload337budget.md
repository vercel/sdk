...
```typescript
import { UserEventPayload337Budget } from "@vercel/sdk/models/usereventpayload334budget.js";

let value: UserEventPayload337Budget = {
  type: "fixed",
  fixedBudget: 1435.02,
  previousSpend: [
    1945.2,
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload337Type](../models/usereventpayload337type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
