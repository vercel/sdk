...
```typescript
import { UserEventPayload338Next } from "@vercel/sdk/models/addedprojects.js";

let value: UserEventPayload338Next = {
  enabled: false,
  scope: "public",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload338Scope](../models/usereventpayload338scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
