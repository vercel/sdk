...
```typescript
import { UserEventPayload341Next } from "@vercel/sdk/models/usereventpayload323geolocationmostspecificsubdivisionnames.js";

let value: UserEventPayload341Next = {
  enabled: false,
  scope: "all",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload341NextScope](../models/usereventpayload341nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
