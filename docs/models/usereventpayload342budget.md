...
```typescript
import { UserEventPayload342Budget } from "@vercel/sdk/models/usereventpayload339budget.js";

let value: UserEventPayload342Budget = {
  type: "fixed",
  fixedBudget: 7096.11,
  previousSpend: [],
  notifiedAt: [
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload342Type](../models/usereventpayload342type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
