...
```typescript
import { UserEventPayload343Budget } from "@vercel/sdk/models/usereventpayload340budget.js";

let value: UserEventPayload343Budget = {
  type: "fixed",
  fixedBudget: 4152.16,
  previousSpend: [
    8053.5,
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload343Type](../models/usereventpayload343type.md)         | :heavy_check_mark:                                                             | The budget type                                                                |
