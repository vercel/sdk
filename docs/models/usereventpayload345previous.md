...
```typescript
import { UserEventPayload345Previous } from "@vercel/sdk/models/usereventpayload327geolocationmostspecificsubdivisionnames.js";

let value: UserEventPayload345Previous = {
  enabled: true,
  scope: "public",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload345Scope](../models/usereventpayload345scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
