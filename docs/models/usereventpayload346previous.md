...
```typescript
import { UserEventPayload346Previous } from "@vercel/sdk/models/usereventpayload328names.js";

let value: UserEventPayload346Previous = {
  enabled: true,
  scope: "private",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload346Scope](../models/usereventpayload346scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
