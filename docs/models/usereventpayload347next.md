...
```typescript
import { UserEventPayload347Next } from "@vercel/sdk/models/usereventpayload333budget.js";

let value: UserEventPayload347Next = {
  enabled: true,
  scope: "public",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload347NextScope](../models/usereventpayload347nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
