...
```typescript
import { UserEventPayload347Previous } from "@vercel/sdk/models/usereventpayload333budget.js";

let value: UserEventPayload347Previous = {
  enabled: false,
...
| `scope`                                                                                                              | [models.UserEventPayload347Scope](../models/usereventpayload347scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
