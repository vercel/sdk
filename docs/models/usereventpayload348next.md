...
```typescript
import { UserEventPayload348Next } from "@vercel/sdk/models/usereventpayload334budget.js";

let value: UserEventPayload348Next = {
  enabled: true,
  scope: "all",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload348NextScope](../models/usereventpayload348nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
