...
```typescript
import { UserEventPayload349Next } from "@vercel/sdk/models/usereventpayload335budget.js";

let value: UserEventPayload349Next = {
  enabled: true,
  scope: "public",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload349NextScope](../models/usereventpayload349nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
