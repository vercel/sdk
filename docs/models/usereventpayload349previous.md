...
```typescript
import { UserEventPayload349Previous } from "@vercel/sdk/models/usereventpayload335budget.js";

let value: UserEventPayload349Previous = {
  enabled: false,
  scope: "public",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload349Scope](../models/usereventpayload349scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
