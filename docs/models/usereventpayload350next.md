...
```typescript
import { UserEventPayload350Next } from "@vercel/sdk/models/usereventpayload336budget.js";

let value: UserEventPayload350Next = {
  enabled: false,
  scope: "all",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload350NextScope](../models/usereventpayload350nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
