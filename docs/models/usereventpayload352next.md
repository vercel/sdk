...
```typescript
import { UserEventPayload352Next } from "@vercel/sdk/models/usereventpayload338budget.js";

let value: UserEventPayload352Next = {
  enabled: true,
  scope: "public",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload352NextScope](../models/usereventpayload352nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
