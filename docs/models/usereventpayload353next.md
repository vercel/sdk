...
```typescript
import { UserEventPayload353Next } from "@vercel/sdk/models/usereventpayload339budget.js";

let value: UserEventPayload353Next = {
  enabled: true,
  scope: "public",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload353NextScope](../models/usereventpayload353nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
