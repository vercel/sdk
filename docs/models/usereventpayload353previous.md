...
```typescript
import { UserEventPayload353Previous } from "@vercel/sdk/models/usereventpayload339budget.js";

let value: UserEventPayload353Previous = {
  enabled: true,
  scope: "public",
  includeDrafts: false,
};
...
| `scope`                                                                                                              | [models.UserEventPayload353Scope](../models/usereventpayload353scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
