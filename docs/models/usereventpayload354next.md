...
```typescript
import { UserEventPayload354Next } from "@vercel/sdk/models/usereventpayload340budget.js";

let value: UserEventPayload354Next = {
  enabled: true,
...
| `scope`                                                                                                              | [models.UserEventPayload354NextScope](../models/usereventpayload354nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
