...
```typescript
import { UserEventPayload354Previous } from "@vercel/sdk/models/usereventpayload340budget.js";

let value: UserEventPayload354Previous = {
  enabled: false,
  scope: "private",
  includeDrafts: true,
};
...
| `scope`                                                                                                              | [models.UserEventPayload354Scope](../models/usereventpayload354scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
