...
```typescript
import { UserEventPayload355Next } from "@vercel/sdk/models/threehundredandfortytwo.js";

let value: UserEventPayload355Next = {
  enabled: false,
...
| `scope`                                                                                                              | [models.UserEventPayload355NextScope](../models/usereventpayload355nextscope.md)                                     | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
