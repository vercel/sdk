...
```typescript
import { UserEventPayload358Next } from "@vercel/sdk/models/payloadmostspecificsubdivision.js";

let value: UserEventPayload358Next = {
  enabled: true,
  includeDrafts: false,
...
| `scope`                                                                                                              | [models.UserEventPayload358Scope](../models/usereventpayload358scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
