...
```typescript
import { UserEventPayload358Previous } from "@vercel/sdk/models/payloadmostspecificsubdivision.js";

let value: UserEventPayload358Previous = {
  enabled: false,
  includeDrafts: true,
  scope: "public",
};
...
| `scope`                                                                                                              | [models.UserEventPayload358PreviousScope](../models/usereventpayload358previousscope.md)                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
