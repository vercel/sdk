...
```typescript
import { UserEventPayload360Previous } from "@vercel/sdk/models/payloadmostspecificsubdivision.js";

let value: UserEventPayload360Previous = {
  enabled: false,
  includeDrafts: true,
...
| `scope`                                                                                                              | [models.UserEventPayload360PreviousScope](../models/usereventpayload360previousscope.md)                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
