...
```typescript
import { UserEventPayload363Next } from "@vercel/sdk/models/payloadcountry.js";

let value: UserEventPayload363Next = {
  enabled: false,
  includeDrafts: false,
...
| `scope`                                                                                                              | [models.UserEventPayload363Scope](../models/usereventpayload363scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
