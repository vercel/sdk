...
```typescript
import { UserEventPayload367Previous } from "@vercel/sdk/models/payloadcity.js";

let value: UserEventPayload367Previous = {
  enabled: false,
  includeDrafts: true,
  scope: "private",
};
...
| `scope`                                                                                                              | [models.UserEventPayload367PreviousScope](../models/usereventpayload367previousscope.md)                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
