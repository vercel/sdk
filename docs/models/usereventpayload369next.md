...
```typescript
import { UserEventPayload369Next } from "@vercel/sdk/models/payloadcity.js";

let value: UserEventPayload369Next = {
  enabled: false,
  includeDrafts: false,
  scope: "public",
};
...
| `scope`                                                                                                              | [models.UserEventPayload369Scope](../models/usereventpayload369scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
