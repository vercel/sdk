...
```typescript
import { UserEventPayload370Next } from "@vercel/sdk/models/usereventpayload351geolocationnames.js";

let value: UserEventPayload370Next = {
  enabled: false,
  includeDrafts: true,
...
| `scope`                                                                                                              | [models.UserEventPayload370Scope](../models/usereventpayload370scope.md)                                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
