...
```typescript
import { UserEventPayload370Previous } from "@vercel/sdk/models/payloadcity.js";

let value: UserEventPayload370Previous = {
  enabled: false,
  includeDrafts: false,
  scope: "private",
};
...
| `scope`                                                                                                              | [models.UserEventPayload370PreviousScope](../models/usereventpayload370previousscope.md)                             | :heavy_check_mark:                                                                                                   | Which repository visibilities get automatic reviews                                                                  |
