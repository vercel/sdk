# UserEventPayload54Permissions

## Example Usage

```typescript
import { UserEventPayload54Permissions } from "@vercel/sdk/models/piiredaction.js";

let value: UserEventPayload54Permissions = "read-write:domain";
```
