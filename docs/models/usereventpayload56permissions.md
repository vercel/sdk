# UserEventPayload56Permissions

## Example Usage

```typescript
import { UserEventPayload56Permissions } from "@vercel/sdk/models/retention.js";

let value: UserEventPayload56Permissions = "read:billing";
```
