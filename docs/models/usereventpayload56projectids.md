...
```typescript
import { UserEventPayload56ProjectIds } from "@vercel/sdk/models/payloadaccessgroup.js";
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `type`                                                                         | [models.UserEventPayload56AfterType](../models/usereventpayload56aftertype.md) | :heavy_check_mark:                                                             | N/A                                                                            |
