...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/twohundredandtwentyfive.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload227Type](../models/usereventpayload227type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
