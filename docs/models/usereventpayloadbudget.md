...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/twohundredandtwentynine.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload231Type](../models/usereventpayload231type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
