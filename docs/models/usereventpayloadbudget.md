...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/twohundredandtwentyeight.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload230Type](../models/usereventpayload230type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
