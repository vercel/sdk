...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/twohundredandtwentyseven.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload229Type](../models/usereventpayload229type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
