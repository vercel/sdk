...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/onehundredandninetytwo.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload242Type](../models/usereventpayload242type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
