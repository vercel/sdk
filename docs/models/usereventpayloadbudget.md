...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/oldoptionsallowlist.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload251Type](../models/usereventpayload251type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
