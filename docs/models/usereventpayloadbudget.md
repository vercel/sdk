...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/usereventpayload221previous.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload224Type](../models/usereventpayload224type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
