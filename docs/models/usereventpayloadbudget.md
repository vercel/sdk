...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/payloadmostspecificsubdivision.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload223Type](../models/usereventpayload223type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
