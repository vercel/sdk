...
```typescript
import { UserEventPayloadBudget } from "@vercel/sdk/models/twohundredandthirtysix.js";
...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `type`                                                                 | [models.UserEventPayload238Type](../models/usereventpayload238type.md) | :heavy_check_mark:                                                     | The budget type                                                        |
