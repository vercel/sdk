...
```typescript
import { UserEventPayloadProjectIds } from "@vercel/sdk/models/payloadchange.js";
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `type`                                                               | [models.UserEventPayload50Type](../models/usereventpayload50type.md) | :heavy_check_mark:                                                   | N/A                                                                  |
