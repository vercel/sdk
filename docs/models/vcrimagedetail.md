...
| `kind`                                                                                                  | [models.VcrImageDetailKind](../models/vcrimagedetailkind.md)                                            | :heavy_check_mark:                                                                                      | Whether the manifest is a multi-platform image index or a single-platform image manifest.               |                                                                                                         |
