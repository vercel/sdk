...
import { apiObservabilityGetObservabilityConfigurationProjects } from "@vercel/sdk/funcs/apiObservabilityGetObservabilityConfigurationProjects.js";
...
async function run() {
  const res = await apiObservabilityGetObservabilityConfigurationProjects(vercel, {
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("apiObservabilityGetObservabilityConfigurationProjects failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { apiObservabilityUpdateObservabilityConfigurationProject } from "@vercel/sdk/funcs/apiObservabilityUpdateObservabilityConfigurationProject.js";
...
async function run() {
  const res = await apiObservabilityUpdateObservabilityConfigurationProject(vercel, {
    projectIdOrName: "<value>",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("apiObservabilityUpdateObservabilityConfigurationProject failed:", res.error);
  }
}
