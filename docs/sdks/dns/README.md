...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("dnsGetRecords failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("dnsCreateRecord failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("dnsUpdateRecord failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("dnsRemoveRecord failed:", res.error);
  }
}
