...
* [getSandboxesV2](#getsandboxesv2) - List sandboxes
...
<!-- UsageSnippet language="typescript" operationID="getSandboxesV2" method="get" path="/v2/sandboxes" -->
```typescript
...
import { sandboxesV2BetaGetSandboxesV2 } from "@vercel/sdk/funcs/sandboxesV2BetaGetSandboxesV2.js";
...
async function run() {
  const res = await sandboxesV2BetaGetSandboxesV2(vercel, {
    project: "prj_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaGetSandboxesV2 failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.GetSandboxesV2Request](../../models/getsandboxesv2request.md)                                                                                                          | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.GetSandboxesV2ResponseBody](../../models/getsandboxesv2responsebody.md)\>**
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaListSessionSnapshots } from "@vercel/sdk/funcs/sandboxesV2BetaListSessionSnapshots.js";
...
async function run() {
  const res = await sandboxesV2BetaListSessionSnapshots(vercel, {
    project: "prj_abc123",
    name: "my-sandbox",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaListSessionSnapshots failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaGetSessionSnapshot } from "@vercel/sdk/funcs/sandboxesV2BetaGetSessionSnapshot.js";
...
async function run() {
  const res = await sandboxesV2BetaGetSessionSnapshot(vercel, {
    snapshotId: "snap_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaGetSessionSnapshot failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaDeleteSessionSnapshot } from "@vercel/sdk/funcs/sandboxesV2BetaDeleteSessionSnapshot.js";
...
async function run() {
  const res = await sandboxesV2BetaDeleteSessionSnapshot(vercel, {
    snapshotId: "snap_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaDeleteSessionSnapshot failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaListSessions } from "@vercel/sdk/funcs/sandboxesV2BetaListSessions.js";
...
async function run() {
  const res = await sandboxesV2BetaListSessions(vercel, {
    project: "prj_abc123",
    name: "my-sandbox",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaListSessions failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaGetSession } from "@vercel/sdk/funcs/sandboxesV2BetaGetSession.js";
...
async function run() {
  const res = await sandboxesV2BetaGetSession(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaGetSession failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaGetNamedSandbox } from "@vercel/sdk/funcs/sandboxesV2BetaGetNamedSandbox.js";
...
async function run() {
  const res = await sandboxesV2BetaGetNamedSandbox(vercel, {
    name: "my-sandbox",
    projectId: "prj_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaGetNamedSandbox failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="updateSandbox" method="patch" path="/v2/sandboxes/{name}" -->
```typescript
import { Vercel } from "@vercel/sdk";
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaUpdateSandbox } from "@vercel/sdk/funcs/sandboxesV2BetaUpdateSandbox.js";
...
async function run() {
  const res = await sandboxesV2BetaUpdateSandbox(vercel, {
    name: "my-sandbox",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
    requestBody: {
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaUpdateSandbox failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.UpdateSandboxRequest](../../models/updatesandboxrequest.md)                                                                                                            | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.UpdateSandboxResponseBody](../../models/updatesandboxresponsebody.md)\>**
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaDeleteSandbox } from "@vercel/sdk/funcs/sandboxesV2BetaDeleteSandbox.js";
...
async function run() {
  const res = await sandboxesV2BetaDeleteSandbox(vercel, {
    name: "my-sandbox",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaDeleteSandbox failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaListSessionCommands } from "@vercel/sdk/funcs/sandboxesV2BetaListSessionCommands.js";
...
async function run() {
  const res = await sandboxesV2BetaListSessionCommands(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaListSessionCommands failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaGetSessionCommand } from "@vercel/sdk/funcs/sandboxesV2BetaGetSessionCommand.js";
...
async function run() {
  const res = await sandboxesV2BetaGetSessionCommand(vercel, {
    sessionId: "sbx_abc123",
    cmdId: "cmd_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaGetSessionCommand failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaKillSessionCommand } from "@vercel/sdk/funcs/sandboxesV2BetaKillSessionCommand.js";
...
async function run() {
  const res = await sandboxesV2BetaKillSessionCommand(vercel, {
    cmdId: "cmd_abc123",
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaKillSessionCommand failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaStopSession } from "@vercel/sdk/funcs/sandboxesV2BetaStopSession.js";
...
async function run() {
  const res = await sandboxesV2BetaStopSession(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaStopSession failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaExtendSessionTimeout } from "@vercel/sdk/funcs/sandboxesV2BetaExtendSessionTimeout.js";
...
async function run() {
  const res = await sandboxesV2BetaExtendSessionTimeout(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
    requestBody: {
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaExtendSessionTimeout failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaUpdateSessionNetworkPolicy } from "@vercel/sdk/funcs/sandboxesV2BetaUpdateSessionNetworkPolicy.js";
...
async function run() {
  const res = await sandboxesV2BetaUpdateSessionNetworkPolicy(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
    requestBody: {
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaUpdateSessionNetworkPolicy failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaReadSessionFile } from "@vercel/sdk/funcs/sandboxesV2BetaReadSessionFile.js";
...
async function run() {
  const res = await sandboxesV2BetaReadSessionFile(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
    requestBody: {
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaReadSessionFile failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaCreateSessionDirectory } from "@vercel/sdk/funcs/sandboxesV2BetaCreateSessionDirectory.js";
...
async function run() {
  const res = await sandboxesV2BetaCreateSessionDirectory(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
    requestBody: {
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaCreateSessionDirectory failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaWriteSessionFiles } from "@vercel/sdk/funcs/sandboxesV2BetaWriteSessionFiles.js";
...
async function run() {
  const res = await sandboxesV2BetaWriteSessionFiles(vercel, {
    xCwd: "/home/vercel-sandbox",
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  ...
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaWriteSessionFiles failed:", res.error);
  }
}
...
```typescript
import { VercelCore } from "@vercel/sdk/core.js";
import { sandboxesV2BetaCreateSessionSnapshot } from "@vercel/sdk/funcs/sandboxesV2BetaCreateSessionSnapshot.js";
...
async function run() {
  const res = await sandboxesV2BetaCreateSessionSnapshot(vercel, {
    sessionId: "sbx_abc123",
    teamId: "team_1a2b3c4d5e6f7g8h9i0j1k2l",
    slug: "my-team-url-slug",
  });
  if (res.ok) {
    ...
    console.log("sandboxesV2BetaCreateSessionSnapshot failed:", res.error);
  }
}
