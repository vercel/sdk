...
test("Domains Get Domain Verification Record", async () => {
  const testHttpClient = createTestHTTPClient("getDomainVerificationRecord");
...
test("Domains Claim Domain Ownership", async () => {
  const testHttpClient = createTestHTTPClient("claimDomainOwnership");
