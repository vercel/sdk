...
it.skip("Environment Get /V9 /Projects/{id Or Name}/custom Environments", async () => {
  assert.fail(
    "incomplete test found please make sure to address the following errors: [`workflow step get_/v9/projects/{idOrName}/custom-environments.test referencing operation get_/v9/projects/{idOrName}/custom-environments not found in document`]",
  );
});
...
test("Environment Get Projects By Id Or Name Custom Environments", async () => {
