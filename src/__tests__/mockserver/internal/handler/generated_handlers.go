...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodDelete, "/v1/v1/bulk-redirects", pathDeleteV1V1BulkRedirects(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v1/v1/bulk-redirects", pathGetV1V1BulkRedirects(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/v1/v1/bulk-redirects/versions", pathGetV1V1BulkRedirectsVersions(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPatch, "/v1/v1/bulk-redirects", pathPatchV1V1BulkRedirects(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/v1/bulk-redirects/restore", pathPostV1V1BulkRedirectsRestore(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/v1/bulk-redirects/versions", pathPostV1V1BulkRedirectsVersions(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPut, "/v1/v1/bulk-redirects", pathPutV1V1BulkRedirects(dir, rt)),
