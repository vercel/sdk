...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodDelete, "/v2/sandboxes/drives/{name}", pathDeleteV2SandboxesDrivesName(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v2/projects/{projectIdOrName}/feature-flags/flags", pathGetV2ProjectsProjectIDOrNameFeatureFlagsFlags(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/v2/sandboxes", pathGetV2Sandboxes(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodGet, "/v2/sandboxes/drives", pathGetV2SandboxesDrives(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v2/teams/{teamId}/feature-flags/flags", pathGetV2TeamsTeamIDFeatureFlagsFlags(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v7/deployments", pathGetV7Deployments(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodGet, "/v9/domains/{domain}/verification", pathGetV9DomainsDomainVerification(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/connect/authorize/{connector}", pathPostV1ConnectAuthorizeConnector(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/connect/connectors", pathPostV1ConnectConnectors(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/connect/networks", pathPostV1ConnectNetworks(dir, rt)),
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/connect/token/{connector}", pathPostV1ConnectTokenConnector(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v1/projects/{idOrName}/avatar", pathPostV1ProjectsIDOrNameAvatar(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v2/sandboxes/drives/{name}", pathPostV2SandboxesDrivesName(dir, rt)),
		...
		NewGeneratedHandler(ctx, http.MethodPost, "/v9/domains/{domain}/claim", pathPostV9DomainsDomainClaim(dir, rt)),
