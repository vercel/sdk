...
func GeneratedHandlers(ctx context.Context, dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) []*GeneratedHandler {
	return []*GeneratedHandler{
		...
		NewGeneratedHandler(ctx, http.MethodDelete, "/v1/installations/{integrationConfigurationId}/resources/{resourceId}", pathDeleteV1InstallationsIntegrationConfigurationIDResourcesResourceID(dir, rt)),
