...
func pathPostV2SandboxesSessionsSessionIDSnapshot(dir *logging.HTTPFileDirectory, rt *tracking.RequestTracker) http.HandlerFunc {
	return func(w http.ResponseWriter, req *http.Request) {
		...
		case "createSessionSnapshot[0]":
			dir.HandlerFunc("createSessionSnapshot", testCreateSessionSnapshotCreateSessionSnapshot0)(w, req)
		default:
...
func testCreateSessionSnapshotCreateSessionSnapshot0(w http.ResponseWriter, req *http.Request) {
	...
	var respBody *operations.CreateSessionSnapshotResponseBody = &operations.CreateSessionSnapshotResponseBody{
