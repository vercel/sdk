...
type AuthTokenTypeTeam string

const (
	AuthTokenTypeTeamTeam AuthTokenTypeTeam = "team"
)

func (e AuthTokenTypeTeam) ToPointer() *AuthTokenTypeTeam {
	return &e
}
func (e *AuthTokenTypeTeam) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "team":
		*e = AuthTokenTypeTeam(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AuthTokenTypeTeam: %v", v)
	}
}
...
const (
	...
	AuthTokenOrigin2TokenExchangeOidc AuthTokenOrigin2 = "token-exchange-oidc"
)
...
type ScopeTeam struct {
	Type      AuthTokenTypeTeam `json:"type"`
...
func (o *ScopeTeam) GetType() AuthTokenTypeTeam {
	if o == nil {
		return AuthTokenTypeTeam("")
	}
	return o.Type
}
...
const (
	SudoOriginEmailOtp     SudoOrigin = "email-otp"
...
func (o *Sudo) GetVerifiedAt() *float64 {
	if o == nil {
		return nil
	}
	return o.VerifiedAt
...
const (
	...
	AuthTokenOrigin1TokenExchangeOidc AuthTokenOrigin1 = "token-exchange-oidc"
)
