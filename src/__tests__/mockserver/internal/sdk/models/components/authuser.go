...
const (
	...
	AuthUserReasonExposureCapExceeded     AuthUserReason = "EXPOSURE_CAP_EXCEEDED"
...
func (m ManagedTeam) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(m, "", false)
}

func (m *ManagedTeam) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &m, "", false, []string{"name", "avatar"}); err != nil {
		return err
	}
	return nil
}

func (o *ManagedTeam) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *ManagedTeam) GetAvatar() *string {
	if o == nil {
		return nil
	}
	return o.Avatar
...
// AccountUpdateContext - Context for the Update Account screen. Present only when `isAccountUpdateRequired` is true. `managedTeams` is empty for orphan mode (user matches an EMU domain but is not on the team).
type AccountUpdateContext struct {
	ManagedTeams []ManagedTeam `json:"managedTeams"`
}

func (a AccountUpdateContext) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AccountUpdateContext) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, []string{"managedTeams"}); err != nil {
		return err
	}
	return nil
}

func (o *AccountUpdateContext) GetManagedTeams() []ManagedTeam {
	if o == nil {
		return []ManagedTeam{}
	}
	return o.ManagedTeams
}
...
type AuthUser struct {
	...
	IsAccountUpdateRequired *bool `json:"isAccountUpdateRequired,omitempty"`
	...
	AccountUpdateContext *AccountUpdateContext `json:"accountUpdateContext,omitempty"`
...
func (o *AuthUser) GetIsAccountUpdateRequired() *bool {
	if o == nil {
		return nil
	}
	return o.IsAccountUpdateRequired
}

func (o *AuthUser) GetAccountUpdateContext() *AccountUpdateContext {
	if o == nil {
		return nil
	}
	return o.AccountUpdateContext
}
