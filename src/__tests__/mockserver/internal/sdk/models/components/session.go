...
func (n NetworkTransfer) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(n, "", false)
}

func (n *NetworkTransfer) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &n, "", false, []string{"ingress", "egress"}); err != nil {
		return err
	}
	return nil
}
...
func (o *Session) GetNetworkTransfer() *NetworkTransfer {
	if o == nil {
		return nil
	}
