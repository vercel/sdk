...
const (
	LimitedByInvalidated LimitedBy = "invalidated"
...
const (
	...
	TeamLimitedTeamPermissionOrgAdmin                 TeamLimitedTeamPermission = "OrgAdmin"
	TeamLimitedTeamPermissionOrgViewer                TeamLimitedTeamPermission = "OrgViewer"
...
const (
	TeamLimitedOriginAccountUpdate               TeamLimitedOrigin = "account-update"
...
type TeamLimited struct {
	...
	Membership *TeamLimitedMembership `json:"membership,omitempty"`
...
func (t *TeamLimited) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &t, "", false, []string{"limited", "limitedBy", "id", "slug", "name", "avatar", "createdAt"}); err != nil {
		return err
	}
	return nil
}
...
func (o *TeamLimited) GetParentID() *string {
	if o == nil {
		return nil
	}
	return o.ParentID
