...
const (
	ApproveRollingReleaseStageCurrentDeploymentReadyStateBlocked      ApproveRollingReleaseStageCurrentDeploymentReadyState = "BLOCKED"
...
// ApproveRollingReleaseStageCurrentDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	ApproveRollingReleaseStageCurrentDeploymentSourceDrop                ApproveRollingReleaseStageCurrentDeploymentSource = "drop"
...
const (
	ApproveRollingReleaseStageCanaryDeploymentReadyStateBlocked      ApproveRollingReleaseStageCanaryDeploymentReadyState = "BLOCKED"
...
// ApproveRollingReleaseStageCanaryDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	ApproveRollingReleaseStageCanaryDeploymentSourceDrop                ApproveRollingReleaseStageCanaryDeploymentSource = "drop"
...
func (o *ApproveRollingReleaseStageRollingRelease) GetCurrentCanaryPercentage() *float64 {
	if o == nil {
		return nil
	}
