...
const (
	...
	CancelDeploymentFrameworkAsh            CancelDeploymentFramework = "ash"
	CancelDeploymentFrameworkSanity         CancelDeploymentFramework = "sanity"
	CancelDeploymentFrameworkSanityV2       CancelDeploymentFramework = "sanity-v2"
...
func (o *CancelDeploymentIntegrations) GetClaimedAt() *float64 {
	if o == nil {
		return nil
	}
	return o.ClaimedAt
...
const (
	...
	CancelDeploymentStatusBlocked      CancelDeploymentStatus = "BLOCKED"
...
const (
	...
	CancelDeploymentReadyStateBlocked      CancelDeploymentReadyState = "BLOCKED"
...
// CancelDeploymentManualProvisioning - Present when deployment was created with manual provisioning enabled, either explicitly or via the experimental BYOC git flow. The deployment stays in INITIALIZING until /continue is called.
...
// CancelDeploymentSourceEnum - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	CancelDeploymentSourceEnumDrop                CancelDeploymentSourceEnum = "drop"
)
...
func (o *CancelDeploymentGitUser) GetType() *string {
	if o == nil {
		return nil
	}
	return o.Type
...
func (o *CancelDeploymentVercelUser) GetTeamRoles() []string {
	if o == nil {
		return nil
	}
	return o.TeamRoles
