...
type CompleteRollingReleaseRequest struct {
	...
	Body *CompleteRollingReleaseRequestBody `request:"mediaType=application/json"`
}
...
func (o *CompleteRollingReleaseRequest) GetBody() *CompleteRollingReleaseRequestBody {
	if o == nil {
		return nil
	}
	return o.Body
...
const (
	...
	CompleteRollingReleaseCurrentDeploymentReadyStateBlocked      CompleteRollingReleaseCurrentDeploymentReadyState = "BLOCKED"
...
// CompleteRollingReleaseCurrentDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	CompleteRollingReleaseCurrentDeploymentSourceDrop                CompleteRollingReleaseCurrentDeploymentSource = "drop"
)
...
type CompleteRollingReleaseCurrentDeployment struct {
	...
	Target optionalnullable.OptionalNullable[CompleteRollingReleaseCurrentDeploymentTarget] `json:"target,omitempty"`
...
func (o *CompleteRollingReleaseCurrentDeployment) GetTarget() optionalnullable.OptionalNullable[CompleteRollingReleaseCurrentDeploymentTarget] {
	if o == nil {
		return nil
	}
	return o.Target
...
const (
	...
	CompleteRollingReleaseCanaryDeploymentReadyStateBlocked      CompleteRollingReleaseCanaryDeploymentReadyState = "BLOCKED"
...
// CompleteRollingReleaseCanaryDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	CompleteRollingReleaseCanaryDeploymentSourceDrop                CompleteRollingReleaseCanaryDeploymentSource = "drop"
)
...
type CompleteRollingReleaseCanaryDeployment struct {
	...
	ID string `json:"id"`
	// If defined, either `staging` if a staging alias in the format `<project>.<team>.now.sh` was assigned upon creation, or `production` if the aliases from `alias` were assigned. `null` value indicates the "preview" deployment.
	Target optionalnullable.OptionalNullable[CompleteRollingReleaseCanaryDeploymentTarget] `json:"target,omitempty"`
	// The state of the deployment depending on the process of deploying, or if it is ready or in an error state
...
func (o *CompleteRollingReleaseCanaryDeployment) GetTarget() optionalnullable.OptionalNullable[CompleteRollingReleaseCanaryDeploymentTarget] {
	if o == nil {
		return nil
	}
	return o.Target
