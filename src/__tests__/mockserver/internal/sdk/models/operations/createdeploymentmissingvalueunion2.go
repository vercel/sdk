...
type TypeVercelRequest string

const (
	TypeVercelRequestVercel TypeVercelRequest = "vercel"
)

func (e TypeVercelRequest) ToPointer() *TypeVercelRequest {
	return &e
}
func (e *TypeVercelRequest) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "vercel":
		*e = TypeVercelRequest(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TypeVercelRequest: %v", v)
	}
}

type GitSourceVercelRequest struct {
	Type TypeVercelRequest `json:"type"`
	Sha  string            `json:"sha"`
}

func (g GitSourceVercelRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GitSourceVercelRequest) UnmarshalJSON(data []byte) error {
...
func (o *GitSourceVercelRequest) GetType() TypeVercelRequest {
	if o == nil {
		return TypeVercelRequest("")
	}
	return o.Type
}

func (o *GitSourceVercelRequest) GetSha() string {
	if o == nil {
		return ""
	}
	return o.Sha
...
const (
	GitSourceRequestUnionTypeGitSourceVercelRequest         GitSourceRequestUnionType = "gitSource_Vercel_request"
...
type GitSourceRequestUnion struct {
	GitSourceVercelRequest         *GitSourceVercelRequest         `queryParam:"inline"`
...
func CreateGitSourceRequestUnionGitSourceVercelRequest(gitSourceVercelRequest GitSourceVercelRequest) GitSourceRequestUnion {
	typ := GitSourceRequestUnionTypeGitSourceVercelRequest

	return GitSourceRequestUnion{
		GitSourceVercelRequest: &gitSourceVercelRequest,
		Type:                   typ,
	}
}
...
func (u *GitSourceRequestUnion) UnmarshalJSON(data []byte) error {
	...
	var gitSourceVercelRequest GitSourceVercelRequest = GitSourceVercelRequest{}
	if err := utils.UnmarshalJSON(data, &gitSourceVercelRequest, "", true, nil); err == nil {
		u.GitSourceVercelRequest = &gitSourceVercelRequest
		u.Type = GitSourceRequestUnionTypeGitSourceVercelRequest
		return nil
	}
...
func (u GitSourceRequestUnion) MarshalJSON() ([]byte, error) {
	if u.GitSourceVercelRequest != nil {
		return utils.MarshalJSON(u.GitSourceVercelRequest, "", true)
	}
...
const (
	...
	CreateDeploymentFrameworkRequestAsh            CreateDeploymentFrameworkRequest = "ash"
	CreateDeploymentFrameworkRequestSanity         CreateDeploymentFrameworkRequest = "sanity"
	CreateDeploymentFrameworkRequestSanityV2       CreateDeploymentFrameworkRequest = "sanity-v2"
...
const (
	...
	CreateDeploymentFrameworkLambdasAsh            CreateDeploymentFrameworkLambdas = "ash"
	CreateDeploymentFrameworkLambdasSanity         CreateDeploymentFrameworkLambdas = "sanity"
	CreateDeploymentFrameworkLambdasSanityV2       CreateDeploymentFrameworkLambdas = "sanity-v2"
...
func (c CreateDeploymentWebAnalytics) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDeploymentWebAnalytics) UnmarshalJSON(data []byte) error {
...
const (
	...
	CreateDeploymentStatusBlocked      CreateDeploymentStatus = "BLOCKED"
...
const (
	...
	CreateDeploymentReadyStateBlocked      CreateDeploymentReadyState = "BLOCKED"
...
type CreateDeploymentGitSourceTypeLambdasVercel2 string

const (
	CreateDeploymentGitSourceTypeLambdasVercel2Vercel CreateDeploymentGitSourceTypeLambdasVercel2 = "vercel"
)

func (e CreateDeploymentGitSourceTypeLambdasVercel2) ToPointer() *CreateDeploymentGitSourceTypeLambdasVercel2 {
	return &e
}
func (e *CreateDeploymentGitSourceTypeLambdasVercel2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "vercel":
		*e = CreateDeploymentGitSourceTypeLambdasVercel2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDeploymentGitSourceTypeLambdasVercel2: %v", v)
	}
}

type CreateDeploymentGitSourceLambdasVercel2 struct {
	Type         CreateDeploymentGitSourceTypeLambdasVercel2 `json:"type"`
	Ref          string                                      `json:"ref"`
	Sha          string                                      `json:"sha"`
	Org          string                                      `json:"org"`
	Repo         string                                      `json:"repo"`
...
func (c CreateDeploymentGitSourceLambdasVercel2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDeploymentGitSourceLambdasVercel2) UnmarshalJSON(data []byte) error {
...
func (o *CreateDeploymentGitSourceLambdasVercel2) GetType() CreateDeploymentGitSourceTypeLambdasVercel2 {
	if o == nil {
		return CreateDeploymentGitSourceTypeLambdasVercel2("")
	}
	return o.Type
}

func (o *CreateDeploymentGitSourceLambdasVercel2) GetRef() string {
	if o == nil {
		return ""
	}
	return o.Ref
...
func (o *CreateDeploymentGitSourceLambdasVercel2) GetSha() string {
	if o == nil {
		return ""
	}
	return o.Sha
...
func (o *CreateDeploymentGitSourceLambdasVercel2) GetOrg() string {
	if o == nil {
		return ""
	}
	return o.Org
...
func (o *CreateDeploymentGitSourceLambdasVercel2) GetRepo() string {
	if o == nil {
		return ""
	}
	return o.Repo
...
func (o *CreateDeploymentGitSourceLambdasVercel2) GetRepoPushedAt() *float64 {
	if o == nil {
		return nil
	}
...
type CreateDeploymentGitSourceTypeLambdasVercel1 string

const (
	CreateDeploymentGitSourceTypeLambdasVercel1Vercel CreateDeploymentGitSourceTypeLambdasVercel1 = "vercel"
)

func (e CreateDeploymentGitSourceTypeLambdasVercel1) ToPointer() *CreateDeploymentGitSourceTypeLambdasVercel1 {
	return &e
}
func (e *CreateDeploymentGitSourceTypeLambdasVercel1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "vercel":
		*e = CreateDeploymentGitSourceTypeLambdasVercel1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDeploymentGitSourceTypeLambdasVercel1: %v", v)
	}
}

type CreateDeploymentGitSourceLambdasVercel1 struct {
	Type         CreateDeploymentGitSourceTypeLambdasVercel1 `json:"type"`
	Org          *string                                     `json:"org,omitempty"`
	Repo         *string                                     `json:"repo,omitempty"`
	Sha          string                                      `json:"sha"`
	RepoPushedAt *float64                                    `json:"repoPushedAt,omitempty"`
...
func (c CreateDeploymentGitSourceLambdasVercel1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDeploymentGitSourceLambdasVercel1) UnmarshalJSON(data []byte) error {
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetType() CreateDeploymentGitSourceTypeLambdasVercel1 {
	if o == nil {
		return CreateDeploymentGitSourceTypeLambdasVercel1("")
	}
	return o.Type
}

func (o *CreateDeploymentGitSourceLambdasVercel1) GetOrg() *string {
	if o == nil {
		return nil
	}
	return o.Org
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetRepo() *string {
	if o == nil {
		return nil
	}
	return o.Repo
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetSha() string {
	if o == nil {
		return ""
	}
	return o.Sha
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetRepoPushedAt() *float64 {
	if o == nil {
		return nil
	}
	return o.RepoPushedAt
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetRef() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.Ref
...
func (o *CreateDeploymentGitSourceLambdasVercel1) GetPrID() optionalnullable.OptionalNullable[float64] {
	if o == nil {
		return nil
	}
	return o.PrID
...
const (
	...
	CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel1        CreateDeploymentGitSourceLambdasUnionType = "createDeployment_gitSource_Lambdas_Vercel_1"
	...
	CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel2        CreateDeploymentGitSourceLambdasUnionType = "createDeployment_gitSource_Lambdas_Vercel_2"
)
...
type CreateDeploymentGitSourceLambdasUnion struct {
	...
	CreateDeploymentGitSourceLambdasVercel1        *CreateDeploymentGitSourceLambdasVercel1        `queryParam:"inline"`
	...
	CreateDeploymentGitSourceLambdasVercel2        *CreateDeploymentGitSourceLambdasVercel2        `queryParam:"inline"`
...
func CreateCreateDeploymentGitSourceLambdasUnionCreateDeploymentGitSourceLambdasVercel1(createDeploymentGitSourceLambdasVercel1 CreateDeploymentGitSourceLambdasVercel1) CreateDeploymentGitSourceLambdasUnion {
	typ := CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel1

	return CreateDeploymentGitSourceLambdasUnion{
		CreateDeploymentGitSourceLambdasVercel1: &createDeploymentGitSourceLambdasVercel1,
		Type:                                    typ,
	}
}
...
func CreateCreateDeploymentGitSourceLambdasUnionCreateDeploymentGitSourceLambdasVercel2(createDeploymentGitSourceLambdasVercel2 CreateDeploymentGitSourceLambdasVercel2) CreateDeploymentGitSourceLambdasUnion {
	typ := CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel2

	return CreateDeploymentGitSourceLambdasUnion{
		CreateDeploymentGitSourceLambdasVercel2: &createDeploymentGitSourceLambdasVercel2,
		Type:                                    typ,
	}
}
...
func (u *CreateDeploymentGitSourceLambdasUnion) UnmarshalJSON(data []byte) error {
	...
	var createDeploymentGitSourceLambdasVercel2 CreateDeploymentGitSourceLambdasVercel2 = CreateDeploymentGitSourceLambdasVercel2{}
	if err := utils.UnmarshalJSON(data, &createDeploymentGitSourceLambdasVercel2, "", true, nil); err == nil {
		u.CreateDeploymentGitSourceLambdasVercel2 = &createDeploymentGitSourceLambdasVercel2
		u.Type = CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel2
		return nil
	}
	...
	var createDeploymentGitSourceLambdasVercel1 CreateDeploymentGitSourceLambdasVercel1 = CreateDeploymentGitSourceLambdasVercel1{}
	if err := utils.UnmarshalJSON(data, &createDeploymentGitSourceLambdasVercel1, "", true, nil); err == nil {
		u.CreateDeploymentGitSourceLambdasVercel1 = &createDeploymentGitSourceLambdasVercel1
		u.Type = CreateDeploymentGitSourceLambdasUnionTypeCreateDeploymentGitSourceLambdasVercel1
		return nil
	}
...
func (u CreateDeploymentGitSourceLambdasUnion) MarshalJSON() ([]byte, error) {
	...
	if u.CreateDeploymentGitSourceLambdasVercel1 != nil {
		return utils.MarshalJSON(u.CreateDeploymentGitSourceLambdasVercel1, "", true)
	}
	...
	if u.CreateDeploymentGitSourceLambdasVercel2 != nil {
		return utils.MarshalJSON(u.CreateDeploymentGitSourceLambdasVercel2, "", true)
	}
...
// CreateDeploymentSourceEnum - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	CreateDeploymentSourceEnumDrop                CreateDeploymentSourceEnum = "drop"
)
...
type CreateDeploymentMaxDurationEnum string

const (
	CreateDeploymentMaxDurationEnumMax CreateDeploymentMaxDurationEnum = "max"
)

func (e CreateDeploymentMaxDurationEnum) ToPointer() *CreateDeploymentMaxDurationEnum {
	return &e
}
func (e *CreateDeploymentMaxDurationEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "max":
		*e = CreateDeploymentMaxDurationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDeploymentMaxDurationEnum: %v", v)
	}
}

type CreateDeploymentMaxDurationUnionType string

const (
	CreateDeploymentMaxDurationUnionTypeNumber                          CreateDeploymentMaxDurationUnionType = "number"
	CreateDeploymentMaxDurationUnionTypeCreateDeploymentMaxDurationEnum CreateDeploymentMaxDurationUnionType = "createDeployment_maxDuration_enum"
)

type CreateDeploymentMaxDurationUnion struct {
	Number                          *float64                         `queryParam:"inline"`
	CreateDeploymentMaxDurationEnum *CreateDeploymentMaxDurationEnum `queryParam:"inline"`

	Type CreateDeploymentMaxDurationUnionType
}

func CreateCreateDeploymentMaxDurationUnionNumber(number float64) CreateDeploymentMaxDurationUnion {
	typ := CreateDeploymentMaxDurationUnionTypeNumber

	return CreateDeploymentMaxDurationUnion{
		Number: &number,
		Type:   typ,
	}
}

func CreateCreateDeploymentMaxDurationUnionCreateDeploymentMaxDurationEnum(createDeploymentMaxDurationEnum CreateDeploymentMaxDurationEnum) CreateDeploymentMaxDurationUnion {
	typ := CreateDeploymentMaxDurationUnionTypeCreateDeploymentMaxDurationEnum

	return CreateDeploymentMaxDurationUnion{
		CreateDeploymentMaxDurationEnum: &createDeploymentMaxDurationEnum,
		Type:                            typ,
	}
}

func (u *CreateDeploymentMaxDurationUnion) UnmarshalJSON(data []byte) error {

	var number float64 = float64(0)
	if err := utils.UnmarshalJSON(data, &number, "", true, nil); err == nil {
		u.Number = &number
		u.Type = CreateDeploymentMaxDurationUnionTypeNumber
		return nil
	}

	var createDeploymentMaxDurationEnum CreateDeploymentMaxDurationEnum = CreateDeploymentMaxDurationEnum("")
	if err := utils.UnmarshalJSON(data, &createDeploymentMaxDurationEnum, "", true, nil); err == nil {
		u.CreateDeploymentMaxDurationEnum = &createDeploymentMaxDurationEnum
		u.Type = CreateDeploymentMaxDurationUnionTypeCreateDeploymentMaxDurationEnum
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDeploymentMaxDurationUnion", string(data))
}

func (u CreateDeploymentMaxDurationUnion) MarshalJSON() ([]byte, error) {
	if u.Number != nil {
		return utils.MarshalJSON(u.Number, "", true)
	}

	if u.CreateDeploymentMaxDurationEnum != nil {
		return utils.MarshalJSON(u.CreateDeploymentMaxDurationEnum, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDeploymentMaxDurationUnion: all fields are null")
}
...
type CreateDeploymentFunctions struct {
	...
	MaxDuration             *CreateDeploymentMaxDurationUnion          `json:"maxDuration,omitempty"`
...
func (o *CreateDeploymentFunctions) GetMaxDuration() *CreateDeploymentMaxDurationUnion {
	if o == nil {
		return nil
	}
