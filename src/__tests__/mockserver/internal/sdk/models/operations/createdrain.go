...
type CreateDrainFilterSourceRequest string

const (
	CreateDrainFilterSourceRequestBuild    CreateDrainFilterSourceRequest = "build"
	CreateDrainFilterSourceRequestEdge     CreateDrainFilterSourceRequest = "edge"
	CreateDrainFilterSourceRequestLambda   CreateDrainFilterSourceRequest = "lambda"
	CreateDrainFilterSourceRequestStatic   CreateDrainFilterSourceRequest = "static"
	CreateDrainFilterSourceRequestExternal CreateDrainFilterSourceRequest = "external"
	CreateDrainFilterSourceRequestFirewall CreateDrainFilterSourceRequest = "firewall"
	CreateDrainFilterSourceRequestRedirect CreateDrainFilterSourceRequest = "redirect"
)

func (e CreateDrainFilterSourceRequest) ToPointer() *CreateDrainFilterSourceRequest {
	return &e
}
func (e *CreateDrainFilterSourceRequest) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "firewall":
		fallthrough
	case "redirect":
		*e = CreateDrainFilterSourceRequest(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainFilterSourceRequest: %v", v)
	}
}

type CreateDrainLogRequest struct {
	Sources []CreateDrainFilterSourceRequest `json:"sources,omitempty"`
}
...
func (o *CreateDrainLogRequest) GetSources() []CreateDrainFilterSourceRequest {
	if o == nil {
		return nil
	}
	return o.Sources
...
type CreateDrainEnvironmentRequest string

const (
	CreateDrainEnvironmentRequestProduction CreateDrainEnvironmentRequest = "production"
	CreateDrainEnvironmentRequestPreview    CreateDrainEnvironmentRequest = "preview"
)

func (e CreateDrainEnvironmentRequest) ToPointer() *CreateDrainEnvironmentRequest {
	return &e
}
func (e *CreateDrainEnvironmentRequest) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "production":
		fallthrough
	case "preview":
		*e = CreateDrainEnvironmentRequest(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainEnvironmentRequest: %v", v)
	}
}
...
func (o *CreateDrainDeploymentRequest) GetEnvironments() []CreateDrainEnvironmentRequest {
	if o == nil {
		return nil
	}
...
type CreateDrainRequest struct {
	...
	Body *CreateDrainRequestBody `request:"mediaType=application/json"`
}
...
func (o *CreateDrainRequest) GetBody() *CreateDrainRequestBody {
	if o == nil {
		return nil
	}
	return o.Body
...
type CreateDrainAiGateway2 struct {
}

func (c CreateDrainAiGateway2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainAiGateway2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
type CreateDrainAuditLog2 struct {
}

func (c CreateDrainAuditLog2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainAuditLog2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
type CreateDrainSchemasResponse2 struct {
	...
	AiGateway     *CreateDrainAiGateway2     `json:"ai_gateway,omitempty"`
	AuditLog      *CreateDrainAuditLog2      `json:"audit_log,omitempty"`
}
...
func (o *CreateDrainSchemasResponse2) GetAiGateway() *CreateDrainAiGateway2 {
	if o == nil {
		return nil
	}
	return o.AiGateway
...
func (o *CreateDrainSchemasResponse2) GetAuditLog() *CreateDrainAuditLog2 {
	if o == nil {
		return nil
	}
	return o.AuditLog
...
type CreateDrainSecretKind4 string

const (
	CreateDrainSecretKind4IntegrationSecret CreateDrainSecretKind4 = "INTEGRATION_SECRET"
)

func (e CreateDrainSecretKind4) ToPointer() *CreateDrainSecretKind4 {
	return &e
}
func (e *CreateDrainSecretKind4) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "INTEGRATION_SECRET":
		*e = CreateDrainSecretKind4(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainSecretKind4: %v", v)
	}
}

type CreateDrainSecretIntegrationSecret4 struct {
	Kind CreateDrainSecretKind4 `json:"kind"`
}

func (c CreateDrainSecretIntegrationSecret4) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainSecretIntegrationSecret4) UnmarshalJSON(data []byte) error {
...
func (o *CreateDrainSecretIntegrationSecret4) GetKind() CreateDrainSecretKind4 {
	if o == nil {
		return CreateDrainSecretKind4("")
	}
	return o.Kind
}

type CreateDrainSecretUnion4Type string

const (
	CreateDrainSecretUnion4TypeStr                                 CreateDrainSecretUnion4Type = "str"
	CreateDrainSecretUnion4TypeCreateDrainSecretIntegrationSecret4 CreateDrainSecretUnion4Type = "createDrain_secret_IntegrationSecret_4"
)

type CreateDrainSecretUnion4 struct {
	Str                                 *string                              `queryParam:"inline"`
	CreateDrainSecretIntegrationSecret4 *CreateDrainSecretIntegrationSecret4 `queryParam:"inline"`

	Type CreateDrainSecretUnion4Type
}

func CreateCreateDrainSecretUnion4Str(str string) CreateDrainSecretUnion4 {
	typ := CreateDrainSecretUnion4TypeStr

	return CreateDrainSecretUnion4{
		Str:  &str,
		Type: typ,
	}
}

func CreateCreateDrainSecretUnion4CreateDrainSecretIntegrationSecret4(createDrainSecretIntegrationSecret4 CreateDrainSecretIntegrationSecret4) CreateDrainSecretUnion4 {
	typ := CreateDrainSecretUnion4TypeCreateDrainSecretIntegrationSecret4

	return CreateDrainSecretUnion4{
		CreateDrainSecretIntegrationSecret4: &createDrainSecretIntegrationSecret4,
		Type:                                typ,
	}
}

func (u *CreateDrainSecretUnion4) UnmarshalJSON(data []byte) error {

	var createDrainSecretIntegrationSecret4 CreateDrainSecretIntegrationSecret4 = CreateDrainSecretIntegrationSecret4{}
	if err := utils.UnmarshalJSON(data, &createDrainSecretIntegrationSecret4, "", true, nil); err == nil {
		u.CreateDrainSecretIntegrationSecret4 = &createDrainSecretIntegrationSecret4
		u.Type = CreateDrainSecretUnion4TypeCreateDrainSecretIntegrationSecret4
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, nil); err == nil {
		u.Str = &str
		u.Type = CreateDrainSecretUnion4TypeStr
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDrainSecretUnion4", string(data))
}

func (u CreateDrainSecretUnion4) MarshalJSON() ([]byte, error) {
	if u.Str != nil {
		return utils.MarshalJSON(u.Str, "", true)
	}

	if u.CreateDrainSecretIntegrationSecret4 != nil {
		return utils.MarshalJSON(u.CreateDrainSecretIntegrationSecret4, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDrainSecretUnion4: all fields are null")
}
...
type CreateDrainDeliveryOtlphttp2 struct {
	...
	Headers  map[string]string            `json:"headers"`
	Secret   *CreateDrainSecretUnion4     `json:"secret,omitempty"`
}
...
func (o *CreateDrainDeliveryOtlphttp2) GetSecret() *CreateDrainSecretUnion4 {
	if o == nil {
		return nil
	}
	return o.Secret
...
type CreateDrainSecretKind3 string

const (
	CreateDrainSecretKind3IntegrationSecret CreateDrainSecretKind3 = "INTEGRATION_SECRET"
)

func (e CreateDrainSecretKind3) ToPointer() *CreateDrainSecretKind3 {
	return &e
}
func (e *CreateDrainSecretKind3) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "INTEGRATION_SECRET":
		*e = CreateDrainSecretKind3(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainSecretKind3: %v", v)
	}
}

type CreateDrainSecretIntegrationSecret3 struct {
	Kind CreateDrainSecretKind3 `json:"kind"`
}

func (c CreateDrainSecretIntegrationSecret3) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainSecretIntegrationSecret3) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"kind"}); err != nil {
		return err
	}
	return nil
...
func (o *CreateDrainSecretIntegrationSecret3) GetKind() CreateDrainSecretKind3 {
	if o == nil {
		return CreateDrainSecretKind3("")
	}
	return o.Kind
}

type CreateDrainSecretUnion3Type string

const (
	CreateDrainSecretUnion3TypeStr                                 CreateDrainSecretUnion3Type = "str"
	CreateDrainSecretUnion3TypeCreateDrainSecretIntegrationSecret3 CreateDrainSecretUnion3Type = "createDrain_secret_IntegrationSecret_3"
)

type CreateDrainSecretUnion3 struct {
	Str                                 *string                              `queryParam:"inline"`
	CreateDrainSecretIntegrationSecret3 *CreateDrainSecretIntegrationSecret3 `queryParam:"inline"`

	Type CreateDrainSecretUnion3Type
}

func CreateCreateDrainSecretUnion3Str(str string) CreateDrainSecretUnion3 {
	typ := CreateDrainSecretUnion3TypeStr

	return CreateDrainSecretUnion3{
		Str:  &str,
		Type: typ,
	}
}

func CreateCreateDrainSecretUnion3CreateDrainSecretIntegrationSecret3(createDrainSecretIntegrationSecret3 CreateDrainSecretIntegrationSecret3) CreateDrainSecretUnion3 {
	typ := CreateDrainSecretUnion3TypeCreateDrainSecretIntegrationSecret3

	return CreateDrainSecretUnion3{
		CreateDrainSecretIntegrationSecret3: &createDrainSecretIntegrationSecret3,
		Type:                                typ,
	}
}

func (u *CreateDrainSecretUnion3) UnmarshalJSON(data []byte) error {

	var createDrainSecretIntegrationSecret3 CreateDrainSecretIntegrationSecret3 = CreateDrainSecretIntegrationSecret3{}
	if err := utils.UnmarshalJSON(data, &createDrainSecretIntegrationSecret3, "", true, nil); err == nil {
		u.CreateDrainSecretIntegrationSecret3 = &createDrainSecretIntegrationSecret3
		u.Type = CreateDrainSecretUnion3TypeCreateDrainSecretIntegrationSecret3
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, nil); err == nil {
		u.Str = &str
		u.Type = CreateDrainSecretUnion3TypeStr
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDrainSecretUnion3", string(data))
}

func (u CreateDrainSecretUnion3) MarshalJSON() ([]byte, error) {
	if u.Str != nil {
		return utils.MarshalJSON(u.Str, "", true)
	}

	if u.CreateDrainSecretIntegrationSecret3 != nil {
		return utils.MarshalJSON(u.CreateDrainSecretIntegrationSecret3, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDrainSecretUnion3: all fields are null")
}
...
type CreateDrainDeliveryHTTP2 struct {
	...
	Headers     map[string]string                `json:"headers"`
	Secret      *CreateDrainSecretUnion3         `json:"secret,omitempty"`
}
...
func (o *CreateDrainDeliveryHTTP2) GetSecret() *CreateDrainSecretUnion3 {
	if o == nil {
		return nil
	}
	return o.Secret
...
type CreateDrainFilterV2Source2 string

const (
	CreateDrainFilterV2Source2Build    CreateDrainFilterV2Source2 = "build"
	CreateDrainFilterV2Source2Edge     CreateDrainFilterV2Source2 = "edge"
	CreateDrainFilterV2Source2External CreateDrainFilterV2Source2 = "external"
	CreateDrainFilterV2Source2Firewall CreateDrainFilterV2Source2 = "firewall"
	CreateDrainFilterV2Source2Lambda   CreateDrainFilterV2Source2 = "lambda"
	CreateDrainFilterV2Source2Redirect CreateDrainFilterV2Source2 = "redirect"
	CreateDrainFilterV2Source2Static   CreateDrainFilterV2Source2 = "static"
)

func (e CreateDrainFilterV2Source2) ToPointer() *CreateDrainFilterV2Source2 {
	return &e
}
func (e *CreateDrainFilterV2Source2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "redirect":
		fallthrough
	case "static":
		*e = CreateDrainFilterV2Source2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainFilterV2Source2: %v", v)
	}
}

type CreateDrainFilterV2Log2 struct {
	Sources                            []CreateDrainFilterV2Source2 `json:"sources,omitempty"`
...
func (o *CreateDrainFilterV2Log2) GetSources() []CreateDrainFilterV2Source2 {
	if o == nil {
		return nil
	}
	return o.Sources
...
func (o *CreateDrainFilterV2Log2) GetLegacyExcludeCachedStaticAssetLogs() *bool {
	if o == nil {
		return nil
	}
...
type CreateDrainFilterV2Environment2 string

const (
	CreateDrainFilterV2Environment2Preview    CreateDrainFilterV2Environment2 = "preview"
	CreateDrainFilterV2Environment2Production CreateDrainFilterV2Environment2 = "production"
)

func (e CreateDrainFilterV2Environment2) ToPointer() *CreateDrainFilterV2Environment2 {
	return &e
}
func (e *CreateDrainFilterV2Environment2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "preview":
		fallthrough
	case "production":
		*e = CreateDrainFilterV2Environment2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainFilterV2Environment2: %v", v)
	}
}

type CreateDrainFilterV2Deployment2 struct {
	Environments []CreateDrainFilterV2Environment2 `json:"environments,omitempty"`
}
...
func (o *CreateDrainFilterV2Deployment2) GetEnvironments() []CreateDrainFilterV2Environment2 {
	if o == nil {
		return nil
	}
	return o.Environments
...
type CreateDrainAccessSome string

const (
	CreateDrainAccessSomeSome CreateDrainAccessSome = "some"
)

func (e CreateDrainAccessSome) ToPointer() *CreateDrainAccessSome {
	return &e
}
func (e *CreateDrainAccessSome) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "some":
		*e = CreateDrainAccessSome(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainAccessSome: %v", v)
	}
}

type CreateDrainManagedBy2 string

const (
	CreateDrainManagedBy2Drain       CreateDrainManagedBy2 = "drain"
	CreateDrainManagedBy2Integration CreateDrainManagedBy2 = "integration"
)

func (e CreateDrainManagedBy2) ToPointer() *CreateDrainManagedBy2 {
	return &e
}
func (e *CreateDrainManagedBy2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "drain":
		fallthrough
	case "integration":
		*e = CreateDrainManagedBy2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainManagedBy2: %v", v)
	}
}

type CreateDrainProjectAccessSome struct {
	Access     CreateDrainAccessSome `json:"access"`
	ProjectIds []string              `json:"projectIds"`
	ManagedBy  CreateDrainManagedBy2 `json:"managedBy"`
}

func (c CreateDrainProjectAccessSome) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainProjectAccessSome) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"access", "projectIds", "managedBy"}); err != nil {
		return err
	}
	return nil
}

func (o *CreateDrainProjectAccessSome) GetAccess() CreateDrainAccessSome {
	if o == nil {
		return CreateDrainAccessSome("")
	}
	return o.Access
}

func (o *CreateDrainProjectAccessSome) GetProjectIds() []string {
	if o == nil {
		return []string{}
	}
	return o.ProjectIds
...
func (o *CreateDrainProjectAccessSome) GetManagedBy() CreateDrainManagedBy2 {
	if o == nil {
		return CreateDrainManagedBy2("")
	}
	return o.ManagedBy
}

type CreateDrainAccessAll string

const (
	CreateDrainAccessAllAll CreateDrainAccessAll = "all"
)

func (e CreateDrainAccessAll) ToPointer() *CreateDrainAccessAll {
	return &e
}
func (e *CreateDrainAccessAll) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "all":
		*e = CreateDrainAccessAll(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainAccessAll: %v", v)
	}
}

type CreateDrainManagedBy1 string

const (
	CreateDrainManagedBy1Drain       CreateDrainManagedBy1 = "drain"
	CreateDrainManagedBy1Integration CreateDrainManagedBy1 = "integration"
)

func (e CreateDrainManagedBy1) ToPointer() *CreateDrainManagedBy1 {
	return &e
}
func (e *CreateDrainManagedBy1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "drain":
		fallthrough
	case "integration":
		*e = CreateDrainManagedBy1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainManagedBy1: %v", v)
	}
}

type CreateDrainProjectAccessAll struct {
	Access    CreateDrainAccessAll  `json:"access"`
	ManagedBy CreateDrainManagedBy1 `json:"managedBy"`
}

func (c CreateDrainProjectAccessAll) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainProjectAccessAll) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"access", "managedBy"}); err != nil {
		return err
	}
	return nil
}

func (o *CreateDrainProjectAccessAll) GetAccess() CreateDrainAccessAll {
	if o == nil {
		return CreateDrainAccessAll("")
	}
	return o.Access
}

func (o *CreateDrainProjectAccessAll) GetManagedBy() CreateDrainManagedBy1 {
	if o == nil {
		return CreateDrainManagedBy1("")
	}
	return o.ManagedBy
}
...
type CreateDrainProjectAccessUnion struct {
	CreateDrainProjectAccessAll  *CreateDrainProjectAccessAll  `queryParam:"inline"`
	CreateDrainProjectAccessSome *CreateDrainProjectAccessSome `queryParam:"inline"`
...
func (u *CreateDrainProjectAccessUnion) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDrainProjectAccessUnion", string(data))
}

func (u CreateDrainProjectAccessUnion) MarshalJSON() ([]byte, error) {
	if u.CreateDrainProjectAccessAll != nil {
		return utils.MarshalJSON(u.CreateDrainProjectAccessAll, "", true)
	}

	if u.CreateDrainProjectAccessSome != nil {
		return utils.MarshalJSON(u.CreateDrainProjectAccessSome, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDrainProjectAccessUnion: all fields are null")
}
...
type CreateDrainResponseBody2 struct {
	...
	ProjectAccess               *CreateDrainProjectAccessUnion            `json:"projectAccess,omitempty"`
}
...
func (c *CreateDrainResponseBody2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"id", "createdAt", "updatedAt", "name", "ownerId", "schemas", "delivery", "source"}); err != nil {
		return err
	}
	return nil
}
...
func (o *CreateDrainResponseBody2) GetTeamID() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.TeamID
...
func (o *CreateDrainResponseBody2) GetProjectAccess() *CreateDrainProjectAccessUnion {
	if o == nil {
		return nil
	}
...
type CreateDrainAiGateway1 struct {
}

func (c CreateDrainAiGateway1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainAiGateway1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
type CreateDrainAuditLog1 struct {
}

func (c CreateDrainAuditLog1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainAuditLog1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
type CreateDrainSchemasResponse1 struct {
	...
	AiGateway     *CreateDrainAiGateway1     `json:"ai_gateway,omitempty"`
	AuditLog      *CreateDrainAuditLog1      `json:"audit_log,omitempty"`
}
...
func (o *CreateDrainSchemasResponse1) GetAiGateway() *CreateDrainAiGateway1 {
	if o == nil {
		return nil
	}
	return o.AiGateway
...
func (o *CreateDrainSchemasResponse1) GetAuditLog() *CreateDrainAuditLog1 {
	if o == nil {
		return nil
	}
	return o.AuditLog
...
type CreateDrainSecretKind2 string

const (
	CreateDrainSecretKind2IntegrationSecret CreateDrainSecretKind2 = "INTEGRATION_SECRET"
)

func (e CreateDrainSecretKind2) ToPointer() *CreateDrainSecretKind2 {
	return &e
}
func (e *CreateDrainSecretKind2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "INTEGRATION_SECRET":
		*e = CreateDrainSecretKind2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainSecretKind2: %v", v)
	}
}

type CreateDrainSecretIntegrationSecret2 struct {
	Kind CreateDrainSecretKind2 `json:"kind"`
}

func (c CreateDrainSecretIntegrationSecret2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainSecretIntegrationSecret2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"kind"}); err != nil {
		return err
	}
	return nil
...
func (o *CreateDrainSecretIntegrationSecret2) GetKind() CreateDrainSecretKind2 {
	if o == nil {
		return CreateDrainSecretKind2("")
	}
	return o.Kind
}

type CreateDrainSecretUnion2Type string

const (
	CreateDrainSecretUnion2TypeStr                                 CreateDrainSecretUnion2Type = "str"
	CreateDrainSecretUnion2TypeCreateDrainSecretIntegrationSecret2 CreateDrainSecretUnion2Type = "createDrain_secret_IntegrationSecret_2"
)

type CreateDrainSecretUnion2 struct {
	Str                                 *string                              `queryParam:"inline"`
	CreateDrainSecretIntegrationSecret2 *CreateDrainSecretIntegrationSecret2 `queryParam:"inline"`

	Type CreateDrainSecretUnion2Type
}

func CreateCreateDrainSecretUnion2Str(str string) CreateDrainSecretUnion2 {
	typ := CreateDrainSecretUnion2TypeStr

	return CreateDrainSecretUnion2{
		Str:  &str,
		Type: typ,
	}
}

func CreateCreateDrainSecretUnion2CreateDrainSecretIntegrationSecret2(createDrainSecretIntegrationSecret2 CreateDrainSecretIntegrationSecret2) CreateDrainSecretUnion2 {
	typ := CreateDrainSecretUnion2TypeCreateDrainSecretIntegrationSecret2

	return CreateDrainSecretUnion2{
		CreateDrainSecretIntegrationSecret2: &createDrainSecretIntegrationSecret2,
		Type:                                typ,
	}
}

func (u *CreateDrainSecretUnion2) UnmarshalJSON(data []byte) error {

	var createDrainSecretIntegrationSecret2 CreateDrainSecretIntegrationSecret2 = CreateDrainSecretIntegrationSecret2{}
	if err := utils.UnmarshalJSON(data, &createDrainSecretIntegrationSecret2, "", true, nil); err == nil {
		u.CreateDrainSecretIntegrationSecret2 = &createDrainSecretIntegrationSecret2
		u.Type = CreateDrainSecretUnion2TypeCreateDrainSecretIntegrationSecret2
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, nil); err == nil {
		u.Str = &str
		u.Type = CreateDrainSecretUnion2TypeStr
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDrainSecretUnion2", string(data))
}

func (u CreateDrainSecretUnion2) MarshalJSON() ([]byte, error) {
	if u.Str != nil {
		return utils.MarshalJSON(u.Str, "", true)
	}

	if u.CreateDrainSecretIntegrationSecret2 != nil {
		return utils.MarshalJSON(u.CreateDrainSecretIntegrationSecret2, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDrainSecretUnion2: all fields are null")
}
...
type CreateDrainDeliveryOtlphttp1 struct {
	...
	Headers  map[string]string            `json:"headers"`
	Secret   *CreateDrainSecretUnion2     `json:"secret,omitempty"`
}
...
func (o *CreateDrainDeliveryOtlphttp1) GetSecret() *CreateDrainSecretUnion2 {
	if o == nil {
		return nil
	}
	return o.Secret
...
type CreateDrainSecretKind1 string

const (
	CreateDrainSecretKind1IntegrationSecret CreateDrainSecretKind1 = "INTEGRATION_SECRET"
)

func (e CreateDrainSecretKind1) ToPointer() *CreateDrainSecretKind1 {
	return &e
}
func (e *CreateDrainSecretKind1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "INTEGRATION_SECRET":
		*e = CreateDrainSecretKind1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainSecretKind1: %v", v)
	}
}

type CreateDrainSecretIntegrationSecret1 struct {
	Kind CreateDrainSecretKind1 `json:"kind"`
}

func (c CreateDrainSecretIntegrationSecret1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateDrainSecretIntegrationSecret1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"kind"}); err != nil {
		return err
	}
	return nil
...
func (o *CreateDrainSecretIntegrationSecret1) GetKind() CreateDrainSecretKind1 {
	if o == nil {
		return CreateDrainSecretKind1("")
	}
	return o.Kind
}

type CreateDrainSecretUnion1Type string

const (
	CreateDrainSecretUnion1TypeStr                                 CreateDrainSecretUnion1Type = "str"
	CreateDrainSecretUnion1TypeCreateDrainSecretIntegrationSecret1 CreateDrainSecretUnion1Type = "createDrain_secret_IntegrationSecret_1"
)

type CreateDrainSecretUnion1 struct {
	Str                                 *string                              `queryParam:"inline"`
	CreateDrainSecretIntegrationSecret1 *CreateDrainSecretIntegrationSecret1 `queryParam:"inline"`

	Type CreateDrainSecretUnion1Type
}

func CreateCreateDrainSecretUnion1Str(str string) CreateDrainSecretUnion1 {
	typ := CreateDrainSecretUnion1TypeStr

	return CreateDrainSecretUnion1{
		Str:  &str,
		Type: typ,
	}
}

func CreateCreateDrainSecretUnion1CreateDrainSecretIntegrationSecret1(createDrainSecretIntegrationSecret1 CreateDrainSecretIntegrationSecret1) CreateDrainSecretUnion1 {
	typ := CreateDrainSecretUnion1TypeCreateDrainSecretIntegrationSecret1

	return CreateDrainSecretUnion1{
		CreateDrainSecretIntegrationSecret1: &createDrainSecretIntegrationSecret1,
		Type:                                typ,
	}
}

func (u *CreateDrainSecretUnion1) UnmarshalJSON(data []byte) error {

	var createDrainSecretIntegrationSecret1 CreateDrainSecretIntegrationSecret1 = CreateDrainSecretIntegrationSecret1{}
	if err := utils.UnmarshalJSON(data, &createDrainSecretIntegrationSecret1, "", true, nil); err == nil {
		u.CreateDrainSecretIntegrationSecret1 = &createDrainSecretIntegrationSecret1
		u.Type = CreateDrainSecretUnion1TypeCreateDrainSecretIntegrationSecret1
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &str, "", true, nil); err == nil {
		u.Str = &str
		u.Type = CreateDrainSecretUnion1TypeStr
		return nil
	}

	return fmt.Errorf("could not unmarshal `%s` into any supported union types for CreateDrainSecretUnion1", string(data))
}

func (u CreateDrainSecretUnion1) MarshalJSON() ([]byte, error) {
	if u.Str != nil {
		return utils.MarshalJSON(u.Str, "", true)
	}

	if u.CreateDrainSecretIntegrationSecret1 != nil {
		return utils.MarshalJSON(u.CreateDrainSecretIntegrationSecret1, "", true)
	}

	return nil, errors.New("could not marshal union type CreateDrainSecretUnion1: all fields are null")
}
...
type CreateDrainDeliveryHTTP1 struct {
	...
	Headers     map[string]string                `json:"headers"`
	Secret      *CreateDrainSecretUnion1         `json:"secret,omitempty"`
}
...
func (o *CreateDrainDeliveryHTTP1) GetSecret() *CreateDrainSecretUnion1 {
	if o == nil {
		return nil
	}
	return o.Secret
...
type CreateDrainFilterV2Source1 string

const (
	CreateDrainFilterV2Source1Build    CreateDrainFilterV2Source1 = "build"
	CreateDrainFilterV2Source1Edge     CreateDrainFilterV2Source1 = "edge"
	CreateDrainFilterV2Source1External CreateDrainFilterV2Source1 = "external"
	CreateDrainFilterV2Source1Firewall CreateDrainFilterV2Source1 = "firewall"
	CreateDrainFilterV2Source1Lambda   CreateDrainFilterV2Source1 = "lambda"
	CreateDrainFilterV2Source1Redirect CreateDrainFilterV2Source1 = "redirect"
	CreateDrainFilterV2Source1Static   CreateDrainFilterV2Source1 = "static"
)

func (e CreateDrainFilterV2Source1) ToPointer() *CreateDrainFilterV2Source1 {
	return &e
}
func (e *CreateDrainFilterV2Source1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "redirect":
		fallthrough
	case "static":
		*e = CreateDrainFilterV2Source1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainFilterV2Source1: %v", v)
	}
}

type CreateDrainFilterV2Log1 struct {
	Sources                            []CreateDrainFilterV2Source1 `json:"sources,omitempty"`
	LegacyExcludeCachedStaticAssetLogs *bool                        `json:"legacy_excludeCachedStaticAssetLogs,omitempty"`
}
...
func (o *CreateDrainFilterV2Log1) GetSources() []CreateDrainFilterV2Source1 {
	if o == nil {
		return nil
	}
	return o.Sources
...
func (o *CreateDrainFilterV2Log1) GetLegacyExcludeCachedStaticAssetLogs() *bool {
	if o == nil {
		return nil
	}
	return o.LegacyExcludeCachedStaticAssetLogs
...
type CreateDrainFilterV2Environment1 string

const (
	CreateDrainFilterV2Environment1Preview    CreateDrainFilterV2Environment1 = "preview"
	CreateDrainFilterV2Environment1Production CreateDrainFilterV2Environment1 = "production"
)

func (e CreateDrainFilterV2Environment1) ToPointer() *CreateDrainFilterV2Environment1 {
	return &e
}
func (e *CreateDrainFilterV2Environment1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "preview":
		fallthrough
	case "production":
		*e = CreateDrainFilterV2Environment1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDrainFilterV2Environment1: %v", v)
	}
}

type CreateDrainFilterV2Deployment1 struct {
	Environments []CreateDrainFilterV2Environment1 `json:"environments,omitempty"`
}
...
func (o *CreateDrainFilterV2Deployment1) GetEnvironments() []CreateDrainFilterV2Environment1 {
	if o == nil {
		return nil
	}
	return o.Environments
...
func (o *CreateDrainResponseBody1) GetTeamID() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.TeamID
