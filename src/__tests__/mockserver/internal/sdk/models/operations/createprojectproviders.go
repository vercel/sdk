...
func (o *CreateProjectPermissions) GetTrustedOidcProviders() []components.ACLAction {
	if o == nil {
		return nil
	}
...
func (o *CreateProjectProjects) GetEnvironments() []string {
	if o == nil {
		return []string{}
	}
	return o.Environments
...
type CreateProjectProviders struct {
	Label  *string             `json:"label,omitempty"`
	Claims map[string][]string `json:"claims"`
}

func (o *CreateProjectProviders) GetLabel() *string {
	if o == nil {
		return nil
	}
	return o.Label
...
func (o *CreateProjectProviders) GetClaims() map[string][]string {
	if o == nil {
