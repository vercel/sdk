...
type GetAllLogDrainsAuditLog2 struct {
}

func (g GetAllLogDrainsAuditLog2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAllLogDrainsAuditLog2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
type GetAllLogDrainsSchemas2 struct {
	...
	AuditLog      *GetAllLogDrainsAuditLog2      `json:"audit_log,omitempty"`
}
...
func (o *GetAllLogDrainsSchemas2) GetAuditLog() *GetAllLogDrainsAuditLog2 {
	if o == nil {
		return nil
	}
	return o.AuditLog
...
type GetAllLogDrainsManagedBy2 string

const (
	GetAllLogDrainsManagedBy2Drain       GetAllLogDrainsManagedBy2 = "drain"
	GetAllLogDrainsManagedBy2Integration GetAllLogDrainsManagedBy2 = "integration"
)

func (e GetAllLogDrainsManagedBy2) ToPointer() *GetAllLogDrainsManagedBy2 {
	return &e
}
func (e *GetAllLogDrainsManagedBy2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "drain":
		fallthrough
	case "integration":
		*e = GetAllLogDrainsManagedBy2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetAllLogDrainsManagedBy2: %v", v)
	}
}
...
type GetAllLogDrainsProjectAccessSome struct {
	...
	ManagedBy  GetAllLogDrainsManagedBy2 `json:"managedBy"`
}
...
func (o *GetAllLogDrainsProjectAccessSome) GetManagedBy() GetAllLogDrainsManagedBy2 {
	if o == nil {
		return GetAllLogDrainsManagedBy2("")
	}
	return o.ManagedBy
}
...
type GetAllLogDrainsManagedBy1 string

const (
	GetAllLogDrainsManagedBy1Drain       GetAllLogDrainsManagedBy1 = "drain"
	GetAllLogDrainsManagedBy1Integration GetAllLogDrainsManagedBy1 = "integration"
)

func (e GetAllLogDrainsManagedBy1) ToPointer() *GetAllLogDrainsManagedBy1 {
	return &e
}
func (e *GetAllLogDrainsManagedBy1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "drain":
		fallthrough
	case "integration":
		*e = GetAllLogDrainsManagedBy1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetAllLogDrainsManagedBy1: %v", v)
	}
}

type GetAllLogDrainsProjectAccessAll struct {
	Access    GetAllLogDrainsAccessAll  `json:"access"`
	ManagedBy GetAllLogDrainsManagedBy1 `json:"managedBy"`
}
...
func (o *GetAllLogDrainsProjectAccessAll) GetManagedBy() GetAllLogDrainsManagedBy1 {
	if o == nil {
		return GetAllLogDrainsManagedBy1("")
	}
	return o.ManagedBy
}
...
func (o *GetAllLogDrainsDrains2) GetTeamID() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.TeamID
...
type GetAllLogDrainsAuditLog1 struct {
}

func (g GetAllLogDrainsAuditLog1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAllLogDrainsAuditLog1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
type GetAllLogDrainsSchemas1 struct {
	...
	AuditLog      *GetAllLogDrainsAuditLog1      `json:"audit_log,omitempty"`
}
...
func (o *GetAllLogDrainsSchemas1) GetAuditLog() *GetAllLogDrainsAuditLog1 {
	if o == nil {
		return nil
	}
	return o.AuditLog
...
func (o *GetAllLogDrainsDrains1) GetTeamID() optionalnullable.OptionalNullable[string] {
	if o == nil {
		return nil
	}
	return o.TeamID
...
const (
	GetAllLogDrainsFrameworkActixWeb       GetAllLogDrainsFramework = "actix-web"
	GetAllLogDrainsFrameworkAngular        GetAllLogDrainsFramework = "angular"
	GetAllLogDrainsFrameworkAsh            GetAllLogDrainsFramework = "ash"
	GetAllLogDrainsFrameworkAstro          GetAllLogDrainsFramework = "astro"
	GetAllLogDrainsFrameworkAxum           GetAllLogDrainsFramework = "axum"
	...
	GetAllLogDrainsFrameworkMastra         GetAllLogDrainsFramework = "mastra"
	...
	GetAllLogDrainsFrameworkSanityV2       GetAllLogDrainsFramework = "sanity-v2"
...
type GetAllLogDrainsProjectsMetadatum struct {
	ID               string                                                      `json:"id"`
	Name             string                                                      `json:"name"`
	Framework        optionalnullable.OptionalNullable[GetAllLogDrainsFramework] `json:"framework,omitempty"`
...
func (o *GetAllLogDrainsProjectsMetadatum) GetFramework() optionalnullable.OptionalNullable[GetAllLogDrainsFramework] {
	if o == nil {
		return nil
	}
	return o.Framework
...
type GetAllLogDrainsResponseBody1 struct {
	...
	ProjectsMetadata            optionalnullable.OptionalNullable[[]GetAllLogDrainsProjectsMetadatum] `json:"projectsMetadata,omitempty"`
	IntegrationIcon             *string                                                               `json:"integrationIcon,omitempty"`
	IntegrationConfigurationURI *string                                                               `json:"integrationConfigurationUri,omitempty"`
	IntegrationWebsite          *string                                                               `json:"integrationWebsite,omitempty"`
}
...
func (o *GetAllLogDrainsResponseBody1) GetProjectsMetadata() optionalnullable.OptionalNullable[[]GetAllLogDrainsProjectsMetadatum] {
	if o == nil {
		return nil
	}
