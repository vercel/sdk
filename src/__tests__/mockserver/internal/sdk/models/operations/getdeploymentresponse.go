...
// GetDeploymentSourceEnum1 - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	GetDeploymentSourceEnum1Drop                GetDeploymentSourceEnum1 = "drop"
)
...
func (o *GetDeploymentOidcTokenClaims1) GetCustomEnvironmentID() *string {
	if o == nil {
		return nil
	}
