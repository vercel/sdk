...
type GetDrainsAuditLog2 struct {
}

func (g GetDrainsAuditLog2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetDrainsAuditLog2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
type GetDrainsSchemas2 struct {
	...
	AuditLog      *GetDrainsAuditLog2      `json:"audit_log,omitempty"`
}
...
func (o *GetDrainsSchemas2) GetAuditLog() *GetDrainsAuditLog2 {
	if o == nil {
		return nil
	}
	return o.AuditLog
...
func (d *DrainsGetDrains2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &d, "", false, []string{"id", "createdAt", "updatedAt", "name", "ownerId", "schemas", "delivery", "source"}); err != nil {
		return err
	}
	return nil
}
...
type GetDrainsAuditLog1 struct {
}

func (g GetDrainsAuditLog1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetDrainsAuditLog1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, nil); err != nil {
		return err
	}
	return nil
...
type GetDrainsSchemas1 struct {
	...
	AuditLog      *GetDrainsAuditLog1      `json:"audit_log,omitempty"`
}
...
func (o *GetDrainsSchemas1) GetAuditLog() *GetDrainsAuditLog1 {
	if o == nil {
		return nil
	}
	return o.AuditLog
