...
type GetProjectEnvTypeBlobWebhookPublicKey2 string

const (
	GetProjectEnvTypeBlobWebhookPublicKey2BlobWebhookPublicKey GetProjectEnvTypeBlobWebhookPublicKey2 = "blob-webhook-public-key"
)

func (e GetProjectEnvTypeBlobWebhookPublicKey2) ToPointer() *GetProjectEnvTypeBlobWebhookPublicKey2 {
	return &e
}
func (e *GetProjectEnvTypeBlobWebhookPublicKey2) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "blob-webhook-public-key":
		*e = GetProjectEnvTypeBlobWebhookPublicKey2(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectEnvTypeBlobWebhookPublicKey2: %v", v)
	}
}

type GetProjectEnvContentHintBlobWebhookPublicKey2 struct {
	Type    GetProjectEnvTypeBlobWebhookPublicKey2 `json:"type"`
	StoreID string                                 `json:"storeId"`
}

func (g GetProjectEnvContentHintBlobWebhookPublicKey2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetProjectEnvContentHintBlobWebhookPublicKey2) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, []string{"type", "storeId"}); err != nil {
		return err
	}
	return nil
...
func (o *GetProjectEnvContentHintBlobWebhookPublicKey2) GetType() GetProjectEnvTypeBlobWebhookPublicKey2 {
	if o == nil {
		return GetProjectEnvTypeBlobWebhookPublicKey2("")
	}
	return o.Type
}

func (o *GetProjectEnvContentHintBlobWebhookPublicKey2) GetStoreID() string {
	if o == nil {
		return ""
	}
	return o.StoreID
...
const (
	...
	GetProjectEnvContentHintUnion2TypeBlobWebhookPublicKey      GetProjectEnvContentHintUnion2Type = "blob-webhook-public-key"
...
type GetProjectEnvContentHintUnion2 struct {
	...
	GetProjectEnvContentHintBlobWebhookPublicKey2      *GetProjectEnvContentHintBlobWebhookPublicKey2      `queryParam:"inline"`
...
func CreateGetProjectEnvContentHintUnion2BlobWebhookPublicKey(blobWebhookPublicKey GetProjectEnvContentHintBlobWebhookPublicKey2) GetProjectEnvContentHintUnion2 {
	typ := GetProjectEnvContentHintUnion2TypeBlobWebhookPublicKey

	typStr := GetProjectEnvTypeBlobWebhookPublicKey2(typ)
	blobWebhookPublicKey.Type = typStr

	return GetProjectEnvContentHintUnion2{
		GetProjectEnvContentHintBlobWebhookPublicKey2: &blobWebhookPublicKey,
		Type: typ,
	}
}
...
func (u *GetProjectEnvContentHintUnion2) UnmarshalJSON(data []byte) error {
	...
	case "blob-store-id":
		...
		return nil
	case "blob-webhook-public-key":
		getProjectEnvContentHintBlobWebhookPublicKey2 := new(GetProjectEnvContentHintBlobWebhookPublicKey2)
		if err := utils.UnmarshalJSON(data, &getProjectEnvContentHintBlobWebhookPublicKey2, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == blob-webhook-public-key) type GetProjectEnvContentHintBlobWebhookPublicKey2 within GetProjectEnvContentHintUnion2: %w", string(data), err)
		}

		u.GetProjectEnvContentHintBlobWebhookPublicKey2 = getProjectEnvContentHintBlobWebhookPublicKey2
		u.Type = GetProjectEnvContentHintUnion2TypeBlobWebhookPublicKey
		return nil
	case "postgres-url":
...
func (u GetProjectEnvContentHintUnion2) MarshalJSON() ([]byte, error) {
	...
	if u.GetProjectEnvContentHintBlobWebhookPublicKey2 != nil {
		return utils.MarshalJSON(u.GetProjectEnvContentHintBlobWebhookPublicKey2, "", true)
	}
...
func (o *GetProjectEnvResponseBody2) GetContentHintBlobWebhookPublicKey() *GetProjectEnvContentHintBlobWebhookPublicKey2 {
	if v := o.GetContentHint(); v != nil {
		if actualValue, ok := v.Get(); ok && actualValue != nil {
			return actualValue.GetProjectEnvContentHintBlobWebhookPublicKey2
		}
		return nil
	}
	return nil
...
type GetProjectEnvTypeBlobWebhookPublicKey1 string

const (
	GetProjectEnvTypeBlobWebhookPublicKey1BlobWebhookPublicKey GetProjectEnvTypeBlobWebhookPublicKey1 = "blob-webhook-public-key"
)

func (e GetProjectEnvTypeBlobWebhookPublicKey1) ToPointer() *GetProjectEnvTypeBlobWebhookPublicKey1 {
	return &e
}
func (e *GetProjectEnvTypeBlobWebhookPublicKey1) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "blob-webhook-public-key":
		*e = GetProjectEnvTypeBlobWebhookPublicKey1(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetProjectEnvTypeBlobWebhookPublicKey1: %v", v)
	}
}

type GetProjectEnvContentHintBlobWebhookPublicKey1 struct {
	Type    GetProjectEnvTypeBlobWebhookPublicKey1 `json:"type"`
	StoreID string                                 `json:"storeId"`
}

func (g GetProjectEnvContentHintBlobWebhookPublicKey1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetProjectEnvContentHintBlobWebhookPublicKey1) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &g, "", false, []string{"type", "storeId"}); err != nil {
		return err
	}
	return nil
...
func (o *GetProjectEnvContentHintBlobWebhookPublicKey1) GetType() GetProjectEnvTypeBlobWebhookPublicKey1 {
	if o == nil {
		return GetProjectEnvTypeBlobWebhookPublicKey1("")
	}
	return o.Type
}

func (o *GetProjectEnvContentHintBlobWebhookPublicKey1) GetStoreID() string {
	if o == nil {
		return ""
	}
	return o.StoreID
...
const (
	...
	GetProjectEnvContentHintUnion1TypeBlobWebhookPublicKey      GetProjectEnvContentHintUnion1Type = "blob-webhook-public-key"
...
type GetProjectEnvContentHintUnion1 struct {
	...
	GetProjectEnvContentHintBlobWebhookPublicKey1      *GetProjectEnvContentHintBlobWebhookPublicKey1      `queryParam:"inline"`
...
func CreateGetProjectEnvContentHintUnion1BlobWebhookPublicKey(blobWebhookPublicKey GetProjectEnvContentHintBlobWebhookPublicKey1) GetProjectEnvContentHintUnion1 {
	typ := GetProjectEnvContentHintUnion1TypeBlobWebhookPublicKey

	typStr := GetProjectEnvTypeBlobWebhookPublicKey1(typ)
	blobWebhookPublicKey.Type = typStr

	return GetProjectEnvContentHintUnion1{
		GetProjectEnvContentHintBlobWebhookPublicKey1: &blobWebhookPublicKey,
		Type: typ,
	}
}
...
func (u *GetProjectEnvContentHintUnion1) UnmarshalJSON(data []byte) error {
	...
	case "blob-store-id":
		...
		return nil
	case "blob-webhook-public-key":
		getProjectEnvContentHintBlobWebhookPublicKey1 := new(GetProjectEnvContentHintBlobWebhookPublicKey1)
		if err := utils.UnmarshalJSON(data, &getProjectEnvContentHintBlobWebhookPublicKey1, "", true, nil); err != nil {
			return fmt.Errorf("could not unmarshal `%s` into expected (Type == blob-webhook-public-key) type GetProjectEnvContentHintBlobWebhookPublicKey1 within GetProjectEnvContentHintUnion1: %w", string(data), err)
		}

		u.GetProjectEnvContentHintBlobWebhookPublicKey1 = getProjectEnvContentHintBlobWebhookPublicKey1
		u.Type = GetProjectEnvContentHintUnion1TypeBlobWebhookPublicKey
		return nil
	case "postgres-url":
...
func (u GetProjectEnvContentHintUnion1) MarshalJSON() ([]byte, error) {
	...
	if u.GetProjectEnvContentHintBlobWebhookPublicKey1 != nil {
		return utils.MarshalJSON(u.GetProjectEnvContentHintBlobWebhookPublicKey1, "", true)
	}
...
func (o *GetProjectEnvResponseBody1) GetContentHintBlobWebhookPublicKey() *GetProjectEnvContentHintBlobWebhookPublicKey1 {
	if v := o.GetContentHint(); v != nil {
		if actualValue, ok := v.Get(); ok && actualValue != nil {
			return actualValue.GetProjectEnvContentHintBlobWebhookPublicKey1
		}
		return nil
	}
	return nil
