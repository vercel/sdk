...
const (
	...
	GetRollingReleaseCurrentDeploymentReadyStateBlocked      GetRollingReleaseCurrentDeploymentReadyState = "BLOCKED"
...
// GetRollingReleaseCurrentDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	GetRollingReleaseCurrentDeploymentSourceDrop                GetRollingReleaseCurrentDeploymentSource = "drop"
)
...
const (
	...
	GetRollingReleaseCanaryDeploymentReadyStateBlocked      GetRollingReleaseCanaryDeploymentReadyState = "BLOCKED"
...
// GetRollingReleaseCanaryDeploymentSource - Where was the deployment created from. Best-effort guess for metrics only — not authoritative; do not gate behavior on it.
...
const (
	...
	GetRollingReleaseCanaryDeploymentSourceDrop                GetRollingReleaseCanaryDeploymentSource = "drop"
)
...
func (o *GetRollingReleaseRollingRelease) GetCurrentCanaryPercentage() *float64 {
	if o == nil {
		return nil
	}
