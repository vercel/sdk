...
type HighlightedDetail struct {
	Label string  `json:"label"`
	Value *string `json:"value,omitempty"`
}

func (o *HighlightedDetail) GetLabel() string {
	if o == nil {
		return ""
	}
	return o.Label
...
func (o *HighlightedDetail) GetValue() *string {
	if o == nil {
		return nil
	}
	return o.Value
...
type GetV1IntegrationsIntegrationIntegrationIDOrSlugProductsProductIDOrSlugPlansPlan struct {
	...
	HighlightedDetails                 []HighlightedDetail                                                                 `json:"highlightedDetails,omitempty"`
...
func (o *GetV1IntegrationsIntegrationIntegrationIDOrSlugProductsProductIDOrSlugPlansPlan) GetHighlightedDetails() []HighlightedDetail {
	if o == nil {
		return nil
	}
...
func (o *GetV1IntegrationsIntegrationIntegrationIDOrSlugProductsProductIDOrSlugPlansPlan) GetQuote() []Quote {
	if o == nil {
		return nil
	}
	return o.Quote
