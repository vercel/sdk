...
// ProjectConsolidatedGitCommitStatus2 - Configuration for consolidated git commit status reporting. When enabled, Vercel will post a single consolidated commit status instead of individual statuses for each deployment.
type ProjectConsolidatedGitCommitStatus2 struct {
...
func (p ProjectConsolidatedGitCommitStatus2) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *ProjectConsolidatedGitCommitStatus2) UnmarshalJSON(data []byte) error {
...
func (o *ProjectConsolidatedGitCommitStatus2) GetEnabled() bool {
	if o == nil {
		return false
	}
	return o.Enabled
...
func (o *ProjectConsolidatedGitCommitStatus2) GetPropagateFailures() bool {
	if o == nil {
		return false
	}
...
type ProjectGitProviderOptions2 struct {
	...
	ConsolidatedGitCommitStatus *ProjectConsolidatedGitCommitStatus2 `json:"consolidatedGitCommitStatus,omitempty"`
}
...
func (o *ProjectGitProviderOptions2) GetConsolidatedGitCommitStatus() *ProjectConsolidatedGitCommitStatus2 {
	if o == nil {
		return nil
	}
