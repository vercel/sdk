...
type GetProjectsProject2 struct {
	...
	TrustedOidcProviders                 optionalnullable.OptionalNullable[ProjectTrustedOidcProviders2]  `json:"trustedOidcProviders,omitempty"`
...
func (o *GetProjectsProject2) GetTrustedOidcProviders() optionalnullable.OptionalNullable[ProjectTrustedOidcProviders2] {
	if o == nil {
		return nil
	}
