...
type SearchRepoOwner struct {
	ID   OwnerID `json:"id"`
	Name string  `json:"name"`
}

func (s SearchRepoOwner) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(s, "", false)
}

func (s *SearchRepoOwner) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &s, "", false, []string{"id", "name"}); err != nil {
		return err
	}
	return nil
}

func (o *SearchRepoOwner) GetID() OwnerID {
	if o == nil {
		return OwnerID{}
	}
	return o.ID
...
func (o *SearchRepoOwner) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
type Repo struct {
	...
	Owner         SearchRepoOwner     `json:"owner"`
...
func (o *Repo) GetOwner() SearchRepoOwner {
	if o == nil {
