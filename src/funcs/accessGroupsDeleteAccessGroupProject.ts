...
import {
  ...
  DeleteAccessGroupProjectRequest$outboundSchema,
} from "../models/deleteaccessgroupprojectop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function accessGroupsDeleteAccessGroupProject(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteAccessGroupProjectRequest$outboundSchema.parse(value),
