...
import {
  ...
  ReadAccessGroupProjectRequest$outboundSchema,
  ReadAccessGroupProjectResponseBody,
  ReadAccessGroupProjectResponseBody$inboundSchema,
 ...
 */
export function accessGroupsReadAccessGroupProject(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ReadAccessGroupProjectRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ReadAccessGroupProjectResponseBody$inboundSchema),
