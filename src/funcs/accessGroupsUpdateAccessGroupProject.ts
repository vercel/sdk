...
import {
  ...
  UpdateAccessGroupProjectRequest$outboundSchema,
 ...
 */
export function accessGroupsUpdateAccessGroupProject(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateAccessGroupProjectRequest$outboundSchema.parse(value),
