...
import {
  ...
  CreateAiGatewayRuleRequest$outboundSchema,
} from "../models/createaigatewayruleop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function apiAiGatewayCreateAiGatewayRule(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateAiGatewayRuleRequest$outboundSchema.parse(value),
