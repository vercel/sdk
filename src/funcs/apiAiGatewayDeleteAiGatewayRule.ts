...
import {
  ...
  DeleteAiGatewayRuleRequest$outboundSchema,
} from "../models/deleteaigatewayruleop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function apiAiGatewayDeleteAiGatewayRule(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteAiGatewayRuleRequest$outboundSchema.parse(value),
