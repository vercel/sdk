...
import {
  ...
  DeleteAiGatewayVirtualModelConfigRequest$outboundSchema,
} from "../models/deleteaigatewayvirtualmodelconfigop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function apiAiGatewayDeleteAiGatewayVirtualModelConfig(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      DeleteAiGatewayVirtualModelConfigRequest$outboundSchema.parse(value),
