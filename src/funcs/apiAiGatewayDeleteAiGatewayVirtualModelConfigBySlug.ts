...
import {
  ...
  DeleteAiGatewayVirtualModelConfigBySlugRequest$outboundSchema,
} from "../models/deleteaigatewayvirtualmodelconfigbyslugop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function apiAiGatewayDeleteAiGatewayVirtualModelConfigBySlug(
  client: VercelCore,
