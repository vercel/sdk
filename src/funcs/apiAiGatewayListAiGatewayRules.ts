...
import {
  AiGatewayRuleList,
  AiGatewayRuleList$inboundSchema,
} from "../models/aigatewayrulelist.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
...
import {
  ...
  ListAiGatewayRulesRequest$outboundSchema,
} from "../models/listaigatewayrulesop.js";
 ...
 */
export function apiAiGatewayListAiGatewayRules(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListAiGatewayRulesRequest$outboundSchema.parse(value),
