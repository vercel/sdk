...
import {
  AiGatewayRule,
  AiGatewayRule$inboundSchema,
} from "../models/aigatewayrule.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
...
import {
  ...
  UpdateAiGatewayRuleRequest$outboundSchema,
} from "../models/updateaigatewayruleop.js";
 ...
 */
export function apiAiGatewayUpdateAiGatewayRule(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateAiGatewayRuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AiGatewayRule$inboundSchema),
