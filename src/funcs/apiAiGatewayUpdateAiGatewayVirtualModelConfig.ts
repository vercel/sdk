...
import {
  ...
  UpdateAiGatewayVirtualModelConfigRequest$outboundSchema,
} from "../models/updateaigatewayvirtualmodelconfigop.js";
 ...
 */
export function apiAiGatewayUpdateAiGatewayVirtualModelConfig(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      UpdateAiGatewayVirtualModelConfigRequest$outboundSchema.parse(value),
