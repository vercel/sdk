...
import {
  ...
  DeleteAllArtifactsRequest$outboundSchema,
  DeleteAllArtifactsResponseBody,
  DeleteAllArtifactsResponseBody$inboundSchema,
 ...
 */
export function artifactsDeleteAllArtifacts(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteAllArtifactsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deleteAllArtifacts",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteAllArtifactsResponseBody$inboundSchema),
