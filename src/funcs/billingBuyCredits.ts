...
import {
  BuyCreditsRequest,
  BuyCreditsRequest$outboundSchema,
  BuyCreditsResponseBody,
  BuyCreditsResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => BuyCreditsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/billing/buy")();
