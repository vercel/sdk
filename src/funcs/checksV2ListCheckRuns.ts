...
import {
  ...
  ListCheckRunsRequest$outboundSchema,
  ListCheckRunsResponseBody,
  ListCheckRunsResponseBody$inboundSchema,
 ...
 */
export function checksV2ListCheckRuns(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListCheckRunsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListCheckRunsResponseBody$inboundSchema),
