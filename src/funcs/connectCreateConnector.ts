...
} from "../models/connectconnectorcreateresult.js";
import {
  ConnectError,
...
import {
  ...
  CreateConnectorRequest$outboundSchema,
 ...
 */
export function connectCreateConnector(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateConnectorRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ConnectCreateConnectorRequest, {
    explode: true,
  });

  const path = pathToFunc("/v1/connect/connectors")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, ConnectConnectorCreateResult$inboundSchema),
