...
import {
  ...
  CreateConnectorAuthorizationRequestRequest$outboundSchema,
  CreateConnectorAuthorizationRequestResponseBody,
  CreateConnectorAuthorizationRequestResponseBody$inboundSchema,
 ...
 */
export function connectCreateConnectorAuthorizationRequest(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      CreateConnectorAuthorizationRequestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/connect/authorize/{connector}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateConnectorAuthorizationRequestResponseBody$inboundSchema),
