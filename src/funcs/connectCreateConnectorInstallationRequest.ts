...
import {
  ...
  CreateConnectorInstallationRequestRequest$outboundSchema,
  CreateConnectorInstallationRequestResponseBody,
  CreateConnectorInstallationRequestResponseBody$inboundSchema,
 ...
 */
export function connectCreateConnectorInstallationRequest(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      CreateConnectorInstallationRequestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/connect/install/{connector}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateConnectorInstallationRequestResponseBody$inboundSchema),
