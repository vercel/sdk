...
import {
  ...
  DeleteConnectorRequest$outboundSchema,
} from "../models/deleteconnectorop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function connectDeleteConnector(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteConnectorRequest$outboundSchema.parse(value),
