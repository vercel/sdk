...
import {
  ...
  ImportConnectorTokensRequest$outboundSchema,
  ImportConnectorTokensResponseBody,
  ImportConnectorTokensResponseBody$inboundSchema,
 ...
 */
export function connectImportConnectorTokens(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ImportConnectorTokensRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/connect/token/{connector}/import")(pathParams);
  ...
  const context = {
    ...
    operationID: "importConnectorTokens",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ImportConnectorTokensResponseBody$inboundSchema),
