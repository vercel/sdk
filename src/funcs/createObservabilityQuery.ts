...
import {
  ...
  CreateObservabilityQueryRequestBody$outboundSchema,
  CreateObservabilityQueryResponseBody,
  CreateObservabilityQueryResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      CreateObservabilityQueryRequestBody$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/observability/query")();
  ...
  const context = {
    ...
    operationID: "createObservabilityQuery",
    oAuth2Scopes: null,
