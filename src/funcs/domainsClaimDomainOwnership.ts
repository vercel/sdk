...
import {
  ...
  ClaimDomainOwnershipRequest$outboundSchema,
  ClaimDomainOwnershipResponseBody,
  ClaimDomainOwnershipResponseBody$inboundSchema,
 ...
 */
export function domainsClaimDomainOwnership(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ClaimDomainOwnershipRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v9/domains/{domain}/claim")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ClaimDomainOwnershipResponseBody$inboundSchema),
