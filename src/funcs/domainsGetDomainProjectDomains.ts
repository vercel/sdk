...
import {
  ...
  GetDomainProjectDomainsRequest$outboundSchema,
  GetDomainProjectDomainsResponseBody,
  GetDomainProjectDomainsResponseBody$inboundSchema,
 ...
 */
export function domainsGetDomainProjectDomains(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetDomainProjectDomainsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/domains/{domain}/project-domains")(pathParams);
  ...
  const context = {
    ...
    operationID: "getDomainProjectDomains",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetDomainProjectDomainsResponseBody$inboundSchema),
