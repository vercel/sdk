...
import {
  ...
  GetDomainVerificationRecordRequest$outboundSchema,
  GetDomainVerificationRecordResponseBody,
  GetDomainVerificationRecordResponseBody$inboundSchema,
 ...
 */
export function domainsGetDomainVerificationRecord(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetDomainVerificationRecordRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v9/domains/{domain}/verification")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetDomainVerificationRecordResponseBody$inboundSchema),
