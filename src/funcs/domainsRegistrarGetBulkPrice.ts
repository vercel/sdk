...
import {
  ...
  GetBulkPriceDomainsRegistrarResponseBody$inboundSchema,
  GetBulkPriceRequest,
  GetBulkPriceRequest$outboundSchema,
  GetBulkPriceResponseBody,
  GetBulkPriceResponseBody$inboundSchema,
 ...
 */
export function domainsRegistrarGetBulkPrice(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetBulkPriceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/registrar/domains/price")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetBulkPriceResponseBody$inboundSchema),
    M.jsonErr(400, GetBulkPriceDomainsRegistrarResponseBody$inboundSchema),
