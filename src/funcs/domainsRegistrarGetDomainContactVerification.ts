...
import {
  ...
  GetDomainContactVerificationRequest$outboundSchema,
  GetDomainContactVerificationResponseBody,
  GetDomainContactVerificationResponseBody$inboundSchema,
 ...
 */
export function domainsRegistrarGetDomainContactVerification(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetDomainContactVerificationRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getDomainContactVerification",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetDomainContactVerificationResponseBody$inboundSchema),
    M.jsonErr(
      400,
      GetDomainContactVerificationDomainsRegistrarResponseBody$inboundSchema,
    ),
