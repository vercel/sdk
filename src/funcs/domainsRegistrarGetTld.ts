...
import {
  ...
  GetTldDomainsRegistrarResponseBody$inboundSchema,
  GetTldRequest,
  GetTldRequest$outboundSchema,
  GetTldResponseBody,
  GetTldResponseBody$inboundSchema,
} from "../models/gettldop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function domainsRegistrarGetTld(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetTldRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/registrar/tlds/{tld}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetTldResponseBody$inboundSchema),
    M.jsonErr(400, GetTldDomainsRegistrarResponseBody$inboundSchema),
