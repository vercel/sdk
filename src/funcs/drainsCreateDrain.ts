...
import {
  CreateDrainRequest,
  CreateDrainRequest$outboundSchema,
 ...
 */
export function drainsCreateDrain(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateDrainRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/drains")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateDrainResponseBody$inboundSchema),
