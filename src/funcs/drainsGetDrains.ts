...
import {
  GetDrainsRequest,
  GetDrainsRequest$outboundSchema,
  GetDrainsResponseBody,
  GetDrainsResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetDrainsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetDrainsResponseBody$inboundSchema),
