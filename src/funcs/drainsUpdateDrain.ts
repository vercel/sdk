...
import {
  UpdateDrainRequest,
  UpdateDrainRequest$outboundSchema,
  UpdateDrainResponseBody,
  UpdateDrainResponseBody$inboundSchema,
 ...
 */
export function drainsUpdateDrain(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateDrainRequest$outboundSchema.parse(value),
