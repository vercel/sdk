...
import {
  ...
  CreateCustomEnvironmentRequest$outboundSchema,
 ...
 */
export function environmentCreateCustomEnvironment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateCustomEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, CreateCustomEnvironmentResponseBody$inboundSchema),
