...
import {
  ...
  CreateSharedEnvVariableRequest$outboundSchema,
 ...
 */
export function environmentCreateSharedEnvVariable(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateSharedEnvVariableRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, CreateSharedEnvVariableResponseBody$inboundSchema),
