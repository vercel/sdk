...
import {
  ...
  DeleteSharedEnvVariableRequest$outboundSchema,
 ...
 */
export function environmentDeleteSharedEnvVariable(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteSharedEnvVariableRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteSharedEnvVariableResponseBody$inboundSchema),
