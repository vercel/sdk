...
import {
  ...
  GetCustomEnvironmentRequest$outboundSchema,
  GetCustomEnvironmentResponseBody,
  GetCustomEnvironmentResponseBody$inboundSchema,
 ...
 */
export function environmentGetCustomEnvironment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetCustomEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetCustomEnvironmentResponseBody$inboundSchema),
