...
import {
  ...
  GetProjectsByIdOrNameCustomEnvironmentsRequest$outboundSchema,
  GetProjectsByIdOrNameCustomEnvironmentsResponseBody,
  GetProjectsByIdOrNameCustomEnvironmentsResponseBody$inboundSchema,
 ...
 */
export function environmentGetProjectsByIdOrNameCustomEnvironments(
  client: VercelCore,
