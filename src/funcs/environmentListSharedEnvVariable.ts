...
import {
  ...
  ListSharedEnvVariableRequest$outboundSchema,
  ListSharedEnvVariableResponseBody,
  ListSharedEnvVariableResponseBody$inboundSchema,
 ...
 */
export function environmentListSharedEnvVariable(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListSharedEnvVariableRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListSharedEnvVariableResponseBody$inboundSchema),
