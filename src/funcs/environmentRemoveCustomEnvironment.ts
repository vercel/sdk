...
import {
  ...
  RemoveCustomEnvironmentRequest$outboundSchema,
 ...
 */
export function environmentRemoveCustomEnvironment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => RemoveCustomEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RemoveCustomEnvironmentResponseBody$inboundSchema),
