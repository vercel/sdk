...
import {
  ...
  UnlinkSharedEnvVariableRequest$outboundSchema,
 ...
 * Disconnects a shared environment variable for a given project
 */
export function environmentUnlinkSharedEnvVariable(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UnlinkSharedEnvVariableRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/env/{id}/unlink/{projectId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UnlinkSharedEnvVariableResponseBody$inboundSchema),
