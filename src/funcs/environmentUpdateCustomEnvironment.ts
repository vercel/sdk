...
import {
  ...
  UpdateCustomEnvironmentRequest$outboundSchema,
 ...
 */
export function environmentUpdateCustomEnvironment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateCustomEnvironmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateCustomEnvironmentResponseBody$inboundSchema),
