...
import {
  ...
  UpdateSharedEnvVariableRequest$outboundSchema,
 ...
 */
export function environmentUpdateSharedEnvVariable(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateSharedEnvVariableRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateSharedEnvVariableResponseBody$inboundSchema),
