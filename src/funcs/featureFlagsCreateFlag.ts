...
import {
  CreateFlagRequest,
  CreateFlagRequest$outboundSchema,
  CreateFlagResponseBody,
  CreateFlagResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateFlagRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, CreateFlagResponseBody$inboundSchema),
