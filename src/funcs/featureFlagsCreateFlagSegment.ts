...
import {
  ...
  CreateFlagSegmentRequest$outboundSchema,
  CreateFlagSegmentResponseBody,
  CreateFlagSegmentResponseBody$inboundSchema,
 ...
 */
export function featureFlagsCreateFlagSegment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateFlagSegmentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, CreateFlagSegmentResponseBody$inboundSchema),
