...
import {
  ...
  DeleteFlagSegmentRequest$outboundSchema,
} from "../models/deleteflagsegmentop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function featureFlagsDeleteFlagSegment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteFlagSegmentRequest$outboundSchema.parse(value),
