...
import {
  DeleteSDKKeyRequest,
  DeleteSDKKeyRequest$outboundSchema,
} from "../models/deletesdkkeyop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteSDKKeyRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    hashKey: encodeSimple("hashKey", payload.hashKey, {
      explode: false,
