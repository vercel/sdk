...
import {
  ...
  GetFlagSegmentRequest$outboundSchema,
} from "../models/getflagsegmentop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function featureFlagsGetFlagSegment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetFlagSegmentRequest$outboundSchema.parse(value),
