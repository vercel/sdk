...
import {
  ...
  GetFlagSettingsRequest$outboundSchema,
  GetFlagSettingsResponseBody,
  GetFlagSettingsResponseBody$inboundSchema,
 ...
 */
export function featureFlagsGetFlagSettings(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetFlagSettingsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetFlagSettingsResponseBody$inboundSchema),
