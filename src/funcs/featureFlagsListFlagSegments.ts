...
import {
  ...
  ListFlagSegmentsRequest$outboundSchema,
  ListFlagSegmentsResponseBody,
  ListFlagSegmentsResponseBody$inboundSchema,
 ...
 */
export function featureFlagsListFlagSegments(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListFlagSegmentsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListFlagSegmentsResponseBody$inboundSchema),
