...
import {
  ...
  ListFlagVersionsRequest$outboundSchema,
  ListFlagVersionsResponseBody,
  ListFlagVersionsResponseBody$inboundSchema,
 ...
 */
export function featureFlagsListFlagVersions(
  client: VercelCore,
  request: ListFlagVersionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    ListFlagVersionsResponseBody | undefined,
    | VercelError
...
> {
  const parsed = safeParse(
    request,
    (value) => ListFlagVersionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, types$.optional(ListFlagVersionsResponseBody$inboundSchema)),
    M.nil(304, types$.optional(ListFlagVersionsResponseBody$inboundSchema)),
