...
import {
  ListFlagsV2Request,
  ListFlagsV2Request$outboundSchema,
  ListFlagsV2ResponseBody,
  ListFlagsV2ResponseBody$inboundSchema,
 ...
 */
export function featureFlagsListFlagsV2(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListFlagsV2Request$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/projects/{projectIdOrName}/feature-flags/flags")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListFlagsV2ResponseBody$inboundSchema),
