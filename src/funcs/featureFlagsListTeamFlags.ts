...
import {
  ...
  ListTeamFlagsRequest$outboundSchema,
  ListTeamFlagsResponseBody,
  ListTeamFlagsResponseBody$inboundSchema,
 ...
 */
export function featureFlagsListTeamFlags(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListTeamFlagsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/teams/{teamId}/feature-flags/flags")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListTeamFlagsResponseBody$inboundSchema),
