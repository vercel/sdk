...
import {
  ...
  ListTeamFlagsV2Request$outboundSchema,
  ListTeamFlagsV2ResponseBody,
  ListTeamFlagsV2ResponseBody$inboundSchema,
 ...
 */
export function featureFlagsListTeamFlagsV2(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListTeamFlagsV2Request$outboundSchema.parse(value),
