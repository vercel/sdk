...
import { Segment, Segment$inboundSchema } from "../models/segment.js";
import {
  UpdateFlagSegmentRequest,
  UpdateFlagSegmentRequest$outboundSchema,
} from "../models/updateflagsegmentop.js";
 ...
 */
export function featureFlagsUpdateFlagSegment(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateFlagSegmentRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    segmentIdOrSlug: encodeSimple("segmentIdOrSlug", payload.segmentIdOrSlug, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, Segment$inboundSchema),
