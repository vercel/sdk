...
import {
  ...
  GetEdgeConfigBackupRequest$outboundSchema,
  GetEdgeConfigBackupResponseBody,
  GetEdgeConfigBackupResponseBody$inboundSchema,
 ...
 */
export function globalConfigGetEdgeConfigBackup(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetEdgeConfigBackupRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetEdgeConfigBackupResponseBody$inboundSchema),
