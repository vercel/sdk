...
import {
  ...
  GetEdgeConfigBackupsRequest$outboundSchema,
  GetEdgeConfigBackupsResponseBody,
  GetEdgeConfigBackupsResponseBody$inboundSchema,
 ...
 */
export function globalConfigGetEdgeConfigBackups(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetEdgeConfigBackupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/global-config/{edgeConfigId}/backups")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetEdgeConfigBackupsResponseBody$inboundSchema),
