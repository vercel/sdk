...
import {
  GlobalConfigToken,
  GlobalConfigToken$inboundSchema,
} from "../models/globalconfigtoken.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function globalConfigGetEdgeConfigToken(
  client: VercelCore,
...
> {
  ...
  const path = pathToFunc("/v1/global-config/{edgeConfigId}/token/{token}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GlobalConfigToken$inboundSchema),
