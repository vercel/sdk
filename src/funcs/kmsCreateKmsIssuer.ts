...
import {
  ...
  CreateKmsIssuerRequest$outboundSchema,
  CreateKmsIssuerResponseBody,
  CreateKmsIssuerResponseBody$inboundSchema,
 ...
 */
export function kmsCreateKmsIssuer(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateKmsIssuerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/kms/issuers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, CreateKmsIssuerResponseBody$inboundSchema),
