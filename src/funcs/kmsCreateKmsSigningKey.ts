...
import {
  ...
  CreateKmsSigningKeyRequest$outboundSchema,
  CreateKmsSigningKeyResponseBody,
  CreateKmsSigningKeyResponseBody$inboundSchema,
 ...
 */
export function kmsCreateKmsSigningKey(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateKmsSigningKeyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/kms/issuers/{issuerId}/keys")(pathParams);
  ...
  const context = {
    ...
    operationID: "createKmsSigningKey",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateKmsSigningKeyResponseBody$inboundSchema),
