...
import {
  ...
  ListKmsIssuersRequest$outboundSchema,
  ListKmsIssuersResponseBody,
  ListKmsIssuersResponseBody$inboundSchema,
 ...
 */
export function kmsListKmsIssuers(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListKmsIssuersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListKmsIssuersResponseBody$inboundSchema),
