...
import {
  ...
  SignKmsMessageRequest$outboundSchema,
  SignKmsMessageResponseBody,
  SignKmsMessageResponseBody$inboundSchema,
 ...
 */
export function kmsSignKmsMessage(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => SignKmsMessageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/kms/issuers/{issuerId}/sign/message")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SignKmsMessageResponseBody$inboundSchema),
