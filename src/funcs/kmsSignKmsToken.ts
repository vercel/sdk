...
import {
  SignKmsTokenRequest,
  SignKmsTokenRequest$outboundSchema,
  SignKmsTokenResponseBody,
  SignKmsTokenResponseBody$inboundSchema,
 ...
 */
export function kmsSignKmsToken(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => SignKmsTokenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/kms/issuers/{issuerId}/sign/token")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, SignKmsTokenResponseBody$inboundSchema),
