...
import {
  ...
  FinalizeInstallationRequest$outboundSchema,
} from "../models/finalizeinstallationop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function marketplaceFinalizeInstallation(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => FinalizeInstallationRequest$outboundSchema.parse(value),
