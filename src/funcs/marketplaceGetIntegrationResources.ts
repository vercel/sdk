...
import {
  ...
  GetIntegrationResourcesRequest$outboundSchema,
 ...
 */
export function marketplaceGetIntegrationResources(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetIntegrationResourcesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetIntegrationResourcesResponseBody$inboundSchema),
