...
import {
  ...
  ImportResourceRequest$outboundSchema,
  ImportResourceResponseBody,
  ImportResourceResponseBody$inboundSchema,
 ...
 */
export function marketplaceImportResource(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ImportResourceRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.fail([400, 401, 403, 404, 409, 410, 422, 429, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
