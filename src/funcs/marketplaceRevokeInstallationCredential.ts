...
import {
  ...
  RevokeInstallationCredentialRequest$outboundSchema,
  RevokeInstallationCredentialResponseBody,
  RevokeInstallationCredentialResponseBody$inboundSchema,
 ...
 */
export function marketplaceRevokeInstallationCredential(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => RevokeInstallationCredentialRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RevokeInstallationCredentialResponseBody$inboundSchema),
