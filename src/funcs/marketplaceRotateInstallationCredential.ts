...
import {
  ...
  RotateInstallationCredentialRequest$outboundSchema,
  RotateInstallationCredentialResponseBody,
  RotateInstallationCredentialResponseBody$inboundSchema,
 ...
 */
export function marketplaceRotateInstallationCredential(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => RotateInstallationCredentialRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RotateInstallationCredentialResponseBody$inboundSchema),
