...
import {
  ...
  SubmitPrepaymentBalancesRequest$outboundSchema,
} from "../models/submitprepaymentbalancesop.js";
import {
 ...
 */
export function marketplaceSubmitPrepaymentBalances(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => SubmitPrepaymentBalancesRequest$outboundSchema.parse(value),
