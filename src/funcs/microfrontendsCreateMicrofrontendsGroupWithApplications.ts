...
import {
  ...
  CreateMicrofrontendsGroupWithApplicationsRequest$outboundSchema,
  CreateMicrofrontendsGroupWithApplicationsResponseBody,
  CreateMicrofrontendsGroupWithApplicationsResponseBody$inboundSchema,
 ...
 */
export function microfrontendsCreateMicrofrontendsGroupWithApplications(
  client: VercelCore,
...
> {
  ...
  const path = pathToFunc("/v1/microfrontends/group")();
