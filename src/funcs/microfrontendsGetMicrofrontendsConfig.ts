...
import {
  ...
  GetMicrofrontendsConfigRequest$outboundSchema,
  GetMicrofrontendsConfigResponseBody,
  GetMicrofrontendsConfigResponseBody$inboundSchema,
 ...
 */
export function microfrontendsGetMicrofrontendsConfig(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetMicrofrontendsConfigRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/microfrontends/{deploymentId}/config")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetMicrofrontendsConfigResponseBody$inboundSchema),
