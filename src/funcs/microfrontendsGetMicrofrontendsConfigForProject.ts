...
import {
  ...
  GetMicrofrontendsConfigForProjectRequest$outboundSchema,
  GetMicrofrontendsConfigForProjectResponseBody,
  GetMicrofrontendsConfigForProjectResponseBody$inboundSchema,
 ...
 */
export function microfrontendsGetMicrofrontendsConfigForProject(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      GetMicrofrontendsConfigForProjectRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetMicrofrontendsConfigForProjectResponseBody$inboundSchema),
