...
import {
  ...
  GetMicrofrontendsGroupsRequest$outboundSchema,
  GetMicrofrontendsGroupsResponseBody,
  GetMicrofrontendsGroupsResponseBody$inboundSchema,
 ...
 */
export function microfrontendsGetMicrofrontendsGroups(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetMicrofrontendsGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/microfrontends/groups")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetMicrofrontendsGroupsResponseBody$inboundSchema),
