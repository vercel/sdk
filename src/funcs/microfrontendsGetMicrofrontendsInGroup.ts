...
} from "../models/getmicrofrontendsingroupbuildmachineelasticreason.js";
import {
 ...
 */
export function microfrontendsGetMicrofrontendsInGroup(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetMicrofrontendsInGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/microfrontends/groups/{groupId}/projects")(
    pathParams,
  );
