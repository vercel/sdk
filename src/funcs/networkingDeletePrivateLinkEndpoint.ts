...
import {
  ...
  DeletePrivateLinkEndpointRequest$outboundSchema,
} from "../models/deleteprivatelinkendpointop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function networkingDeletePrivateLinkEndpoint(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeletePrivateLinkEndpointRequest$outboundSchema.parse(value),
