...
import {
  ...
  UpdateStaticIpsRequest$outboundSchema,
  UpdateStaticIpsResponseBody,
  UpdateStaticIpsResponseBody$inboundSchema,
 ...
 */
export function networkingUpdateStaticIps(
  client: VercelCore,
  request: UpdateStaticIpsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<UpdateStaticIpsResponseBody>,
    | VercelError
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateStaticIpsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(UpdateStaticIpsResponseBody$inboundSchema)),
