...
import {
  AddRouteRequest,
  AddRouteRequest$outboundSchema,
  AddRouteResponseBody,
  AddRouteResponseBody$inboundSchema,
} from "../models/addrouteop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function projectRoutesAddRoute(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => AddRouteRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AddRouteResponseBody$inboundSchema),
