...
import {
  DeleteRoutesRequest,
  DeleteRoutesRequest$outboundSchema,
  DeleteRoutesResponseBody,
  DeleteRoutesResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteRoutesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteRoutesResponseBody$inboundSchema),
