...
import {
  EditRouteRequest,
  EditRouteRequest$outboundSchema,
  EditRouteResponseBody,
  EditRouteResponseBody$inboundSchema,
 ...
 */
export function projectRoutesEditRoute(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => EditRouteRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/routes/{routeId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, EditRouteResponseBody$inboundSchema),
