...
import {
  ...
  GenerateRouteRequest$outboundSchema,
  GenerateRouteResponseBody,
  GenerateRouteResponseBody$inboundSchema,
 ...
 */
export function projectRoutesGenerateRoute(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GenerateRouteRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/routes/generate")(
    pathParams,
  );
