...
import {
  ...
  GetRouteVersionsRequest$outboundSchema,
  GetRouteVersionsResponseBody,
  GetRouteVersionsResponseBody$inboundSchema,
 ...
 */
export function projectRoutesGetRouteVersions(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetRouteVersionsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetRouteVersionsResponseBody$inboundSchema),
