...
import {
  GetRoutesRequest,
  GetRoutesRequest$outboundSchema,
  GetRoutesResponseBody,
  GetRoutesResponseBody$inboundSchema,
 ...
 */
export function projectRoutesGetRoutes(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetRoutesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetRoutesResponseBody$inboundSchema),
