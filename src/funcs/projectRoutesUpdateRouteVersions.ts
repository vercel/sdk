...
import {
  ...
  UpdateRouteVersionsRequest$outboundSchema,
  UpdateRouteVersionsResponseBody,
  UpdateRouteVersionsResponseBody$inboundSchema,
 ...
 */
export function projectRoutesUpdateRouteVersions(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateRouteVersionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/routes/versions")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateRouteVersionsResponseBody$inboundSchema),
