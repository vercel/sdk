...
import {
  ...
  CreateTraceSessionRequest$outboundSchema,
  CreateTraceSessionResponseBody,
  CreateTraceSessionResponseBody$inboundSchema,
 ...
 */
export function projectsCreateTraceSession(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateTraceSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/traces/session")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CreateTraceSessionResponseBody$inboundSchema),
