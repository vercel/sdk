...
import {
  ...
  DeleteProjectClientCertRequest$outboundSchema,
 ...
 */
export function projectsDeleteProjectClientCert(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteProjectClientCertRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/client-cert/{certId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteProjectClientCertResponseBody$inboundSchema),
