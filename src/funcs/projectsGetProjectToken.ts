...
import {
  ...
  GetProjectTokenRequest$outboundSchema,
  GetProjectTokenResponseBody,
  GetProjectTokenResponseBody$inboundSchema,
 ...
 */
export function projectsGetProjectToken(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetProjectTokenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/token")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetProjectTokenResponseBody$inboundSchema),
