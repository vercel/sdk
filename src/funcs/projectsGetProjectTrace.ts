...
import {
  ...
  GetProjectTraceRequest$outboundSchema,
  GetProjectTraceResponseBody,
  GetProjectTraceResponseBody$inboundSchema,
 ...
 */
export function projectsGetProjectTrace(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetProjectTraceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/traces")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetProjectTraceResponseBody$inboundSchema),
