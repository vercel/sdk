...
} from "../models/updatemicrofrontendsprojectsfunctiondefaultmemorytype.js";
import {
 ...
 */
export function projectsUpdateMicrofrontends(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateMicrofrontendsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{projectId}/microfrontends")(
    pathParams,
  );
