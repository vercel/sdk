...
} from "../models/uploadprojectavatarcve55182migrationappliedfrom.js";
import {
 ...
 */
export function projectsUploadProjectAvatar(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UploadProjectAvatarRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/avatar")(pathParams);
