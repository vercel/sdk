 ...
 */
export function rollingReleaseApproveRollingReleaseStage(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ApproveRollingReleaseStageRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ApproveRollingReleaseStageResponseBody$inboundSchema),
