...
import {
  ...
  CompleteRollingReleaseRequest$outboundSchema,
  CompleteRollingReleaseResponseBody,
  CompleteRollingReleaseResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => CompleteRollingReleaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/rolling-release/complete")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CompleteRollingReleaseResponseBody$inboundSchema),
