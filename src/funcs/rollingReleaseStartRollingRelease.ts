...
import {
  ...
  StartRollingReleaseRequest$outboundSchema,
  StartRollingReleaseResponseBody,
  StartRollingReleaseResponseBody$inboundSchema,
 ...
 */
export function rollingReleaseStartRollingRelease(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => StartRollingReleaseRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/projects/{idOrName}/rolling-release/start")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "startRollingRelease",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, StartRollingReleaseResponseBody$inboundSchema),
