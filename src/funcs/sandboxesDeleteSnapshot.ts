...
import {
  ...
  DeleteSnapshotRequest$outboundSchema,
  DeleteSnapshotResponseBody,
  DeleteSnapshotResponseBody$inboundSchema,
 ...
 */
export function sandboxesDeleteSnapshot(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteSnapshotRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/sandboxes/snapshots/{snapshotId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteSnapshotResponseBody$inboundSchema),
