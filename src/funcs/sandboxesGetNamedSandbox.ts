...
import {
  ...
  GetNamedSandboxRequest$outboundSchema,
  GetNamedSandboxResponseBody,
  GetNamedSandboxResponseBody$inboundSchema,
 ...
 */
export function sandboxesGetNamedSandbox(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetNamedSandboxRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetNamedSandboxResponseBody$inboundSchema),
    M.fail([400, 401, 402, 403, 404, 409, 410, 422, 429, "4XX"]),
    M.fail([500, 502, "5XX"]),
  )(response, req);
  if (!result.ok) {
