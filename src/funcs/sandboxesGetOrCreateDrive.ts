...
import {
  ...
  GetOrCreateDriveRequest$outboundSchema,
  GetOrCreateDriveResponse,
  GetOrCreateDriveResponse$inboundSchema,
 ...
 */
export function sandboxesGetOrCreateDrive(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetOrCreateDriveRequest$outboundSchema.parse(value),
