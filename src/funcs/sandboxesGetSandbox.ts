...
import {
  GetSandboxRequest,
  GetSandboxRequest$outboundSchema,
  GetSandboxResponseBody,
  GetSandboxResponseBody$inboundSchema,
 ...
 */
export function sandboxesGetSandbox(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSandboxRequest$outboundSchema.parse(value),
