...
import {
  ...
  GetSandboxesV1Request$outboundSchema,
  GetSandboxesV1ResponseBody,
  GetSandboxesV1ResponseBody$inboundSchema,
 ...
 */
export function sandboxesGetSandboxesV1(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSandboxesV1Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetSandboxesV1ResponseBody$inboundSchema),
