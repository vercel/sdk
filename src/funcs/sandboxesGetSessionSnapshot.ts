...
import {
  ...
  GetSessionSnapshotRequest$outboundSchema,
  GetSessionSnapshotResponseBody,
  GetSessionSnapshotResponseBody$inboundSchema,
 ...
 */
export function sandboxesGetSessionSnapshot(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSessionSnapshotRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetSessionSnapshotResponseBody$inboundSchema),
