...
import {
  GetSnapshotRequest,
  GetSnapshotRequest$outboundSchema,
  GetSnapshotResponseBody,
  GetSnapshotResponseBody$inboundSchema,
 ...
 */
export function sandboxesGetSnapshot(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSnapshotRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetSnapshotResponseBody$inboundSchema),
