...
import {
  KillCommandRequest,
  KillCommandRequest$outboundSchema,
  KillCommandResponseBody,
  KillCommandResponseBody$inboundSchema,
 ...
 */
export function sandboxesKillCommand(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => KillCommandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, KillCommandResponseBody$inboundSchema),
