...
import {
  ...
  ListNamedSandboxesRequest$outboundSchema,
  ListNamedSandboxesResponseBody,
  ListNamedSandboxesResponseBody$inboundSchema,
 ...
 */
export function sandboxesListNamedSandboxes(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListNamedSandboxesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes")();
  ...
  const context = {
    ...
    operationID: "listNamedSandboxes",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListNamedSandboxesResponseBody$inboundSchema),
