...
import {
  ...
  CreateSessionSnapshotRequest$outboundSchema,
  CreateSessionSnapshotResponseBody,
  CreateSessionSnapshotResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaCreateSessionSnapshot(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CreateSessionSnapshotRequest$outboundSchema.parse(value),
