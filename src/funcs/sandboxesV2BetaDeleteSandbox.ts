...
import {
  ...
  DeleteSandboxRequest$outboundSchema,
  DeleteSandboxResponseBody,
  DeleteSandboxResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaDeleteSandbox(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteSandboxRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteSandboxResponseBody$inboundSchema),
