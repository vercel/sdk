...
import {
  ...
  DeleteSessionSnapshotRequest$outboundSchema,
  DeleteSessionSnapshotResponseBody,
  DeleteSessionSnapshotResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaDeleteSessionSnapshot(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteSessionSnapshotRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/snapshots/{snapshotId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteSessionSnapshotResponseBody$inboundSchema),
