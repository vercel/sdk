...
import {
  ...
  ExtendSessionTimeoutRequest$outboundSchema,
  ExtendSessionTimeoutResponseBody,
  ExtendSessionTimeoutResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaExtendSessionTimeout(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ExtendSessionTimeoutRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/sessions/{sessionId}/extend-timeout")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "410", "422", "4XX", "500", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ExtendSessionTimeoutResponseBody$inboundSchema),
