...
import {
  ...
  GetSandboxesV2Request$outboundSchema,
  GetSandboxesV2ResponseBody,
  GetSandboxesV2ResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSandboxesV2Request$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetSandboxesV2ResponseBody$inboundSchema),
