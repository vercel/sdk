...
import {
  ...
  GetSessionCommandLogsRequest$outboundSchema,
  GetSessionCommandLogsResponseBody,
  GetSessionCommandLogsResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaGetSessionCommandLogs(
  client: VercelCore,
  request: GetSessionCommandLogsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    JsonLStream<GetSessionCommandLogsResponseBody>,
    | VercelError
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSessionCommandLogsRequest$outboundSchema.parse(value),
    ...
    M.jsonl(
      ...
      z.instanceof(ReadableStream<Uint8Array>).transform(stream => {
        return new JsonLStream({
          stream,
          decoder(rawEvent) {
            const schema = GetSessionCommandLogsResponseBody$inboundSchema;
