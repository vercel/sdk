...
import {
  ...
  KillSessionCommandRequest$outboundSchema,
  KillSessionCommandResponseBody,
  KillSessionCommandResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaKillSessionCommand(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => KillSessionCommandRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, KillSessionCommandResponseBody$inboundSchema),
