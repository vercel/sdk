...
import {
  ...
  ListSessionCommandsRequest$outboundSchema,
  ListSessionCommandsResponseBody,
  ListSessionCommandsResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaListSessionCommands(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListSessionCommandsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListSessionCommandsResponseBody$inboundSchema),
