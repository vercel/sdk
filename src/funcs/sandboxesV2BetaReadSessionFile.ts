...
import {
  ...
  ReadSessionFileRequest$outboundSchema,
} from "../models/readsessionfileop.js";
 ...
 */
export function sandboxesV2BetaReadSessionFile(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ReadSessionFileRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/sessions/{sessionId}/fs/read")(
    pathParams,
  );
