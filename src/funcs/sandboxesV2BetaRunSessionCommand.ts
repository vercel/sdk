...
import {
  ...
  RunSessionCommandRequest$outboundSchema,
  RunSessionCommandResponse,
  RunSessionCommandResponse$inboundSchema,
...
export enum RunSessionCommandAcceptEnum {
 ...
 */
export function sandboxesV2BetaRunSessionCommand(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => RunSessionCommandRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/sessions/{sessionId}/cmd")(pathParams);
  ...
  const headers = new Headers(compactMap({
    ...
    Accept: options?.acceptHeaderOverride
      || "application/json;q=1, application/x-ndjson;q=0",
  }));
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, RunSessionCommandResponse$inboundSchema),
    M.jsonl(200, RunSessionCommandResponse$inboundSchema, {
