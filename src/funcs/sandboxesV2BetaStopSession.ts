...
import {
  StopSessionRequest,
  StopSessionRequest$outboundSchema,
  StopSessionResponseBody,
  StopSessionResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaStopSession(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => StopSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/sessions/{sessionId}/stop")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, StopSessionResponseBody$inboundSchema),
