...
import {
  ...
  UpdateSandboxRequest$outboundSchema,
  UpdateSandboxResponseBody,
  UpdateSandboxResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaUpdateSandbox(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateSandboxRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateSandboxResponseBody$inboundSchema),
