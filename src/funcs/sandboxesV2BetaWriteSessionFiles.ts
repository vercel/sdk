...
import {
  ...
  WriteSessionFilesRequest$outboundSchema,
  WriteSessionFilesResponseBody,
  WriteSessionFilesResponseBody$inboundSchema,
 ...
 */
export function sandboxesV2BetaWriteSessionFiles(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => WriteSessionFilesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/sandboxes/sessions/{sessionId}/fs/write")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, WriteSessionFilesResponseBody$inboundSchema),
