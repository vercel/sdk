...
import {
  ...
  GetSecurityFirewallEventsRequest$outboundSchema,
  GetSecurityFirewallEventsResponseBody,
  GetSecurityFirewallEventsResponseBody$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetSecurityFirewallEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetSecurityFirewallEventsResponseBody$inboundSchema),
