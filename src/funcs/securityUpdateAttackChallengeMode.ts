...
import {
  ...
  UpdateAttackChallengeModeRequest$outboundSchema,
 ...
 */
export function securityUpdateAttackChallengeMode(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateAttackChallengeModeRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateAttackChallengeModeResponseBody$inboundSchema),
