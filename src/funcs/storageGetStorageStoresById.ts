...
import {
  ...
  GetStorageStoresByIdRequest$outboundSchema,
  GetStorageStoresByIdResponseBody,
  GetStorageStoresByIdResponseBody$inboundSchema,
 ...
 * Get a store
 */
export function storageGetStorageStoresById(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetStorageStoresByIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getStorageStoresById",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetStorageStoresByIdResponseBody$inboundSchema),
