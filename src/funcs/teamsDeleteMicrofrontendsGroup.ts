...
import {
  ...
  DeleteMicrofrontendsGroupRequest$outboundSchema,
  DeleteMicrofrontendsGroupResponseBody,
  DeleteMicrofrontendsGroupResponseBody$inboundSchema,
 ...
 */
export function teamsDeleteMicrofrontendsGroup(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteMicrofrontendsGroupRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, DeleteMicrofrontendsGroupResponseBody$inboundSchema),
