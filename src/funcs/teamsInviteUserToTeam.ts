...
import {
  InvitedTeamMember,
  InvitedTeamMember$inboundSchema,
} from "../models/invitedteammember.js";
import {
  InviteUserToTeamRequestBody,
  InviteUserToTeamRequestBody$outboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.array(InviteUserToTeamRequestBody$outboundSchema).optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, InvitedTeamMember$inboundSchema),
