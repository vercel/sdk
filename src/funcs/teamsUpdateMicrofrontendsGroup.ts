...
import {
  ...
  UpdateMicrofrontendsGroupRequest$outboundSchema,
  UpdateMicrofrontendsGroupResponseBody,
  UpdateMicrofrontendsGroupResponseBody$inboundSchema,
 ...
 */
export function teamsUpdateMicrofrontendsGroup(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateMicrofrontendsGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/teams/{teamId}/microfrontends/{groupId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, UpdateMicrofrontendsGroupResponseBody$inboundSchema),
