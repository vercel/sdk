...
} from "../models/createbyteamslugbyprojectslugbyrepositorynameblobsuploadsop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrCreateByTeamSlugByProjectSlugByRepositoryNameBlobsUploads(
  client: VercelCore,
...
> {
  ...
  const context = {
    ...
    operationID: "createByTeamSlugByProjectSlugByRepositoryNameBlobsUploads",
    oAuth2Scopes: null,
