...
} from "../models/deletebyteamslugbyprojectslugbyrepositorynameblobsbydigestop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrDeleteByTeamSlugByProjectSlugByRepositoryNameBlobsByDigest(
  client: VercelCore,
...
> {
  ...
  const context = {
    ...
    operationID: "deleteByTeamSlugByProjectSlugByRepositoryNameBlobsByDigest",
    oAuth2Scopes: null,
  ...
  >(
    M.nil("2XX", z.void()),
    M.fail([400, 401, 402, 403, 404, 405, 410, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
