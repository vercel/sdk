...
} from "../models/deletebyteamslugbyprojectslugbyrepositorynameblobsuploadsbyuuidop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrDeleteByTeamSlugByProjectSlugByRepositoryNameBlobsUploadsByUuid(
  client: VercelCore,
  request:
    DeleteByTeamSlugByProjectSlugByRepositoryNameBlobsUploadsByUuidRequest,
