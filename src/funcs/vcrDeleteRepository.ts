...
import {
  ...
  DeleteRepositoryRequest$outboundSchema,
} from "../models/deleterepositoryop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrDeleteRepository(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteRepositoryRequest$outboundSchema.parse(value),
