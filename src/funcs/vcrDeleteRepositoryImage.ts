...
import {
  ...
  DeleteRepositoryImageRequest$outboundSchema,
} from "../models/deleterepositoryimageop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrDeleteRepositoryImage(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteRepositoryImageRequest$outboundSchema.parse(value),
