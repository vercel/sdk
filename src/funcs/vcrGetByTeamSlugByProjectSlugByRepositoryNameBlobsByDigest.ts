...
} from "../models/getbyteamslugbyprojectslugbyrepositorynameblobsbydigestop.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function vcrGetByTeamSlugByProjectSlugByRepositoryNameBlobsByDigest(
  client: VercelCore,
...
> {
  ...
  >(
    M.nil("2XX", z.void()),
    M.fail([400, 401, 402, 403, 404, 410, 416, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
