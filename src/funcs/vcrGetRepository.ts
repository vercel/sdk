...
import {
  ...
  GetRepositoryRequest$outboundSchema,
  GetRepositoryResponseBody,
  GetRepositoryResponseBody$inboundSchema,
 ...
 */
export function vcrGetRepository(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetRepositoryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/vcr/repository/{idOrName}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetRepositoryResponseBody$inboundSchema),
