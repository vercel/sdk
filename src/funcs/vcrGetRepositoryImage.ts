...
import {
  ...
  GetRepositoryImageRequest$outboundSchema,
  GetRepositoryImageResponseBody,
  GetRepositoryImageResponseBody$inboundSchema,
 ...
 */
export function vcrGetRepositoryImage(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetRepositoryImageRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    imageIdOrDigest: encodeSimple("imageIdOrDigest", payload.imageIdOrDigest, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetRepositoryImageResponseBody$inboundSchema),
