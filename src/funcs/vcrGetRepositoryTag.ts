...
import {
  ...
  GetRepositoryTagRequest$outboundSchema,
  GetRepositoryTagResponseBody,
  GetRepositoryTagResponseBody$inboundSchema,
 ...
 */
export function vcrGetRepositoryTag(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => GetRepositoryTagRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/vcr/repository/{idOrName}/tags/{tag}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, GetRepositoryTagResponseBody$inboundSchema),
