...
import {
  ...
  ListRepositoryTagsRequest$outboundSchema,
  ListRepositoryTagsResponseBody,
  ListRepositoryTagsResponseBody$inboundSchema,
 ...
 */
export function vcrListRepositoryTags(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListRepositoryTagsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/vcr/repository/{idOrName}/tags")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ListRepositoryTagsResponseBody$inboundSchema),
