...
import {
  ...
  AggregateEventsRequest$outboundSchema,
  AggregateEventsResponseBody,
  AggregateEventsResponseBody$inboundSchema,
 ...
 */
export function webAnalyticsAggregateEvents(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => AggregateEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/query/web-analytics/events/aggregate")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AggregateEventsResponseBody$inboundSchema),
