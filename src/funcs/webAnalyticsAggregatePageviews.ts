...
import {
  ...
  AggregatePageviewsRequest$outboundSchema,
  AggregatePageviewsResponseBody,
  AggregatePageviewsResponseBody$inboundSchema,
 ...
 */
export function webAnalyticsAggregatePageviews(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => AggregatePageviewsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/query/web-analytics/visits/aggregate")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, AggregatePageviewsResponseBody$inboundSchema),
