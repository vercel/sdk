...
import {
  CountEventsRequest,
  CountEventsRequest$outboundSchema,
  CountEventsResponseBody,
  CountEventsResponseBody$inboundSchema,
 ...
 */
export function webAnalyticsCountEvents(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CountEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/query/web-analytics/events/count")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CountEventsResponseBody$inboundSchema),
