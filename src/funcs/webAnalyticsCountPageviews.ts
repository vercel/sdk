...
import {
  ...
  CountPageviewsRequest$outboundSchema,
  CountPageviewsResponseBody,
  CountPageviewsResponseBody$inboundSchema,
 ...
 */
export function webAnalyticsCountPageviews(
  client: VercelCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CountPageviewsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/query/web-analytics/visits/count")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CountPageviewsResponseBody$inboundSchema),
