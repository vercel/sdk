...
import { tool$sandboxesListSessionSnapshots } from "./tools/sandboxesListSessionSnapshots.js";
import { tool$sandboxesReadSessionFile } from "./tools/sandboxesReadSessionFile.js";
import { tool$sandboxesStopSession } from "./tools/sandboxesStopSession.js";
import { tool$sandboxesUpdateSessionNetworkPolicy } from "./tools/sandboxesUpdateSessionNetworkPolicy.js";
import { tool$sandboxesWriteSessionFiles } from "./tools/sandboxesWriteSessionFiles.js";
...
export function createMCPServer(deps: {
  ...
  tool(tool$sandboxesListSessions);
  tool(tool$sandboxesGetSession);
  tool(tool$sandboxesGetNamedSandbox);
  tool(tool$sandboxesDeleteSandbox);
  tool(tool$sandboxesListSessionCommands);
  tool(tool$sandboxesGetSessionCommand);
  tool(tool$sandboxesKillSessionCommand);
  tool(tool$sandboxesStopSession);
  tool(tool$sandboxesExtendSessionTimeout);
  tool(tool$sandboxesUpdateSessionNetworkPolicy);
  tool(tool$sandboxesReadSessionFile);
  tool(tool$sandboxesCreateSessionDirectory);
  tool(tool$sandboxesWriteSessionFiles);
  tool(tool$sandboxesCreateSessionSnapshot);
