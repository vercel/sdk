...
export const tool$marketplaceGetInstallationsByIntegrationConfigurationIdResourcesByResourceIdExperimentationEdgeConfig:
  ToolDefinition<typeof args> = {
    name:
      "marketplace-get-installations-by-integration-configuration-id-resources-by-resource-id-experimentation-edge-config",
...
When the user enabled Edge Config syncing, then this endpoint can be used by the partner to fetch the contents of the Edge Config.`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] =
        await marketplaceGetInstallationsByIntegrationConfigurationIdResourcesByResourceIdExperimentationEdgeConfig(
          client,
          args.request,
