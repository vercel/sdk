...
export const UserEventPayload181RequestKind = {
  GetKeyData: "get_key_data",
} as const;
export type UserEventPayload181RequestKind = ClosedEnum<
  typeof UserEventPayload181RequestKind
>;
...
export type OneHundredAndEightyOne = {
  ...
  requestKind: UserEventPayload181RequestKind;
  key: string;
};
...
export const UserEventPayload170Plan = {
  Enterprise: "enterprise",
  Hobby: "hobby",
  Pro: "pro",
} as const;
export type UserEventPayload170Plan = ClosedEnum<
  typeof UserEventPayload170Plan
>;

export type PayloadBilling = {
  plan: UserEventPayload170Plan;
};
...
export const UserEventPayload170Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload170Configuration = ClosedEnum<
  typeof UserEventPayload170Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload170Configuration | undefined;
};
...
export const UserEventPayload170Reason = {
...
export type UserEventPayload170Reason = ClosedEnum<
  typeof UserEventPayload170Reason
>;
...
export type PayloadSoftBlock = {
  blockedAt: number;
  reason: UserEventPayload170Reason;
...
export const UserEventPayload170Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload170Role = ClosedEnum<
  typeof UserEventPayload170Role
>;
...
export const UserEventPayload170Origin = {
...
export type UserEventPayload170Origin = ClosedEnum<
  typeof UserEventPayload170Origin
>;

export type UserEventPayload170GitUserId = string | number;

export type UserEventPayload170JoinedFrom = {
  origin: UserEventPayload170Origin;
...
export type Teams = {
  ...
  created: number;
  joinedFrom?: UserEventPayload170JoinedFrom | undefined;
};
...
/** @internal */
export const UserEventPayload181RequestKind$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload181RequestKind
> = z.nativeEnum(UserEventPayload181RequestKind);
...
> = z.object({
  ...
  requestKind: UserEventPayload181RequestKind$inboundSchema,
  key: types.string(),
});
...
/** @internal */
export const UserEventPayload170Plan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload170Plan
> = z.nativeEnum(UserEventPayload170Plan);
...
export const PayloadBilling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  plan: UserEventPayload170Plan$inboundSchema,
});
...
/** @internal */
export const UserEventPayload170Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload170Configuration
> = z.nativeEnum(UserEventPayload170Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload170Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload170Reason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload170Reason
> = z.nativeEnum(UserEventPayload170Reason);
...
> = z.object({
  ...
  reason: UserEventPayload170Reason$inboundSchema,
...
/** @internal */
export const UserEventPayload170Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload170Role
> = z.nativeEnum(UserEventPayload170Role);
...
/** @internal */
export const UserEventPayload170Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload170Origin
> = z.nativeEnum(UserEventPayload170Origin);

/** @internal */
export const UserEventPayload170GitUserId$inboundSchema: z.ZodType<
  UserEventPayload170GitUserId,
  z.ZodTypeDef,
  unknown
> = smartUnion([types.string(), types.number()]);

export function userEventPayload170GitUserIdFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload170GitUserId, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload170GitUserId$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload170GitUserId' from JSON`,
  );
}

/** @internal */
export const UserEventPayload170JoinedFrom$inboundSchema: z.ZodType<
  UserEventPayload170JoinedFrom,
  z.ZodTypeDef,
  unknown
> = z.object({
  origin: UserEventPayload170Origin$inboundSchema,
...
export function userEventPayload170JoinedFromFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload170JoinedFrom, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload170JoinedFrom$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload170JoinedFrom' from JSON`,
  );
}
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    teamId: types.string(),
    createdAt: types.number(),
    role: UserEventPayload170Role$inboundSchema,
    ...
    joinedFrom: types.optional(
      z.lazy(() => UserEventPayload170JoinedFrom$inboundSchema),
    ),
  });
