...
export type TwoHundredAndEightyOne = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload281Previous | null;
  next: UserEventPayload281Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload265Role | undefined;
...
export const UserEventPayload263Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload263Role = ClosedEnum<
  typeof UserEventPayload263Role
>;

export type UserEventPayload263Project = {
  name: string;
  role: UserEventPayload263Role;
 ...
 * The type of matching to perform
 */
export const UserEventPayload234NextType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload234NextType = ClosedEnum<
  typeof UserEventPayload234NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload234NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export const UserEventPayload229Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload229Action = ClosedEnum<
  typeof UserEventPayload229Action
>;
...
export type TwoHundredAndTwentyNine = {
  projectId: string;
  projectName: string;
  action: UserEventPayload229Action;
};
...
export type UserEventPayload227Team = {
  id: string;
  name: string;
};
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload281Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload281Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload265Role$inboundSchema),
...
/** @internal */
export const UserEventPayload263Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload263Role
> = z.nativeEnum(UserEventPayload263Role);
...
> = z.object({
  name: types.string(),
  role: UserEventPayload263Role$inboundSchema,
...
> = z.object({
  ...
  previous: types.optional(
    z.lazy(() => UserEventPayload243Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload234NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload234NextType
> = z.nativeEnum(UserEventPayload234NextType);
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload234NextType$inboundSchema,
  pattern: types.string(),
});
...
/** @internal */
export const UserEventPayload229Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload229Action
> = z.nativeEnum(UserEventPayload229Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload229Action$inboundSchema,
});
...
/** @internal */
export const UserEventPayload227Team$inboundSchema: z.ZodType<
  UserEventPayload227Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload227TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload227Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload227Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload227Team' from JSON`,
  );
}
