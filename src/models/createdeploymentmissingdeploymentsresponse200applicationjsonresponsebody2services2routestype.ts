...
export const CreateDeploymentValueDeployments2$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  eq: types.optional(CreateDeploymentValueDeploymentsEq$inboundSchema),
