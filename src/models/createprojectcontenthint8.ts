...
export type BuildMachineElasticTransition = {
  at: number;
  direction: Direction;
...
export type CreateProjectResourceConfig = {
  ...
  buildMachineElasticTransition?: BuildMachineElasticTransition | undefined;
...
export const CreateProjectDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type CreateProjectDirection = ClosedEnum<typeof CreateProjectDirection>;

export type CreateProjectBuildMachineElasticTransition = {
  algorithmVersion: string;
  at: number;
  direction: CreateProjectDirection;
};
...
export type DefaultResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | CreateProjectBuildMachineElasticTransition
    | undefined;
...
/** @internal */
export type BuildMachineElasticTransition$Outbound = {
  at: number;
  direction: string;
  algorithmVersion: string;
};
...
/** @internal */
export const BuildMachineElasticTransition$outboundSchema: z.ZodType<
  BuildMachineElasticTransition$Outbound,
  z.ZodTypeDef,
  BuildMachineElasticTransition
> = z.object({
  at: z.number(),
...
export function buildMachineElasticTransitionToJSON(
  buildMachineElasticTransition: BuildMachineElasticTransition,
): string {
  return JSON.stringify(
    BuildMachineElasticTransition$outboundSchema.parse(
      buildMachineElasticTransition,
    ),
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: z.lazy(() =>
    BuildMachineElasticTransition$outboundSchema
  ).optional(),
...
/** @internal */
export const CreateProjectDirection$inboundSchema: z.ZodNativeEnum<
  typeof CreateProjectDirection
> = z.nativeEnum(CreateProjectDirection);

/** @internal */
export const CreateProjectBuildMachineElasticTransition$inboundSchema:
  z.ZodType<CreateProjectBuildMachineElasticTransition, z.ZodTypeDef, unknown> =
    z.object({
      algorithmVersion: types.string(),
      at: types.number(),
      direction: CreateProjectDirection$inboundSchema,
    });

export function createProjectBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  CreateProjectBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CreateProjectBuildMachineElasticTransition$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreateProjectBuildMachineElasticTransition' from JSON`,
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: types.optional(
    z.lazy(() => CreateProjectBuildMachineElasticTransition$inboundSchema),
  ),
