...
import {
  ...
  UserEventPayload112Role$outboundSchema,
  UserEventPayloadJoinedFrom,
  UserEventPayloadJoinedFrom$inboundSchema,
  UserEventPayloadJoinedFrom$Outbound,
  UserEventPayloadJoinedFrom$outboundSchema,
...
} from "./usereventpayloadjoinedfrom.js";
...
export const UserEventPayload112Type = {
  User: "user",
} as const;
export type UserEventPayload112Type = ClosedEnum<
...
export const UserEventPayload112BlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload112BlockReason = ClosedEnum<
  typeof UserEventPayload112BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload112BlockReason;
};

export const UserEventPayload112NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload112NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload112NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload112NewOwnerBlockReason;
};

export const UserEventPayload112NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload112NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload112NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload112NewOwnerFeatureBlocksBlockReason;
};
...
export const UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    LimitsExceeded: "limits_exceeded",
    HardBlocked: "hard_blocked",
  } as const;
export type UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  >;
...
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  {
    AdminOverride: "admin_override",
    LimitsExceeded: "limits_exceeded",
    HardBlocked: "hard_blocked",
  } as const;
export type UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  ClosedEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason
  >;
...
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason =
  ClosedEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason
  >;
...
export type WorkflowStep = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason;
};
 ...
 */
export const UserEventPayload112NewOwnerAction = {
  Enabled: "enabled",
  Disabled: "disabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload112NewOwnerAction = ClosedEnum<
  typeof UserEventPayload112NewOwnerAction
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload112NewOwnerAction;
  /**
...
export type UserEventPayload108Action = ClosedEnum<
  typeof UserEventPayload108Action
>;

export type RuleGroups = {
  active: boolean;
  action?: UserEventPayload108Action | undefined;
};
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    ...
    joinedFrom: types.optional(UserEventPayloadJoinedFrom$inboundSchema),
  });
/** @internal */
...
> = z.object({
  ...
  joinedFrom: UserEventPayloadJoinedFrom$outboundSchema.optional(),
});
...
/** @internal */
export const UserEventPayload112BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload112BlockReason
> = z.nativeEnum(UserEventPayload112BlockReason);
/** @internal */
export const UserEventPayload112BlockReason$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload112BlockReason
> = UserEventPayload112BlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload112BlockReason$inboundSchema,
});
/** @internal */
...
> = z.object({
  ...
  blockedFrom: z.number().optional(),
  blockedUntil: z.number().optional(),
  blockReason: UserEventPayload112BlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload112NewOwnerBlockReason> = z.nativeEnum(
    UserEventPayload112NewOwnerBlockReason,
  );
/** @internal */
export const UserEventPayload112NewOwnerBlockReason$outboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload112NewOwnerBlockReason> =
    UserEventPayload112NewOwnerBlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload112NewOwnerBlockReason$inboundSchema,
});
/** @internal */
...
> = z.object({
  ...
  blockedFrom: z.number().optional(),
  blockedUntil: z.number().optional(),
  blockReason: UserEventPayload112NewOwnerBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload112NewOwnerFeatureBlocksBlockReason> =
    z.nativeEnum(UserEventPayload112NewOwnerFeatureBlocksBlockReason);
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksBlockReason$outboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload112NewOwnerFeatureBlocksBlockReason> =
    UserEventPayload112NewOwnerFeatureBlocksBlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedUntil: z.number().optional(),
  blockReason:
    UserEventPayload112NewOwnerFeatureBlocksBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > =
    UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedUntil: z.number().optional(),
  blockReason:
    UserEventPayload112NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason
  > = z.nativeEnum(
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason,
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason
  > =
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedUntil: z.number().optional(),
  blockReason:
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStorageBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason
  > = z.nativeEnum(
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason,
  );
/** @internal */
export const UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason
  > =
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema;
...
> = z.object({
  ...
  blockedUntil: z.number().optional(),
  blockReason:
    UserEventPayload112NewOwnerFeatureBlocksWorkflowStepBlockReason$outboundSchema,
});
...
/** @internal */
export const UserEventPayload112NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload112NewOwnerAction
> = z.nativeEnum(UserEventPayload112NewOwnerAction);
/** @internal */
export const UserEventPayload112NewOwnerAction$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload112NewOwnerAction
> = UserEventPayload112NewOwnerAction$inboundSchema;
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload112NewOwnerAction$inboundSchema,
...
export const PayloadHistory$outboundSchema: z.ZodType<
  ...
  PayloadHistory
> = z.object({
  action: UserEventPayload112NewOwnerAction$outboundSchema,
...
> = z.object({
  ...
  type: UserEventPayload112Type$inboundSchema,
...
/** @internal */
export const UserEventPayload108Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload108Action
> = z.nativeEnum(UserEventPayload108Action);
/** @internal */
export const UserEventPayload108Action$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload108Action
> = UserEventPayload108Action$inboundSchema;
...
> = z.object({
  active: types.boolean(),
  action: types.optional(UserEventPayload108Action$inboundSchema),
});
/** @internal */
...
> = z.object({
  active: z.boolean(),
  action: UserEventPayload108Action$outboundSchema.optional(),
});
