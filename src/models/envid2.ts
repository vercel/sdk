...
export type TwoHundredAndEightySix = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload286Previous | null;
  next: UserEventPayload286Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload270Role | undefined;
...
export type TwoHundredAndFortyEight = {
  projectId: string;
  projectName: string;
  previous?: UserEventPayload248Previous | undefined;
 ...
 * The type of matching to perform
 */
export const UserEventPayload239NextType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload239NextType = ClosedEnum<
  typeof UserEventPayload239NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload239NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export type UserEventPayload232Team = {
  id: string;
  name: string;
};
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload286Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload286Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload270Role$inboundSchema),
...
/** @internal */
export const UserEventPayload239NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload239NextType
> = z.nativeEnum(UserEventPayload239NextType);
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload239NextType$inboundSchema,
  pattern: types.string(),
});
...
/** @internal */
export const UserEventPayload232Team$inboundSchema: z.ZodType<
  UserEventPayload232Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload232TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload232Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload232Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload232Team' from JSON`,
  );
}
