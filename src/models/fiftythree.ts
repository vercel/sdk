...
export const UserEventPayload103DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload103DeploymentType = ClosedEnum<
  typeof UserEventPayload103DeploymentType
>;

export type OldPasswordProtection = {
  deploymentType: UserEventPayload103DeploymentType;
};
...
/** @internal */
export const UserEventPayload103DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload103DeploymentType
> = z.nativeEnum(UserEventPayload103DeploymentType);
...
export const OldPasswordProtection$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  deploymentType: UserEventPayload103DeploymentType$inboundSchema,
});
