...
export type UserEventPayload446Names = {
  en: string;
};

export type UserEventPayload446City = {
  names: UserEventPayload446Names;
};

export type UserEventPayload446GeolocationNames = {
  en: string;
};

export type UserEventPayload446Country = {
  names: UserEventPayload446GeolocationNames;
};

export type UserEventPayload446GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload446MostSpecificSubdivision = {
  names: UserEventPayload446GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload446Geolocation = {
  city?: UserEventPayload446City | undefined;
  country: UserEventPayload446Country;
...
export type FourHundredAndFortySix = {
  ...
  geolocation?: UserEventPayload446Geolocation | null | undefined;
...
export type UserEventPayload445City = {
...
export type UserEventPayload445Country = {
...
export type UserEventPayload445MostSpecificSubdivision = {
  names: UserEventPayload445GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload445Geolocation = {
  city?: UserEventPayload445City | undefined;
  country: UserEventPayload445Country;
  mostSpecificSubdivision?:
...
export type FourHundredAndFortyFive = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload445Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 */
export type UserEventPayload443Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload443Resources | null;
  /**
...
export type UserEventPayload443Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload443Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload443AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload443AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload442Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload442Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload434Team = {
  name: string;
  id: string;
};

export type UserEventPayload434Configuration = {
  id: string;
...
export type FourHundredAndThirtyFour = {
  team: UserEventPayload434Team;
  configuration: UserEventPayload434Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload433Team = {
  name: string;
  id: string;
};

export type UserEventPayload433Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndThirtyThree = {
  team: UserEventPayload433Team;
  configuration: UserEventPayload433Configuration;
...
export const UserEventPayload417Provider = {
  Google: "google",
} as const;
export type UserEventPayload417Provider = ClosedEnum<
  typeof UserEventPayload417Provider
>;
...
export type FourHundredAndSeventeen = {
  provider: UserEventPayload417Provider;
  providerSubjectId: string;
  outcome: PayloadOutcome;
  decision: PayloadDecision;
};

export type UserEventPayload416Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload416Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndSixteen = {
  previous: UserEventPayload416Previous;
  next: UserEventPayload416Next;
};
...
export type UserEventPayload411Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload411Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndEleven = {
  previous: UserEventPayload411Previous;
  next: UserEventPayload411Next;
  method?: PayloadMethod | undefined;
};

export const UserEventPayload410Action = {
...
export type UserEventPayload410Action = ClosedEnum<
  typeof UserEventPayload410Action
>;
...
export type FourHundredAndTen = {
  action: UserEventPayload410Action;
  reason: string;
};
...
export type FourHundredAndSix = {
  enabled: boolean;
  actorId: string;
  actorType: UserEventPayload406ActorType;
};
...
/** @internal */
export const UserEventPayload446Names$inboundSchema: z.ZodType<
...
export function userEventPayload446NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446City$inboundSchema: z.ZodType<
  UserEventPayload446City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload446Names$inboundSchema),
});

export function userEventPayload446CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload446GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload446GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446Country$inboundSchema: z.ZodType<
  UserEventPayload446Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload446GeolocationNames$inboundSchema),
});

export function userEventPayload446CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload446GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload446GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload446GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload446MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload446GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload446MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload446MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload446MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload446MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload446Geolocation$inboundSchema: z.ZodType<
  UserEventPayload446Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload446City$inboundSchema)),
  country: z.lazy(() => UserEventPayload446Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload446MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload446GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload446Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload445City$inboundSchema: z.ZodType<
...
export function userEventPayload445CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload445Country$inboundSchema: z.ZodType<
...
export function userEventPayload445CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload445MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload445MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload445GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload445MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload445MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload445MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload445MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload445Geolocation$inboundSchema: z.ZodType<
  UserEventPayload445Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload445City$inboundSchema)),
  country: z.lazy(() => UserEventPayload445Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload445MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload445GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload445Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload443Resources$inboundSchema: z.ZodType<
...
export function userEventPayload443ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload443Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload443Values$inboundSchema: z.ZodType<
  UserEventPayload443Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload443ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload443Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload443AfterResources$inboundSchema: z.ZodType<
  UserEventPayload443AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload443AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload443AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload442Resources$inboundSchema: z.ZodType<
...
export function userEventPayload442ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload442Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload442Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload442Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload442Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload434Team$inboundSchema: z.ZodType<
...
export function userEventPayload434TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload434Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload434ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload434Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload434Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload433Team$inboundSchema: z.ZodType<
...
export function userEventPayload433TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload433Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload433ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload433Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload433Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload417Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload417Provider
> = z.nativeEnum(UserEventPayload417Provider);
...
export const FourHundredAndSeventeen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload417Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload416Previous$inboundSchema: z.ZodType<
...
export function userEventPayload416PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload416Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload416Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload416Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload416Next$inboundSchema: z.ZodType<
...
export function userEventPayload416NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload416Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload416Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload416Next' from JSON`,
  );
}
...
export const FourHundredAndSixteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload416Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload416Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload411Previous$inboundSchema: z.ZodType<
...
export function userEventPayload411PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411Next$inboundSchema: z.ZodType<
  UserEventPayload411Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload411NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411Next' from JSON`,
  );
}
...
export const FourHundredAndEleven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload411Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload411Next$inboundSchema),
...
/** @internal */
export const UserEventPayload410Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload410Action
> = z.nativeEnum(UserEventPayload410Action);
...
export const FourHundredAndTen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload410Action$inboundSchema,
  reason: types.string(),
});
...
> = z.object({
  enabled: types.boolean(),
  actorId: types.string(),
  actorType: UserEventPayload406ActorType$inboundSchema,
});
