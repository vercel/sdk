...
export type UserEventPayload451City = {
...
export type UserEventPayload451Country = {
...
export type UserEventPayload451MostSpecificSubdivision = {
  names: UserEventPayload451GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload451Geolocation = {
  city?: UserEventPayload451City | undefined;
  country: UserEventPayload451Country;
  mostSpecificSubdivision?:
    | UserEventPayload451MostSpecificSubdivision
    | undefined;
...
export type FourHundredAndFiftyOne = {
  ...
  geolocation?: UserEventPayload451Geolocation | null | undefined;
 ...
 */
export type UserEventPayload448Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload448Resources | null;
  /**
...
export type UserEventPayload448Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload448Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload448AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload448AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload439Team = {
  name: string;
  id: string;
};

export type UserEventPayload439Configuration = {
  id: string;
...
export type FourHundredAndThirtyNine = {
  team: UserEventPayload439Team;
  configuration: UserEventPayload439Configuration;
...
export const UserEventPayload422Provider = {
  Google: "google",
} as const;
export type UserEventPayload422Provider = ClosedEnum<
  typeof UserEventPayload422Provider
>;
...
export type FourHundredAndTwentyTwo = {
  provider: UserEventPayload422Provider;
...
export const UserEventPayload415Action = {
...
export type UserEventPayload415Action = ClosedEnum<
  typeof UserEventPayload415Action
>;
...
export type FourHundredAndFifteen = {
  action: UserEventPayload415Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload451City$inboundSchema: z.ZodType<
  UserEventPayload451City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload451CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload451City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload451City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload451City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload451Country$inboundSchema: z.ZodType<
  UserEventPayload451Country,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload451CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload451Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload451Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload451Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload451MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload451MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload451GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload451MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload451MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload451MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload451MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload451Geolocation$inboundSchema: z.ZodType<
  UserEventPayload451Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload451City$inboundSchema)),
  country: z.lazy(() => UserEventPayload451Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload451MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload451GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload451Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload451Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload451Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload451Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload448Resources$inboundSchema: z.ZodType<
  UserEventPayload448Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload448ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload448Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload448Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload448Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload448Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload448Values$inboundSchema: z.ZodType<
  UserEventPayload448Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload448ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload448Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload448Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload448Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload448Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload448AfterResources$inboundSchema: z.ZodType<
  UserEventPayload448AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload448AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload448AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload448AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload448AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload448AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload439Team$inboundSchema: z.ZodType<
  UserEventPayload439Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload439TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload439Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload439Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload439Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload439Configuration$inboundSchema: z.ZodType<
  UserEventPayload439Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload439ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload439Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload439Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload439Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload439Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload439Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload422Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload422Provider
> = z.nativeEnum(UserEventPayload422Provider);
...
export const FourHundredAndTwentyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload422Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload415Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload415Action
> = z.nativeEnum(UserEventPayload415Action);
...
export const FourHundredAndFifteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload415Action$inboundSchema,
  reason: types.string(),
});
