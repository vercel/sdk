...
export type UserEventPayload443Names = {
  en: string;
};

export type UserEventPayload443City = {
  names: UserEventPayload443Names;
};

export type UserEventPayload443GeolocationNames = {
  en: string;
};

export type UserEventPayload443Country = {
  names: UserEventPayload443GeolocationNames;
};

export type UserEventPayload443GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload443MostSpecificSubdivision = {
  names: UserEventPayload443GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload443Geolocation = {
  city?: UserEventPayload443City | undefined;
  country: UserEventPayload443Country;
...
export type FourHundredAndFortyThree = {
  ...
  geolocation?: UserEventPayload443Geolocation | null | undefined;
 ...
 */
export type UserEventPayload440Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload440Resources | null;
  /**
...
export type UserEventPayload440Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload440Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload440AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload440AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload431Team = {
  name: string;
  id: string;
};

export type UserEventPayload431Configuration = {
  id: string;
...
export type FourHundredAndThirtyOne = {
  team: UserEventPayload431Team;
  configuration: UserEventPayload431Configuration;
...
export const UserEventPayload414Provider = {
  Google: "google",
} as const;
export type UserEventPayload414Provider = ClosedEnum<
  typeof UserEventPayload414Provider
>;
...
export type FourHundredAndFourteen = {
  provider: UserEventPayload414Provider;
  providerSubjectId: string;
  outcome: PayloadOutcome;
  decision: PayloadDecision;
};

export type UserEventPayload413Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload413Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndThirteen = {
  previous: UserEventPayload413Previous;
  next: UserEventPayload413Next;
};
...
export const UserEventPayload407Action = {
...
export type UserEventPayload407Action = ClosedEnum<
  typeof UserEventPayload407Action
>;
...
export type FourHundredAndSeven = {
  action: UserEventPayload407Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload443Names$inboundSchema: z.ZodType<
...
export function userEventPayload443NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443City$inboundSchema: z.ZodType<
  UserEventPayload443City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload443Names$inboundSchema),
});

export function userEventPayload443CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload443GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload443GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443Country$inboundSchema: z.ZodType<
  UserEventPayload443Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload443GeolocationNames$inboundSchema),
});

export function userEventPayload443CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload443GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload443GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload443GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload443MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload443GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload443MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload443MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload443MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload443MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload443Geolocation$inboundSchema: z.ZodType<
  UserEventPayload443Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload443City$inboundSchema)),
  country: z.lazy(() => UserEventPayload443Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload443MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload443GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload443Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload443Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload443Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload443Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload440Resources$inboundSchema: z.ZodType<
...
export function userEventPayload440ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload440Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload440Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload440Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload440Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload440Values$inboundSchema: z.ZodType<
  UserEventPayload440Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload440ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload440Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload440Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload440Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload440Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload440AfterResources$inboundSchema: z.ZodType<
  UserEventPayload440AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload440AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload440AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload440AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload440AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload440AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload431Team$inboundSchema: z.ZodType<
...
export function userEventPayload431TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload431Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload431Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload431Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload431Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload431ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload431Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload431Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload431Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload431Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload431Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload414Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload414Provider
> = z.nativeEnum(UserEventPayload414Provider);
...
export const FourHundredAndFourteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload414Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload413Previous$inboundSchema: z.ZodType<
...
export function userEventPayload413PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413Next$inboundSchema: z.ZodType<
  UserEventPayload413Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload413NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413Next' from JSON`,
  );
}
...
export const FourHundredAndThirteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload413Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload413Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload407Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload407Action
> = z.nativeEnum(UserEventPayload407Action);
...
export const FourHundredAndSeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload407Action$inboundSchema,
  reason: types.string(),
});
