...
export type UserEventPayload446Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload446Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload446AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload446AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export const UserEventPayload420Provider = {
  Google: "google",
} as const;
export type UserEventPayload420Provider = ClosedEnum<
  typeof UserEventPayload420Provider
>;
...
export type FourHundredAndTwenty = {
  provider: UserEventPayload420Provider;
...
export const UserEventPayload413Action = {
...
export type UserEventPayload413Action = ClosedEnum<
  typeof UserEventPayload413Action
>;
...
export type FourHundredAndThirteen = {
  action: UserEventPayload413Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload446Values$inboundSchema: z.ZodType<
  UserEventPayload446Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload446ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload446Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload446AfterResources$inboundSchema: z.ZodType<
  UserEventPayload446AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload446AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload446AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload446AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload446AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload446AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload420Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload420Provider
> = z.nativeEnum(UserEventPayload420Provider);
...
export const FourHundredAndTwenty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload420Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload413Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload413Action
> = z.nativeEnum(UserEventPayload413Action);
...
export const FourHundredAndThirteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload413Action$inboundSchema,
  reason: types.string(),
});
