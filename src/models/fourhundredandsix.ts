...
export type UserEventPayload447Names = {
  en: string;
};

export type UserEventPayload447City = {
  names: UserEventPayload447Names;
};

export type UserEventPayload447GeolocationNames = {
  en: string;
};

export type UserEventPayload447Country = {
  names: UserEventPayload447GeolocationNames;
};

export type UserEventPayload447GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload447MostSpecificSubdivision = {
  names: UserEventPayload447GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload447Geolocation = {
  city?: UserEventPayload447City | undefined;
  country: UserEventPayload447Country;
  mostSpecificSubdivision?:
...
export type FourHundredAndFortySeven = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload447Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 */
export type UserEventPayload445Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload445Resources | null;
  /**
...
export type UserEventPayload445Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload445Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload445AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload445AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload444Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload444Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload435Team = {
  name: string;
  id: string;
};

export type UserEventPayload435Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndThirtyFive = {
  team: UserEventPayload435Team;
  configuration: UserEventPayload435Configuration;
...
export const UserEventPayload419Provider = {
  Google: "google",
} as const;
export type UserEventPayload419Provider = ClosedEnum<
  typeof UserEventPayload419Provider
>;
...
export type FourHundredAndNineteen = {
  provider: UserEventPayload419Provider;
  providerSubjectId: string;
  outcome: PayloadOutcome;
  decision: PayloadDecision;
};

export type UserEventPayload418Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload418Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndEighteen = {
  previous: UserEventPayload418Previous;
  next: UserEventPayload418Next;
};
...
export const UserEventPayload412Action = {
...
export type UserEventPayload412Action = ClosedEnum<
  typeof UserEventPayload412Action
>;
...
export type FourHundredAndTwelve = {
  action: UserEventPayload412Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload447Names$inboundSchema: z.ZodType<
...
export function userEventPayload447NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload447Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload447Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447City$inboundSchema: z.ZodType<
  UserEventPayload447City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload447Names$inboundSchema),
});

export function userEventPayload447CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload447City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload447City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload447GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload447GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload447GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447Country$inboundSchema: z.ZodType<
  UserEventPayload447Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload447GeolocationNames$inboundSchema),
});

export function userEventPayload447CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload447Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload447Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload447GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload447GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload447GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload447MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload447GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload447MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload447MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload447MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload447MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload447Geolocation$inboundSchema: z.ZodType<
  UserEventPayload447Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload447City$inboundSchema)),
  country: z.lazy(() => UserEventPayload447Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload447MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload447GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload447Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload447Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload447Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload447Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload445Resources$inboundSchema: z.ZodType<
...
export function userEventPayload445ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload445Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload445Values$inboundSchema: z.ZodType<
  UserEventPayload445Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload445ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload445Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload445AfterResources$inboundSchema: z.ZodType<
  UserEventPayload445AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload445AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload445AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload445AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload445AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload445AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload444Resources$inboundSchema: z.ZodType<
  UserEventPayload444Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload444ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload444Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload444Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload435Team$inboundSchema: z.ZodType<
...
export function userEventPayload435TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload435ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload435Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload435Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload419Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload419Provider
> = z.nativeEnum(UserEventPayload419Provider);
...
export const FourHundredAndNineteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload419Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload418Previous$inboundSchema: z.ZodType<
  UserEventPayload418Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload418PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload418Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload418Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload418Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload418Next$inboundSchema: z.ZodType<
  UserEventPayload418Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload418NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload418Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload418Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload418Next' from JSON`,
  );
}
...
export const FourHundredAndEighteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload418Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload418Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload412Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload412Action
> = z.nativeEnum(UserEventPayload412Action);
...
export const FourHundredAndTwelve$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload412Action$inboundSchema,
  reason: types.string(),
});
