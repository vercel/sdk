 ...
 */
export const UserEventPayload466Scope = {
  Project: "project",
  Team: "team",
  User: "user",
} as const;
 ...
 * Scope of the token: - `'user'`: full-account token (not tied to any team). - `'team'`: scoped to a single team. - `'project'`: scoped to a single project within a team.
 */
export type UserEventPayload466Scope = ClosedEnum<
  typeof UserEventPayload466Scope
>;
...
export type FourHundredAndSixtySix = {
   ...
   * Scope of the token: - `'user'`: full-account token (not tied to any team). - `'team'`: scoped to a single team. - `'project'`: scoped to a single project within a team.
   */
  scope: UserEventPayload466Scope;
  /**
...
export type UserEventPayload465Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload465Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload465BeforeResources = {
  projectIds: Array<string>;
};
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload465BeforeResources | null;
  teamId: string;
  /**
   * Last-update time (epoch ms).
   */
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload464Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload464Resources | null;
  teamId: string;
  /**
   * Last-update time (epoch ms).
   */
...
export const UserEventPayload441ActorType = {
  Admin: "admin",
} as const;
export type UserEventPayload441ActorType = ClosedEnum<
  typeof UserEventPayload441ActorType
>;
...
export type FourHundredAndFortyOne = {
  ...
  actorId: string;
  actorName?: string | undefined;
  actorType: UserEventPayload441ActorType;
};
...
export const UserEventPayload439Provider = {
  Google: "google",
} as const;
export type UserEventPayload439Provider = ClosedEnum<
  typeof UserEventPayload439Provider
>;
...
export type FourHundredAndThirtyNine = {
  ...
  provider: UserEventPayload439Provider;
  providerSubjectId: string;
};

export type UserEventPayload438Next = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload438Previous = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndThirtyEight = {
  next: UserEventPayload438Next;
  previous: UserEventPayload438Previous;
};
...
export type UserEventPayload433Next = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload433Previous = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndThirtyThree = {
  ...
  next: UserEventPayload433Next;
  previous: UserEventPayload433Previous;
};

export const UserEventPayload432Action = {
...
export type UserEventPayload432Action = ClosedEnum<
  typeof UserEventPayload432Action
>;
...
export type FourHundredAndThirtyTwo = {
  action: UserEventPayload432Action;
  reason: string;
};
...
export type FourHundredAndTwenty = {
   ...
   */
  actorName?: string | undefined;
  actorType?: UserEventPayload420ActorType | undefined;
  reason?: string | undefined;
...
export const UserEventPayload415Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload415Type = ClosedEnum<
  typeof UserEventPayload415Type
>;
...
/** @internal */
export const UserEventPayload466Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload466Scope
> = z.nativeEnum(UserEventPayload466Scope);
...
> = z.object({
  ...
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
  scope: UserEventPayload466Scope$inboundSchema,
  teamId: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload465Values$inboundSchema: z.ZodType<
  UserEventPayload465Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload465ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload465Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload465Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload465Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload465Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload465BeforeResources$inboundSchema: z.ZodType<
  UserEventPayload465BeforeResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload465BeforeResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload465BeforeResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload465BeforeResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload465BeforeResources' from JSON`,
  );
}
...
> = z.object({
  ...
  policyId: types.string(),
  resources: types.nullable(
    z.lazy(() => UserEventPayload465BeforeResources$inboundSchema),
  ),
  teamId: types.string(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload464Resources$inboundSchema: z.ZodType<
  UserEventPayload464Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload464ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload464Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload464Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload464Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    policyId: types.string(),
    resources: types.nullable(
      z.lazy(() => UserEventPayload464Resources$inboundSchema),
    ),
    teamId: types.string(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload441ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload441ActorType
> = z.nativeEnum(UserEventPayload441ActorType);
...
> = z.object({
  ...
  actorId: types.string(),
  actorName: types.optional(types.string()),
  actorType: UserEventPayload441ActorType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload439Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload439Provider
> = z.nativeEnum(UserEventPayload439Provider);
...
> = z.object({
  ...
  provider: UserEventPayload439Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload438Next$inboundSchema: z.ZodType<
  UserEventPayload438Next,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload438NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload438Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload438Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload438Next' from JSON`,
  );
}

/** @internal */
export const UserEventPayload438Previous$inboundSchema: z.ZodType<
  UserEventPayload438Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload438PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload438Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload438Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload438Previous' from JSON`,
  );
}
...
export const FourHundredAndThirtyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: z.lazy(() => UserEventPayload438Next$inboundSchema),
  previous: z.lazy(() => UserEventPayload438Previous$inboundSchema),
});
...
/** @internal */
export const UserEventPayload433Next$inboundSchema: z.ZodType<
  UserEventPayload433Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload433NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Next' from JSON`,
  );
}

/** @internal */
export const UserEventPayload433Previous$inboundSchema: z.ZodType<
  UserEventPayload433Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload433PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Previous' from JSON`,
  );
}
...
> = z.object({
  ...
  next: z.lazy(() => UserEventPayload433Next$inboundSchema),
  previous: z.lazy(() => UserEventPayload433Previous$inboundSchema),
});
...
/** @internal */
export const UserEventPayload432Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload432Action
> = z.nativeEnum(UserEventPayload432Action);
...
export const FourHundredAndThirtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload432Action$inboundSchema,
  reason: types.string(),
});
...
> = z.object({
  ...
  actorName: types.optional(types.string()),
  actorType: types.optional(UserEventPayload420ActorType$inboundSchema),
  reason: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload415Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload415Type
> = z.nativeEnum(UserEventPayload415Type);
...
> = z.object({
  ...
  type: UserEventPayload415Type$inboundSchema,
});
