...
export type UserEventPayload442Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload442Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload442AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload442AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export const UserEventPayload416Provider = {
  Google: "google",
} as const;
export type UserEventPayload416Provider = ClosedEnum<
  typeof UserEventPayload416Provider
>;
...
export type FourHundredAndSixteen = {
  provider: UserEventPayload416Provider;
...
export type UserEventPayload410Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload410Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndTen = {
  previous: UserEventPayload410Previous;
  next: UserEventPayload410Next;
  method?: PayloadMethod | undefined;
};

export const UserEventPayload409Action = {
...
export type UserEventPayload409Action = ClosedEnum<
  typeof UserEventPayload409Action
>;
...
export type FourHundredAndNine = {
  action: UserEventPayload409Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload442Values$inboundSchema: z.ZodType<
  UserEventPayload442Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload442ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload442Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload442Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload442Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload442Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload442AfterResources$inboundSchema: z.ZodType<
  UserEventPayload442AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload442AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload442AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload442AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload442AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload442AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload416Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload416Provider
> = z.nativeEnum(UserEventPayload416Provider);
...
export const FourHundredAndSixteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload416Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload410Previous$inboundSchema: z.ZodType<
  UserEventPayload410Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload410PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload410Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload410Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload410Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload410Next$inboundSchema: z.ZodType<
  UserEventPayload410Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload410NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload410Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload410Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload410Next' from JSON`,
  );
}
...
export const FourHundredAndTen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload410Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload410Next$inboundSchema),
...
/** @internal */
export const UserEventPayload409Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload409Action
> = z.nativeEnum(UserEventPayload409Action);
...
export const FourHundredAndNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload409Action$inboundSchema,
  reason: types.string(),
});
