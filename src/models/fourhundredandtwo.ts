...
export type UserEventPayload444Names = {
  en: string;
};

export type UserEventPayload444City = {
  names: UserEventPayload444Names;
};

export type UserEventPayload444GeolocationNames = {
  en: string;
};

export type UserEventPayload444Country = {
  names: UserEventPayload444GeolocationNames;
};

export type UserEventPayload444GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload444MostSpecificSubdivision = {
  names: UserEventPayload444GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload444Geolocation = {
  city?: UserEventPayload444City | undefined;
  country: UserEventPayload444Country;
...
export type FourHundredAndFortyFour = {
  ...
  geolocation?: UserEventPayload444Geolocation | null | undefined;
 ...
 */
export type UserEventPayload441Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload441Resources | null;
  /**
...
export type UserEventPayload441Values = {
  value: string;
  wildcards: boolean;
};
...
export type UserEventPayloadClaims = {
  name: string;
  values: Array<UserEventPayload441Values>;
};

/**
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload441AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload441AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload439Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload439Names;
};

export type UserEventPayload439GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload439GeolocationNames;
};

export type UserEventPayload439GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload439GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload432Team = {
  name: string;
  id: string;
};

export type UserEventPayload432Configuration = {
  id: string;
...
export type FourHundredAndThirtyTwo = {
  team: UserEventPayload432Team;
  configuration: UserEventPayload432Configuration;
...
export type FourHundredAndEighteen = {
   ...
   */
  actorId: string;
  actorType: UserEventPayload418ActorType;
...
export const UserEventPayload415Provider = {
  Google: "google",
} as const;
export type UserEventPayload415Provider = ClosedEnum<
  typeof UserEventPayload415Provider
>;
...
export type FourHundredAndFifteen = {
  provider: UserEventPayload415Provider;
  providerSubjectId: string;
  outcome: PayloadOutcome;
  decision: PayloadDecision;
};

export type UserEventPayload414Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload414Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndFourteen = {
  previous: UserEventPayload414Previous;
  next: UserEventPayload414Next;
};
...
export type UserEventPayload409Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload409Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndNine = {
  previous: UserEventPayload409Previous;
  next: UserEventPayload409Next;
  method?: PayloadMethod | undefined;
};

export const UserEventPayload408Action = {
...
export type UserEventPayload408Action = ClosedEnum<
  typeof UserEventPayload408Action
>;
...
export type FourHundredAndEight = {
  action: UserEventPayload408Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload444Names$inboundSchema: z.ZodType<
...
export function userEventPayload444NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload444Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444City$inboundSchema: z.ZodType<
  UserEventPayload444City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload444Names$inboundSchema),
});

export function userEventPayload444CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload444City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload444GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload444GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444Country$inboundSchema: z.ZodType<
  UserEventPayload444Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload444GeolocationNames$inboundSchema),
});

export function userEventPayload444CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload444Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload444GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload444GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload444GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload444MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload444GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload444MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload444MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload444MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload444MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload444Geolocation$inboundSchema: z.ZodType<
  UserEventPayload444Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload444City$inboundSchema)),
  country: z.lazy(() => UserEventPayload444Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload444MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload444GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload444Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload444Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload444Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload444Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload441Resources$inboundSchema: z.ZodType<
...
export function userEventPayload441ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload441Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload441Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload441Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload441Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload441Values$inboundSchema: z.ZodType<
  UserEventPayload441Values,
  z.ZodTypeDef,
  unknown
> = z.object({
  value: types.string(),
...
export function userEventPayload441ValuesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload441Values, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload441Values$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload441Values' from JSON`,
  );
}
...
> = z.object({
  name: types.string(),
  values: z.array(z.lazy(() => UserEventPayload441Values$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload441AfterResources$inboundSchema: z.ZodType<
  UserEventPayload441AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload441AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload441AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload441AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload441AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload441AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload439Names$inboundSchema: z.ZodType<
...
export function userEventPayload439NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload439Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload439Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload439Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload439Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload439GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload439GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload439GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload439GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload439GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload439GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload439GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload439GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload439GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload439GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload439GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload432Team$inboundSchema: z.ZodType<
...
export function userEventPayload432TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload432ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432Configuration' from JSON`,
  );
}
...
export const FourHundredAndThirtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload432Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload432Configuration$inboundSchema),
...
> = z.object({
  ...
  actorType: UserEventPayload418ActorType$inboundSchema,
...
/** @internal */
export const UserEventPayload415Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload415Provider
> = z.nativeEnum(UserEventPayload415Provider);
...
export const FourHundredAndFifteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload415Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload414Previous$inboundSchema: z.ZodType<
...
export function userEventPayload414PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload414Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload414Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload414Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload414Next$inboundSchema: z.ZodType<
...
export function userEventPayload414NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload414Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload414Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload414Next' from JSON`,
  );
}
...
export const FourHundredAndFourteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload414Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload414Next$inboundSchema),
});
...
export const FourHundredAndNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload409Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload409Next$inboundSchema),
...
/** @internal */
export const UserEventPayload408Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload408Action
> = z.nativeEnum(UserEventPayload408Action);
...
export const FourHundredAndEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload408Action$inboundSchema,
  reason: types.string(),
});
