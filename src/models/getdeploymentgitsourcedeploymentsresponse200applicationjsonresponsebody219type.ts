...
export type GetDeploymentGitSourceDeploymentsAuthor = {
  date: string;
  email: string;
  name: string;
};

export type GetDeploymentGitSourceDeploymentsCommitter = {
  date: string;
  email: string;
  name: string;
};

export type GetDeploymentGitSourceDeploymentsCommitMetadata = {
  author: GetDeploymentGitSourceDeploymentsAuthor;
  committer: GetDeploymentGitSourceDeploymentsCommitter;
  message: string;
};
...
export type GetDeploymentGitSourceDeployments18 = {
  commitMetadata?: GetDeploymentGitSourceDeploymentsCommitMetadata | undefined;
  org: string;
  ref: string;
  repo: string;
...
export type GetDeploymentGitSourceAuthor = {
  date: string;
  email: string;
  name: string;
};

export type GetDeploymentGitSourceCommitter = {
  date: string;
  email: string;
  name: string;
};

export type GetDeploymentGitSourceCommitMetadata = {
  author: GetDeploymentGitSourceAuthor;
  committer: GetDeploymentGitSourceCommitter;
  message: string;
};
...
export type GetDeploymentGitSourceDeployments10 = {
  commitMetadata?: GetDeploymentGitSourceCommitMetadata | undefined;
  org?: string | undefined;
  prId?: number | null | undefined;
  ref?: string | null | undefined;
  repo?: string | undefined;
...
/** @internal */
export const GetDeploymentGitSourceDeploymentsAuthor$inboundSchema: z.ZodType<
  GetDeploymentGitSourceDeploymentsAuthor,
  z.ZodTypeDef,
  unknown
> = z.object({
  date: types.string(),
...
export function getDeploymentGitSourceDeploymentsAuthorFromJSON(
  jsonString: string,
): SafeParseResult<
  GetDeploymentGitSourceDeploymentsAuthor,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetDeploymentGitSourceDeploymentsAuthor$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetDeploymentGitSourceDeploymentsAuthor' from JSON`,
  );
}

/** @internal */
export const GetDeploymentGitSourceDeploymentsCommitter$inboundSchema:
  z.ZodType<GetDeploymentGitSourceDeploymentsCommitter, z.ZodTypeDef, unknown> =
    z.object({
      date: types.string(),
      email: types.string(),
      name: types.string(),
...
export function getDeploymentGitSourceDeploymentsCommitterFromJSON(
  jsonString: string,
): SafeParseResult<
  GetDeploymentGitSourceDeploymentsCommitter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetDeploymentGitSourceDeploymentsCommitter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetDeploymentGitSourceDeploymentsCommitter' from JSON`,
  );
}

/** @internal */
export const GetDeploymentGitSourceDeploymentsCommitMetadata$inboundSchema:
  z.ZodType<
    GetDeploymentGitSourceDeploymentsCommitMetadata,
    z.ZodTypeDef,
    unknown
  > = z.object({
    author: z.lazy(() => GetDeploymentGitSourceDeploymentsAuthor$inboundSchema),
    committer: z.lazy(() =>
      GetDeploymentGitSourceDeploymentsCommitter$inboundSchema
    ),
    message: types.string(),
  });

export function getDeploymentGitSourceDeploymentsCommitMetadataFromJSON(
  jsonString: string,
): SafeParseResult<
  GetDeploymentGitSourceDeploymentsCommitMetadata,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetDeploymentGitSourceDeploymentsCommitMetadata$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetDeploymentGitSourceDeploymentsCommitMetadata' from JSON`,
  );
}
...
> = z.object({
  commitMetadata: types.optional(
    z.lazy(() => GetDeploymentGitSourceDeploymentsCommitMetadata$inboundSchema),
  ),
  org: types.string(),
  ref: types.string(),
  repo: types.string(),
...
/** @internal */
export const GetDeploymentGitSourceAuthor$inboundSchema: z.ZodType<
  GetDeploymentGitSourceAuthor,
  z.ZodTypeDef,
  unknown
> = z.object({
  date: types.string(),
...
export function getDeploymentGitSourceAuthorFromJSON(
  jsonString: string,
): SafeParseResult<GetDeploymentGitSourceAuthor, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetDeploymentGitSourceAuthor$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetDeploymentGitSourceAuthor' from JSON`,
  );
}

/** @internal */
export const GetDeploymentGitSourceCommitter$inboundSchema: z.ZodType<
  GetDeploymentGitSourceCommitter,
  z.ZodTypeDef,
  unknown
> = z.object({
  date: types.string(),
...
export function getDeploymentGitSourceCommitterFromJSON(
  jsonString: string,
): SafeParseResult<GetDeploymentGitSourceCommitter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetDeploymentGitSourceCommitter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetDeploymentGitSourceCommitter' from JSON`,
  );
}

/** @internal */
export const GetDeploymentGitSourceCommitMetadata$inboundSchema: z.ZodType<
  GetDeploymentGitSourceCommitMetadata,
  z.ZodTypeDef,
  unknown
> = z.object({
  author: z.lazy(() => GetDeploymentGitSourceAuthor$inboundSchema),
  committer: z.lazy(() => GetDeploymentGitSourceCommitter$inboundSchema),
  message: types.string(),
});

export function getDeploymentGitSourceCommitMetadataFromJSON(
  jsonString: string,
): SafeParseResult<GetDeploymentGitSourceCommitMetadata, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      GetDeploymentGitSourceCommitMetadata$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetDeploymentGitSourceCommitMetadata' from JSON`,
  );
}
...
> = z.object({
  commitMetadata: types.optional(
    z.lazy(() => GetDeploymentGitSourceCommitMetadata$inboundSchema),
  ),
  org: types.optional(types.string()),
  prId: z.nullable(types.number()).optional(),
  ref: z.nullable(types.string()).optional(),
