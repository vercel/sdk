...
import {
  ...
  GetDeploymentServicesAffinity$inboundSchema,
  GetDeploymentServicesArchitecture,
  GetDeploymentServicesArchitecture$inboundSchema,
  ...
  GetDeploymentServicesExperimentalTriggers$inboundSchema,
  ResponseBodyProject,
...
} from "./getdeploymentmaxdurationdeployments2.js";
...
export type GetDeploymentServicesFunctions = {
  ...
  experimentalTriggers?:
    | Array<GetDeploymentServicesExperimentalTriggers>
    | undefined;
...
export const GetDeploymentServicesFunctions$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  affinity: types.optional(GetDeploymentServicesAffinity$inboundSchema),
  ...
  experimentalTriggers: types.optional(
    z.array(GetDeploymentServicesExperimentalTriggers$inboundSchema),
  ),
