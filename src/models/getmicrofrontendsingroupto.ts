...
export const GetMicrofrontendsInGroupMicrofrontendsDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type GetMicrofrontendsInGroupMicrofrontendsDirection = ClosedEnum<
  typeof GetMicrofrontendsInGroupMicrofrontendsDirection
>;

export type GetMicrofrontendsInGroupBuildMachineElasticTransition = {
  algorithmVersion: string;
  at: number;
  direction: GetMicrofrontendsInGroupMicrofrontendsDirection;
};
...
export type GetMicrofrontendsInGroupResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | GetMicrofrontendsInGroupBuildMachineElasticTransition
    | undefined;
...
/** @internal */
export const GetMicrofrontendsInGroupMicrofrontendsDirection$inboundSchema:
  z.ZodNativeEnum<typeof GetMicrofrontendsInGroupMicrofrontendsDirection> = z
    .nativeEnum(GetMicrofrontendsInGroupMicrofrontendsDirection);

/** @internal */
export const GetMicrofrontendsInGroupBuildMachineElasticTransition$inboundSchema:
  z.ZodType<
    GetMicrofrontendsInGroupBuildMachineElasticTransition,
    z.ZodTypeDef,
    unknown
  > = z.object({
    ...
    at: types.number(),
    direction: GetMicrofrontendsInGroupMicrofrontendsDirection$inboundSchema,
  });

export function getMicrofrontendsInGroupBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  GetMicrofrontendsInGroupBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetMicrofrontendsInGroupBuildMachineElasticTransition$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetMicrofrontendsInGroupBuildMachineElasticTransition' from JSON`,
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: types.optional(
    z.lazy(() =>
      GetMicrofrontendsInGroupBuildMachineElasticTransition$inboundSchema
    ),
  ),
