...
export const GetProjectDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type GetProjectDirection = ClosedEnum<typeof GetProjectDirection>;

export type GetProjectBuildMachineElasticTransition = {
...
export type GetProjectDefaultResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | GetProjectBuildMachineElasticTransition
    | undefined;
...
/** @internal */
export const GetProjectDirection$inboundSchema: z.ZodNativeEnum<
  typeof GetProjectDirection
> = z.nativeEnum(GetProjectDirection);

/** @internal */
export const GetProjectBuildMachineElasticTransition$inboundSchema: z.ZodType<
  GetProjectBuildMachineElasticTransition,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  at: types.number(),
  direction: GetProjectDirection$inboundSchema,
});

export function getProjectBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  GetProjectBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetProjectBuildMachineElasticTransition$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetProjectBuildMachineElasticTransition' from JSON`,
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: types.optional(
    z.lazy(() => GetProjectBuildMachineElasticTransition$inboundSchema),
  ),
