...
export type GetProjectsResponseBodyProviders = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

export type GetProjectsResponseBodyTrustedOidcProviders = {
  projects: { [k: string]: GetProjectsResponseBodyProjectsResponseProjects };
  providers: { [k: string]: GetProjectsResponseBodyProviders };
};
...
/** @internal */
export const GetProjectsResponseBodyProviders$inboundSchema: z.ZodType<
  GetProjectsResponseBodyProviders,
  z.ZodTypeDef,
  unknown
> = z.object({
  label: types.optional(types.string()),
...
/** @internal */
export type GetProjectsResponseBodyProviders$Outbound = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

/** @internal */
export const GetProjectsResponseBodyProviders$outboundSchema: z.ZodType<
  GetProjectsResponseBodyProviders$Outbound,
  z.ZodTypeDef,
  GetProjectsResponseBodyProviders
> = z.object({
  label: z.string().optional(),
...
export function getProjectsResponseBodyProvidersToJSON(
  getProjectsResponseBodyProviders: GetProjectsResponseBodyProviders,
): string {
  return JSON.stringify(
    GetProjectsResponseBodyProviders$outboundSchema.parse(
      getProjectsResponseBodyProviders,
    ),
  );
}
export function getProjectsResponseBodyProvidersFromJSON(
  jsonString: string,
): SafeParseResult<GetProjectsResponseBodyProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetProjectsResponseBodyProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetProjectsResponseBodyProviders' from JSON`,
  );
}

/** @internal */
export const GetProjectsResponseBodyTrustedOidcProviders$inboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    providers: z.record(
      z.lazy(() => GetProjectsResponseBodyProviders$inboundSchema),
    ),
  });
/** @internal */
export type GetProjectsResponseBodyTrustedOidcProviders$Outbound = {
  projects: {
    [k: string]: GetProjectsResponseBodyProjectsResponseProjects$Outbound;
  };
  providers: { [k: string]: GetProjectsResponseBodyProviders$Outbound };
};

/** @internal */
export const GetProjectsResponseBodyTrustedOidcProviders$outboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    providers: z.record(
      z.lazy(() => GetProjectsResponseBodyProviders$outboundSchema),
    ),
  });

export function getProjectsResponseBodyTrustedOidcProvidersToJSON(
  getProjectsResponseBodyTrustedOidcProviders:
    GetProjectsResponseBodyTrustedOidcProviders,
): string {
  return JSON.stringify(
    GetProjectsResponseBodyTrustedOidcProviders$outboundSchema.parse(
      getProjectsResponseBodyTrustedOidcProviders,
    ),
  );
}
export function getProjectsResponseBodyTrustedOidcProvidersFromJSON(
  jsonString: string,
): SafeParseResult<
  GetProjectsResponseBodyTrustedOidcProviders,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetProjectsResponseBodyTrustedOidcProviders$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetProjectsResponseBodyTrustedOidcProviders' from JSON`,
  );
}
