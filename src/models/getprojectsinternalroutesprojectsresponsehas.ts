...
import {
  ...
  GetProjectsResponseBodyProjectsResponseChecks$inboundSchema,
  GetProjectsResponseBodyProjectsStages,
  GetProjectsResponseBodyProjectsStages$inboundSchema,
...
> = z.object({
  ...
  checks: z.array(GetProjectsResponseBodyProjectsResponseChecks$inboundSchema),
...
export const GetProjectsResponseBodyProjectsRollingRelease$inboundSchema:
  ...
  > = z.object({
    target: types.string(),
    stages: z.nullable(
      z.array(GetProjectsResponseBodyProjectsStages$inboundSchema),
    ).optional(),
