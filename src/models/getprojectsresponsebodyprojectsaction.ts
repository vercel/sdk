...
import {
  ...
  GetProjectsResponseBodyProjectsTrustedOidcProviders$inboundSchema,
  GetProjectsResponseBodyProjectsTrustedOidcProviders$Outbound,
  GetProjectsResponseBodyProjectsTrustedOidcProviders$outboundSchema,
...
} from "./getprojectshasprojectsresponse200applicationjsonresponsebody22.js";
import {
  Pagination,
...
export type ResponseBodyProviders = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

export type ResponseBodyTrustedOidcProviders = {
  projects: { [k: string]: GetProjectsResponseBodyProjectsProjects };
  providers: { [k: string]: ResponseBodyProviders };
};
...
/** @internal */
export const ResponseBodyProviders$inboundSchema: z.ZodType<
...
/** @internal */
export type ResponseBodyProviders$Outbound = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

/** @internal */
export const ResponseBodyProviders$outboundSchema: z.ZodType<
  ResponseBodyProviders$Outbound,
  z.ZodTypeDef,
  ResponseBodyProviders
> = z.object({
  label: z.string().optional(),
...
export function responseBodyProvidersToJSON(
  responseBodyProviders: ResponseBodyProviders,
): string {
  return JSON.stringify(
    ResponseBodyProviders$outboundSchema.parse(responseBodyProviders),
  );
}
export function responseBodyProvidersFromJSON(
  jsonString: string,
): SafeParseResult<ResponseBodyProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ResponseBodyProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ResponseBodyProviders' from JSON`,
  );
}

/** @internal */
export const ResponseBodyTrustedOidcProviders$inboundSchema: z.ZodType<
  ResponseBodyTrustedOidcProviders,
  z.ZodTypeDef,
  unknown
> = z.object({
  projects: z.record(
  ...
  providers: z.record(z.lazy(() => ResponseBodyProviders$inboundSchema)),
});
/** @internal */
export type ResponseBodyTrustedOidcProviders$Outbound = {
  projects: { [k: string]: GetProjectsResponseBodyProjectsProjects$Outbound };
  providers: { [k: string]: ResponseBodyProviders$Outbound };
};

/** @internal */
export const ResponseBodyTrustedOidcProviders$outboundSchema: z.ZodType<
  ResponseBodyTrustedOidcProviders$Outbound,
  z.ZodTypeDef,
  ResponseBodyTrustedOidcProviders
> = z.object({
  projects: z.record(
  ...
  providers: z.record(z.lazy(() => ResponseBodyProviders$outboundSchema)),
});

export function responseBodyTrustedOidcProvidersToJSON(
  responseBodyTrustedOidcProviders: ResponseBodyTrustedOidcProviders,
): string {
  return JSON.stringify(
    ResponseBodyTrustedOidcProviders$outboundSchema.parse(
      responseBodyTrustedOidcProviders,
    ),
  );
}
export function responseBodyTrustedOidcProvidersFromJSON(
  jsonString: string,
): SafeParseResult<ResponseBodyTrustedOidcProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ResponseBodyTrustedOidcProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ResponseBodyTrustedOidcProviders' from JSON`,
  );
}
