...
export type GetProjectsLogHeadersProjectsResponse200ApplicationJSONResponseBody2 =
  ClosedEnum<
    typeof GetProjectsLogHeadersProjectsResponse200ApplicationJSONResponseBody2
  >;

export type GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders =
  | Array<string>
...
export const GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction =
  {
...
export type GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction =
  ClosedEnum<
    typeof GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction
  >;
...
/** @internal */
export const GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders$inboundSchema:
  z.ZodType<
    GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders,
    z.ZodTypeDef,
    unknown
  > = smartUnion([
    z.array(types.string()),
    GetProjectsLogHeadersProjectsResponse200ApplicationJSONResponseBody2$inboundSchema,
  ]);

export function getProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeadersFromJSON(
  jsonString: string,
): SafeParseResult<
  GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'GetProjectsResponseBodyProjectsResponse200ApplicationJSONLogHeaders' from JSON`,
  );
}
...
/** @internal */
export const GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction$inboundSchema:
  z.ZodNativeEnum<
    typeof GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction
  > = z.nativeEnum(
    GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction,
...
export const GetProjectsResponseBodyProjectsInterstitialHistory$inboundSchema:
  ...
  > = z.object({
    action:
      GetProjectsResponseBodyProjectsResponse200ApplicationJson3ProjectsAbuseAction$inboundSchema,
    createdAt: types.number(),
    caseId: types.optional(types.string()),
