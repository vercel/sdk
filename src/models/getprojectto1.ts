...
export const GetProjectProjectsDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type GetProjectProjectsDirection = ClosedEnum<
  typeof GetProjectProjectsDirection
>;

export type GetProjectProjectsBuildMachineElasticTransition = {
  algorithmVersion: string;
  at: number;
  direction: GetProjectProjectsDirection;
};
...
export type GetProjectResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | GetProjectProjectsBuildMachineElasticTransition
    | undefined;
...
/** @internal */
export const GetProjectProjectsDirection$inboundSchema: z.ZodNativeEnum<
  typeof GetProjectProjectsDirection
> = z.nativeEnum(GetProjectProjectsDirection);

/** @internal */
export const GetProjectProjectsBuildMachineElasticTransition$inboundSchema:
  z.ZodType<
    GetProjectProjectsBuildMachineElasticTransition,
    z.ZodTypeDef,
    unknown
  > = z.object({
    ...
    at: types.number(),
    direction: GetProjectProjectsDirection$inboundSchema,
  });

export function getProjectProjectsBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  GetProjectProjectsBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      GetProjectProjectsBuildMachineElasticTransition$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'GetProjectProjectsBuildMachineElasticTransition' from JSON`,
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: types.optional(
    z.lazy(() => GetProjectProjectsBuildMachineElasticTransition$inboundSchema),
  ),
