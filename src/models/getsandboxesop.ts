...
export type GetSandboxesRequest = {
  /**
...
export type GetSandboxesPagination = {
  count: number;
  next: string | null;
};

export type GetSandboxesResponseBody = {
  sandboxes: Array<NamedSandbox>;
  pagination: GetSandboxesPagination;
};
...
/** @internal */
export type GetSandboxesRequest$Outbound = {
  project?: string | undefined;
  limit: number;
  sortBy: string;
  namePrefix?: string | undefined;
...
/** @internal */
export const GetSandboxesRequest$outboundSchema: z.ZodType<
  GetSandboxesRequest$Outbound,
  z.ZodTypeDef,
  GetSandboxesRequest
> = z.object({
...
export function getSandboxesRequestToJSON(
  getSandboxesRequest: GetSandboxesRequest,
): string {
  return JSON.stringify(
    GetSandboxesRequest$outboundSchema.parse(getSandboxesRequest),
  );
}

/** @internal */
export const GetSandboxesPagination$inboundSchema: z.ZodType<
  GetSandboxesPagination,
  z.ZodTypeDef,
  unknown
> = z.object({
  count: types.number(),
...
export function getSandboxesPaginationFromJSON(
  jsonString: string,
): SafeParseResult<GetSandboxesPagination, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetSandboxesPagination$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetSandboxesPagination' from JSON`,
  );
}

/** @internal */
export const GetSandboxesResponseBody$inboundSchema: z.ZodType<
  GetSandboxesResponseBody,
  z.ZodTypeDef,
  unknown
> = z.object({
  sandboxes: z.array(NamedSandbox$inboundSchema),
  pagination: z.lazy(() => GetSandboxesPagination$inboundSchema),
});

export function getSandboxesResponseBodyFromJSON(
  jsonString: string,
): SafeParseResult<GetSandboxesResponseBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetSandboxesResponseBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetSandboxesResponseBody' from JSON`,
  );
}
