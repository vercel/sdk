...
import {
  ...
  Tracing,
  Tracing$inboundSchema,
  UserEventPayload172NewOwnerFeatureBlocksVcrBlockReason,
  UserEventPayload172NewOwnerFeatureBlocksVcrBlockReason$inboundSchema,
...
export type Vcr = {
  ...
  blockReason: UserEventPayload172NewOwnerFeatureBlocksVcrBlockReason;
  updatedAt: number;
};

export const UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason =
  ClosedEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason
  >;

export type PayloadWebAnalytics = {
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason;
  updatedAt: number;
  graceEmailSentAt?: number | undefined;
};

export const UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  ClosedEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason
  >;
...
export type WorkflowEvents = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason;
  updatedAt: number;
};

export const UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  ClosedEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  >;
...
export type WorkflowStorageWrite = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason;
  updatedAt: number;
};
 ...
 */
export const UserEventPayload172NewOwnerAction = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload172NewOwnerAction = ClosedEnum<
  typeof UserEventPayload172NewOwnerAction
>;

/**
 * Type of actor
 */
export const UserEventPayload172ActorType = {
  Admin: "admin",
  User: "user",
} as const;
/**
 * Type of actor
 */
export type UserEventPayload172ActorType = ClosedEnum<
  typeof UserEventPayload172ActorType
>;
 ...
 */
export const UserEventPayload172Method = {
 ...
 * Method used for the state change - 'totp': User set up TOTP authenticator - 'passkey': User registered a passkey - 'user_disabled': User disabled their own MFA - 'admin_removal': Admin removed MFA via backoffice - 'self_serve_recovery': User disabled their own MFA through the self-serve MFA disable recovery flow (a "Locked Out User" with only a passkey) - 'unknown': Method unknown (for pre-tracking events)
 */
export type UserEventPayload172Method = ClosedEnum<
  typeof UserEventPayload172Method
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload172NewOwnerAction;
  /**
   ...
   * Type of actor
   */
  actorType: UserEventPayload172ActorType;
  /**
   * Method used for the state change - 'totp': User set up TOTP authenticator - 'passkey': User registered a passkey - 'user_disabled': User disabled their own MFA - 'admin_removal': Admin removed MFA via backoffice - 'self_serve_recovery': User disabled their own MFA through the self-serve MFA disable recovery flow (a "Locked Out User" with only a passkey) - 'unknown': Method unknown (for pre-tracking events)
   */
  method: UserEventPayload172Method;
  /**
...
export const UserEventPayload172Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload172Configuration = ClosedEnum<
  typeof UserEventPayload172Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload172Configuration | undefined;
};
...
export const UserEventPayload172Reason = {
...
export type UserEventPayload172Reason = ClosedEnum<
  typeof UserEventPayload172Reason
>;

export type PayloadSoftBlock = {
  blockedAt: number;
  blockedDueToOverageType?: PayloadBlockedDueToOverageType | undefined;
  reason: UserEventPayload172Reason;
  /**
...
export type UserEventPayload172GitUserId = string | number;

export const UserEventPayload172Origin = {
...
export type UserEventPayload172Origin = ClosedEnum<
  typeof UserEventPayload172Origin
>;

export type UserEventPayload172JoinedFrom = {
  ...
  origin: UserEventPayload172Origin;
...
export const UserEventPayload172Role = {
  Billing: "BILLING",
...
export type UserEventPayload172Role = ClosedEnum<
  typeof UserEventPayload172Role
>;
...
export type Teams = {
  ...
  created: number;
  createdAt: number;
  joinedFrom?: UserEventPayload172JoinedFrom | undefined;
  role: UserEventPayload172Role;
  teamId: string;
...
export const UserEventPayload169Provider = {
  Bitbucket: "bitbucket",
  CursorOrigin: "cursor-origin",
  Github: "github",
  Gitlab: "gitlab",
} as const;
export type UserEventPayload169Provider = ClosedEnum<
  typeof UserEventPayload169Provider
>;
...
export type OneHundredAndSixtyNine = {
  ...
  outcome: Outcome;
  provider: UserEventPayload169Provider;
...
export type OneHundredAndSixtySeven = {
  action: UserEventPayload167Action;
};
...
export type OneHundredAndSixtyFive = {
  action?: UserEventPayload165Action | undefined;
  active: boolean;
  projectId: string;
  rulesetName: string;
};
 ...
 */
export const UserEventPayload157Target = {
 ...
 * environments this env variable targets
 */
export type UserEventPayload157Target = ClosedEnum<
  typeof UserEventPayload157Target
>;
...
export type NewEnvVar = {
   ...
   * environments this env variable targets
   */
  target?: Array<UserEventPayload157Target> | undefined;
  /**
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload157Type | undefined;
  /**
 ...
 * environments this env variable targets
 */
export const UserEventPayload157OldEnvVarTarget = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload157OldEnvVarTarget = ClosedEnum<
  typeof UserEventPayload157OldEnvVarTarget
>;

/**
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload157OldEnvVarType = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload157OldEnvVarType = ClosedEnum<
  typeof UserEventPayload157OldEnvVarType
>;
...
export type OldEnvVar = {
   ...
   * environments this env variable targets
   */
  target?: Array<UserEventPayload157OldEnvVarTarget> | undefined;
  /**
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload157OldEnvVarType | undefined;
  /**
   * Timestamp for when the Shared Env Var was last updated.
   */
  updatedAt?: number | undefined;
...
export type OneHundredAndFiftySix = {
  ...
  provider: string;
  repository: string;
  target: Array<UserEventPayload156Target>;
};
...
/** @internal */
export const UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason
  > = z.nativeEnum(
    UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason,
  );
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload172NewOwnerFeatureBlocksWebAnalyticsBlockReason$inboundSchema,
  updatedAt: types.number(),
...
/** @internal */
export const UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason
  > = z.nativeEnum(
    UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload172NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema,
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  > = z.nativeEnum(
    UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload172NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema,
  updatedAt: types.number(),
});
...
> = z.object({
  ...
  tracing: types.optional(Tracing$inboundSchema),
...
/** @internal */
export const UserEventPayload172NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172NewOwnerAction
> = z.nativeEnum(UserEventPayload172NewOwnerAction);

/** @internal */
export const UserEventPayload172ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172ActorType
> = z.nativeEnum(UserEventPayload172ActorType);

/** @internal */
export const UserEventPayload172Method$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172Method
> = z.nativeEnum(UserEventPayload172Method);
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload172NewOwnerAction$inboundSchema,
  actorId: types.string(),
  actorType: UserEventPayload172ActorType$inboundSchema,
  method: UserEventPayload172Method$inboundSchema,
...
/** @internal */
export const UserEventPayload172Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172Configuration
> = z.nativeEnum(UserEventPayload172Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload172Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload172Reason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172Reason
> = z.nativeEnum(UserEventPayload172Reason);
...
> = z.object({
  ...
  reason: UserEventPayload172Reason$inboundSchema,
...
/** @internal */
export const UserEventPayload172GitUserId$inboundSchema: z.ZodType<
  UserEventPayload172GitUserId,
  z.ZodTypeDef,
  unknown
> = smartUnion([types.string(), types.number()]);

export function userEventPayload172GitUserIdFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload172GitUserId, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload172GitUserId$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload172GitUserId' from JSON`,
  );
}

/** @internal */
export const UserEventPayload172Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172Origin
> = z.nativeEnum(UserEventPayload172Origin);

/** @internal */
export const UserEventPayload172JoinedFrom$inboundSchema: z.ZodType<
  UserEventPayload172JoinedFrom,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  origin: UserEventPayload172Origin$inboundSchema,
...
export function userEventPayload172JoinedFromFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload172JoinedFrom, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload172JoinedFrom$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload172JoinedFrom' from JSON`,
  );
}

/** @internal */
export const UserEventPayload172Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload172Role
> = z.nativeEnum(UserEventPayload172Role);
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    ...
    joinedFrom: types.optional(
      z.lazy(() => UserEventPayload172JoinedFrom$inboundSchema),
    ),
    role: UserEventPayload172Role$inboundSchema,
    teamId: types.string(),
...
> = z.object({
  ...
  type: UserEventPayload172Type$inboundSchema,
  updatedAt: types.number(),
...
/** @internal */
export const UserEventPayload169Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload169Provider
> = z.nativeEnum(UserEventPayload169Provider);
...
> = z.object({
  ...
  provider: UserEventPayload169Provider$inboundSchema,
...
export const OneHundredAndSixtySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload167Action$inboundSchema,
});
...
export const OneHundredAndSixtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: types.optional(UserEventPayload165Action$inboundSchema),
...
/** @internal */
export const UserEventPayload157Target$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload157Target
> = z.nativeEnum(UserEventPayload157Target);
...
> = z.object({
  ...
  target: types.optional(z.array(UserEventPayload157Target$inboundSchema)),
  type: types.optional(UserEventPayload157Type$inboundSchema),
...
/** @internal */
export const UserEventPayload157OldEnvVarTarget$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload157OldEnvVarTarget
> = z.nativeEnum(UserEventPayload157OldEnvVarTarget);

/** @internal */
export const UserEventPayload157OldEnvVarType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload157OldEnvVarType
> = z.nativeEnum(UserEventPayload157OldEnvVarType);
...
> = z.object({
  ...
  target: types.optional(
    z.array(UserEventPayload157OldEnvVarTarget$inboundSchema),
  ),
  type: types.optional(UserEventPayload157OldEnvVarType$inboundSchema),
  updatedAt: types.optional(types.number()),
  updatedBy: z.nullable(types.string()).optional(),
  value: types.optional(types.string()),
});
...
> = z.object({
  ...
  target: z.array(UserEventPayload156Target$inboundSchema),
});
