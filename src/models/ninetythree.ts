...
export const UserEventPayload130BlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload130BlockReason = ClosedEnum<
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload130BlockReason;
};

export const UserEventPayload130NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload130NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload130NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload130NewOwnerBlockReason;
};

export const UserEventPayload130NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload130NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload130NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload130NewOwnerFeatureBlocksBlockReason;
};
...
export const UserEventPayload130NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    LimitsExceeded: "limits_exceeded",
    HardBlocked: "hard_blocked",
  } as const;
export type UserEventPayload130NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
...
export const UserEventPayload130NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  {
    AdminOverride: "admin_override",
    LimitsExceeded: "limits_exceeded",
    HardBlocked: "hard_blocked",
  } as const;
export type UserEventPayload130NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  ClosedEnum<
...
export const UserEventPayload130NewOwnerFeatureBlocksWorkflowStepBlockReason = {
  AdminOverride: "admin_override",
  LimitsExceeded: "limits_exceeded",
  HardBlocked: "hard_blocked",
} as const;
export type UserEventPayload130NewOwnerFeatureBlocksWorkflowStepBlockReason =
  ClosedEnum<
...
export type WorkflowStep = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload130NewOwnerFeatureBlocksWorkflowStepBlockReason;
};

export const UserEventPayload130NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  {
    AdminOverride: "admin_override",
    LimitsExceeded: "limits_exceeded",
    HardBlocked: "hard_blocked",
  } as const;
export type UserEventPayload130NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  ClosedEnum<
 ...
 */
export const UserEventPayload130NewOwnerAction = {
  Enabled: "enabled",
  Disabled: "disabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload130NewOwnerAction = ClosedEnum<
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload130NewOwnerAction;
  /**
...
export const UserEventPayload128Action = {
  Enable: "enable",
  Disable: "disable",
} as const;
export type UserEventPayload128Action = ClosedEnum<
...
export type OneHundredAndTwentyEight = {
  action: UserEventPayload128Action;
};

export const UserEventPayload127Action = {
  Log: "log",
  Challenge: "challenge",
  Deny: "deny",
} as const;
export type UserEventPayload127Action = ClosedEnum<
...
export type OneHundredAndTwentySeven = {
  ...
  rulesetName: string;
  active: boolean;
  action?: UserEventPayload127Action | undefined;
};
...
export type RuleGroups = {
  active: boolean;
  action?: UserEventPayload126Action | undefined;
};
 ...
 */
export const UserEventPayload121Type = {
  System: "system",
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload121Type = ClosedEnum<
 ...
 */
export const UserEventPayload121Target = {
 ...
 * environments this env variable targets
 */
export type UserEventPayload121Target = ClosedEnum<
...
export type OldEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload121Type | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload121Target> | undefined;
  /**
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload121NewEnvVarType = {
  System: "system",
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload121NewEnvVarType = ClosedEnum<
 ...
 * environments this env variable targets
 */
export const UserEventPayload121NewEnvVarTarget = {
  Production: "production",
  Preview: "preview",
  Development: "development",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload121NewEnvVarTarget = ClosedEnum<
...
export type NewEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload121NewEnvVarType | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload121NewEnvVarTarget> | undefined;
  /**
   * whether or not this env varible applies to custom environments
   */
  applyToAllCustomEnvironments?: boolean | undefined;
...
export type UserEventPayload117Team = {
  id: string;
  name?: string | undefined;
};
...
export const UserEventPayload112ToAccountType = {
  User: "user",
  Team: "team",
} as const;
export type UserEventPayload112ToAccountType = ClosedEnum<
  typeof UserEventPayload112ToAccountType
>;

export type ToAccount = {
  id: string;
  type: UserEventPayload112ToAccountType;
  slug?: string | undefined;
  username?: string | undefined;
};
...
/** @internal */
export const UserEventPayload130NewOwnerBlockReason$inboundSchema:
...
/** @internal */
export const UserEventPayload130NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload130NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload130NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
/** @internal */
export const UserEventPayload130NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload130NewOwnerFeatureBlocksWorkflowStorageBlockReason
  > = z.nativeEnum(
    UserEventPayload130NewOwnerFeatureBlocksWorkflowStorageBlockReason,
...
/** @internal */
export const UserEventPayload130NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload130NewOwnerFeatureBlocksWorkflowStepBlockReason
  > = z.nativeEnum(
...
/** @internal */
export const UserEventPayload130NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload130NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  > = z.nativeEnum(
    UserEventPayload130NewOwnerFeatureBlocksConnexTokenRequestsBlockReason,
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload130NewOwnerAction$inboundSchema,
...
> = z.object({
  ...
  type: types.optional(UserEventPayload121Type$inboundSchema),
  target: types.optional(z.array(UserEventPayload121Target$inboundSchema)),
...
> = z.object({
  ...
  value: types.optional(types.string()),
  projectId: types.optional(z.array(types.string())),
  type: types.optional(UserEventPayload121NewEnvVarType$inboundSchema),
  target: types.optional(
    z.array(UserEventPayload121NewEnvVarTarget$inboundSchema),
  ),
  applyToAllCustomEnvironments: types.optional(types.boolean()),
  customEnvironmentIds: types.optional(z.array(types.string())),
  decrypted: types.optional(types.boolean()),
...
/** @internal */
export const UserEventPayload117Team$inboundSchema: z.ZodType<
...
export function userEventPayload117TeamFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => UserEventPayload117Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload117Team' from JSON`,
  );
}
...
export const OneHundredAndSeventeen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload117Team$inboundSchema),
...
/** @internal */
export const UserEventPayload116Team$inboundSchema: z.ZodType<
...
export function userEventPayload116TeamFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => UserEventPayload116Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload116Team' from JSON`,
  );
}
...
> = z.object({
  id: types.string(),
  type: UserEventPayload112ToAccountType$inboundSchema,
  slug: types.optional(types.string()),
  username: types.optional(types.string()),
});
/** @internal */
