...
export type UserEventPayload234Team = {
  id: string;
  name: string;
};
...
export type UserEventPayload211Passport = {
  connectorId: string;
  deploymentType: UserEventPayload211DeploymentType;
};

export type UserEventPayload211Next = {
  passport?: UserEventPayload211Passport | null | undefined;
};
...
export type UserEventPayload186PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload186PrevProject;
};
...
/** @internal */
export const UserEventPayload234Team$inboundSchema: z.ZodType<
  UserEventPayload234Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload234TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload234Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload234Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload234Team' from JSON`,
  );
}
...
export const TwoHundredAndThirtyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload234Team$inboundSchema),
...
/** @internal */
export const UserEventPayload211Passport$inboundSchema: z.ZodType<
  UserEventPayload211Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload211PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload211Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload211Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload211Passport' from JSON`,
  );
}
...
export const UserEventPayload211Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload211Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload186PrevProject$inboundSchema: z.ZodType<
  UserEventPayload186PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload186PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload186PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload186PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload186PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload186PrevProject$inboundSchema),
});
