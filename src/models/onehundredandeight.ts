...
import {
  ...
  UserEventPayload137Type,
  UserEventPayload137Type$inboundSchema,
...
export const UserEventPayload137BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload137BlockReason = ClosedEnum<
  typeof UserEventPayload137BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload137BlockReason;
};

export const UserEventPayload137NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload137NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload137NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload137NewOwnerBlockReason;
};

export const UserEventPayload137NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload137NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload137NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload137NewOwnerFeatureBlocksBlockReason;
};
...
export const UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  >;
...
export type MicrofrontendsRequest = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason;
};

export const UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  ClosedEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason
  >;
...
export type WorkflowStorage = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason;
};

export const UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason =
  ClosedEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason
  >;
...
export type WorkflowStep = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason;
};

export const UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  ClosedEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  >;
...
export type ConnexTokenRequests = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason;
};
 ...
 */
export const UserEventPayload137NewOwnerAction = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload137NewOwnerAction = ClosedEnum<
  typeof UserEventPayload137NewOwnerAction
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload137NewOwnerAction;
  /**
...
export type OneHundredAndThirtyFive = {
  action: UserEventPayload135Action;
};
...
export const UserEventPayload133Action = {
  Challenge: "challenge",
  Deny: "deny",
  Log: "log",
} as const;
export type UserEventPayload133Action = ClosedEnum<
  typeof UserEventPayload133Action
>;

export type RuleGroups = {
  active: boolean;
  action?: UserEventPayload133Action | undefined;
};
 ...
 */
export const UserEventPayload128Type = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload128Type = ClosedEnum<
  typeof UserEventPayload128Type
>;

/**
 * environments this env variable targets
 */
export const UserEventPayload128Target = {
 ...
 * environments this env variable targets
 */
export type UserEventPayload128Target = ClosedEnum<
  typeof UserEventPayload128Target
>;
...
export type OldEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload128Type | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload128Target> | undefined;
  /**
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload128NewEnvVarType = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload128NewEnvVarType = ClosedEnum<
  typeof UserEventPayload128NewEnvVarType
>;

/**
 * environments this env variable targets
 */
export const UserEventPayload128NewEnvVarTarget = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload128NewEnvVarTarget = ClosedEnum<
  typeof UserEventPayload128NewEnvVarTarget
>;
...
export type NewEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload128NewEnvVarType | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload128NewEnvVarTarget> | undefined;
  /**
   * whether or not this env varible applies to custom environments
   */
  applyToAllCustomEnvironments?: boolean | undefined;
...
export type UserEventPayload123Team = {
  id: string;
  name?: string | undefined;
};
...
export const UserEventPayload119ToAccountType = {
  Team: "team",
  User: "user",
} as const;
export type UserEventPayload119ToAccountType = ClosedEnum<
  typeof UserEventPayload119ToAccountType
>;

export type ToAccount = {
  id: string;
  type: UserEventPayload119ToAccountType;
  slug?: string | undefined;
  username?: string | undefined;
};
...
/** @internal */
export const UserEventPayload137BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload137BlockReason
> = z.nativeEnum(UserEventPayload137BlockReason);
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload137BlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload137NewOwnerBlockReason> = z.nativeEnum(
    UserEventPayload137NewOwnerBlockReason,
  );
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload137NewOwnerBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerFeatureBlocksBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload137NewOwnerFeatureBlocksBlockReason> =
    z.nativeEnum(UserEventPayload137NewOwnerFeatureBlocksBlockReason);
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason
  > = z.nativeEnum(
    UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason
  > = z.nativeEnum(
    UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason,
  );
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  > = z.nativeEnum(
    UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload137NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload137NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload137NewOwnerAction
> = z.nativeEnum(UserEventPayload137NewOwnerAction);
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload137NewOwnerAction$inboundSchema,
...
> = z.object({
  ...
  type: UserEventPayload137Type$inboundSchema,
...
export const OneHundredAndThirtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload135Action$inboundSchema,
});
...
/** @internal */
export const UserEventPayload133Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload133Action
> = z.nativeEnum(UserEventPayload133Action);
...
> = z.object({
  active: types.boolean(),
  action: types.optional(UserEventPayload133Action$inboundSchema),
});
...
/** @internal */
export const UserEventPayload128Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload128Type
> = z.nativeEnum(UserEventPayload128Type);

/** @internal */
export const UserEventPayload128Target$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload128Target
> = z.nativeEnum(UserEventPayload128Target);
...
> = z.object({
  ...
  type: types.optional(UserEventPayload128Type$inboundSchema),
  target: types.optional(z.array(UserEventPayload128Target$inboundSchema)),
...
/** @internal */
export const UserEventPayload128NewEnvVarType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload128NewEnvVarType
> = z.nativeEnum(UserEventPayload128NewEnvVarType);

/** @internal */
export const UserEventPayload128NewEnvVarTarget$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload128NewEnvVarTarget
> = z.nativeEnum(UserEventPayload128NewEnvVarTarget);
...
> = z.object({
  ...
  value: types.optional(types.string()),
  projectId: types.optional(z.array(types.string())),
  type: types.optional(UserEventPayload128NewEnvVarType$inboundSchema),
  target: types.optional(
    z.array(UserEventPayload128NewEnvVarTarget$inboundSchema),
  ),
  applyToAllCustomEnvironments: types.optional(types.boolean()),
  customEnvironmentIds: types.optional(z.array(types.string())),
  decrypted: types.optional(types.boolean()),
...
/** @internal */
export const UserEventPayload123Team$inboundSchema: z.ZodType<
...
export function userEventPayload123TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload123Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload123Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload123Team' from JSON`,
  );
}
...
export const OneHundredAndTwentyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload123Team$inboundSchema),
...
/** @internal */
export const UserEventPayload119ToAccountType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload119ToAccountType
> = z.nativeEnum(UserEventPayload119ToAccountType);
...
> = z.object({
  id: types.string(),
  type: UserEventPayload119ToAccountType$inboundSchema,
  slug: types.optional(types.string()),
  username: types.optional(types.string()),
});
