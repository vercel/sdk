...
export type PayloadProjectMembership = {
  role?: UserEventPayload242Role | undefined;
...
export type TwoHundredAndTwenty = {
  projectId: string;
  projectName: string;
  previous?: UserEventPayload220Previous | undefined;
 ...
 * The type of matching to perform
 */
export const UserEventPayload211NextType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload211NextType = ClosedEnum<
  typeof UserEventPayload211NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload211NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export const UserEventPayload206Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload206Action = ClosedEnum<
  typeof UserEventPayload206Action
>;
...
export type TwoHundredAndSix = {
  projectId: string;
  projectName: string;
  action: UserEventPayload206Action;
};
...
export type UserEventPayload204Team = {
  id: string;
  name: string;
};
...
export const UserEventPayload194Action = {
  Disabled: "disabled",
  Enabled: "enabled",
  Regenerated: "regenerated",
  Updated: "updated",
} as const;
export type UserEventPayload194Action = ClosedEnum<
  typeof UserEventPayload194Action
>;
...
export type OneHundredAndNinetyFour = {
  projectId: string;
  projectName: string;
  action: UserEventPayload194Action;
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload242Role$inboundSchema),
...
> = z.object({
  ...
  previous: types.optional(
    z.lazy(() => UserEventPayload220Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload211NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload211NextType
> = z.nativeEnum(UserEventPayload211NextType);
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload211NextType$inboundSchema,
  pattern: types.string(),
});
...
/** @internal */
export const UserEventPayload206Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload206Action
> = z.nativeEnum(UserEventPayload206Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload206Action$inboundSchema,
});
...
/** @internal */
export const UserEventPayload204Team$inboundSchema: z.ZodType<
  UserEventPayload204Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload204TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload204Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload204Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload204Team' from JSON`,
  );
}
...
export const TwoHundredAndFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload204Team$inboundSchema),
...
/** @internal */
export const UserEventPayload194Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload194Action
> = z.nativeEnum(UserEventPayload194Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload194Action$inboundSchema,
