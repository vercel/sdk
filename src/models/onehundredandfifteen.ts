...
import {
  ...
  UserEventPayload139Origin,
  UserEventPayload139Origin$inboundSchema,
  UserEventPayload139Role,
...
export type UserEventPayloadJoinedFrom = {
  origin: UserEventPayload139Origin;
...
export const UserEventPayload139BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload139BlockReason = ClosedEnum<
  typeof UserEventPayload139BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload139BlockReason;
};

export const UserEventPayload139NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload139NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload139NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload139NewOwnerBlockReason;
};

export const UserEventPayload139NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload139NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload139NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload139NewOwnerFeatureBlocksBlockReason;
};
...
export const UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  >;
...
export type MicrofrontendsRequest = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason;
};

export const UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason =
  ClosedEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason
  >;
...
export type WorkflowStorage = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason;
};

export const UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason =
  ClosedEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason
  >;
...
export type WorkflowStep = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason;
};

export const UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  ClosedEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  >;
...
export type ConnexTokenRequests = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason;
};
 ...
 */
export const UserEventPayload139NewOwnerAction = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload139NewOwnerAction = ClosedEnum<
  typeof UserEventPayload139NewOwnerAction
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload139NewOwnerAction;
  /**
...
export const UserEventPayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload139Origin$inboundSchema,
...
/** @internal */
export const UserEventPayload139BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload139BlockReason
> = z.nativeEnum(UserEventPayload139BlockReason);
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload139BlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload139NewOwnerBlockReason> = z.nativeEnum(
    UserEventPayload139NewOwnerBlockReason,
  );
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload139NewOwnerBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerFeatureBlocksBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload139NewOwnerFeatureBlocksBlockReason> =
    z.nativeEnum(UserEventPayload139NewOwnerFeatureBlocksBlockReason);
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason
  > = z.nativeEnum(
    UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksWorkflowStorageBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason
  > = z.nativeEnum(
    UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason,
  );
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksWorkflowStepBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  > = z.nativeEnum(
    UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload139NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload139NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload139NewOwnerAction
> = z.nativeEnum(UserEventPayload139NewOwnerAction);
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload139NewOwnerAction$inboundSchema,
