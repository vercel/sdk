...
import {
  ...
  PayloadGeolocation$outboundSchema,
  UserEventFactors1,
  UserEventFactors1$inboundSchema,
  UserEventFactors1$Outbound,
  UserEventFactors1$outboundSchema,
} from "./usereventfactors1.js";
...
export type UserEventPayload202PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload202Previous = {
  project: UserEventPayload202PreviousProject;
};
...
export type OneHundredAndNinetyTwo = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload192Previous;
...
> = z.object({
  ...
  factors: types.optional(z.array(UserEventFactors1$inboundSchema)),
...
> = z.object({
  ...
  geolocation: z.nullable(PayloadGeolocation$outboundSchema).optional(),
  env: z.string().optional(),
  os: z.string().optional(),
  username: z.string().optional(),
  ssoType: z.string().optional(),
  factors: z.array(UserEventFactors1$outboundSchema).optional(),
...
/** @internal */
export const UserEventPayload202PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload202PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
/** @internal */
export type UserEventPayload202PreviousProject$Outbound = {
  id?: string | undefined;
  staticIps: PayloadStaticIps$Outbound;
};

/** @internal */
export const UserEventPayload202PreviousProject$outboundSchema: z.ZodType<
  UserEventPayload202PreviousProject$Outbound,
  z.ZodTypeDef,
  UserEventPayload202PreviousProject
> = z.object({
  id: z.string().optional(),
...
export function userEventPayload202PreviousProjectToJSON(
  userEventPayload202PreviousProject: UserEventPayload202PreviousProject,
): string {
  return JSON.stringify(
    UserEventPayload202PreviousProject$outboundSchema.parse(
      userEventPayload202PreviousProject,
    ),
  );
}
export function userEventPayload202PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload202PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload202PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload202PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload202Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload202PreviousProject$inboundSchema),
});
/** @internal */
export type UserEventPayload202Previous$Outbound = {
  project: UserEventPayload202PreviousProject$Outbound;
};
...
export const UserEventPayload202Previous$outboundSchema: z.ZodType<
  ...
  UserEventPayload202Previous
> = z.object({
  project: z.lazy(() => UserEventPayload202PreviousProject$outboundSchema),
});
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  previous: z.lazy(() => UserEventPayload192Previous$inboundSchema),
...
export type OneHundredAndNinetyTwo$Outbound = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload192Previous$Outbound;
...
> = z.object({
  projectId: z.string(),
  projectName: z.string(),
  previous: z.lazy(() => UserEventPayload192Previous$outboundSchema),
