 ...
 * environments this env variable targets
 */
export const UserEventPayload156OldEnvVarTarget = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload156OldEnvVarTarget = ClosedEnum<
  typeof UserEventPayload156OldEnvVarTarget
>;

/**
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload156OldEnvVarType = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload156OldEnvVarType = ClosedEnum<
  typeof UserEventPayload156OldEnvVarType
>;
...
export type OldEnvVar = {
   ...
   * environments this env variable targets
   */
  target?: Array<UserEventPayload156OldEnvVarTarget> | undefined;
  /**
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload156OldEnvVarType | undefined;
  /**
   * Timestamp for when the Shared Env Var was last updated.
   */
  updatedAt?: number | undefined;
...
> = z.object({
  ...
  vcr: types.optional(Vcr$inboundSchema),
  webAnalytics: types.optional(PayloadWebAnalytics$inboundSchema),
  workflowEvents: types.optional(WorkflowEvents$inboundSchema),
...
/** @internal */
export const UserEventPayload156OldEnvVarTarget$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156OldEnvVarTarget
> = z.nativeEnum(UserEventPayload156OldEnvVarTarget);

/** @internal */
export const UserEventPayload156OldEnvVarType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156OldEnvVarType
> = z.nativeEnum(UserEventPayload156OldEnvVarType);
...
> = z.object({
  ...
  target: types.optional(
    z.array(UserEventPayload156OldEnvVarTarget$inboundSchema),
  ),
  type: types.optional(UserEventPayload156OldEnvVarType$inboundSchema),
  updatedAt: types.optional(types.number()),
  updatedBy: z.nullable(types.string()).optional(),
  value: types.optional(types.string()),
});
