...
export type TwoHundredAndFiftySix = {
  projectId: string;
  projectName: string;
  previous?: UserEventPayload256Previous | undefined;
 ...
 * The type of matching to perform
 */
export const UserEventPayload247NextType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload247NextType = ClosedEnum<
  typeof UserEventPayload247NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload247NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export const UserEventPayload242Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload242Action = ClosedEnum<
  typeof UserEventPayload242Action
>;
...
export type TwoHundredAndFortyTwo = {
  projectId: string;
  projectName: string;
  action: UserEventPayload242Action;
};
...
export const UserEventPayload218Origin = {
...
export type UserEventPayload218Origin = ClosedEnum<
  typeof UserEventPayload218Origin
>;

export type PayloadGitUserId = string | number;

export type PayloadJoinedFrom = {
  origin: UserEventPayload218Origin;
...
export type UserEventPayload216Passport = {
  connectorId: string;
  deploymentType: UserEventPayload216DeploymentType;
};

export type UserEventPayload216Next = {
  passport?: UserEventPayload216Passport | null | undefined;
};
...
export const UserEventPayload215DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload215DeploymentType = ClosedEnum<
  typeof UserEventPayload215DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload215DeploymentType;
};
...
export const UserEventPayload209Type = {
  Header: "header",
} as const;
export type UserEventPayload209Type = ClosedEnum<
  typeof UserEventPayload209Type
>;
...
> = z.object({
  ...
  previous: types.optional(
    z.lazy(() => UserEventPayload256Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload247NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload247NextType
> = z.nativeEnum(UserEventPayload247NextType);
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload247NextType$inboundSchema,
  pattern: types.string(),
});
...
/** @internal */
export const UserEventPayload242Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload242Action
> = z.nativeEnum(UserEventPayload242Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload242Action$inboundSchema,
});
...
/** @internal */
export const UserEventPayload218Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload218Origin
> = z.nativeEnum(UserEventPayload218Origin);
...
export const PayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload218Origin$inboundSchema,
...
/** @internal */
export const UserEventPayload216Passport$inboundSchema: z.ZodType<
  UserEventPayload216Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload216PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload216Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload216Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload216Passport' from JSON`,
  );
}
...
export const UserEventPayload216Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload216Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload215DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload215DeploymentType
> = z.nativeEnum(UserEventPayload215DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload215DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload209Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload209Type
> = z.nativeEnum(UserEventPayload209Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload209Type$inboundSchema,
