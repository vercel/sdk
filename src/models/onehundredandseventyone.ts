...
import {
  ...
  UserEventPayload232Team$inboundSchema,
} from "./envid2.js";
...
export type UserEventPayload209Passport = {
  connectorId: string;
  deploymentType: UserEventPayload209DeploymentType;
};

export type UserEventPayload209Next = {
  passport?: UserEventPayload209Passport | null | undefined;
};
...
export const UserEventPayload208DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload208DeploymentType = ClosedEnum<
  typeof UserEventPayload208DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload208DeploymentType;
};
...
export type UserEventPayload184PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload184PrevProject;
};
...
export const UserEventPayload175Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload175Provider = ClosedEnum<
  typeof UserEventPayload175Provider
>;
...
export type OneHundredAndSeventyFive = {
  provider: UserEventPayload175Provider;
  login: string;
};
...
export const TwoHundredAndThirtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: UserEventPayload232Team$inboundSchema,
...
/** @internal */
export const UserEventPayload209Passport$inboundSchema: z.ZodType<
  UserEventPayload209Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload209PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload209Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload209Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload209Passport' from JSON`,
  );
}
...
export const UserEventPayload209Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload209Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload208DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload208DeploymentType
> = z.nativeEnum(UserEventPayload208DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload208DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload184PrevProject$inboundSchema: z.ZodType<
  UserEventPayload184PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload184PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload184PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload184PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload184PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload184PrevProject$inboundSchema),
});
...
/** @internal */
export const UserEventPayload175Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload175Provider
> = z.nativeEnum(UserEventPayload175Provider);
...
export const OneHundredAndSeventyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload175Provider$inboundSchema,
  login: types.string(),
});
