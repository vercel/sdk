...
import {
  ...
  UserEventPayload228Team$inboundSchema,
} from "./envid.js";
...
export type UserEventPayload228Project = {
  id: string;
...
export type TwoHundredAndTwentyEight = {
  team: UserEventPayload228Team;
  project: UserEventPayload228Project;
};
...
export const UserEventPayload217Action = {
  Disabled: "disabled",
  Enabled: "enabled",
  Regenerated: "regenerated",
  Updated: "updated",
} as const;
export type UserEventPayload217Action = ClosedEnum<
  typeof UserEventPayload217Action
>;
...
export type TwoHundredAndSeventeen = {
  projectId: string;
  projectName: string;
  action: UserEventPayload217Action;
...
export const UserEventPayload205DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload205DeploymentType = ClosedEnum<
  typeof UserEventPayload205DeploymentType
>;

export type UserEventPayload205Passport = {
  connectorId: string;
  deploymentType: UserEventPayload205DeploymentType;
};

export type UserEventPayload205Next = {
  passport?: UserEventPayload205Passport | null | undefined;
};
...
export const UserEventPayload199Type = {
  ConnectSrc: "connectSrc",
} as const;
export type UserEventPayload199Type = ClosedEnum<
  typeof UserEventPayload199Type
>;
...
export type UserEventPayload182PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload182PrevProject;
};
...
/** @internal */
export const UserEventPayload228Project$inboundSchema: z.ZodType<
...
export function userEventPayload228ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload228Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload228Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload228Project' from JSON`,
  );
}
...
export const TwoHundredAndTwentyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: UserEventPayload228Team$inboundSchema,
  project: z.lazy(() => UserEventPayload228Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload217Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload217Action
> = z.nativeEnum(UserEventPayload217Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload217Action$inboundSchema,
...
/** @internal */
export const UserEventPayload205DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload205DeploymentType
> = z.nativeEnum(UserEventPayload205DeploymentType);

/** @internal */
export const UserEventPayload205Passport$inboundSchema: z.ZodType<
  UserEventPayload205Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload205DeploymentType$inboundSchema,
});

export function userEventPayload205PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload205Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload205Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload205Passport' from JSON`,
  );
}
...
export const UserEventPayload205Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload205Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload199Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload199Type
> = z.nativeEnum(UserEventPayload199Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload199Type$inboundSchema,
...
/** @internal */
export const UserEventPayload182PrevProject$inboundSchema: z.ZodType<
  UserEventPayload182PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload182PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload182PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload182PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload182PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload182PrevProject$inboundSchema),
});
