...
export const UserEventPayload237Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload237Action = ClosedEnum<
  typeof UserEventPayload237Action
>;
...
export type TwoHundredAndThirtySeven = {
  projectId: string;
  projectName: string;
  action: UserEventPayload237Action;
};
...
export type UserEventPayload235Team = {
  id: string;
  name: string;
};
...
export const UserEventPayload224Action = {
  Disabled: "disabled",
  Enabled: "enabled",
  Regenerated: "regenerated",
  Updated: "updated",
} as const;
export type UserEventPayload224Action = ClosedEnum<
  typeof UserEventPayload224Action
>;
...
export type TwoHundredAndTwentyFour = {
  projectId: string;
  projectName: string;
  action: UserEventPayload224Action;
...
export type UserEventPayload212Passport = {
  connectorId: string;
  deploymentType: UserEventPayload212DeploymentType;
};

export type UserEventPayload212Next = {
  passport?: UserEventPayload212Passport | null | undefined;
};
...
export const UserEventPayload211DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload211DeploymentType = ClosedEnum<
  typeof UserEventPayload211DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload211DeploymentType;
};
...
export const UserEventPayload205Type = {
  Header: "header",
} as const;
export type UserEventPayload205Type = ClosedEnum<
  typeof UserEventPayload205Type
>;
...
export type UserEventPayload187PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload187PrevProject;
};
...
> = z.object({
  ...
  previous: UserEventPayload242Previous$inboundSchema,
  next: UserEventPayload242Next$inboundSchema,
});
...
/** @internal */
export const UserEventPayload237Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload237Action
> = z.nativeEnum(UserEventPayload237Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload237Action$inboundSchema,
});
...
/** @internal */
export const UserEventPayload235Team$inboundSchema: z.ZodType<
  UserEventPayload235Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload235TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload235Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload235Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload235Team' from JSON`,
  );
}
...
export const TwoHundredAndThirtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload235Team$inboundSchema),
...
/** @internal */
export const UserEventPayload224Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload224Action
> = z.nativeEnum(UserEventPayload224Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload224Action$inboundSchema,
...
/** @internal */
export const UserEventPayload212Passport$inboundSchema: z.ZodType<
  UserEventPayload212Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload212PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload212Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload212Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload212Passport' from JSON`,
  );
}
...
export const UserEventPayload212Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload212Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload211DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload211DeploymentType
> = z.nativeEnum(UserEventPayload211DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload211DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload205Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload205Type
> = z.nativeEnum(UserEventPayload205Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload205Type$inboundSchema,
...
/** @internal */
export const UserEventPayload187PrevProject$inboundSchema: z.ZodType<
  UserEventPayload187PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload187PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload187PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload187PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload187PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload187PrevProject$inboundSchema),
});
