...
import {
  ...
  UserEventPayload167Previous$inboundSchema,
  UserEventPayload167Previous$Outbound,
  UserEventPayload167Previous$outboundSchema,
...
export type OneHundredAndSixtySeven = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload167Previous;
 ...
 * The type of matching to perform
 */
export const UserEventPayload163NextType = {
  EndsWith: "endsWith",
  StartsWith: "startsWith",
  Equals: "equals",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload163NextType = ClosedEnum<
  typeof UserEventPayload163NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload163NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export type UserEventPayload145Action = ClosedEnum<
  typeof UserEventPayload145Action
>;
...
> = z.object({
  ...
  previous: UserEventPayload167Previous$inboundSchema,
...
export type OneHundredAndSixtySeven$Outbound = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload167Previous$Outbound;
...
> = z.object({
  ...
  previous: UserEventPayload167Previous$outboundSchema,
...
/** @internal */
export const UserEventPayload163NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload163NextType
> = z.nativeEnum(UserEventPayload163NextType);
/** @internal */
export const UserEventPayload163NextType$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload163NextType
> = UserEventPayload163NextType$inboundSchema;
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload163NextType$inboundSchema,
  pattern: types.string(),
});
/** @internal */
...
export const PayloadBranchMatcher$outboundSchema: z.ZodType<
  ...
  PayloadBranchMatcher
> = z.object({
  type: UserEventPayload163NextType$outboundSchema,
  pattern: z.string(),
});
...
/** @internal */
export const UserEventPayload145Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload145Action
> = z.nativeEnum(UserEventPayload145Action);
/** @internal */
export const UserEventPayload145Action$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload145Action
> = UserEventPayload145Action$inboundSchema;
