...
export type UserEventPayload405Next = Next1 | Next2;
...
export type UserEventPayload405Previous = Previous1 | Previous2;
...
export const UserEventPayload404Scope = {
  Dashboard: "dashboard",
  LogDrains: "log-drains",
} as const;
export type UserEventPayload404Scope = ClosedEnum<
  typeof UserEventPayload404Scope
>;
...
export type FourHundredAndFour = {
  enabled: boolean;
  scope: UserEventPayload404Scope;
};
...
export const UserEventPayload373Scope = {
  Organization: "organization",
} as const;
export type UserEventPayload373Scope = ClosedEnum<
  typeof UserEventPayload373Scope
>;
...
export type ThreeHundredAndSeventyThree = {
  enabled: boolean;
  scope?: UserEventPayload373Scope | undefined;
};
...
export const UserEventPayload372Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload372Role = ClosedEnum<
  typeof UserEventPayload372Role
>;

export type UserEventPayloadRemovedUsers = {
  confirmed: boolean;
  confirmedAt?: number | undefined;
  role: UserEventPayload372Role;
};
...
export type ThreeHundredAndSeventyOne = {
  ...
  next?: UserEventPayload371Next | undefined;
  previous?: UserEventPayload371Previous | undefined;
  reason?: PayloadReason | undefined;
};

export const UserEventPayload370Next = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload370Next = ClosedEnum<
  typeof UserEventPayload370Next
>;

export const UserEventPayload370Previous = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload370Previous = ClosedEnum<
  typeof UserEventPayload370Previous
>;
 ...
 */
export const UserEventPayload366Scope = {
  All: "all",
  Private: "private",
  Public: "public",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload366Scope = ClosedEnum<
  typeof UserEventPayload366Scope
>;

/**
 * Automatic code review settings
 */
export type UserEventPayload366Next = {
  /**
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload366Scope;
  /**
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload366PreviousScope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload366PreviousScope = ClosedEnum<
  typeof UserEventPayload366PreviousScope
>;

/**
 * Automatic code review settings
 */
export type UserEventPayload366Previous = {
  /**
   * Whether automatic code reviews are enabled
   */
  enabled: boolean;
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload366PreviousScope;
  /**
   * GitHub repos to scope automatic reviews to. Format: "owner/repo" (lowercase). Only used when scope='selected_repos'.
   */
  selectedRepos?: Array<string> | null | undefined;
...
export type ThreeHundredAndSixtySix = {
   ...
   * Automatic code review settings
   */
  next: UserEventPayload366Next;
  /**
   * Automatic code review settings
   */
  previous?: UserEventPayload366Previous | undefined;
};
...
export const UserEventPayload364ActorType = {
  Admin: "admin",
  User: "user",
} as const;
export type UserEventPayload364ActorType = ClosedEnum<
  typeof UserEventPayload364ActorType
>;
...
export type ThreeHundredAndSixtyFour = {
  ...
  actorType?: UserEventPayload364ActorType | undefined;
...
export type UserEventPayload362Store = {
  id: string;
  name: string;
};
...
export type ThreeHundredAndSixtyTwo = {
  ...
  store: UserEventPayload362Store;
};
 ...
 * Which budget this is. Matches Copper SDK `BudgetScope`. Omitted on events published before team/org/project scopes existed (treat as team).
 */
export const UserEventPayload355PrevBudgetScope = {
  Organization: "organization",
  Project: "project",
  Team: "team",
} as const;
 ...
 * Which budget this is. Matches Copper SDK `BudgetScope`. Omitted on events published before team/org/project scopes existed (treat as team).
 */
export type UserEventPayload355PrevBudgetScope = ClosedEnum<
  typeof UserEventPayload355PrevBudgetScope
>;

/**
 * The budget type
 */
export const UserEventPayload355PrevBudgetType = {
  Fixed: "fixed",
} as const;
/**
 * The budget type
 */
export type UserEventPayload355PrevBudgetType = ClosedEnum<
  typeof UserEventPayload355PrevBudgetType
>;
...
export type PrevBudget = {
   ...
   * Which budget this is. Matches Copper SDK `BudgetScope`. Omitted on events published before team/org/project scopes existed (treat as team).
   */
  scope?: UserEventPayload355PrevBudgetScope | undefined;
  /**
   * Project id when `scope` is `project`.
   */
  scopeId?: string | undefined;
   ...
   * The budget type
   */
  type: UserEventPayload355PrevBudgetType;
  /**
   * Date time when budget is updated last
   */
  updatedAt?: number | undefined;
...
export type UserEventPayload351Previous = {
...
export type ThreeHundredAndFiftyOne = {
  ...
  previous: UserEventPayload351Previous;
...
export type UserEventPayload347Names = {
  en: string;
};

export type PayloadCity = {
  names: UserEventPayload347Names;
};
...
/** @internal */
export const UserEventPayload405Next$inboundSchema: z.ZodType<
  UserEventPayload405Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload405NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload405Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload405Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload405Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload405Previous$inboundSchema: z.ZodType<
...
export function userEventPayload405PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload405Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload405Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload405Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload404Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload404Scope
> = z.nativeEnum(UserEventPayload404Scope);
...
> = z.object({
  ...
  scope: UserEventPayload404Scope$inboundSchema,
});
...
/** @internal */
export const UserEventPayload374Next$inboundSchema: z.ZodType<
  UserEventPayload374Next,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload374NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload374Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload374Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload374Next' from JSON`,
  );
}

/** @internal */
export const UserEventPayload374Previous$inboundSchema: z.ZodType<
  UserEventPayload374Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  deploymentSources: z.nullable(z.array(z.any())).optional(),
...
export function userEventPayload374PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload374Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload374Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload374Previous' from JSON`,
  );
}
...
export const ThreeHundredAndSeventyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: types.nullable(z.lazy(() => UserEventPayload374Next$inboundSchema)),
  previous: types.nullable(
    z.lazy(() => UserEventPayload374Previous$inboundSchema),
  ),
});
...
/** @internal */
export const UserEventPayload373Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload373Scope
> = z.nativeEnum(UserEventPayload373Scope);
...
> = z.object({
  enabled: types.boolean(),
  scope: types.optional(UserEventPayload373Scope$inboundSchema),
});
...
/** @internal */
export const UserEventPayload372Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload372Role
> = z.nativeEnum(UserEventPayload372Role);
...
> = z.object({
  ...
  role: UserEventPayload372Role$inboundSchema,
});
...
> = z.object({
  ...
  next: types.optional(UserEventPayload371Next$inboundSchema),
  previous: types.optional(UserEventPayload371Previous$inboundSchema),
...
/** @internal */
export const UserEventPayload370Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload370Next
> = z.nativeEnum(UserEventPayload370Next);

/** @internal */
export const UserEventPayload370Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload370Previous
> = z.nativeEnum(UserEventPayload370Previous);
...
export const ThreeHundredAndSeventy$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: types.nullable(UserEventPayload370Next$inboundSchema),
  previous: types.nullable(UserEventPayload370Previous$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload366Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload366Scope
> = z.nativeEnum(UserEventPayload366Scope);

/** @internal */
export const UserEventPayload366Next$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  scope: UserEventPayload366Scope$inboundSchema,
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});

export function userEventPayload366NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload366Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload366Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload366Next' from JSON`,
  );
}

/** @internal */
export const UserEventPayload366PreviousScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload366PreviousScope
> = z.nativeEnum(UserEventPayload366PreviousScope);

/** @internal */
export const UserEventPayload366Previous$inboundSchema: z.ZodType<
...
> = z.object({
  enabled: types.boolean(),
  includeDrafts: types.boolean(),
  scope: UserEventPayload366PreviousScope$inboundSchema,
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});

export function userEventPayload366PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload366Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload366Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload366Previous' from JSON`,
  );
}
...
export const ThreeHundredAndSixtySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: z.lazy(() => UserEventPayload366Next$inboundSchema),
  previous: types.optional(
    z.lazy(() => UserEventPayload366Previous$inboundSchema),
  ),
});
...
/** @internal */
export const UserEventPayload364ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload364ActorType
> = z.nativeEnum(UserEventPayload364ActorType);
...
> = z.object({
  ...
  actorType: types.optional(UserEventPayload364ActorType$inboundSchema),
...
/** @internal */
export const UserEventPayload362Store$inboundSchema: z.ZodType<
  UserEventPayload362Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload362StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload362Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload362Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload362Store' from JSON`,
  );
}
...
> = z.object({
  ...
  store: z.lazy(() => UserEventPayload362Store$inboundSchema),
});
...
/** @internal */
export const UserEventPayload355PrevBudgetScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload355PrevBudgetScope
> = z.nativeEnum(UserEventPayload355PrevBudgetScope);

/** @internal */
export const UserEventPayload355PrevBudgetType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload355PrevBudgetType
> = z.nativeEnum(UserEventPayload355PrevBudgetType);
...
> = z.object({
  ...
  scope: types.optional(UserEventPayload355PrevBudgetScope$inboundSchema),
  scopeId: types.optional(types.string()),
  teamId: types.string(),
  type: UserEventPayload355PrevBudgetType$inboundSchema,
  updatedAt: types.optional(types.number()),
  webhookId: types.optional(types.string()),
  webhookNotified: types.optional(types.boolean()),
});
...
/** @internal */
export const UserEventPayload351Previous$inboundSchema: z.ZodType<
  UserEventPayload351Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload351PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload351Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload351Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload351Previous' from JSON`,
  );
}
...
> = z.object({
  ...
  previous: z.lazy(() => UserEventPayload351Previous$inboundSchema),
...
/** @internal */
export const UserEventPayload347Names$inboundSchema: z.ZodType<
  UserEventPayload347Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload347NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload347Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347Names' from JSON`,
  );
}
...
export const PayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload347Names$inboundSchema),
});
