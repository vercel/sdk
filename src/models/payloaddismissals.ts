...
export const UserEventPayload201DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload201DeploymentType = ClosedEnum<
  typeof UserEventPayload201DeploymentType
>;

export type UserEventPayload201Passport = {
  connectorId: string;
  deploymentType: UserEventPayload201DeploymentType;
};

export type UserEventPayload201Next = {
  passport?: UserEventPayload201Passport | null | undefined;
};
...
export const UserEventPayload200DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload200DeploymentType = ClosedEnum<
  typeof UserEventPayload200DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload200DeploymentType;
};
...
export const UserEventPayload195Type = {
  ConnectSrc: "connectSrc",
} as const;
export type UserEventPayload195Type = ClosedEnum<
  typeof UserEventPayload195Type
>;
...
export type OneHundredAndNinetyFive = {
  projectId: string;
  type: UserEventPayload195Type;
  resourceUrl: string;
};

export const UserEventPayload194Type = {
  Header: "header",
} as const;
export type UserEventPayload194Type = ClosedEnum<
  typeof UserEventPayload194Type
>;
...
export type UserEventPayload178PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload178PrevProject;
};
...
export const UserEventPayload163RequestKind = {
  GetKeyData: "get_key_data",
} as const;
export type UserEventPayload163RequestKind = ClosedEnum<
  typeof UserEventPayload163RequestKind
>;
...
export type OneHundredAndSixtyThree = {
  ...
  requestKind: UserEventPayload163RequestKind;
  key: string;
};
...
/** @internal */
export const UserEventPayload201DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload201DeploymentType
> = z.nativeEnum(UserEventPayload201DeploymentType);

/** @internal */
export const UserEventPayload201Passport$inboundSchema: z.ZodType<
  UserEventPayload201Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload201DeploymentType$inboundSchema,
});

export function userEventPayload201PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload201Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload201Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload201Passport' from JSON`,
  );
}
...
export const UserEventPayload201Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload201Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload200DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload200DeploymentType
> = z.nativeEnum(UserEventPayload200DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload200DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload195Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload195Type
> = z.nativeEnum(UserEventPayload195Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload195Type$inboundSchema,
...
/** @internal */
export const UserEventPayload194Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload194Type
> = z.nativeEnum(UserEventPayload194Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload194Type$inboundSchema,
...
/** @internal */
export const UserEventPayload178PrevProject$inboundSchema: z.ZodType<
...
export function userEventPayload178PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload178PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload178PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload178PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload178PrevProject$inboundSchema),
});
...
/** @internal */
export const UserEventPayload163RequestKind$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload163RequestKind
> = z.nativeEnum(UserEventPayload163RequestKind);
...
> = z.object({
  ...
  requestKind: UserEventPayload163RequestKind$inboundSchema,
  key: types.string(),
});
