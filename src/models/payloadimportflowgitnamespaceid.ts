...
import {
  ...
  UserEventPayload172Next$inboundSchema,
  UserEventPayload172Next$Outbound,
  UserEventPayload172Next$outboundSchema,
  UserEventPayload172Previous,
  UserEventPayload172Previous$inboundSchema,
  UserEventPayload172Previous$Outbound,
  UserEventPayload172Previous$outboundSchema,
} from "./usereventpayload172next.js";
...
export type OneHundredAndSixtyNine = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload169Previous;
 ...
 * The type of matching to perform
 */
export const UserEventPayload166NextType = {
  EndsWith: "endsWith",
  StartsWith: "startsWith",
  Equals: "equals",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload166NextType = ClosedEnum<
  typeof UserEventPayload166NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload166NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
export type UserEventPayload157Project = {
  id: string;
...
export type OneHundredAndFiftySeven = {
  ...
  project: UserEventPayload157Project;
};
...
export type UserEventPayload139Role = ClosedEnum<
  typeof UserEventPayload139Role
>;
...
> = z.object({
  ...
  previous: UserEventPayload172Previous$inboundSchema,
  next: UserEventPayload172Next$inboundSchema,
});
/** @internal */
...
> = z.object({
  ...
  previous: UserEventPayload172Previous$outboundSchema,
  next: UserEventPayload172Next$outboundSchema,
});
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  previous: z.lazy(() => UserEventPayload169Previous$inboundSchema),
...
export type OneHundredAndSixtyNine$Outbound = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload169Previous$Outbound;
...
> = z.object({
  projectId: z.string(),
  projectName: z.string(),
  previous: z.lazy(() => UserEventPayload169Previous$outboundSchema),
...
/** @internal */
export const UserEventPayload166Type$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload166Type
> = UserEventPayload166Type$inboundSchema;
...
export const BranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload166Type$inboundSchema,
...
export const BranchMatcher$outboundSchema: z.ZodType<
  ...
  BranchMatcher
> = z.object({
  type: UserEventPayload166Type$outboundSchema,
  pattern: z.string(),
});
...
/** @internal */
export const UserEventPayload166NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload166NextType
> = z.nativeEnum(UserEventPayload166NextType);
/** @internal */
export const UserEventPayload166NextType$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload166NextType
> = UserEventPayload166NextType$inboundSchema;
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload166NextType$inboundSchema,
  pattern: types.string(),
});
/** @internal */
...
export const PayloadBranchMatcher$outboundSchema: z.ZodType<
  ...
  PayloadBranchMatcher
> = z.object({
  type: UserEventPayload166NextType$outboundSchema,
  pattern: z.string(),
});
...
/** @internal */
export const UserEventPayload157Project$inboundSchema: z.ZodType<
...
/** @internal */
export type UserEventPayload157Project$Outbound = {
  id: string;
  name?: string | undefined;
...
/** @internal */
export const UserEventPayload157Project$outboundSchema: z.ZodType<
  UserEventPayload157Project$Outbound,
  z.ZodTypeDef,
  UserEventPayload157Project
> = z.object({
  id: z.string(),
...
export function userEventPayload157ProjectToJSON(
  userEventPayload157Project: UserEventPayload157Project,
): string {
  return JSON.stringify(
    UserEventPayload157Project$outboundSchema.parse(userEventPayload157Project),
  );
}
export function userEventPayload157ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload157Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload157Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload157Project' from JSON`,
  );
}
...
> = z.object({
  ...
  project: z.lazy(() => UserEventPayload157Project$inboundSchema),
});
/** @internal */
export type OneHundredAndFiftySeven$Outbound = {
  team: UserEventPayload157Team$Outbound;
  project: UserEventPayload157Project$Outbound;
};
...
> = z.object({
  ...
  project: z.lazy(() => UserEventPayload157Project$outboundSchema),
});
...
/** @internal */
export const UserEventPayload139Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload139Role
> = z.nativeEnum(UserEventPayload139Role);
/** @internal */
export const UserEventPayload139Role$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload139Role
> = UserEventPayload139Role$inboundSchema;
