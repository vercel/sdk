...
} from "./usereventpayloadgitprovider.js";
 ...
 * The type of matching to perform
 */
export const UserEventPayload258PreviousType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload258PreviousType = ClosedEnum<
  typeof UserEventPayload258PreviousType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload258PreviousType;
};
...
export const UserEventPayload253Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload253Action = ClosedEnum<
  typeof UserEventPayload253Action
>;
...
export type TwoHundredAndFiftyThree = {
  action: UserEventPayload253Action;
  projectId: string;
  projectName: string;
};
...
export type UserEventPayload251Project = {
  id: string;
...
export type UserEventPayload251Team = {
  id: string;
  name: string;
};
...
export type TwoHundredAndFiftyOne = {
  project: UserEventPayload251Project;
  team: UserEventPayload251Team;
};
...
export const UserEventPayload240Action = {
  Disabled: "disabled",
  Enabled: "enabled",
  Regenerated: "regenerated",
  Updated: "updated",
} as const;
export type UserEventPayload240Action = ClosedEnum<
  typeof UserEventPayload240Action
>;
...
export type TwoHundredAndForty = {
  action: UserEventPayload240Action;
...
export const UserEventPayload229Origin = {
...
export type UserEventPayload229Origin = ClosedEnum<
  typeof UserEventPayload229Origin
>;
...
export type PayloadJoinedFrom = {
  ...
  origin: UserEventPayload229Origin;
...
export type UserEventPayload227Passport = {
  connectorId: string;
  deploymentType: UserEventPayload227DeploymentType;
};

export type UserEventPayload227Previous = {
  passport?: UserEventPayload227Passport | null | undefined;
};
...
/** @internal */
export const UserEventPayload258PreviousType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload258PreviousType
> = z.nativeEnum(UserEventPayload258PreviousType);
...
> = z.object({
  pattern: types.string(),
  type: UserEventPayload258PreviousType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload253Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload253Action
> = z.nativeEnum(UserEventPayload253Action);
...
export const TwoHundredAndFiftyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload253Action$inboundSchema,
  projectId: types.string(),
  projectName: types.string(),
});
...
/** @internal */
export const UserEventPayload251Project$inboundSchema: z.ZodType<
...
export function userEventPayload251ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload251Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload251Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload251Project' from JSON`,
  );
}

/** @internal */
export const UserEventPayload251Team$inboundSchema: z.ZodType<
  UserEventPayload251Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload251TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload251Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload251Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload251Team' from JSON`,
  );
}
...
export const TwoHundredAndFiftyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload251Project$inboundSchema),
  team: z.lazy(() => UserEventPayload251Team$inboundSchema),
});
...
/** @internal */
export const UserEventPayload240Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload240Action
> = z.nativeEnum(UserEventPayload240Action);
...
export const TwoHundredAndForty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload240Action$inboundSchema,
...
/** @internal */
export const UserEventPayload229Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload229Origin
> = z.nativeEnum(UserEventPayload229Origin);
...
> = z.object({
  ...
  origin: UserEventPayload229Origin$inboundSchema,
...
/** @internal */
export const UserEventPayload227Passport$inboundSchema: z.ZodType<
  UserEventPayload227Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload227PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload227Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload227Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload227Passport' from JSON`,
  );
}
...
export const UserEventPayload227Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload227Passport$inboundSchema))
    .optional(),
});
