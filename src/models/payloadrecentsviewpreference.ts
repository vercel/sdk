...
import {
  ...
  UserEventPayload160Next$inboundSchema,
  UserEventPayload160Next$Outbound,
  UserEventPayload160Next$outboundSchema,
  UserEventPayload160Previous,
  UserEventPayload160Previous$inboundSchema,
  UserEventPayload160Previous$Outbound,
  UserEventPayload160Previous$outboundSchema,
} from "./usereventpayload160next.js";
 ...
 * The type of matching to perform
 */
export const UserEventPayload156NextType = {
  EndsWith: "endsWith",
  StartsWith: "startsWith",
  Equals: "equals",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload156NextType = ClosedEnum<
  typeof UserEventPayload156NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload156NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
> = z.object({
  ...
  previous: UserEventPayload160Previous$inboundSchema,
  next: UserEventPayload160Next$inboundSchema,
});
/** @internal */
...
> = z.object({
  ...
  previous: UserEventPayload160Previous$outboundSchema,
  next: UserEventPayload160Next$outboundSchema,
});
...
/** @internal */
export const UserEventPayload156NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156NextType
> = z.nativeEnum(UserEventPayload156NextType);
/** @internal */
export const UserEventPayload156NextType$outboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156NextType
> = UserEventPayload156NextType$inboundSchema;
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload156NextType$inboundSchema,
  pattern: types.string(),
});
/** @internal */
...
export const PayloadBranchMatcher$outboundSchema: z.ZodType<
  ...
  PayloadBranchMatcher
> = z.object({
  type: UserEventPayload156NextType$outboundSchema,
  pattern: z.string(),
});
