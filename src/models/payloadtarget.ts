...
export const UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason =
  ClosedEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason
  >;
...
export const UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason =
  ClosedEnum<typeof UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason>;

export type Tracing = {
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason;
  updatedAt: number;
};

export const UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason = ClosedEnum<
  typeof UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason
>;

export type Vcr = {
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason;
  updatedAt: number;
};

export const UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason =
  ClosedEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason
  >;

export type PayloadWebAnalytics = {
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason;
  updatedAt: number;
  graceEmailSentAt?: number | undefined;
};

export const UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  ClosedEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason
  >;
...
export const UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  ClosedEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  >;
 ...
 */
export const UserEventPayload174NewOwnerAction = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload174NewOwnerAction = ClosedEnum<
  typeof UserEventPayload174NewOwnerAction
>;

/**
 * Type of actor
 */
export const UserEventPayload174ActorType = {
  Admin: "admin",
  User: "user",
} as const;
/**
 * Type of actor
 */
export type UserEventPayload174ActorType = ClosedEnum<
  typeof UserEventPayload174ActorType
>;
 ...
 */
export const UserEventPayload174Method = {
 ...
 * Method used for the state change - 'totp': User set up TOTP authenticator - 'passkey': User registered a passkey - 'user_disabled': User disabled their own MFA - 'admin_removal': Admin removed MFA via backoffice - 'self_serve_recovery': User disabled their own MFA through the self-serve MFA disable recovery flow (a "Locked Out User" with only a passkey) - 'unknown': Method unknown (for pre-tracking events)
 */
export type UserEventPayload174Method = ClosedEnum<
  typeof UserEventPayload174Method
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload174NewOwnerAction;
  /**
   ...
   * Type of actor
   */
  actorType: UserEventPayload174ActorType;
  /**
   * Method used for the state change - 'totp': User set up TOTP authenticator - 'passkey': User registered a passkey - 'user_disabled': User disabled their own MFA - 'admin_removal': Admin removed MFA via backoffice - 'self_serve_recovery': User disabled their own MFA through the self-serve MFA disable recovery flow (a "Locked Out User" with only a passkey) - 'unknown': Method unknown (for pre-tracking events)
   */
  method: UserEventPayload174Method;
  /**
...
export const UserEventPayload174Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload174Configuration = ClosedEnum<
  typeof UserEventPayload174Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload174Configuration | undefined;
};
...
export const UserEventPayload174Reason = {
...
export type UserEventPayload174Reason = ClosedEnum<
  typeof UserEventPayload174Reason
>;

export type PayloadSoftBlock = {
  blockedAt: number;
  blockedDueToOverageType?: PayloadBlockedDueToOverageType | undefined;
  reason: UserEventPayload174Reason;
  /**
...
export type UserEventPayload174GitUserId = string | number;

export const UserEventPayload174Origin = {
...
export type UserEventPayload174Origin = ClosedEnum<
  typeof UserEventPayload174Origin
>;

export type UserEventPayload174JoinedFrom = {
  ...
  origin: UserEventPayload174Origin;
...
export type Teams = {
  ...
  created: number;
  createdAt: number;
  joinedFrom?: UserEventPayload174JoinedFrom | undefined;
...
export const UserEventPayload174Type = {
  User: "user",
} as const;
export type UserEventPayload174Type = ClosedEnum<
  typeof UserEventPayload174Type
>;
...
export const UserEventPayload171Provider = {
  Bitbucket: "bitbucket",
  CursorOrigin: "cursor-origin",
  Github: "github",
  Gitlab: "gitlab",
} as const;
export type UserEventPayload171Provider = ClosedEnum<
  typeof UserEventPayload171Provider
>;
...
export type OneHundredAndSeventyOne = {
  ...
  outcome: Outcome;
  provider: UserEventPayload171Provider;
...
export const UserEventPayload167Action = {
  Challenge: "challenge",
  Deny: "deny",
  Log: "log",
} as const;
export type UserEventPayload167Action = ClosedEnum<
  typeof UserEventPayload167Action
>;
...
export type OneHundredAndSixtySeven = {
  action?: UserEventPayload167Action | undefined;
  active: boolean;
  projectId: string;
  rulesetName: string;
};
...
export type RuleGroups = {
  action?: UserEventPayload166Action | undefined;
  active: boolean;
};
 ...
 */
export const UserEventPayload159Target = {
 ...
 * environments this env variable targets
 */
export type UserEventPayload159Target = ClosedEnum<
  typeof UserEventPayload159Target
>;
...
export type NewEnvVar = {
   ...
   * environments this env variable targets
   */
  target?: Array<UserEventPayload159Target> | undefined;
  /**
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload159Type | undefined;
  /**
 ...
 * environments this env variable targets
 */
export const UserEventPayload159OldEnvVarTarget = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload159OldEnvVarTarget = ClosedEnum<
  typeof UserEventPayload159OldEnvVarTarget
>;

/**
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload159OldEnvVarType = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload159OldEnvVarType = ClosedEnum<
  typeof UserEventPayload159OldEnvVarType
>;
...
export type OldEnvVar = {
   ...
   * environments this env variable targets
   */
  target?: Array<UserEventPayload159OldEnvVarTarget> | undefined;
  /**
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload159OldEnvVarType | undefined;
  /**
   * Timestamp for when the Shared Env Var was last updated.
   */
  updatedAt?: number | undefined;
...
export const UserEventPayload158Target = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
export type UserEventPayload158Target = ClosedEnum<
  typeof UserEventPayload158Target
>;
...
export type OneHundredAndFiftyEight = {
  ...
  provider: string;
  repository: string;
  target: Array<UserEventPayload158Target>;
};
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason
  > = z.nativeEnum(
    UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload174NewOwnerFeatureBlocksSpeedInsightsFreeBlockReason$inboundSchema,
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason
  > = z.nativeEnum(UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason);
...
export const Tracing$inboundSchema: z.ZodType<Tracing, z.ZodTypeDef, unknown> =
  z.object({
    ...
    blockedUntil: types.optional(types.number()),
    blockReason:
      UserEventPayload174NewOwnerFeatureBlocksTracingBlockReason$inboundSchema,
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason
  > = z.nativeEnum(UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason);
...
export const Vcr$inboundSchema: z.ZodType<Vcr, z.ZodTypeDef, unknown> = z
  .object({
    ...
    blockedUntil: types.optional(types.number()),
    blockReason:
      UserEventPayload174NewOwnerFeatureBlocksVcrBlockReason$inboundSchema,
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason
  > = z.nativeEnum(
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload174NewOwnerFeatureBlocksWebAnalyticsBlockReason$inboundSchema,
  updatedAt: types.number(),
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason
  > = z.nativeEnum(
    UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload174NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema,
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  > = z.nativeEnum(
    UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload174NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema,
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload174NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174NewOwnerAction
> = z.nativeEnum(UserEventPayload174NewOwnerAction);

/** @internal */
export const UserEventPayload174ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174ActorType
> = z.nativeEnum(UserEventPayload174ActorType);

/** @internal */
export const UserEventPayload174Method$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174Method
> = z.nativeEnum(UserEventPayload174Method);
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload174NewOwnerAction$inboundSchema,
  actorId: types.string(),
  actorType: UserEventPayload174ActorType$inboundSchema,
  method: UserEventPayload174Method$inboundSchema,
...
/** @internal */
export const UserEventPayload174Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174Configuration
> = z.nativeEnum(UserEventPayload174Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload174Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload174Reason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174Reason
> = z.nativeEnum(UserEventPayload174Reason);
...
> = z.object({
  ...
  reason: UserEventPayload174Reason$inboundSchema,
...
/** @internal */
export const UserEventPayload174GitUserId$inboundSchema: z.ZodType<
  UserEventPayload174GitUserId,
  z.ZodTypeDef,
  unknown
> = smartUnion([types.string(), types.number()]);

export function userEventPayload174GitUserIdFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload174GitUserId, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload174GitUserId$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload174GitUserId' from JSON`,
  );
}

/** @internal */
export const UserEventPayload174Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174Origin
> = z.nativeEnum(UserEventPayload174Origin);

/** @internal */
export const UserEventPayload174JoinedFrom$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  origin: UserEventPayload174Origin$inboundSchema,
...
export function userEventPayload174JoinedFromFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload174JoinedFrom, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload174JoinedFrom$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload174JoinedFrom' from JSON`,
  );
}
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    ...
    joinedFrom: types.optional(
      z.lazy(() => UserEventPayload174JoinedFrom$inboundSchema),
    ),
...
/** @internal */
export const UserEventPayload174Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload174Type
> = z.nativeEnum(UserEventPayload174Type);
...
> = z.object({
  ...
  type: UserEventPayload174Type$inboundSchema,
  updatedAt: types.number(),
...
/** @internal */
export const UserEventPayload171Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload171Provider
> = z.nativeEnum(UserEventPayload171Provider);
...
> = z.object({
  ...
  provider: UserEventPayload171Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload167Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload167Action
> = z.nativeEnum(UserEventPayload167Action);
...
export const OneHundredAndSixtySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: types.optional(UserEventPayload167Action$inboundSchema),
...
export const RuleGroups$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: types.optional(UserEventPayload166Action$inboundSchema),
  active: types.boolean(),
});
...
/** @internal */
export const UserEventPayload159Target$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload159Target
> = z.nativeEnum(UserEventPayload159Target);
...
> = z.object({
  ...
  target: types.optional(z.array(UserEventPayload159Target$inboundSchema)),
  type: types.optional(UserEventPayload159Type$inboundSchema),
...
/** @internal */
export const UserEventPayload159OldEnvVarTarget$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload159OldEnvVarTarget
> = z.nativeEnum(UserEventPayload159OldEnvVarTarget);

/** @internal */
export const UserEventPayload159OldEnvVarType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload159OldEnvVarType
> = z.nativeEnum(UserEventPayload159OldEnvVarType);
...
> = z.object({
  ...
  target: types.optional(
    z.array(UserEventPayload159OldEnvVarTarget$inboundSchema),
  ),
  type: types.optional(UserEventPayload159OldEnvVarType$inboundSchema),
  updatedAt: types.optional(types.number()),
  updatedBy: z.nullable(types.string()).optional(),
  value: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload158Target$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158Target
> = z.nativeEnum(UserEventPayload158Target);
...
> = z.object({
  ...
  target: z.array(UserEventPayload158Target$inboundSchema),
});
