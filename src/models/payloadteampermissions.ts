...
import {
  ...
  PayloadBranchMatcher$inboundSchema,
  PayloadBranchMatcher$Outbound,
  PayloadBranchMatcher$outboundSchema,
  PayloadPrevious,
  PayloadPrevious$inboundSchema,
  PayloadPrevious$Outbound,
  PayloadPrevious$outboundSchema,
} from "./payloadbranchmatcher.js";
...
export const PayloadNext$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  branchMatcher: types.optional(PayloadBranchMatcher$inboundSchema),
});
/** @internal */
...
export const PayloadNext$outboundSchema: z.ZodType<
  ...
  PayloadNext
> = z.object({
  branchMatcher: PayloadBranchMatcher$outboundSchema.optional(),
});
...
> = z.object({
  ...
  previous: PayloadPrevious$inboundSchema,
...
> = z.object({
  ...
  previous: PayloadPrevious$outboundSchema,
