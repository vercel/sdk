...
export type UserEventPayload181Passport = {
  connectorId: string;
  deploymentType: UserEventPayload181DeploymentType;
};

export type UserEventPayloadNext = {
  passport?: UserEventPayload181Passport | null | undefined;
};
...
export const UserEventPayload180DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload180DeploymentType = ClosedEnum<
  typeof UserEventPayload180DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload180DeploymentType;
};
...
export type UserEventPayload162PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload162PrevProject;
};
...
export const UserEventPayload145Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload145Configuration = ClosedEnum<
  typeof UserEventPayload145Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload145Configuration | undefined;
};
...
/** @internal */
export const UserEventPayload181Passport$inboundSchema: z.ZodType<
  UserEventPayload181Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload181PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload181Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload181Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload181Passport' from JSON`,
  );
}
...
export const UserEventPayloadNext$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload181Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload180DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload180DeploymentType
> = z.nativeEnum(UserEventPayload180DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload180DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload162PrevProject$inboundSchema: z.ZodType<
  UserEventPayload162PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload162PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload162PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload162PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload162PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload162PrevProject$inboundSchema),
});
...
/** @internal */
export const UserEventPayload145Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload145Configuration
> = z.nativeEnum(UserEventPayload145Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload145Configuration$inboundSchema),
});
