...
import {
  ...
  UserEventPayload162Next$inboundSchema,
  UserEventPayload162Next$Outbound,
  UserEventPayload162Next$outboundSchema,
...
> = z.object({
  ...
  next: UserEventPayload162Next$inboundSchema,
});
/** @internal */
...
> = z.object({
  ...
  next: UserEventPayload162Next$outboundSchema,
});
