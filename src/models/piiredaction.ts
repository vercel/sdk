...
export type UserEventPayload82Team = {
  name: string;
  id: string;
};
...
export const UserEventPayload65Reason = {
  NonPayment: "non-payment",
} as const;
export type UserEventPayload65Reason = ClosedEnum<
  typeof UserEventPayload65Reason
>;

export type UserEventPayloadData = {
  planSlug: PlanSlug;
  reason?: UserEventPayload65Reason | undefined;
};
...
/** @internal */
export const UserEventPayload82Team$inboundSchema: z.ZodType<
  UserEventPayload82Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload82TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload82Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload82Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload82Team' from JSON`,
  );
}
...
export const EightyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload82Team$inboundSchema),
...
/** @internal */
export const UserEventPayload65Reason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload65Reason
> = z.nativeEnum(UserEventPayload65Reason);
...
> = z.object({
  ...
  reason: types.optional(UserEventPayload65Reason$inboundSchema),
});
