...
export const UserEventPayload155Plan = {
  Enterprise: "enterprise",
  Hobby: "hobby",
  Pro: "pro",
} as const;
export type UserEventPayload155Plan = ClosedEnum<
  typeof UserEventPayload155Plan
>;

export type PayloadBilling = {
  plan: UserEventPayload155Plan;
};
...
/** @internal */
export const UserEventPayload155Plan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload155Plan
> = z.nativeEnum(UserEventPayload155Plan);
...
export const PayloadBilling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  plan: UserEventPayload155Plan$inboundSchema,
});
