...
import {
  ...
  UserEventPayload227Team$inboundSchema,
} from "./aws.js";
...
export const UserEventPayload216Action = {
  Disabled: "disabled",
  Enabled: "enabled",
  Regenerated: "regenerated",
  Updated: "updated",
} as const;
export type UserEventPayload216Action = ClosedEnum<
  typeof UserEventPayload216Action
>;
...
export type TwoHundredAndSixteen = {
  projectId: string;
  projectName: string;
  action: UserEventPayload216Action;
...
export const UserEventPayload204DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload204DeploymentType = ClosedEnum<
  typeof UserEventPayload204DeploymentType
>;

export type UserEventPayload204Passport = {
  connectorId: string;
  deploymentType: UserEventPayload204DeploymentType;
};

export type UserEventPayload204Next = {
  passport?: UserEventPayload204Passport | null | undefined;
};
...
export const UserEventPayload203DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload203DeploymentType = ClosedEnum<
  typeof UserEventPayload203DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload203DeploymentType;
};
...
export const UserEventPayload198Type = {
  ConnectSrc: "connectSrc",
} as const;
export type UserEventPayload198Type = ClosedEnum<
  typeof UserEventPayload198Type
>;
...
export type OneHundredAndNinetyEight = {
  projectId: string;
  type: UserEventPayload198Type;
  resourceUrl: string;
};

export const UserEventPayload197Type = {
  Header: "header",
} as const;
export type UserEventPayload197Type = ClosedEnum<
  typeof UserEventPayload197Type
>;
...
export type UserEventPayload181PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload181PrevProject;
};
...
export const UserEventPayload166RequestKind = {
  GetKeyData: "get_key_data",
} as const;
export type UserEventPayload166RequestKind = ClosedEnum<
  typeof UserEventPayload166RequestKind
>;
...
export type OneHundredAndSixtySix = {
  ...
  requestKind: UserEventPayload166RequestKind;
  key: string;
};
...
export const TwoHundredAndTwentySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: UserEventPayload227Team$inboundSchema,
...
/** @internal */
export const UserEventPayload216Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload216Action
> = z.nativeEnum(UserEventPayload216Action);
...
> = z.object({
  projectId: types.string(),
  projectName: types.string(),
  action: UserEventPayload216Action$inboundSchema,
...
/** @internal */
export const UserEventPayload204DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload204DeploymentType
> = z.nativeEnum(UserEventPayload204DeploymentType);

/** @internal */
export const UserEventPayload204Passport$inboundSchema: z.ZodType<
  UserEventPayload204Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload204DeploymentType$inboundSchema,
});

export function userEventPayload204PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload204Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload204Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload204Passport' from JSON`,
  );
}
...
export const UserEventPayload204Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload204Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload203DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload203DeploymentType
> = z.nativeEnum(UserEventPayload203DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload203DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload198Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload198Type
> = z.nativeEnum(UserEventPayload198Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload198Type$inboundSchema,
...
/** @internal */
export const UserEventPayload197Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload197Type
> = z.nativeEnum(UserEventPayload197Type);
...
> = z.object({
  projectId: types.string(),
  type: UserEventPayload197Type$inboundSchema,
...
/** @internal */
export const UserEventPayload181PrevProject$inboundSchema: z.ZodType<
  UserEventPayload181PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload181PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload181PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload181PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload181PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload181PrevProject$inboundSchema),
});
...
/** @internal */
export const UserEventPayload166RequestKind$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload166RequestKind
> = z.nativeEnum(UserEventPayload166RequestKind);
...
> = z.object({
  ...
  requestKind: UserEventPayload166RequestKind$inboundSchema,
  key: types.string(),
});
