...
export type GitSourceAuthor = {
  date: string;
  email: string;
  name: string;
};

export type GitSourceCommitter = {
  date: string;
  email: string;
  name: string;
};

export type GitSourceCommitMetadata = {
  author: GitSourceAuthor;
  committer: GitSourceCommitter;
  message: string;
};
...
export type GitSource18 = {
  commitMetadata?: GitSourceCommitMetadata | undefined;
  org: string;
  ref: string;
  repo: string;
...
export type CancelDeploymentGitSourceAuthor = {
  date: string;
  email: string;
  name: string;
};

export type CancelDeploymentGitSourceCommitter = {
  date: string;
  email: string;
  name: string;
};

export type CancelDeploymentGitSourceCommitMetadata = {
  author: CancelDeploymentGitSourceAuthor;
  committer: CancelDeploymentGitSourceCommitter;
  message: string;
};
...
export type GitSource10 = {
  commitMetadata?: CancelDeploymentGitSourceCommitMetadata | undefined;
  org?: string | undefined;
  prId?: number | null | undefined;
  ref?: string | null | undefined;
  repo?: string | undefined;
...
/** @internal */
export const GitSourceAuthor$inboundSchema: z.ZodType<
  GitSourceAuthor,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function gitSourceAuthorFromJSON(
  jsonString: string,
): SafeParseResult<GitSourceAuthor, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GitSourceAuthor$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GitSourceAuthor' from JSON`,
  );
}

/** @internal */
export const GitSourceCommitter$inboundSchema: z.ZodType<
  GitSourceCommitter,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function gitSourceCommitterFromJSON(
  jsonString: string,
): SafeParseResult<GitSourceCommitter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GitSourceCommitter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GitSourceCommitter' from JSON`,
  );
}

/** @internal */
export const GitSourceCommitMetadata$inboundSchema: z.ZodType<
  GitSourceCommitMetadata,
  z.ZodTypeDef,
  unknown
> = z.object({
  author: z.lazy(() => GitSourceAuthor$inboundSchema),
  committer: z.lazy(() => GitSourceCommitter$inboundSchema),
  message: types.string(),
});

export function gitSourceCommitMetadataFromJSON(
  jsonString: string,
): SafeParseResult<GitSourceCommitMetadata, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GitSourceCommitMetadata$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GitSourceCommitMetadata' from JSON`,
  );
}
...
> = z.object({
  commitMetadata: types.optional(
    z.lazy(() => GitSourceCommitMetadata$inboundSchema),
  ),
  org: types.string(),
  ref: types.string(),
  repo: types.string(),
...
/** @internal */
export const CancelDeploymentGitSourceAuthor$inboundSchema: z.ZodType<
  CancelDeploymentGitSourceAuthor,
  z.ZodTypeDef,
  unknown
> = z.object({
  date: types.string(),
...
export function cancelDeploymentGitSourceAuthorFromJSON(
  jsonString: string,
): SafeParseResult<CancelDeploymentGitSourceAuthor, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CancelDeploymentGitSourceAuthor$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CancelDeploymentGitSourceAuthor' from JSON`,
  );
}

/** @internal */
export const CancelDeploymentGitSourceCommitter$inboundSchema: z.ZodType<
  CancelDeploymentGitSourceCommitter,
  z.ZodTypeDef,
  unknown
> = z.object({
  date: types.string(),
...
export function cancelDeploymentGitSourceCommitterFromJSON(
  jsonString: string,
): SafeParseResult<CancelDeploymentGitSourceCommitter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CancelDeploymentGitSourceCommitter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CancelDeploymentGitSourceCommitter' from JSON`,
  );
}

/** @internal */
export const CancelDeploymentGitSourceCommitMetadata$inboundSchema: z.ZodType<
  CancelDeploymentGitSourceCommitMetadata,
  z.ZodTypeDef,
  unknown
> = z.object({
  author: z.lazy(() => CancelDeploymentGitSourceAuthor$inboundSchema),
  committer: z.lazy(() => CancelDeploymentGitSourceCommitter$inboundSchema),
  message: types.string(),
});

export function cancelDeploymentGitSourceCommitMetadataFromJSON(
  jsonString: string,
): SafeParseResult<
  CancelDeploymentGitSourceCommitMetadata,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CancelDeploymentGitSourceCommitMetadata$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CancelDeploymentGitSourceCommitMetadata' from JSON`,
  );
}
...
> = z.object({
  commitMetadata: types.optional(
    z.lazy(() => CancelDeploymentGitSourceCommitMetadata$inboundSchema),
  ),
  org: types.optional(types.string()),
  prId: z.nullable(types.number()).optional(),
  ref: z.nullable(types.string()).optional(),
