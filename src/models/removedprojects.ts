...
import {
  ...
  UserEventPayload373Previous$inboundSchema,
...
export type UserEventPayload373Next = Next1 | Next2;

/**
 * The payload of the event, if requested.
 */
export type ThreeHundredAndSeventyThree = {
  previous?: { [k: string]: UserEventPayload373Previous } | undefined;
...
export type UserEventPayload354User = {
  id: string;
  username: string;
};
...
export type UserEventPayload343Next = {};

/**
 * The payload of the event, if requested.
 */
export type ThreeHundredAndFortyThree = {
  previous: UserEventPayload343Previous | null;
  next: UserEventPayload343Next | null;
};
...
export const UserEventPayload342Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload342Role = ClosedEnum<
  typeof UserEventPayload342Role
>;

export type PayloadRemovedUsers = {
  role: UserEventPayload342Role;
  confirmed: boolean;
...
export const UserEventPayload341Previous = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload341Previous = ClosedEnum<
  typeof UserEventPayload341Previous
>;

export const UserEventPayload341Next = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload341Next = ClosedEnum<
  typeof UserEventPayload341Next
>;
...
export type ThreeHundredAndFortyOne = {
  ...
  next?: UserEventPayload341Next | undefined;
};
...
export type ThreeHundredAndForty = {
  previous: UserEventPayload340Previous | null;
  next: UserEventPayload340Next | null;
  teamSlug?: string | undefined;
};
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload336Scope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload336Scope = ClosedEnum<
  typeof UserEventPayload336Scope
>;
...
export type UserEventPayload336Next = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload336Scope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export type ThreeHundredAndThirtySix = {
   ...
   * Automatic code review settings
   */
  previous?: UserEventPayload336Previous | undefined;
  /**
   * Automatic code review settings
   */
...
export type UserEventPayload332Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndThirtyTwo = {
  store: UserEventPayload332Store;
...
/** @internal */
export const UserEventPayload373Next$inboundSchema: z.ZodType<
  UserEventPayload373Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload373NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload373Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload373Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload373Next' from JSON`,
  );
}
...
export const ThreeHundredAndSeventyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(z.record(UserEventPayload373Previous$inboundSchema)),
  next: types.optional(
    z.record(
      smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]),
    ),
...
/** @internal */
export const UserEventPayload354User$inboundSchema: z.ZodType<
  UserEventPayload354User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload354UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload354User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload354User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload354User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload354User$inboundSchema),
...
/** @internal */
export const UserEventPayload343Next$inboundSchema: z.ZodType<
  UserEventPayload343Next,
  z.ZodTypeDef,
  unknown
> = z.object({});

export function userEventPayload343NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload343Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload343Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload343Next' from JSON`,
  );
}
...
> = z.object({
  previous: types.nullable(
    z.lazy(() => UserEventPayload343Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload343Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload342Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload342Role
> = z.nativeEnum(UserEventPayload342Role);
...
export const PayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload342Role$inboundSchema,
...
/** @internal */
export const UserEventPayload341Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload341Previous
> = z.nativeEnum(UserEventPayload341Previous);

/** @internal */
export const UserEventPayload341Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload341Next
> = z.nativeEnum(UserEventPayload341Next);
...
export const ThreeHundredAndFortyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload341Previous$inboundSchema),
  next: types.optional(UserEventPayload341Next$inboundSchema),
});
...
export const ThreeHundredAndForty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload340Previous$inboundSchema),
  next: types.nullable(UserEventPayload340Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload336Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload336Scope
> = z.nativeEnum(UserEventPayload336Scope);
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload336Scope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});
...
> = z.object({
  previous: types.optional(
    z.lazy(() => UserEventPayload336Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload332Store$inboundSchema: z.ZodType<
  UserEventPayload332Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload332StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload332Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload332Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload332Store' from JSON`,
  );
}
...
export const ThreeHundredAndThirtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload332Store$inboundSchema),
