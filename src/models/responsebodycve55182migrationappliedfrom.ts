...
import {
  ...
  GetProjectsResponseBodyOidcProviders$outboundSchema,
...
> = z.object({
  ...
  oidcProviders: types.optional(
    z.record(z.array(GetProjectsResponseBodyOidcProviders$inboundSchema)),
  ),
});
/** @internal */
...
> = z.object({
  ...
  oidcProviders: z.record(
    z.array(GetProjectsResponseBodyOidcProviders$outboundSchema),
  ).optional(),
});
