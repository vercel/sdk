...
import {
  ...
  GetProjectsToProjectsResponse2$inboundSchema,
  GetProjectsToProjectsResponse2$Outbound,
  GetProjectsToProjectsResponse2$outboundSchema,
  ResponseBodyAlias,
...
> = z.object({
  projects: types.optional(
    z.record(GetProjectsResponseBodyProjectsResponse200Projects$inboundSchema),
  ),
