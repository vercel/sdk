...
export const UserEventPayload56BeforeResourcesType = {
  String: "string",
} as const;
export type UserEventPayload56BeforeResourcesType = ClosedEnum<
  typeof UserEventPayload56BeforeResourcesType
>;

export type PayloadItems = {
  type: UserEventPayload56BeforeResourcesType;
};
...
export type UserEventPayload39User = {
  id: string;
  username?: string | undefined;
};
...
/** @internal */
export const UserEventPayload56BeforeResourcesType$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload56BeforeResourcesType> = z.nativeEnum(
    UserEventPayload56BeforeResourcesType,
  );
...
export const PayloadItems$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload56BeforeResourcesType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload39User$inboundSchema: z.ZodType<
...
export function userEventPayload39UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload39User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload39User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload39User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload39User$inboundSchema),
});
