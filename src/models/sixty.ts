...
import {
  ...
  UserEventJobPayload9810HeadInfo$inboundSchema,
} from "./usereventjobpayload9810headinfo.js";

export type UserEventJobPayload9810GitComments = {
  onPullRequest: boolean;
  onCommit: boolean;
};

export const UserEventJobPayload9810Provider = {
  CursorOrigin: "cursor-origin",
} as const;
export type UserEventJobPayload9810Provider = ClosedEnum<
  typeof UserEventJobPayload9810Provider
>;
...
export type Job10 = {
   ...
   * Cursor Origin
   */
  headInfo: UserEventJobPayload9810HeadInfo;
  /**
  ...
  gitComments?: UserEventJobPayload9810GitComments | undefined;
  provider: UserEventJobPayload9810Provider;
};

export type UserEventJobPayload989DeployHook = {
  createdAt: number;
  id: string;
  name: string;
  ref: string;
...
/** @internal */
export const UserEventJobPayload9810GitComments$inboundSchema: z.ZodType<
  UserEventJobPayload9810GitComments,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventJobPayload9810GitCommentsFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload9810GitComments, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventJobPayload9810GitComments$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload9810GitComments' from JSON`,
  );
}

/** @internal */
export const UserEventJobPayload9810Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventJobPayload9810Provider
> = z.nativeEnum(UserEventJobPayload9810Provider);
...
export const Job10$inboundSchema: z.ZodType<Job10, z.ZodTypeDef, unknown> = z
  .object({
    ...
    headInfo: UserEventJobPayload9810HeadInfo$inboundSchema,
    ...
    gitComments: types.optional(
      z.lazy(() => UserEventJobPayload9810GitComments$inboundSchema),
    ),
    provider: UserEventJobPayload9810Provider$inboundSchema,
  });
...
/** @internal */
export const UserEventJobPayload989DeployHook$inboundSchema: z.ZodType<
...
export function userEventJobPayload989DeployHookFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload989DeployHook, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventJobPayload989DeployHook$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload989DeployHook' from JSON`,
  );
}
...
export const Job9$inboundSchema: z.ZodType<Job9, z.ZodTypeDef, unknown> = z
  .object({
    ...
    deployHook: types.optional(
      z.lazy(() => UserEventJobPayload989DeployHook$inboundSchema),
    ),
