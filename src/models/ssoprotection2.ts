...
export type UserEventPayload345User = {
  id: string;
  username: string;
};
...
export type UserEventPayload334Next = {};

/**
 * The payload of the event, if requested.
 */
export type ThreeHundredAndThirtyFour = {
  previous: UserEventPayload334Previous | null;
  next: UserEventPayload334Next | null;
};
...
export const UserEventPayload333Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload333Role = ClosedEnum<
  typeof UserEventPayload333Role
>;

export type PayloadRemovedUsers = {
  role: UserEventPayload333Role;
  confirmed: boolean;
...
export const UserEventPayload332Previous = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload332Previous = ClosedEnum<
  typeof UserEventPayload332Previous
>;

export const UserEventPayload332Next = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload332Next = ClosedEnum<
  typeof UserEventPayload332Next
>;
...
export type ThreeHundredAndThirtyTwo = {
  ...
  next?: UserEventPayload332Next | undefined;
};
...
export type ThreeHundredAndThirtyOne = {
  previous: UserEventPayload331Previous | null;
  next: UserEventPayload331Next | null;
  teamSlug?: string | undefined;
};
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload327Scope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload327Scope = ClosedEnum<
  typeof UserEventPayload327Scope
>;
...
export type UserEventPayload327Next = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload327Scope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export type UserEventPayload324Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndTwentyFour = {
  store: UserEventPayload324Store;
 ...
 */
export type UserEventPayload317Budget = {
  /**
   * The budget type
   */
...
export type ThreeHundredAndSeventeen = {
   ...
   * Represents a budget for tracking and notifying teams on their spending.
   */
  budget: UserEventPayload317Budget;
  webhookUrl?: string | undefined;
};
...
export type UserEventPayload310Names = {
  en: string;
};

export type PayloadCity = {
  names: UserEventPayload310Names;
};

export type UserEventPayload310GeolocationNames = {
  en: string;
};

export type PayloadCountry = {
  names: UserEventPayload310GeolocationNames;
};

export type UserEventPayload310GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type PayloadMostSpecificSubdivision = {
  names: UserEventPayload310GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload295PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload295Previous = {
  project: UserEventPayload295PreviousProject;
};
...
/** @internal */
export const UserEventPayload345User$inboundSchema: z.ZodType<
  UserEventPayload345User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload345UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload345User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload345User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload345User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload345User$inboundSchema),
...
> = z.object({
  previous: types.nullable(
    z.lazy(() => UserEventPayload334Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload334Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload333Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload333Role
> = z.nativeEnum(UserEventPayload333Role);
...
export const PayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload333Role$inboundSchema,
...
/** @internal */
export const UserEventPayload332Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload332Previous
> = z.nativeEnum(UserEventPayload332Previous);

/** @internal */
export const UserEventPayload332Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload332Next
> = z.nativeEnum(UserEventPayload332Next);
...
export const ThreeHundredAndThirtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload332Previous$inboundSchema),
  next: types.optional(UserEventPayload332Next$inboundSchema),
});
...
export const ThreeHundredAndThirtyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload331Previous$inboundSchema),
  next: types.nullable(UserEventPayload331Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload327Scope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload327Scope
> = z.nativeEnum(UserEventPayload327Scope);
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload327Scope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});
...
/** @internal */
export const UserEventPayload324Store$inboundSchema: z.ZodType<
  UserEventPayload324Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload324StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload324Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload324Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload324Store' from JSON`,
  );
}
...
export const ThreeHundredAndTwentyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload324Store$inboundSchema),
...
/** @internal */
export const UserEventPayload317Budget$inboundSchema: z.ZodType<
...
export function userEventPayload317BudgetFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload317Budget, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload317Budget$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload317Budget' from JSON`,
  );
}
...
export const ThreeHundredAndSeventeen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: z.lazy(() => UserEventPayload317Budget$inboundSchema),
  webhookUrl: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload310Names$inboundSchema: z.ZodType<
  UserEventPayload310Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload310NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload310Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload310Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload310Names' from JSON`,
  );
}
...
export const PayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload310Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload310GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload310GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload310GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload310GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload310GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload310GeolocationNames' from JSON`,
  );
}
...
export const PayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload310GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload310GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload310GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload310GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload310GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload310GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload310GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload295PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload295PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload295PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload295PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload295PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload295PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload295Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload295PreviousProject$inboundSchema),
});
