...
export type UserEventPayload174Passport = {
  connectorId: string;
  deploymentType: UserEventPayload174DeploymentType;
};

export type UserEventPayloadNext = {
  passport?: UserEventPayload174Passport | null | undefined;
};
...
/** @internal */
export const UserEventPayload174Passport$inboundSchema: z.ZodType<
  UserEventPayload174Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
...
export function userEventPayload174PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload174Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload174Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload174Passport' from JSON`,
  );
}
...
export const UserEventPayloadNext$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload174Passport$inboundSchema))
    .optional(),
});
