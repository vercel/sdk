...
export type UserEventPayload360Names = {
  en: string;
};

export type UserEventPayload360City = {
  names: UserEventPayload360Names;
};

export type UserEventPayload360GeolocationNames = {
  en: string;
};

export type UserEventPayload360Country = {
  names: UserEventPayload360GeolocationNames;
};

export type UserEventPayload360GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload360MostSpecificSubdivision = {
  names: UserEventPayload360GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload360Geolocation = {
  city?: UserEventPayload360City | undefined;
  country: UserEventPayload360Country;
  mostSpecificSubdivision?:
    | UserEventPayload360MostSpecificSubdivision
    | undefined;
...
export type ThreeHundredAndSixty = {
  ...
  geolocation?: UserEventPayload360Geolocation | null | undefined;
...
export type UserEventPayload359Names = {
  en: string;
};

export type UserEventPayload359City = {
  names: UserEventPayload359Names;
};

export type UserEventPayload359GeolocationNames = {
  en: string;
};

export type UserEventPayload359Country = {
  names: UserEventPayload359GeolocationNames;
};

export type UserEventPayload359GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload359MostSpecificSubdivision = {
  names: UserEventPayload359GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload359Geolocation = {
  city?: UserEventPayload359City | undefined;
  country: UserEventPayload359Country;
  mostSpecificSubdivision?:
    | UserEventPayload359MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type ThreeHundredAndFiftyNine = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload359Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload358Names = {
  en: string;
};

export type UserEventPayload358City = {
  names: UserEventPayload358Names;
};

export type UserEventPayload358GeolocationNames = {
  en: string;
};

export type UserEventPayload358Country = {
  names: UserEventPayload358GeolocationNames;
};

export type UserEventPayload358GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload358MostSpecificSubdivision = {
  names: UserEventPayload358GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload358Geolocation = {
  city?: UserEventPayload358City | undefined;
  country: UserEventPayload358Country;
  mostSpecificSubdivision?:
    | UserEventPayload358MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type ThreeHundredAndFiftyEight = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload358Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload357Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload357Names;
};

export type UserEventPayload357GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload357GeolocationNames;
};

export type UserEventPayload357GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload357GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload350Team = {
  id: string;
  name: string;
};

export type UserEventPayload350Configuration = {
  id: string;
...
export type ThreeHundredAndFifty = {
  team: UserEventPayload350Team;
  configuration: UserEventPayload350Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload349Team = {
  id: string;
  name: string;
};

export type UserEventPayload349Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndFortyNine = {
  team: UserEventPayload349Team;
  configuration: UserEventPayload349Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload348Team = {
  id: string;
  name: string;
};

export type UserEventPayload348Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndFortyEight = {
  team: UserEventPayload348Team;
  configuration: UserEventPayload348Configuration;
  peering: Peering;
};
...
export type UserEventPayload340Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export const UserEventPayload336Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload336Provider = ClosedEnum<
  typeof UserEventPayload336Provider
>;
...
export type ThreeHundredAndThirtySix = {
  provider: UserEventPayload336Provider;
  login: string;
};
...
export type UserEventPayload330Previous = Previous1 | Previous2;
...
export type UserEventPayload330Next = Next1 | Next2;
...
export type UserEventPayload313User = {
  id: string;
  username: string;
};
...
/** @internal */
export const UserEventPayload360Names$inboundSchema: z.ZodType<
  UserEventPayload360Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload360NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360City$inboundSchema: z.ZodType<
  UserEventPayload360City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload360Names$inboundSchema),
});

export function userEventPayload360CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload360GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload360GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload360GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360Country$inboundSchema: z.ZodType<
  UserEventPayload360Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload360GeolocationNames$inboundSchema),
});

export function userEventPayload360CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload360GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload360GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload360GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload360GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload360MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload360GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload360MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload360MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload360MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload360MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360Geolocation$inboundSchema: z.ZodType<
  UserEventPayload360Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload360City$inboundSchema)),
  country: z.lazy(() => UserEventPayload360Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload360MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload360GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload360Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload359Names$inboundSchema: z.ZodType<
  UserEventPayload359Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload359NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359City$inboundSchema: z.ZodType<
  UserEventPayload359City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload359Names$inboundSchema),
});

export function userEventPayload359CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload359GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload359GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload359GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359Country$inboundSchema: z.ZodType<
  UserEventPayload359Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload359GeolocationNames$inboundSchema),
});

export function userEventPayload359CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload359GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload359GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload359GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload359GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload359MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload359GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload359MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload359MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload359MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload359MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359Geolocation$inboundSchema: z.ZodType<
  UserEventPayload359Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload359City$inboundSchema)),
  country: z.lazy(() => UserEventPayload359Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload359MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload359GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload359Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload358Names$inboundSchema: z.ZodType<
  UserEventPayload358Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload358NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358City$inboundSchema: z.ZodType<
  UserEventPayload358City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload358Names$inboundSchema),
});

export function userEventPayload358CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload358GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload358GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload358GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358Country$inboundSchema: z.ZodType<
  UserEventPayload358Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload358GeolocationNames$inboundSchema),
});

export function userEventPayload358CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload358GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload358GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload358GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload358GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload358MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload358GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload358MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload358MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload358MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload358MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358Geolocation$inboundSchema: z.ZodType<
  UserEventPayload358Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload358City$inboundSchema)),
  country: z.lazy(() => UserEventPayload358Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload358MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload358GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload358Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload357Names$inboundSchema: z.ZodType<
...
export function userEventPayload357NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload357Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload357GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload357GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload357GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload357GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload357GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload357GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload357GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload357GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload350Team$inboundSchema: z.ZodType<
  UserEventPayload350Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload350TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload350Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload350Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload350Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload350Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload350ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload350Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload350Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload350Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFifty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload350Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload350Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload349Team$inboundSchema: z.ZodType<
  UserEventPayload349Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload349TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload349Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload349Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload349Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload349Configuration$inboundSchema: z.ZodType<
  UserEventPayload349Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload349ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload349Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload349Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload349Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFortyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload349Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload349Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload348Team$inboundSchema: z.ZodType<
  UserEventPayload348Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload348TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload348Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload348Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload348Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload348Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload348ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload348Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload348Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload348Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFortyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload348Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload348Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload340Next$inboundSchema: z.ZodType<
  UserEventPayload340Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload340NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload340Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload340Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload340Next' from JSON`,
  );
}
...
> = z.object({
  ...
  next: z.lazy(() => UserEventPayload340Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload336Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload336Provider
> = z.nativeEnum(UserEventPayload336Provider);
...
export const ThreeHundredAndThirtySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload336Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload330Previous$inboundSchema: z.ZodType<
...
export function userEventPayload330PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload330Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload330Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload330Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload330Next$inboundSchema: z.ZodType<
  UserEventPayload330Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload330NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload330Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload330Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload330Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload313User$inboundSchema: z.ZodType<
  UserEventPayload313User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload313UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload313User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload313User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload313User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload313User$inboundSchema),
