...
export type UserEventPayload370Names = {
  en: string;
};

export type UserEventPayload370City = {
  names: UserEventPayload370Names;
};

export type UserEventPayload370GeolocationNames = {
  en: string;
};

export type UserEventPayload370Country = {
  names: UserEventPayload370GeolocationNames;
};

export type UserEventPayload370GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload370MostSpecificSubdivision = {
  names: UserEventPayload370GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload370Geolocation = {
  city?: UserEventPayload370City | undefined;
  country: UserEventPayload370Country;
  mostSpecificSubdivision?:
    | UserEventPayload370MostSpecificSubdivision
    | undefined;
...
export type ThreeHundredAndSeventy = {
  ...
  geolocation?: UserEventPayload370Geolocation | null | undefined;
...
export type UserEventPayload369Names = {
  en: string;
};

export type UserEventPayload369City = {
  names: UserEventPayload369Names;
};

export type UserEventPayload369GeolocationNames = {
  en: string;
};

export type UserEventPayload369Country = {
  names: UserEventPayload369GeolocationNames;
};

export type UserEventPayload369GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload369MostSpecificSubdivision = {
  names: UserEventPayload369GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload369Geolocation = {
  city?: UserEventPayload369City | undefined;
  country: UserEventPayload369Country;
  mostSpecificSubdivision?:
...
export type ThreeHundredAndSixtyNine = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload369Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload368Names = {
  en: string;
};

export type UserEventPayload368City = {
  names: UserEventPayload368Names;
};

export type UserEventPayload368GeolocationNames = {
  en: string;
};

export type UserEventPayload368Country = {
  names: UserEventPayload368GeolocationNames;
};

export type UserEventPayload368GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload368MostSpecificSubdivision = {
  names: UserEventPayload368GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload368Geolocation = {
  city?: UserEventPayload368City | undefined;
  country: UserEventPayload368Country;
  mostSpecificSubdivision?:
...
export type ThreeHundredAndSixtyEight = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload368Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload367Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload367Names;
};

export type UserEventPayload367GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload367GeolocationNames;
};

export type UserEventPayload367GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload367GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload360Team = {
  id: string;
  name: string;
};

export type UserEventPayload360Configuration = {
  id: string;
...
export type ThreeHundredAndSixty = {
  team: UserEventPayload360Team;
  configuration: UserEventPayload360Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload359Team = {
  id: string;
  name: string;
};

export type UserEventPayload359Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndFiftyNine = {
  team: UserEventPayload359Team;
  configuration: UserEventPayload359Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload358Team = {
  id: string;
  name: string;
};

export type UserEventPayload358Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndFiftyEight = {
  team: UserEventPayload358Team;
  configuration: UserEventPayload358Configuration;
  peering: Peering;
};
...
export type UserEventPayload347Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload347Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndFortySeven = {
  previous: UserEventPayload347Previous;
  next: UserEventPayload347Next;
};
...
export const UserEventPayload343Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload343Provider = ClosedEnum<
  typeof UserEventPayload343Provider
>;
...
export type ThreeHundredAndFortyThree = {
  provider: UserEventPayload343Provider;
  login: string;
};
...
export type UserEventPayload337Previous = Previous1 | Previous2;
...
export type UserEventPayload337Next = Next1 | Next2;
...
export type UserEventPayload320User = {
  id: string;
  username: string;
};
...
/** @internal */
export const UserEventPayload370Names$inboundSchema: z.ZodType<
  UserEventPayload370Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload370NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload370Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload370Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370City$inboundSchema: z.ZodType<
  UserEventPayload370City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload370Names$inboundSchema),
});

export function userEventPayload370CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload370City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload370City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload370GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload370GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload370GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload370GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370Country$inboundSchema: z.ZodType<
  UserEventPayload370Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload370GeolocationNames$inboundSchema),
});

export function userEventPayload370CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload370Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload370Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload370GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload370GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload370GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload370GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload370MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload370GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload370MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload370MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload370MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload370MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload370Geolocation$inboundSchema: z.ZodType<
  UserEventPayload370Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload370City$inboundSchema)),
  country: z.lazy(() => UserEventPayload370Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload370MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload370GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload370Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload370Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload370Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload370Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload369Names$inboundSchema: z.ZodType<
...
export function userEventPayload369NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload369Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload369Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369City$inboundSchema: z.ZodType<
  UserEventPayload369City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload369Names$inboundSchema),
});

export function userEventPayload369CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload369City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload369City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload369GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload369GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload369GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369Country$inboundSchema: z.ZodType<
  UserEventPayload369Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload369GeolocationNames$inboundSchema),
});

export function userEventPayload369CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload369Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload369Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload369GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload369GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload369GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload369MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload369GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload369MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload369MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload369MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload369MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload369Geolocation$inboundSchema: z.ZodType<
  UserEventPayload369Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload369City$inboundSchema)),
  country: z.lazy(() => UserEventPayload369Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload369MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload369GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload369Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload369Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload369Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload369Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload368Names$inboundSchema: z.ZodType<
...
export function userEventPayload368NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368City$inboundSchema: z.ZodType<
  UserEventPayload368City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload368Names$inboundSchema),
});

export function userEventPayload368CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload368GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload368GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368Country$inboundSchema: z.ZodType<
  UserEventPayload368Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload368GeolocationNames$inboundSchema),
});

export function userEventPayload368CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload368GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload368GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload368GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload368MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload368GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload368MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload368MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload368MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload368MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368Geolocation$inboundSchema: z.ZodType<
  UserEventPayload368Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload368City$inboundSchema)),
  country: z.lazy(() => UserEventPayload368Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload368MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload368GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload368Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload367Names$inboundSchema: z.ZodType<
...
export function userEventPayload367NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload367Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload367Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload367Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload367GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload367GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload367GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload367GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload367GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload367GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload367GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload367GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload367GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload360Team$inboundSchema: z.ZodType<
  UserEventPayload360Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload360TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload360Configuration$inboundSchema: z.ZodType<
  UserEventPayload360Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload360ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload360Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload360Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload360Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndSixty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload360Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload360Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload359Team$inboundSchema: z.ZodType<
...
export function userEventPayload359TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload359Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload359ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload359Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload359Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload359Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFiftyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload359Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload359Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload358Team$inboundSchema: z.ZodType<
...
export function userEventPayload358TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload358Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload358ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload358Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload358Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload358Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFiftyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload358Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload358Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload347Previous$inboundSchema: z.ZodType<
...
export function userEventPayload347PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload347Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload347Next$inboundSchema: z.ZodType<
...
export function userEventPayload347NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload347Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347Next' from JSON`,
  );
}
...
export const ThreeHundredAndFortySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload347Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload347Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload343Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload343Provider
> = z.nativeEnum(UserEventPayload343Provider);
...
export const ThreeHundredAndFortyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload343Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload337Previous$inboundSchema: z.ZodType<
...
export function userEventPayload337PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload337Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload337Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload337Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload337Next$inboundSchema: z.ZodType<
  UserEventPayload337Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload337NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload337Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload337Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload337Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload320User$inboundSchema: z.ZodType<
  UserEventPayload320User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload320UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload320User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload320User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload320User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload320User$inboundSchema),
