...
export type UserEventPayload357City = {
...
export type UserEventPayload357Country = {
...
export type UserEventPayload357MostSpecificSubdivision = {
  names: UserEventPayload357GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload357Geolocation = {
  city?: UserEventPayload357City | undefined;
  country: UserEventPayload357Country;
  mostSpecificSubdivision?:
    | UserEventPayload357MostSpecificSubdivision
    | undefined;
...
export type ThreeHundredAndFiftySeven = {
  ...
  geolocation?: UserEventPayload357Geolocation | null | undefined;
...
export type UserEventPayload347Team = {
  id: string;
  name: string;
};

export type UserEventPayload347Configuration = {
  id: string;
...
export type ThreeHundredAndFortySeven = {
  team: UserEventPayload347Team;
  configuration: UserEventPayload347Configuration;
...
export type UserEventPayload337Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export const UserEventPayload333Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload333Provider = ClosedEnum<
  typeof UserEventPayload333Provider
>;
...
export type ThreeHundredAndThirtyThree = {
  provider: UserEventPayload333Provider;
  login: string;
};
...
export type UserEventPayload327Previous = Previous1 | Previous2;
...
export type UserEventPayload327Next = Next1 | Next2;
...
export type UserEventPayload311User = {
  id: string;
  username: string;
};
...
/** @internal */
export const UserEventPayload357City$inboundSchema: z.ZodType<
  UserEventPayload357City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload357CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload357Country$inboundSchema: z.ZodType<
  UserEventPayload357Country,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload357CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload357MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload357MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload357GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload357MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload357MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload357MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload357MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload357Geolocation$inboundSchema: z.ZodType<
  UserEventPayload357Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload357City$inboundSchema)),
  country: z.lazy(() => UserEventPayload357Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload357MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload357GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload357Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload347Team$inboundSchema: z.ZodType<
  UserEventPayload347Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload347TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload347Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload347Configuration$inboundSchema: z.ZodType<
  UserEventPayload347Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload347ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload347Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFortySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload347Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload347Configuration$inboundSchema),
...
> = z.object({
  ...
  next: z.lazy(() => UserEventPayload337Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload333Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload333Provider
> = z.nativeEnum(UserEventPayload333Provider);
...
export const ThreeHundredAndThirtyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload333Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload311User$inboundSchema: z.ZodType<
  UserEventPayload311User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload311UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload311User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload311User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload311User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload311User$inboundSchema),
