...
export type UserEventPayload396Names = {
  en: string;
};

export type UserEventPayload396City = {
  names: UserEventPayload396Names;
};

export type UserEventPayload396GeolocationNames = {
  en: string;
};

export type UserEventPayload396Country = {
  names: UserEventPayload396GeolocationNames;
};

export type UserEventPayload396GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload396MostSpecificSubdivision = {
  names: UserEventPayload396GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload396Geolocation = {
  city?: UserEventPayload396City | undefined;
  country: UserEventPayload396Country;
  mostSpecificSubdivision?:
    | UserEventPayload396MostSpecificSubdivision
    | undefined;
...
export type ThreeHundredAndNinetySix = {
  ...
  geolocation?: UserEventPayload396Geolocation | null | undefined;
...
export type UserEventPayload386Team = {
  id: string;
  name: string;
};

export type UserEventPayload386Configuration = {
  id: string;
...
export type ThreeHundredAndEightySix = {
  team: UserEventPayload386Team;
  configuration: UserEventPayload386Configuration;
...
export type ThreeHundredAndSixtyNine = {
  previous: UserEventPayload369Previous;
...
export const UserEventPayload365Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload365Provider = ClosedEnum<
  typeof UserEventPayload365Provider
>;
...
export type ThreeHundredAndSixtyFive = {
  provider: UserEventPayload365Provider;
  login: string;
};
...
export type UserEventPayload358Previous = Previous1 | Previous2;
...
export type UserEventPayload358Next = Next1 | Next2;
...
/** @internal */
export const UserEventPayload396Names$inboundSchema: z.ZodType<
  UserEventPayload396Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload396NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload396Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload396Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396City$inboundSchema: z.ZodType<
  UserEventPayload396City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload396Names$inboundSchema),
});

export function userEventPayload396CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload396City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload396City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload396GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload396GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload396GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload396GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396Country$inboundSchema: z.ZodType<
  UserEventPayload396Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload396GeolocationNames$inboundSchema),
});

export function userEventPayload396CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload396Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload396Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload396GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload396GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload396GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload396GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload396MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload396GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload396MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload396MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload396MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload396MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload396Geolocation$inboundSchema: z.ZodType<
  UserEventPayload396Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload396City$inboundSchema)),
  country: z.lazy(() => UserEventPayload396Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload396MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload396GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload396Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload396Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload396Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload396Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload386Team$inboundSchema: z.ZodType<
  UserEventPayload386Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload386TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload386Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload386Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload386Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload386Configuration$inboundSchema: z.ZodType<
  UserEventPayload386Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload386ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload386Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload386Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload386Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndEightySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload386Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload386Configuration$inboundSchema),
...
export const ThreeHundredAndSixtyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload369Previous$inboundSchema),
...
/** @internal */
export const UserEventPayload365Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload365Provider
> = z.nativeEnum(UserEventPayload365Provider);
...
export const ThreeHundredAndSixtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload365Provider$inboundSchema,
  login: types.string(),
});
