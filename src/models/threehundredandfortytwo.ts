...
export type UserEventPayload395Names = {
  en: string;
};

export type UserEventPayload395City = {
  names: UserEventPayload395Names;
};

export type UserEventPayload395GeolocationNames = {
  en: string;
};

export type UserEventPayload395Country = {
  names: UserEventPayload395GeolocationNames;
};

export type UserEventPayload395GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload395MostSpecificSubdivision = {
  names: UserEventPayload395GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload395Geolocation = {
  city?: UserEventPayload395City | undefined;
  country: UserEventPayload395Country;
...
export type ThreeHundredAndNinetyFive = {
  ...
  geolocation?: UserEventPayload395Geolocation | null | undefined;
...
export type UserEventPayload385Team = {
  id: string;
  name: string;
};

export type UserEventPayload385Configuration = {
  id: string;
...
export type ThreeHundredAndEightyFive = {
  team: UserEventPayload385Team;
  configuration: UserEventPayload385Configuration;
...
export type UserEventPayload368Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload368Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndSixtyEight = {
  previous: UserEventPayload368Previous;
  next: UserEventPayload368Next;
};
...
export const UserEventPayload364Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload364Provider = ClosedEnum<
  typeof UserEventPayload364Provider
>;
...
export type ThreeHundredAndSixtyFour = {
  provider: UserEventPayload364Provider;
  login: string;
};
...
export type UserEventPayload357Previous = Previous1 | Previous2;
...
export type UserEventPayload357Next = Next1 | Next2;
...
/** @internal */
export const UserEventPayload395Names$inboundSchema: z.ZodType<
...
export function userEventPayload395NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload395Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload395Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395City$inboundSchema: z.ZodType<
  UserEventPayload395City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload395Names$inboundSchema),
});

export function userEventPayload395CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload395City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload395City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload395GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload395GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload395GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395Country$inboundSchema: z.ZodType<
  UserEventPayload395Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload395GeolocationNames$inboundSchema),
});

export function userEventPayload395CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload395Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload395Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload395GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload395GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload395GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload395MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload395GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload395MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload395MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload395MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload395MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload395Geolocation$inboundSchema: z.ZodType<
  UserEventPayload395Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload395City$inboundSchema)),
  country: z.lazy(() => UserEventPayload395Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload395MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload395GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload395Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload395Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload395Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload395Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload385Team$inboundSchema: z.ZodType<
...
export function userEventPayload385TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload385Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload385Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload385Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload385Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload385ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload385Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload385Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload385Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndEightyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload385Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload385Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload368Previous$inboundSchema: z.ZodType<
  UserEventPayload368Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload368PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload368Next$inboundSchema: z.ZodType<
  UserEventPayload368Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload368NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368Next' from JSON`,
  );
}
...
export const ThreeHundredAndSixtyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload368Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload368Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload364Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload364Provider
> = z.nativeEnum(UserEventPayload364Provider);
...
export const ThreeHundredAndSixtyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload364Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload357Previous$inboundSchema: z.ZodType<
...
export function userEventPayload357PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload357Next$inboundSchema: z.ZodType<
  UserEventPayload357Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload357NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Next' from JSON`,
  );
}
