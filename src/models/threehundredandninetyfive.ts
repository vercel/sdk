...
export type UserEventPayload435Names = {
  en: string;
};

export type UserEventPayload435City = {
  names: UserEventPayload435Names;
};

export type UserEventPayload435GeolocationNames = {
  en: string;
};

export type UserEventPayload435Country = {
  names: UserEventPayload435GeolocationNames;
};

export type UserEventPayload435GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload435MostSpecificSubdivision = {
  names: UserEventPayload435GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload435Geolocation = {
  city?: UserEventPayload435City | undefined;
  country: UserEventPayload435Country;
  mostSpecificSubdivision?:
    | UserEventPayload435MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndThirtyFive = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload435Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload434AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload434AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload433Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload433Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload423Team = {
  id: string;
  name: string;
};

export type UserEventPayload423Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndTwentyThree = {
  team: UserEventPayload423Team;
  configuration: UserEventPayload423Configuration;
  peering: Peering;
};
...
export const UserEventPayload408Provider = {
  Google: "google",
} as const;
export type UserEventPayload408Provider = ClosedEnum<
  typeof UserEventPayload408Provider
>;
...
export type FourHundredAndEight = {
  provider: UserEventPayload408Provider;
...
export type UserEventPayload402Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload402Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type FourHundredAndTwo = {
  previous: UserEventPayload402Previous;
  next: UserEventPayload402Next;
  method?: PayloadMethod | undefined;
};

export const UserEventPayload401Action = {
...
export type UserEventPayload401Action = ClosedEnum<
  typeof UserEventPayload401Action
>;
...
export type FourHundredAndOne = {
  action: UserEventPayload401Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload435Names$inboundSchema: z.ZodType<
  UserEventPayload435Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload435NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435City$inboundSchema: z.ZodType<
  UserEventPayload435City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload435Names$inboundSchema),
});

export function userEventPayload435CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload435GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload435GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload435GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435Country$inboundSchema: z.ZodType<
  UserEventPayload435Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload435GeolocationNames$inboundSchema),
});

export function userEventPayload435CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload435GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload435GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload435GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload435GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload435MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload435GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload435MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload435MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload435MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload435MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload435Geolocation$inboundSchema: z.ZodType<
  UserEventPayload435Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload435City$inboundSchema)),
  country: z.lazy(() => UserEventPayload435Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload435MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload435GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload435Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload435Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload435Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload435Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload434AfterResources$inboundSchema: z.ZodType<
...
export function userEventPayload434AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload434AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload433Resources$inboundSchema: z.ZodType<
  UserEventPayload433Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload433ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload433Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload423Team$inboundSchema: z.ZodType<
  UserEventPayload423Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload423TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload423Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload423Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload423Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload423Configuration$inboundSchema: z.ZodType<
  UserEventPayload423Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload423ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload423Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload423Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload423Configuration' from JSON`,
  );
}
...
export const FourHundredAndTwentyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload423Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload423Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload408Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload408Provider
> = z.nativeEnum(UserEventPayload408Provider);
...
export const FourHundredAndEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload408Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload402Previous$inboundSchema: z.ZodType<
  UserEventPayload402Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload402PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload402Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload402Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload402Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload402Next$inboundSchema: z.ZodType<
  UserEventPayload402Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload402NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload402Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload402Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload402Next' from JSON`,
  );
}
...
export const FourHundredAndTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload402Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload402Next$inboundSchema),
...
/** @internal */
export const UserEventPayload401Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload401Action
> = z.nativeEnum(UserEventPayload401Action);
...
export const FourHundredAndOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload401Action$inboundSchema,
  reason: types.string(),
});
