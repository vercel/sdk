...
export type UserEventPayload434City = {
...
export type UserEventPayload434Country = {
...
export type UserEventPayload434MostSpecificSubdivision = {
  names: UserEventPayload434GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload434Geolocation = {
  city?: UserEventPayload434City | undefined;
  country: UserEventPayload434Country;
  mostSpecificSubdivision?:
    | UserEventPayload434MostSpecificSubdivision
    | undefined;
...
export type FourHundredAndThirtyFour = {
  ...
  geolocation?: UserEventPayload434Geolocation | null | undefined;
...
export type UserEventPayload433City = {
...
export type UserEventPayload433Country = {
...
export type UserEventPayload433MostSpecificSubdivision = {
  names: UserEventPayload433GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload433Geolocation = {
  city?: UserEventPayload433City | undefined;
  country: UserEventPayload433Country;
  mostSpecificSubdivision?:
    | UserEventPayload433MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndThirtyThree = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload433Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload432Names = {
  en: string;
};

export type UserEventPayload432City = {
  names: UserEventPayload432Names;
};

export type UserEventPayload432GeolocationNames = {
  en: string;
};

export type UserEventPayload432Country = {
  names: UserEventPayload432GeolocationNames;
};

export type UserEventPayload432GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload432MostSpecificSubdivision = {
  names: UserEventPayload432GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload432Geolocation = {
  city?: UserEventPayload432City | undefined;
  country: UserEventPayload432Country;
  mostSpecificSubdivision?:
    | UserEventPayload432MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndThirtyTwo = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload432Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 */
export type UserEventPayload431Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload431Resources | null;
  /**
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload431AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload431AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload430Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload430Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload429Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload429Names;
};

export type UserEventPayload429GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload429GeolocationNames;
};

export type UserEventPayload429GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload429GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload422Team = {
  id: string;
  name: string;
};

export type UserEventPayload422Configuration = {
  id: string;
...
export type FourHundredAndTwentyTwo = {
  team: UserEventPayload422Team;
  configuration: UserEventPayload422Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload421Team = {
  id: string;
  name: string;
};

export type UserEventPayload421Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndTwentyOne = {
  team: UserEventPayload421Team;
  configuration: UserEventPayload421Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload420Team = {
  id: string;
  name: string;
};

export type UserEventPayload420Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndTwenty = {
  team: UserEventPayload420Team;
  configuration: UserEventPayload420Configuration;
  peering: Peering;
};
...
export const UserEventPayload405Provider = {
  Google: "google",
} as const;
export type UserEventPayload405Provider = ClosedEnum<
  typeof UserEventPayload405Provider
>;
...
export type FourHundredAndFive = {
  provider: UserEventPayload405Provider;
...
export type UserEventPayload399Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload399Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndNinetyNine = {
  previous: UserEventPayload399Previous;
  next: UserEventPayload399Next;
  method?: PayloadMethod | undefined;
};

export const UserEventPayload398Action = {
...
export type UserEventPayload398Action = ClosedEnum<
  typeof UserEventPayload398Action
>;
...
export type ThreeHundredAndNinetyEight = {
  action: UserEventPayload398Action;
  reason: string;
};
...
/** @internal */
export const UserEventPayload434City$inboundSchema: z.ZodType<
  UserEventPayload434City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload434CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload434Country$inboundSchema: z.ZodType<
...
export function userEventPayload434CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload434MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload434MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload434GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload434MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload434MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload434MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload434MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload434Geolocation$inboundSchema: z.ZodType<
  UserEventPayload434Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload434City$inboundSchema)),
  country: z.lazy(() => UserEventPayload434Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload434MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload434GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload434Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload434Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload434Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload434Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload433City$inboundSchema: z.ZodType<
  UserEventPayload433City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload433CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload433Country$inboundSchema: z.ZodType<
  UserEventPayload433Country,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload433CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload433MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload433MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload433GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload433MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload433MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload433MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload433MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload433Geolocation$inboundSchema: z.ZodType<
  UserEventPayload433Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload433City$inboundSchema)),
  country: z.lazy(() => UserEventPayload433Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload433MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload433GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload433Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload433Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload433Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload433Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload432Names$inboundSchema: z.ZodType<
  UserEventPayload432Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload432NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432City$inboundSchema: z.ZodType<
  UserEventPayload432City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload432Names$inboundSchema),
});

export function userEventPayload432CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload432GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload432GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload432GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432Country$inboundSchema: z.ZodType<
  UserEventPayload432Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload432GeolocationNames$inboundSchema),
});

export function userEventPayload432CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload432GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload432GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload432GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload432MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload432GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload432MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload432MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload432MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload432MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload432Geolocation$inboundSchema: z.ZodType<
  UserEventPayload432Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload432City$inboundSchema)),
  country: z.lazy(() => UserEventPayload432Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload432MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload432GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload432Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload432Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload432Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload432Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload431Resources$inboundSchema: z.ZodType<
  UserEventPayload431Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload431ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload431Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload431Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload431Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload431Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload431AfterResources$inboundSchema: z.ZodType<
  UserEventPayload431AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload431AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload431AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload431AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload431AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload431AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload430Resources$inboundSchema: z.ZodType<
  UserEventPayload430Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload430ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload430Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload430Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload430Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload430Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload429Names$inboundSchema: z.ZodType<
  UserEventPayload429Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload429NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload429Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload429Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload429Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload429Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload429GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload429GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload429GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload429GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload429GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload429GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload429GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload429GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload429GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload429GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload429GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload429GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload429GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload422Team$inboundSchema: z.ZodType<
  UserEventPayload422Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload422TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload422Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload422Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload422Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload422Configuration$inboundSchema: z.ZodType<
  UserEventPayload422Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload422ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload422Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload422Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload422Configuration' from JSON`,
  );
}
...
export const FourHundredAndTwentyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload422Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload422Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload421Team$inboundSchema: z.ZodType<
  UserEventPayload421Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload421TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload421Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload421Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload421Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload421Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload421ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload421Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload421Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload421Configuration' from JSON`,
  );
}
...
export const FourHundredAndTwentyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload421Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload421Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload420Team$inboundSchema: z.ZodType<
...
export function userEventPayload420TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload420Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload420Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload420Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload420Configuration$inboundSchema: z.ZodType<
  UserEventPayload420Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload420ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload420Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload420Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload420Configuration' from JSON`,
  );
}
...
export const FourHundredAndTwenty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload420Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload420Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload405Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload405Provider
> = z.nativeEnum(UserEventPayload405Provider);
...
export const FourHundredAndFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload405Provider$inboundSchema,
...
/** @internal */
export const UserEventPayload399Previous$inboundSchema: z.ZodType<
  UserEventPayload399Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload399PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload399Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload399Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload399Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload399Next$inboundSchema: z.ZodType<
  UserEventPayload399Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload399NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload399Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload399Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload399Next' from JSON`,
  );
}
...
export const ThreeHundredAndNinetyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload399Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload399Next$inboundSchema),
...
/** @internal */
export const UserEventPayload398Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload398Action
> = z.nativeEnum(UserEventPayload398Action);
...
export const ThreeHundredAndNinetyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload398Action$inboundSchema,
  reason: types.string(),
});
