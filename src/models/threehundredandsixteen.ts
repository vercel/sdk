...
export type UserEventPayload367City = {
...
export type UserEventPayload367Country = {
...
export type UserEventPayload367MostSpecificSubdivision = {
  names: UserEventPayload367GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload367Geolocation = {
  city?: UserEventPayload367City | undefined;
  country: UserEventPayload367Country;
  mostSpecificSubdivision?:
    | UserEventPayload367MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type ThreeHundredAndSixtySeven = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload367Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload366Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload366Names;
};

export type UserEventPayload366GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload366GeolocationNames;
};

export type UserEventPayload366GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload366GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload357Team = {
  id: string;
  name: string;
};

export type UserEventPayload357Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndFiftySeven = {
  team: UserEventPayload357Team;
  configuration: UserEventPayload357Configuration;
  peering: Peering;
};
...
export type UserEventPayload346Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload346Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndFortySix = {
  previous: UserEventPayload346Previous;
  next: UserEventPayload346Next;
};
...
export const UserEventPayload342Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload342Provider = ClosedEnum<
  typeof UserEventPayload342Provider
>;
...
export type ThreeHundredAndFortyTwo = {
  provider: UserEventPayload342Provider;
  login: string;
};
...
export type UserEventPayload336Previous = Previous1 | Previous2;
...
export type UserEventPayload336Next = Next1 | Next2;
...
export type UserEventPayload319User = {
  id: string;
  username: string;
};
...
/** @internal */
export const UserEventPayload367City$inboundSchema: z.ZodType<
  UserEventPayload367City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload367CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload367City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload367City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload367Country$inboundSchema: z.ZodType<
  UserEventPayload367Country,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload367CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload367Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload367Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload367MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload367MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload367GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload367MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload367MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload367MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload367MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload367Geolocation$inboundSchema: z.ZodType<
  UserEventPayload367Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload367City$inboundSchema)),
  country: z.lazy(() => UserEventPayload367Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload367MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload367GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload367Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload367Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload367Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload367Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload366Names$inboundSchema: z.ZodType<
  UserEventPayload366Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload366NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload366Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload366Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload366Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload366Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload366GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload366GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload366GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload366GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload366GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload366GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload366GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload366GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload366GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload366GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload366GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload366GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload366GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload357Team$inboundSchema: z.ZodType<
  UserEventPayload357Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload357TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload357Configuration$inboundSchema: z.ZodType<
  UserEventPayload357Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload357ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload357Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload357Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload357Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndFiftySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload357Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload357Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload346Previous$inboundSchema: z.ZodType<
...
export function userEventPayload346PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload346Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload346Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload346Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload346Next$inboundSchema: z.ZodType<
...
export function userEventPayload346NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload346Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload346Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload346Next' from JSON`,
  );
}
...
export const ThreeHundredAndFortySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload346Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload346Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload342Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload342Provider
> = z.nativeEnum(UserEventPayload342Provider);
...
export const ThreeHundredAndFortyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload342Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload319User$inboundSchema: z.ZodType<
  UserEventPayload319User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload319UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload319User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload319User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload319User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload319User$inboundSchema),
