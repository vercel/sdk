...
export type UserEventPayload404Names = {
  en: string;
};

export type UserEventPayload404City = {
  names: UserEventPayload404Names;
};

export type UserEventPayload404GeolocationNames = {
  en: string;
};

export type UserEventPayload404Country = {
  names: UserEventPayload404GeolocationNames;
};

export type UserEventPayload404GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload404MostSpecificSubdivision = {
  names: UserEventPayload404GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload404Geolocation = {
  city?: UserEventPayload404City | undefined;
  country: UserEventPayload404Country;
  mostSpecificSubdivision?:
    | UserEventPayload404MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndFour = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload404Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload403Names = {
  en: string;
};

export type UserEventPayload403City = {
  names: UserEventPayload403Names;
};

export type UserEventPayload403GeolocationNames = {
  en: string;
};

export type UserEventPayload403Country = {
  names: UserEventPayload403GeolocationNames;
};

export type UserEventPayload403GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload403MostSpecificSubdivision = {
  names: UserEventPayload403GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload403Geolocation = {
  city?: UserEventPayload403City | undefined;
  country: UserEventPayload403Country;
  mostSpecificSubdivision?:
    | UserEventPayload403MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndThree = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload403Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 */
export type UserEventPayload402Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload402Resources | null;
  /**
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload402AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload402AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload401Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload401Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload400Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload400Names;
};

export type UserEventPayload400GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload400GeolocationNames;
};

export type UserEventPayload400GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload400GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload392Team = {
  id: string;
  name: string;
};

export type UserEventPayload392Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndNinetyTwo = {
  team: UserEventPayload392Team;
  configuration: UserEventPayload392Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload391Team = {
  id: string;
  name: string;
};

export type UserEventPayload391Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndNinetyOne = {
  team: UserEventPayload391Team;
  configuration: UserEventPayload391Configuration;
  peering: Peering;
};
...
export type UserEventPayload376Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload376Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndSeventySix = {
  previous: UserEventPayload376Previous;
  next: UserEventPayload376Next;
};

export const UserEventPayload375Action = {
...
export type UserEventPayload375Action = ClosedEnum<
  typeof UserEventPayload375Action
>;
...
export type ThreeHundredAndSeventyFive = {
  action: UserEventPayload375Action;
  reason: string;
};
...
export const UserEventPayload370Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload370Provider = ClosedEnum<
  typeof UserEventPayload370Provider
>;
...
export type ThreeHundredAndSeventy = {
  provider: UserEventPayload370Provider;
  login: string;
};

export const UserEventPayload369Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload369Type = ClosedEnum<
  typeof UserEventPayload369Type
>;
...
export type UserEventPayload363Previous = Previous1 | Previous2;
...
export type UserEventPayload363Next = Next1 | Next2;
...
/** @internal */
export const UserEventPayload404Names$inboundSchema: z.ZodType<
  UserEventPayload404Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload404NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload404Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload404Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404City$inboundSchema: z.ZodType<
  UserEventPayload404City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload404Names$inboundSchema),
});

export function userEventPayload404CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload404City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload404City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload404GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload404GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload404GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload404GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404Country$inboundSchema: z.ZodType<
  UserEventPayload404Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload404GeolocationNames$inboundSchema),
});

export function userEventPayload404CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload404Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload404Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload404GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload404GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload404GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload404GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload404MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload404GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload404MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload404MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload404MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload404MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload404Geolocation$inboundSchema: z.ZodType<
  UserEventPayload404Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload404City$inboundSchema)),
  country: z.lazy(() => UserEventPayload404Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload404MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload404GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload404Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload404Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload404Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload404Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload403Names$inboundSchema: z.ZodType<
  UserEventPayload403Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload403NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload403Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload403Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403City$inboundSchema: z.ZodType<
  UserEventPayload403City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload403Names$inboundSchema),
});

export function userEventPayload403CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload403City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload403City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload403GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload403GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload403GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload403GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403Country$inboundSchema: z.ZodType<
  UserEventPayload403Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload403GeolocationNames$inboundSchema),
});

export function userEventPayload403CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload403Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload403Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload403GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload403GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload403GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload403GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload403MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload403GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload403MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload403MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload403MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload403MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload403Geolocation$inboundSchema: z.ZodType<
  UserEventPayload403Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload403City$inboundSchema)),
  country: z.lazy(() => UserEventPayload403Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload403MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload403GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload403Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload403Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload403Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload403Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload402Resources$inboundSchema: z.ZodType<
  UserEventPayload402Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload402ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload402Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload402Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload402Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload402Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload402AfterResources$inboundSchema: z.ZodType<
  UserEventPayload402AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload402AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload402AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload402AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload402AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload402AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload401Resources$inboundSchema: z.ZodType<
  UserEventPayload401Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload401ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload401Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload401Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload401Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload401Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload400Names$inboundSchema: z.ZodType<
  UserEventPayload400Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload400NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload400Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload400Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload400Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload400Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload400GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload400GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload400GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload400GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload400GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload400GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload400GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload400GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload400GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload400GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload400GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload400GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload392Team$inboundSchema: z.ZodType<
  UserEventPayload392Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload392TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload392Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload392Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload392Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload392Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload392ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload392Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload392Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload392Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndNinetyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload392Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload392Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload391Team$inboundSchema: z.ZodType<
  UserEventPayload391Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload391TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload391Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload391Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload391Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload391Configuration$inboundSchema: z.ZodType<
  UserEventPayload391Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload391ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload391Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload391Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload391Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndNinetyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload391Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload391Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload376Previous$inboundSchema: z.ZodType<
  UserEventPayload376Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload376PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload376Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload376Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload376Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload376Next$inboundSchema: z.ZodType<
  UserEventPayload376Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload376NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload376Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload376Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload376Next' from JSON`,
  );
}
...
export const ThreeHundredAndSeventySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload376Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload376Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload375Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload375Action
> = z.nativeEnum(UserEventPayload375Action);
...
export const ThreeHundredAndSeventyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload375Action$inboundSchema,
  reason: types.string(),
});
...
/** @internal */
export const UserEventPayload370Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload370Provider
> = z.nativeEnum(UserEventPayload370Provider);
...
export const ThreeHundredAndSeventy$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload370Provider$inboundSchema,
  login: types.string(),
});
...
/** @internal */
export const UserEventPayload369Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload369Type
> = z.nativeEnum(UserEventPayload369Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload369Type$inboundSchema,
  rate: types.number(),
