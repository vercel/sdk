...
export type UserEventPayload413Names = {
  en: string;
};

export type UserEventPayload413City = {
  names: UserEventPayload413Names;
};

export type UserEventPayload413GeolocationNames = {
  en: string;
};

export type UserEventPayload413Country = {
  names: UserEventPayload413GeolocationNames;
};

export type UserEventPayload413GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload413MostSpecificSubdivision = {
  names: UserEventPayload413GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload413Geolocation = {
  city?: UserEventPayload413City | undefined;
  country: UserEventPayload413Country;
  mostSpecificSubdivision?:
    | UserEventPayload413MostSpecificSubdivision
    | undefined;
...
export type FourHundredAndThirteen = {
  ...
  geolocation?: UserEventPayload413Geolocation | null | undefined;
...
export type UserEventPayload412Names = {
  en: string;
};

export type UserEventPayload412City = {
  names: UserEventPayload412Names;
};

export type UserEventPayload412GeolocationNames = {
  en: string;
};

export type UserEventPayload412Country = {
  names: UserEventPayload412GeolocationNames;
};

export type UserEventPayload412GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload412MostSpecificSubdivision = {
  names: UserEventPayload412GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload412Geolocation = {
  city?: UserEventPayload412City | undefined;
  country: UserEventPayload412Country;
  mostSpecificSubdivision?:
    | UserEventPayload412MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndTwelve = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload412Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload411Names = {
  en: string;
};

export type UserEventPayload411City = {
  names: UserEventPayload411Names;
};

export type UserEventPayload411GeolocationNames = {
  en: string;
};

export type UserEventPayload411Country = {
  names: UserEventPayload411GeolocationNames;
};

export type UserEventPayload411GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload411MostSpecificSubdivision = {
  names: UserEventPayload411GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload411Geolocation = {
  city?: UserEventPayload411City | undefined;
  country: UserEventPayload411Country;
  mostSpecificSubdivision?:
    | UserEventPayload411MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndEleven = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload411Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 */
export type UserEventPayload410Resources = {
...
export type PayloadBefore = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload410Resources | null;
  /**
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload410AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload410AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload409Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload409Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload408Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload408Names;
};

export type UserEventPayload408GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload408GeolocationNames;
};

export type UserEventPayload408GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload408GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload401Team = {
  id: string;
  name: string;
};

export type UserEventPayload401Configuration = {
  id: string;
...
export type FourHundredAndOne = {
  team: UserEventPayload401Team;
  configuration: UserEventPayload401Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload400Team = {
  id: string;
  name: string;
};

export type UserEventPayload400Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundred = {
  team: UserEventPayload400Team;
  configuration: UserEventPayload400Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload399Team = {
  id: string;
  name: string;
};

export type UserEventPayload399Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndNinetyNine = {
  team: UserEventPayload399Team;
  configuration: UserEventPayload399Configuration;
  peering: Peering;
};
...
export type UserEventPayload382Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload382Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndEightyTwo = {
  previous: UserEventPayload382Previous;
  next: UserEventPayload382Next;
};

export const UserEventPayload381Action = {
...
export type UserEventPayload381Action = ClosedEnum<
  typeof UserEventPayload381Action
>;
...
export type ThreeHundredAndEightyOne = {
  action: UserEventPayload381Action;
  reason: string;
};
...
export const UserEventPayload375Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload375Type = ClosedEnum<
  typeof UserEventPayload375Type
>;
...
export type UserEventPayload369Previous = Previous1 | Previous2;
...
export type UserEventPayload369Next = Next1 | Next2;
...
/** @internal */
export const UserEventPayload413Names$inboundSchema: z.ZodType<
  UserEventPayload413Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload413NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413City$inboundSchema: z.ZodType<
  UserEventPayload413City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload413Names$inboundSchema),
});

export function userEventPayload413CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload413GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload413GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload413GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413Country$inboundSchema: z.ZodType<
  UserEventPayload413Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload413GeolocationNames$inboundSchema),
});

export function userEventPayload413CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload413GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload413GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload413GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload413GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload413MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload413GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload413MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload413MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload413MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload413MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload413Geolocation$inboundSchema: z.ZodType<
  UserEventPayload413Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload413City$inboundSchema)),
  country: z.lazy(() => UserEventPayload413Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload413MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload413GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload413Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload413Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload413Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload413Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload412Names$inboundSchema: z.ZodType<
  UserEventPayload412Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload412NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload412Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload412Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412City$inboundSchema: z.ZodType<
  UserEventPayload412City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload412Names$inboundSchema),
});

export function userEventPayload412CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload412City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload412City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload412GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload412GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload412GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload412GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412Country$inboundSchema: z.ZodType<
  UserEventPayload412Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload412GeolocationNames$inboundSchema),
});

export function userEventPayload412CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload412Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload412Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload412GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload412GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload412GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload412GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload412MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload412GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload412MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload412MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload412MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload412MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload412Geolocation$inboundSchema: z.ZodType<
  UserEventPayload412Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload412City$inboundSchema)),
  country: z.lazy(() => UserEventPayload412Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload412MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload412GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload412Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload412Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload412Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload412Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload411Names$inboundSchema: z.ZodType<
  UserEventPayload411Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload411NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411City$inboundSchema: z.ZodType<
  UserEventPayload411City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload411Names$inboundSchema),
});

export function userEventPayload411CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload411GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload411GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload411GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411Country$inboundSchema: z.ZodType<
  UserEventPayload411Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload411GeolocationNames$inboundSchema),
});

export function userEventPayload411CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload411GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload411GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload411GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload411GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload411MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload411GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload411MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload411MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload411MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload411MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload411Geolocation$inboundSchema: z.ZodType<
  UserEventPayload411Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload411City$inboundSchema)),
  country: z.lazy(() => UserEventPayload411Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload411MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload411GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload411Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload411Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload411Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload411Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload410Resources$inboundSchema: z.ZodType<
  UserEventPayload410Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload410ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload410Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload410Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload410Resources' from JSON`,
  );
}
...
> = z.object({
  ...
  resources: types.nullable(
    z.lazy(() => UserEventPayload410Resources$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload410AfterResources$inboundSchema: z.ZodType<
  UserEventPayload410AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload410AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload410AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload410AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload410AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload410AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload409Resources$inboundSchema: z.ZodType<
  UserEventPayload409Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload409ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload409Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload409Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload409Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload409Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload408Names$inboundSchema: z.ZodType<
  UserEventPayload408Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload408NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload408Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload408Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload408Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload408Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload408GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload408GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload408GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload408GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload408GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload408GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload408GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload408GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload408GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload408GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload408GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload408GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload408GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload401Team$inboundSchema: z.ZodType<
  UserEventPayload401Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload401TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload401Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload401Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload401Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload401Configuration$inboundSchema: z.ZodType<
  UserEventPayload401Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload401ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload401Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload401Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload401Configuration' from JSON`,
  );
}
...
export const FourHundredAndOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload401Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload401Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload400Team$inboundSchema: z.ZodType<
  UserEventPayload400Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload400TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload400Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload400Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload400Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload400Configuration$inboundSchema: z.ZodType<
  UserEventPayload400Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload400ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload400Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload400Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload400Configuration' from JSON`,
  );
}
...
export const FourHundred$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload400Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload400Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload399Team$inboundSchema: z.ZodType<
  UserEventPayload399Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload399TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload399Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload399Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload399Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload399Configuration$inboundSchema: z.ZodType<
  UserEventPayload399Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload399ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload399Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload399Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload399Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndNinetyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload399Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload399Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload382Previous$inboundSchema: z.ZodType<
...
export function userEventPayload382PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload382Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload382Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload382Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload382Next$inboundSchema: z.ZodType<
...
export function userEventPayload382NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload382Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload382Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload382Next' from JSON`,
  );
}
...
export const ThreeHundredAndEightyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload382Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload382Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload381Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload381Action
> = z.nativeEnum(UserEventPayload381Action);
...
export const ThreeHundredAndEightyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload381Action$inboundSchema,
  reason: types.string(),
});
...
/** @internal */
export const UserEventPayload375Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload375Type
> = z.nativeEnum(UserEventPayload375Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload375Type$inboundSchema,
  rate: types.number(),
