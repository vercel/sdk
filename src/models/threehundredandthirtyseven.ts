...
export type UserEventPayload390Names = {
  en: string;
};

export type UserEventPayload390City = {
  names: UserEventPayload390Names;
};

export type UserEventPayload390GeolocationNames = {
  en: string;
};

export type UserEventPayload390Country = {
  names: UserEventPayload390GeolocationNames;
};

export type UserEventPayload390GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload390MostSpecificSubdivision = {
  names: UserEventPayload390GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload390Geolocation = {
  city?: UserEventPayload390City | undefined;
  country: UserEventPayload390Country;
  mostSpecificSubdivision?:
    | UserEventPayload390MostSpecificSubdivision
    | undefined;
...
export type ThreeHundredAndNinety = {
  ...
  geolocation?: UserEventPayload390Geolocation | null | undefined;
...
export type UserEventPayload389Names = {
  en: string;
};

export type UserEventPayload389City = {
  names: UserEventPayload389Names;
};

export type UserEventPayload389GeolocationNames = {
  en: string;
};

export type UserEventPayload389Country = {
  names: UserEventPayload389GeolocationNames;
};

export type UserEventPayload389GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload389MostSpecificSubdivision = {
  names: UserEventPayload389GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload389Geolocation = {
  city?: UserEventPayload389City | undefined;
  country: UserEventPayload389Country;
  mostSpecificSubdivision?:
    | UserEventPayload389MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type ThreeHundredAndEightyNine = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload389Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload388Names = {
  en: string;
};

export type UserEventPayload388City = {
  names: UserEventPayload388Names;
};

export type UserEventPayload388GeolocationNames = {
  en: string;
};

export type UserEventPayload388Country = {
  names: UserEventPayload388GeolocationNames;
};

export type UserEventPayload388GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayload388MostSpecificSubdivision = {
  names: UserEventPayload388GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload388Geolocation = {
  city?: UserEventPayload388City | undefined;
  country: UserEventPayload388Country;
  mostSpecificSubdivision?:
    | UserEventPayload388MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type ThreeHundredAndEightyEight = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload388Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
...
export type UserEventPayload387Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload387Names;
};

export type UserEventPayload387GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload387GeolocationNames;
};

export type UserEventPayload387GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload387GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload380Team = {
  id: string;
  name: string;
};

export type UserEventPayload380Configuration = {
  id: string;
...
export type ThreeHundredAndEighty = {
  team: UserEventPayload380Team;
  configuration: UserEventPayload380Configuration;
  peering: UserEventPayloadPeering;
  newName?: string | undefined;
};

export type UserEventPayload379Team = {
  id: string;
  name: string;
};

export type UserEventPayload379Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndSeventyNine = {
  team: UserEventPayload379Team;
  configuration: UserEventPayload379Configuration;
  peering: PayloadPeering;
};

export type UserEventPayload378Team = {
  id: string;
  name: string;
};

export type UserEventPayload378Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type ThreeHundredAndSeventyEight = {
  team: UserEventPayload378Team;
  configuration: UserEventPayload378Configuration;
  peering: Peering;
};
...
export type ThreeHundredAndSixtyThree = {
  previous: UserEventPayload363Previous;
...
export const UserEventPayload359Provider = {
  Apple: "apple",
  Bitbucket: "bitbucket",
  Chatgpt: "chatgpt",
  Github: "github",
...
export type UserEventPayload359Provider = ClosedEnum<
  typeof UserEventPayload359Provider
>;
...
export type ThreeHundredAndFiftyNine = {
  provider: UserEventPayload359Provider;
  login: string;
};
...
export type UserEventPayload352Previous = Previous1 | Previous2;
...
export type UserEventPayload352Next = Next1 | Next2;
...
/** @internal */
export const UserEventPayload390Names$inboundSchema: z.ZodType<
  UserEventPayload390Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload390NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload390Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload390Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390City$inboundSchema: z.ZodType<
  UserEventPayload390City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload390Names$inboundSchema),
});

export function userEventPayload390CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload390City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload390City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload390GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload390GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload390GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload390GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390Country$inboundSchema: z.ZodType<
  UserEventPayload390Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload390GeolocationNames$inboundSchema),
});

export function userEventPayload390CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload390Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload390Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload390GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload390GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload390GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload390MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload390GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload390MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload390MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload390MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload390MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload390Geolocation$inboundSchema: z.ZodType<
  UserEventPayload390Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload390City$inboundSchema)),
  country: z.lazy(() => UserEventPayload390Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload390MostSpecificSubdivision$inboundSchema),
  ),
...
export function userEventPayload390GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload390Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload390Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload390Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload390Geolocation$inboundSchema),
  ).optional(),
...
/** @internal */
export const UserEventPayload389Names$inboundSchema: z.ZodType<
  UserEventPayload389Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload389NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389City$inboundSchema: z.ZodType<
  UserEventPayload389City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload389Names$inboundSchema),
});

export function userEventPayload389CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload389GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload389GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload389GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389Country$inboundSchema: z.ZodType<
  UserEventPayload389Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload389GeolocationNames$inboundSchema),
});

export function userEventPayload389CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload389GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload389GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload389GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload389GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload389MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload389GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload389MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload389MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload389MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload389MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389Geolocation$inboundSchema: z.ZodType<
  UserEventPayload389Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload389City$inboundSchema)),
  country: z.lazy(() => UserEventPayload389Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload389MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload389GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload389Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload388Names$inboundSchema: z.ZodType<
  UserEventPayload388Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload388NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388Names' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388City$inboundSchema: z.ZodType<
  UserEventPayload388City,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload388Names$inboundSchema),
});

export function userEventPayload388CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388City' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload388GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload388GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload388GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388GeolocationNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388Country$inboundSchema: z.ZodType<
  UserEventPayload388Country,
  z.ZodTypeDef,
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload388GeolocationNames$inboundSchema),
});

export function userEventPayload388CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388Country' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload388GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload388GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload388GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload388GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload388MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload388GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload388MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload388MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload388MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload388MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload388Geolocation$inboundSchema: z.ZodType<
  UserEventPayload388Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload388City$inboundSchema)),
  country: z.lazy(() => UserEventPayload388Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload388MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload388GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload388Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload387Names$inboundSchema: z.ZodType<
  UserEventPayload387Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload387NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload387Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload387Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload387Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload387Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload387GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload387GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload387GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload387GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload387GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload387GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload387GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload387GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload387GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload387GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload387GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload387GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload387GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload380Team$inboundSchema: z.ZodType<
  UserEventPayload380Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload380TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload380Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload380Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload380Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload380Configuration$inboundSchema: z.ZodType<
  UserEventPayload380Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload380ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload380Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload380Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload380Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndEighty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload380Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload380Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload379Team$inboundSchema: z.ZodType<
  UserEventPayload379Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload379TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload379Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload379Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload379Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload379Configuration$inboundSchema: z.ZodType<
  UserEventPayload379Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload379ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload379Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload379Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload379Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndSeventyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload379Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload379Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload378Team$inboundSchema: z.ZodType<
  UserEventPayload378Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload378TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload378Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload378Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload378Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload378Configuration$inboundSchema: z.ZodType<
  UserEventPayload378Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload378ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload378Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload378Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload378Configuration' from JSON`,
  );
}
...
export const ThreeHundredAndSeventyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload378Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload378Configuration$inboundSchema),
...
export const ThreeHundredAndSixtyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload363Previous$inboundSchema),
...
/** @internal */
export const UserEventPayload359Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload359Provider
> = z.nativeEnum(UserEventPayload359Provider);
...
export const ThreeHundredAndFiftyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  provider: UserEventPayload359Provider$inboundSchema,
  login: types.string(),
});
