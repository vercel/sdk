...
export type TwoHundredAndSeventyThree = {
  ...
  previous?: UserEventPayload273Previous | undefined;
  projectId: string;
  projectName: string;
};
 ...
 * The type of matching to perform
 */
export const UserEventPayload262PreviousType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload262PreviousType = ClosedEnum<
  typeof UserEventPayload262PreviousType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload262PreviousType;
};
...
export const UserEventPayload257Action = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
export type UserEventPayload257Action = ClosedEnum<
  typeof UserEventPayload257Action
>;
...
export type TwoHundredAndFiftySeven = {
  action: UserEventPayload257Action;
  projectId: string;
  projectName: string;
};
...
export type UserEventPayload255Team = {
  id: string;
  name: string;
};
...
export const UserEventPayload233Origin = {
...
export type UserEventPayload233Origin = ClosedEnum<
  typeof UserEventPayload233Origin
>;
...
export type PayloadJoinedFrom = {
  ...
  origin: UserEventPayload233Origin;
...
export const UserEventPayload231DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload231DeploymentType = ClosedEnum<
  typeof UserEventPayload231DeploymentType
>;

export type UserEventPayload231Passport = {
  connectorId: string;
  deploymentType: UserEventPayload231DeploymentType;
};

export type UserEventPayload231Previous = {
  passport?: UserEventPayload231Passport | null | undefined;
};
...
export const UserEventPayload230DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload230DeploymentType = ClosedEnum<
  typeof UserEventPayload230DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload230DeploymentType;
};
...
/** @internal */
export const UserEventPayload262PreviousType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload262PreviousType
> = z.nativeEnum(UserEventPayload262PreviousType);
...
> = z.object({
  pattern: types.string(),
  type: UserEventPayload262PreviousType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload257Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload257Action
> = z.nativeEnum(UserEventPayload257Action);
...
export const TwoHundredAndFiftySeven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload257Action$inboundSchema,
  projectId: types.string(),
  projectName: types.string(),
});
...
/** @internal */
export const UserEventPayload255Team$inboundSchema: z.ZodType<
  UserEventPayload255Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload255TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload255Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload255Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload255Team' from JSON`,
  );
}
...
> = z.object({
  ...
  team: z.lazy(() => UserEventPayload255Team$inboundSchema),
});
...
/** @internal */
export const UserEventPayload233Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload233Origin
> = z.nativeEnum(UserEventPayload233Origin);
...
> = z.object({
  ...
  origin: UserEventPayload233Origin$inboundSchema,
...
/** @internal */
export const UserEventPayload231DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload231DeploymentType
> = z.nativeEnum(UserEventPayload231DeploymentType);

/** @internal */
export const UserEventPayload231Passport$inboundSchema: z.ZodType<
  UserEventPayload231Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload231DeploymentType$inboundSchema,
});

export function userEventPayload231PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload231Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload231Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload231Passport' from JSON`,
  );
}
...
export const UserEventPayload231Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload231Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload230DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload230DeploymentType
> = z.nativeEnum(UserEventPayload230DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload230DeploymentType$inboundSchema,
});
