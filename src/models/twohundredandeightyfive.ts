...
export type UserEventPayload339User = {
  id: string;
  username: string;
};
...
export type ThreeHundredAndTwentyEight = {
  previous: UserEventPayload328Previous | null;
  next: UserEventPayload328Next | null;
};
...
export const UserEventPayload327Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload327Role = ClosedEnum<
  typeof UserEventPayload327Role
>;

export type PayloadRemovedUsers = {
  role: UserEventPayload327Role;
  confirmed: boolean;
...
export type ThreeHundredAndTwentySix = {
  ...
  next?: UserEventPayload326Next | undefined;
};
...
export type ThreeHundredAndTwentyFive = {
  previous: UserEventPayload325Previous | null;
  next: UserEventPayload325Next | null;
  teamSlug?: string | undefined;
};
...
/** @internal */
export const UserEventPayload339User$inboundSchema: z.ZodType<
  UserEventPayload339User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload339UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload339User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload339User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload339User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload339User$inboundSchema),
...
> = z.object({
  previous: types.nullable(
    z.lazy(() => UserEventPayload328Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload328Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload327Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload327Role
> = z.nativeEnum(UserEventPayload327Role);
...
export const PayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload327Role$inboundSchema,
...
export const ThreeHundredAndTwentySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload326Previous$inboundSchema),
  next: types.optional(UserEventPayload326Next$inboundSchema),
});
...
export const ThreeHundredAndTwentyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload325Previous$inboundSchema),
  next: types.nullable(UserEventPayload325Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
