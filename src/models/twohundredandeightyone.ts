...
export type UserEventPayload347GeolocationNames = {
  en: string;
};

export type PayloadCountry = {
  names: UserEventPayload347GeolocationNames;
};

export type UserEventPayload347GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type PayloadMostSpecificSubdivision = {
  names: UserEventPayload347GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload327Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload327Next = {
  project: UserEventPayload327Project;
};
...
export type UserEventPayload327PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload327Previous = {
  project: UserEventPayload327PreviousProject;
};
...
export type ThreeHundredAndTwentyTwo = {
  ...
  previous: UserEventPayload322Previous;
  projectId?: string | undefined;
  projectName?: string | undefined;
};
...
export type ThreeHundredAndFourteen = {
  next: UserEventPayload314Next | null;
  previous: UserEventPayload314Previous | null;
  projectId: string;
  projectName: string;
};
...
export type PayloadProjectMembership = {
  ...
  role?: UserEventPayload298Role | undefined;
  uid?: string | undefined;
...
export type UserEventPayload295Project = {
  id?: string | undefined;
  name: string;
};
...
export type TwoHundredAndNinetyFive = {
  project: UserEventPayload295Project;
...
/** @internal */
export const UserEventPayload347GeolocationNames$inboundSchema: z.ZodType<
...
export function userEventPayload347GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload347GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload347GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347GeolocationNames' from JSON`,
  );
}
...
export const PayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload347GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload347GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload347GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload347GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload347GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload347GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload347GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload327Project$inboundSchema: z.ZodType<
  UserEventPayload327Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload327ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload327Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload327Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload327Project' from JSON`,
  );
}
...
export const UserEventPayload327Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload327Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload327PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload327PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload327PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload327PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload327PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload327PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload327Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload327PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  previous: z.lazy(() => UserEventPayload322Previous$inboundSchema),
  projectId: types.optional(types.string()),
  projectName: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload316Next$inboundSchema: z.ZodType<
...
export function userEventPayload316NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload316Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload316Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload316Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload316Previous$inboundSchema: z.ZodType<
...
export function userEventPayload316PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload316Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload316Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload316Previous' from JSON`,
  );
}
...
export const ThreeHundredAndFourteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: types.nullable(z.lazy(() => UserEventPayload314Next$inboundSchema)),
  previous: types.nullable(
    z.lazy(() => UserEventPayload314Previous$inboundSchema),
  ),
  projectId: types.string(),
  projectName: types.string(),
});
...
> = z.object({
  ...
  role: types.optional(UserEventPayload298Role$inboundSchema),
  uid: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload295Project$inboundSchema: z.ZodType<
  UserEventPayload295Project,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload295ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload295Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload295Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload295Project' from JSON`,
  );
}
...
export const TwoHundredAndNinetyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload295Project$inboundSchema),
