...
export type UserEventPayload330Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload330Next = {
  project: UserEventPayload330Project;
};
...
export type UserEventPayload330PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload330Previous = {
  project: UserEventPayload330PreviousProject;
};
...
export type UserEventPayload319Next = {
...
export type UserEventPayload319Previous = {
...
export type ThreeHundredAndNineteen = {
  next: UserEventPayload319Next;
  previous: UserEventPayload319Previous;
  projectId: string;
  projectName: string;
};
...
export type ThreeHundredAndSeventeen = {
  next: UserEventPayload317Next | null;
  previous: UserEventPayload317Previous | null;
  projectId: string;
  projectName: string;
};
...
export type PayloadProjectMembership = {
  ...
  role?: UserEventPayload301Role | undefined;
  uid?: string | undefined;
...
/** @internal */
export const UserEventPayload330Project$inboundSchema: z.ZodType<
  UserEventPayload330Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload330ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload330Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload330Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload330Project' from JSON`,
  );
}
...
export const UserEventPayload330Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload330Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload330PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload330PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload330PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload330PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload330PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload330PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload330Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload330PreviousProject$inboundSchema),
});
...
export const ThreeHundredAndThirty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: z.lazy(() => UserEventPayload330Next$inboundSchema),
...
/** @internal */
export const UserEventPayload319Next$inboundSchema: z.ZodType<
  UserEventPayload319Next,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload319NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload319Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload319Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload319Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload319Previous$inboundSchema: z.ZodType<
  UserEventPayload319Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload319PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload319Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload319Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload319Previous' from JSON`,
  );
}
...
export const ThreeHundredAndNineteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: z.lazy(() => UserEventPayload319Next$inboundSchema),
  previous: z.lazy(() => UserEventPayload319Previous$inboundSchema),
  projectId: types.string(),
  projectName: types.string(),
});
...
export const ThreeHundredAndSeventeen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: types.nullable(z.lazy(() => UserEventPayload317Next$inboundSchema)),
...
> = z.object({
  ...
  role: types.optional(UserEventPayload301Role$inboundSchema),
  uid: types.optional(types.string()),
