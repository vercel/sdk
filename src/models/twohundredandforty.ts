...
export type UserEventPayload300PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload300Previous = {
  project: UserEventPayload300PreviousProject;
};
...
export type TwoHundredAndNinetyFive = {
  projectId?: string | undefined;
  projectName?: string | undefined;
  previous: UserEventPayload295Previous;
...
export type TwoHundredAndEightySeven = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload287Previous | null;
  next: UserEventPayload287Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload271Role | undefined;
...
export const UserEventPayload269Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload269Role = ClosedEnum<
  typeof UserEventPayload269Role
>;

export type UserEventPayload269Project = {
  name: string;
  role: UserEventPayload269Role;
...
export type UserEventPayload268Project = {
  name: string;
  id?: string | undefined;
};
...
export type TwoHundredAndSixtyEight = {
  project: UserEventPayload268Project;
...
export type TwoHundredAndFortyNine = {
  projectId: string;
  projectName: string;
  previous?: UserEventPayload249Previous | undefined;
 ...
 * The type of matching to perform
 */
export const UserEventPayload240NextType = {
  EndsWith: "endsWith",
  Equals: "equals",
  StartsWith: "startsWith",
} as const;
 ...
 * The type of matching to perform
 */
export type UserEventPayload240NextType = ClosedEnum<
  typeof UserEventPayload240NextType
>;
...
export type PayloadBranchMatcher = {
   ...
   * The type of matching to perform
   */
  type: UserEventPayload240NextType;
  /**
   * The pattern to match against branch names
   */
  pattern: string;
...
/** @internal */
export const UserEventPayload300PreviousProject$inboundSchema: z.ZodType<
...
export function userEventPayload300PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload300PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload300PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload300PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload300Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload300PreviousProject$inboundSchema),
});
...
> = z.object({
  projectId: types.optional(types.string()),
  projectName: types.optional(types.string()),
  previous: z.lazy(() => UserEventPayload295Previous$inboundSchema),
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload287Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload287Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload271Role$inboundSchema),
...
/** @internal */
export const UserEventPayload269Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload269Role
> = z.nativeEnum(UserEventPayload269Role);
...
> = z.object({
  name: types.string(),
  role: UserEventPayload269Role$inboundSchema,
...
/** @internal */
export const UserEventPayload268Project$inboundSchema: z.ZodType<
  UserEventPayload268Project,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload268ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload268Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload268Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload268Project' from JSON`,
  );
}
...
export const TwoHundredAndSixtyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload268Project$inboundSchema),
...
> = z.object({
  projectId: types.string(),
  role: UserEventPayload266Role$inboundSchema,
...
/** @internal */
export const UserEventPayload240NextType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload240NextType
> = z.nativeEnum(UserEventPayload240NextType);
...
export const PayloadBranchMatcher$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload240NextType$inboundSchema,
  pattern: types.string(),
});
