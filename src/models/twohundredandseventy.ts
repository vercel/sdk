...
import {
  ...
  UserEventPayload333Budget$inboundSchema,
} from "./usereventpayload333budget.js";
...
export type UserEventPayload309Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload309Next = {
  project: UserEventPayload309Project;
};
...
export type UserEventPayload309PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload309Previous = {
  project: UserEventPayload309PreviousProject;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload280Role | undefined;
  uid?: string | undefined;
...
export const ThreeHundredAndThirtyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: UserEventPayload333Budget$inboundSchema,
});
...
/** @internal */
export const UserEventPayload309Project$inboundSchema: z.ZodType<
  UserEventPayload309Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload309ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload309Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload309Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload309Project' from JSON`,
  );
}
...
export const UserEventPayload309Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload309Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload309PreviousProject$inboundSchema: z.ZodType<
...
export function userEventPayload309PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload309PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload309PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload309PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload309Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload309PreviousProject$inboundSchema),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload280Role$inboundSchema),
  uid: types.optional(types.string()),
