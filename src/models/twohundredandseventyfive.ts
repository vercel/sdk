...
export type UserEventPayload344GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type PayloadMostSpecificSubdivision = {
  names: UserEventPayload344GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload324Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload324Next = {
  project: UserEventPayload324Project;
};
...
export type UserEventPayload324PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload324Previous = {
  project: UserEventPayload324PreviousProject;
};
...
export type ThreeHundredAndEleven = {
  next: UserEventPayload311Next | null;
  previous: UserEventPayload311Previous | null;
  projectId: string;
  projectName: string;
};
...
export type PayloadProjectMembership = {
  ...
  role?: UserEventPayload295Role | undefined;
  uid?: string | undefined;
...
export const UserEventPayload294Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload294Role = ClosedEnum<
  typeof UserEventPayload294Role
>;

export type RemovedMembership = {
  createdAt: number;
  role: UserEventPayload294Role;
  uid: string;
  username?: string | undefined;
};
...
export const UserEventPayload293Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload293Role = ClosedEnum<
  typeof UserEventPayload293Role
>;

export type UserEventPayload293Project = {
  id?: string | undefined;
  invitedUserId?: string | undefined;
  invitedUserName: string;
  name: string;
  role: UserEventPayload293Role;
};
...
export type TwoHundredAndNinetyThree = {
  project: UserEventPayload293Project;
};

export type UserEventPayload292Project = {
  id?: string | undefined;
  name: string;
};

export const UserEventPayload292Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload292Role = ClosedEnum<
  typeof UserEventPayload292Role
>;

export type ProjectMembership = {
  createdAt: number;
  role: UserEventPayload292Role;
  uid: string;
  username?: string | undefined;
};
...
export type TwoHundredAndNinetyTwo = {
  project: UserEventPayload292Project;
...
/** @internal */
export const UserEventPayload344GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload344GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload344GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload344GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload344GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload344GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload324Project$inboundSchema: z.ZodType<
  UserEventPayload324Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload324ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload324Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload324Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload324Project' from JSON`,
  );
}
...
export const UserEventPayload324Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload324Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload324PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload324PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload324PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload324PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload324PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload324PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload324Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload324PreviousProject$inboundSchema),
});
...
export const ThreeHundredAndEleven$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: types.nullable(z.lazy(() => UserEventPayload311Next$inboundSchema)),
  previous: types.nullable(
    z.lazy(() => UserEventPayload311Previous$inboundSchema),
  ),
  projectId: types.string(),
  projectName: types.string(),
});
...
> = z.object({
  ...
  role: types.optional(UserEventPayload295Role$inboundSchema),
  uid: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload294Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload294Role
> = z.nativeEnum(UserEventPayload294Role);
...
> = z.object({
  createdAt: types.number(),
  role: UserEventPayload294Role$inboundSchema,
  uid: types.string(),
  username: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload293Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload293Role
> = z.nativeEnum(UserEventPayload293Role);

/** @internal */
export const UserEventPayload293Project$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  name: types.string(),
  role: UserEventPayload293Role$inboundSchema,
});

export function userEventPayload293ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload293Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload293Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload293Project' from JSON`,
  );
}
...
export const TwoHundredAndNinetyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload293Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload292Project$inboundSchema: z.ZodType<
  UserEventPayload292Project,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload292ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload292Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload292Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload292Project' from JSON`,
  );
}

/** @internal */
export const UserEventPayload292Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload292Role
> = z.nativeEnum(UserEventPayload292Role);
...
> = z.object({
  createdAt: types.number(),
  role: UserEventPayload292Role$inboundSchema,
  uid: types.string(),
  username: types.optional(types.string()),
});
...
export const TwoHundredAndNinetyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload292Project$inboundSchema),
