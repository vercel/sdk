...
import {
  ...
  UserEventPayload338Budget$inboundSchema,
} from "./usereventpayload338budget.js";
...
export type UserEventPayload337Previous = {
...
export type ThreeHundredAndThirtySeven = {
  ...
  sampleRatePercent: number | null;
  spendLimitInDollars: number | null;
  previous: UserEventPayload337Previous;
};
...
export type UserEventPayload333Names = {
  en: string;
};

export type PayloadCity = {
  names: UserEventPayload333Names;
};

export type UserEventPayload333GeolocationNames = {
  en: string;
};

export type PayloadCountry = {
  names: UserEventPayload333GeolocationNames;
};

export type UserEventPayload333GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type PayloadMostSpecificSubdivision = {
  names: UserEventPayload333GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload314Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload314Next = {
  project: UserEventPayload314Project;
};
...
export type UserEventPayload314PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload314Previous = {
  project: UserEventPayload314PreviousProject;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload285Role | undefined;
  uid?: string | undefined;
...
export const ThreeHundredAndThirtyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: UserEventPayload338Budget$inboundSchema,
});
...
> = z.object({
  ...
  sampleRatePercent: types.nullable(types.number()),
  spendLimitInDollars: types.nullable(types.number()),
  previous: z.lazy(() => UserEventPayload337Previous$inboundSchema),
});
...
/** @internal */
export const UserEventPayload333Names$inboundSchema: z.ZodType<
  UserEventPayload333Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload333NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload333Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload333Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload333Names' from JSON`,
  );
}
...
export const PayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload333Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload333GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload333GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload333GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload333GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload333GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload333GeolocationNames' from JSON`,
  );
}
...
export const PayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload333GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload333GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
...
export function userEventPayload333GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload333GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload333GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload333GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload314Project$inboundSchema: z.ZodType<
  UserEventPayload314Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload314ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload314Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload314Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload314Project' from JSON`,
  );
}
...
export const UserEventPayload314Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload314Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload314PreviousProject$inboundSchema: z.ZodType<
...
export function userEventPayload314PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload314PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload314PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload314PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload314Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload314PreviousProject$inboundSchema),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload285Role$inboundSchema),
  uid: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload284Project$inboundSchema: z.ZodType<
...
export function userEventPayload284ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload284Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload284Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload284Project' from JSON`,
  );
}
