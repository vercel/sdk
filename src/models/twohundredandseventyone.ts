...
import {
  ...
  UserEventPayload334Budget$inboundSchema,
...
export type UserEventPayload310Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload310Next = {
  project: UserEventPayload310Project;
};
...
export type UserEventPayload310PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload310Previous = {
  project: UserEventPayload310PreviousProject;
};
...
export type TwoHundredAndNinetySeven = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload297Previous | null;
  next: UserEventPayload297Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload281Role | undefined;
  uid?: string | undefined;
...
export const ThreeHundredAndThirtyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: UserEventPayload334Budget$inboundSchema,
});
...
/** @internal */
export const UserEventPayload310Project$inboundSchema: z.ZodType<
...
export function userEventPayload310ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload310Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload310Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload310Project' from JSON`,
  );
}
...
export const UserEventPayload310Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload310Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload310PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload310PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload310PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload310PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload310PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload310PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload310Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload310PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload297Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload297Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload281Role$inboundSchema),
  uid: types.optional(types.string()),
...
export const ProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload278Role$inboundSchema,
  uid: types.string(),
  createdAt: types.number(),
  username: types.optional(types.string()),
});
