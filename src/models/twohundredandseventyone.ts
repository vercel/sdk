...
export type UserEventPayload321Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload321Next = {
  project: UserEventPayload321Project;
};
...
export type UserEventPayload321PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload321Previous = {
  project: UserEventPayload321PreviousProject;
};
...
export type ThreeHundredAndEighteen = {
  next: UserEventPayload318Next;
  previous: UserEventPayload318Previous;
  projectId: string;
  projectName: string;
};
...
export type PayloadProjectMembership = {
  ...
  role?: UserEventPayload292Role | undefined;
  uid?: string | undefined;
...
export type UserEventPayload291Project = {
  id?: string | undefined;
  name: string;
};

export const UserEventPayload291Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload291Role = ClosedEnum<
  typeof UserEventPayload291Role
>;

export type RemovedMembership = {
  createdAt: number;
  role: UserEventPayload291Role;
  uid: string;
  username?: string | undefined;
};
...
export type TwoHundredAndNinetyOne = {
  project: UserEventPayload291Project;
  removedMembership: RemovedMembership;
};

export const UserEventPayload290Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload290Role = ClosedEnum<
  typeof UserEventPayload290Role
>;
...
export const UserEventPayload289Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload289Role = ClosedEnum<
  typeof UserEventPayload289Role
>;

export type ProjectMembership = {
  createdAt: number;
  role: UserEventPayload289Role;
  uid: string;
  username?: string | undefined;
};
...
/** @internal */
export const UserEventPayload321Project$inboundSchema: z.ZodType<
...
export function userEventPayload321ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload321Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload321Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload321Project' from JSON`,
  );
}
...
export const UserEventPayload321Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload321Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload321PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload321PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload321PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload321PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload321PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload321PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload321Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload321PreviousProject$inboundSchema),
});
...
export const ThreeHundredAndEighteen$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  next: z.lazy(() => UserEventPayload318Next$inboundSchema),
  previous: z.lazy(() => UserEventPayload318Previous$inboundSchema),
  projectId: types.string(),
  projectName: types.string(),
});
...
> = z.object({
  ...
  role: types.optional(UserEventPayload292Role$inboundSchema),
  uid: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload291Project$inboundSchema: z.ZodType<
...
export function userEventPayload291ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload291Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload291Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload291Project' from JSON`,
  );
}

/** @internal */
export const UserEventPayload291Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload291Role
> = z.nativeEnum(UserEventPayload291Role);
...
> = z.object({
  createdAt: types.number(),
  role: UserEventPayload291Role$inboundSchema,
  uid: types.string(),
  username: types.optional(types.string()),
});
...
export const TwoHundredAndNinetyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload291Project$inboundSchema),
...
/** @internal */
export const UserEventPayload290Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload290Role
> = z.nativeEnum(UserEventPayload290Role);
...
> = z.object({
  ...
  name: types.string(),
  role: UserEventPayload290Role$inboundSchema,
});
...
/** @internal */
export const UserEventPayload289Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload289Role
> = z.nativeEnum(UserEventPayload289Role);
...
> = z.object({
  createdAt: types.number(),
  role: UserEventPayload289Role$inboundSchema,
  uid: types.string(),
  username: types.optional(types.string()),
});
