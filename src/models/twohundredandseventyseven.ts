...
import {
  ...
  UserEventPayload340Budget$inboundSchema,
...
/** @internal */
export const UserEventPayload335Names$inboundSchema: z.ZodType<
  UserEventPayload335Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload335NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload335Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload335Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload335Names' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload335GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload335GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload335GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload335GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload335GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload335GeolocationNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload335GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload335GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload335GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload335GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload335GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload335GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload316Project$inboundSchema: z.ZodType<
  UserEventPayload316Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload316ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload316Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload316Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload316Project' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload316PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload316PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload316PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload316PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload316PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload316PreviousProject' from JSON`,
  );
}
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload303Previous$inboundSchema),
  ),
