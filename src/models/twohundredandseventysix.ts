...
import {
  ...
  UserEventPayload339Budget$inboundSchema,
} from "./usereventpayload339budget.js";
...
export type ThreeHundredAndThirtyEight = {
  ...
  sampleRatePercent: number | null;
  spendLimitInDollars: number | null;
  previous: UserEventPayload338Previous;
};
...
export type UserEventPayload334Names = {
  en: string;
};

export type PayloadCity = {
  names: UserEventPayload334Names;
};

export type UserEventPayload334GeolocationNames = {
  en: string;
};

export type PayloadCountry = {
  names: UserEventPayload334GeolocationNames;
};

export type UserEventPayload334GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type PayloadMostSpecificSubdivision = {
  names: UserEventPayload334GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload315Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload315Next = {
  project: UserEventPayload315Project;
};
...
export type UserEventPayload315PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload315Previous = {
  project: UserEventPayload315PreviousProject;
};
...
export type ThreeHundredAndTwo = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload302Previous | null;
  next: UserEventPayload302Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload286Role | undefined;
  uid?: string | undefined;
...
export const ThreeHundredAndThirtyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: UserEventPayload339Budget$inboundSchema,
});
...
> = z.object({
  ...
  sampleRatePercent: types.nullable(types.number()),
  spendLimitInDollars: types.nullable(types.number()),
  previous: z.lazy(() => UserEventPayload338Previous$inboundSchema),
});
...
/** @internal */
export const UserEventPayload334Names$inboundSchema: z.ZodType<
  UserEventPayload334Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload334NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload334Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload334Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload334Names' from JSON`,
  );
}
...
export const PayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload334Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload334GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload334GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload334GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload334GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload334GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload334GeolocationNames' from JSON`,
  );
}
...
export const PayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload334GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload334GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload334GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload334GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload334GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload334GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload334GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload315Project$inboundSchema: z.ZodType<
...
export function userEventPayload315ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload315Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload315Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload315Project' from JSON`,
  );
}
...
export const UserEventPayload315Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload315Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload315PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload315PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload315PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload315PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload315PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload315PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload315Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload315PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  next: types.nullable(z.lazy(() => UserEventPayload302Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload286Role$inboundSchema),
  uid: types.optional(types.string()),
