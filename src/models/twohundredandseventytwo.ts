...
import {
  ...
  UserEventPayload335Budget$inboundSchema,
} from "./usereventpayload335budget.js";
...
export type UserEventPayload334Previous = {
...
export type ThreeHundredAndThirtyFour = {
  ...
  sampleRatePercent: number | null;
  spendLimitInDollars: number | null;
  previous: UserEventPayload334Previous;
};
...
export type UserEventPayload311Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload311Next = {
  project: UserEventPayload311Project;
};
...
export type UserEventPayload311PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload311Previous = {
  project: UserEventPayload311PreviousProject;
};
...
export type TwoHundredAndNinetyEight = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload298Previous | null;
  next: UserEventPayload298Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload282Role | undefined;
  uid?: string | undefined;
...
export type UserEventPayload279Project = {
  name: string;
  id?: string | undefined;
};

export const UserEventPayload279Role = {
  Admin: "ADMIN",
  ProjectDeveloper: "PROJECT_DEVELOPER",
  ProjectGuest: "PROJECT_GUEST",
  ProjectViewer: "PROJECT_VIEWER",
} as const;
export type UserEventPayload279Role = ClosedEnum<
  typeof UserEventPayload279Role
>;

export type ProjectMembership = {
  role: UserEventPayload279Role;
  uid: string;
  createdAt: number;
  username?: string | undefined;
};
...
export type TwoHundredAndSeventyNine = {
  project: UserEventPayload279Project;
...
export const ThreeHundredAndThirtyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: UserEventPayload335Budget$inboundSchema,
});
...
> = z.object({
  ...
  sampleRatePercent: types.nullable(types.number()),
  spendLimitInDollars: types.nullable(types.number()),
  previous: z.lazy(() => UserEventPayload334Previous$inboundSchema),
});
...
/** @internal */
export const UserEventPayload311Project$inboundSchema: z.ZodType<
  UserEventPayload311Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload311ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload311Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload311Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload311Project' from JSON`,
  );
}
...
export const UserEventPayload311Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload311Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload311PreviousProject$inboundSchema: z.ZodType<
...
export function userEventPayload311PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload311PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload311PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload311PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload311Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload311PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  previous: types.nullable(
    z.lazy(() => UserEventPayload298Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload298Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload282Role$inboundSchema),
  uid: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload279Project$inboundSchema: z.ZodType<
...
export function userEventPayload279ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload279Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload279Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload279Project' from JSON`,
  );
}

/** @internal */
export const UserEventPayload279Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload279Role
> = z.nativeEnum(UserEventPayload279Role);
...
export const ProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload279Role$inboundSchema,
  uid: types.string(),
  createdAt: types.number(),
  username: types.optional(types.string()),
});
...
export const TwoHundredAndSeventyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload279Project$inboundSchema),
