...
import {
  ...
  UserEventPayload327GeolocationNames$inboundSchema,
...
export type UserEventPayload308Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload308Next = {
  project: UserEventPayload308Project;
};
...
export type UserEventPayload308PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload308Previous = {
  project: UserEventPayload308PreviousProject;
};
...
export type TwoHundredAndNinetyFive = {
  projectId: string;
  projectName: string;
  previous: UserEventPayload295Previous | null;
  next: UserEventPayload295Next | null;
};
...
export type PayloadProjectMembership = {
  role?: UserEventPayload279Role | undefined;
  uid?: string | undefined;
...
export const PayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: UserEventPayload327GeolocationNames$inboundSchema,
});
...
/** @internal */
export const UserEventPayload308Project$inboundSchema: z.ZodType<
...
export function userEventPayload308ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload308Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload308Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload308Project' from JSON`,
  );
}
...
export const UserEventPayload308Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload308Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload308PreviousProject$inboundSchema: z.ZodType<
...
export function userEventPayload308PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload308PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload308PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload308PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload308Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload308PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  next: types.nullable(z.lazy(() => UserEventPayload295Next$inboundSchema)),
});
...
export const PayloadProjectMembership$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: types.optional(UserEventPayload279Role$inboundSchema),
  uid: types.optional(types.string()),
