...
export type UserEventPayload290Team = {
  id: string;
  name: string;
};

export type UserEventPayload290Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type TwoHundredAndNinety = {
  team: UserEventPayload290Team;
  configuration: UserEventPayload290Configuration;
  peering: Peering;
};
...
/** @internal */
export const UserEventPayload290Team$inboundSchema: z.ZodType<
  UserEventPayload290Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
/** @internal */
export type UserEventPayload290Team$Outbound = {
  id: string;
  name: string;
};

/** @internal */
export const UserEventPayload290Team$outboundSchema: z.ZodType<
  UserEventPayload290Team$Outbound,
  z.ZodTypeDef,
  UserEventPayload290Team
> = z.object({
  id: z.string(),
...
export function userEventPayload290TeamToJSON(
  userEventPayload290Team: UserEventPayload290Team,
): string {
  return JSON.stringify(
    UserEventPayload290Team$outboundSchema.parse(userEventPayload290Team),
  );
}
export function userEventPayload290TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload290Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload290Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload290Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload290Configuration$inboundSchema: z.ZodType<
  UserEventPayload290Configuration,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
/** @internal */
export type UserEventPayload290Configuration$Outbound = {
  id: string;
  name?: string | undefined;
};

/** @internal */
export const UserEventPayload290Configuration$outboundSchema: z.ZodType<
  UserEventPayload290Configuration$Outbound,
  z.ZodTypeDef,
  UserEventPayload290Configuration
> = z.object({
  id: z.string(),
...
export function userEventPayload290ConfigurationToJSON(
  userEventPayload290Configuration: UserEventPayload290Configuration,
): string {
  return JSON.stringify(
    UserEventPayload290Configuration$outboundSchema.parse(
      userEventPayload290Configuration,
    ),
  );
}
export function userEventPayload290ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload290Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload290Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload290Configuration' from JSON`,
  );
}
...
export const TwoHundredAndNinety$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload290Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload290Configuration$inboundSchema),
  peering: z.lazy(() => Peering$inboundSchema),
});
/** @internal */
export type TwoHundredAndNinety$Outbound = {
  team: UserEventPayload290Team$Outbound;
  configuration: UserEventPayload290Configuration$Outbound;
...
export const TwoHundredAndNinety$outboundSchema: z.ZodType<
  ...
  TwoHundredAndNinety
> = z.object({
  team: z.lazy(() => UserEventPayload290Team$outboundSchema),
  configuration: z.lazy(() => UserEventPayload290Configuration$outboundSchema),
