...
export const UpdateProjectDirection = {
  Upgrade: "upgrade",
  Downgrade: "downgrade",
} as const;
export type UpdateProjectDirection = ClosedEnum<typeof UpdateProjectDirection>;

export type UpdateProjectBuildMachineElasticTransition = {
  at: number;
  direction: UpdateProjectDirection;
...
export type UpdateProjectResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | UpdateProjectBuildMachineElasticTransition
    | undefined;
 ...
 */
export type UpdateProjectRegisteredShaBlock = {
  createdAt: string;
  createdBy: string;
  sha: string;
};
 ...
 * Since September 2026. Set on the live `abuse.block` only, by the consumer that auto-registers this project's production git SHA in the lineage blocklist, so unblocking can disable the row this block created. Absent means this block registered nothing, which includes the case where registration was skipped because the SHA already belonged to an earlier block. Unblock must therefore clear only what is named here, never the project's current SHA, or it would disable another block's row.
 */
export type UpdateProjectBlockHistoryRegisteredShaBlock = {
  createdAt: string;
  createdBy: string;
  sha: string;
};
...
/** @internal */
export const UpdateProjectDirection$outboundSchema: z.ZodNativeEnum<
  typeof UpdateProjectDirection
> = z.nativeEnum(UpdateProjectDirection);

/** @internal */
export type UpdateProjectBuildMachineElasticTransition$Outbound = {
  at: number;
  direction: string;
  algorithmVersion: string;
};
...
/** @internal */
export const UpdateProjectBuildMachineElasticTransition$outboundSchema:
  z.ZodType<
    UpdateProjectBuildMachineElasticTransition$Outbound,
    z.ZodTypeDef,
    UpdateProjectBuildMachineElasticTransition
  > = z.object({
    at: z.number(),
    direction: UpdateProjectDirection$outboundSchema,
    algorithmVersion: z.string(),
  });

export function updateProjectBuildMachineElasticTransitionToJSON(
  updateProjectBuildMachineElasticTransition:
    UpdateProjectBuildMachineElasticTransition,
): string {
  return JSON.stringify(
    UpdateProjectBuildMachineElasticTransition$outboundSchema.parse(
      updateProjectBuildMachineElasticTransition,
    ),
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: z.lazy(() =>
    UpdateProjectBuildMachineElasticTransition$outboundSchema
  ).optional(),
...
/** @internal */
export const UpdateProjectRegisteredShaBlock$inboundSchema: z.ZodType<
...
export function updateProjectRegisteredShaBlockFromJSON(
  jsonString: string,
): SafeParseResult<UpdateProjectRegisteredShaBlock, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UpdateProjectRegisteredShaBlock$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdateProjectRegisteredShaBlock' from JSON`,
  );
}
...
/** @internal */
export const UpdateProjectBlockHistoryRegisteredShaBlock$inboundSchema:
  z.ZodType<
...
export function updateProjectBlockHistoryRegisteredShaBlockFromJSON(
  jsonString: string,
): SafeParseResult<
  UpdateProjectBlockHistoryRegisteredShaBlock,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UpdateProjectBlockHistoryRegisteredShaBlock$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UpdateProjectBlockHistoryRegisteredShaBlock' from JSON`,
  );
}
