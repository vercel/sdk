...
/** @internal */
export type UpdateProjectProjectsPassport$Outbound = {
  deploymentType: string;
  connectorId: string;
};

/** @internal */
export const UpdateProjectProjectsPassport$outboundSchema: z.ZodType<
...
export function updateProjectProjectsPassportToJSON(
  updateProjectProjectsPassport: UpdateProjectProjectsPassport,
): string {
  return JSON.stringify(
    UpdateProjectProjectsPassport$outboundSchema.parse(
      updateProjectProjectsPassport,
    ),
  );
}
