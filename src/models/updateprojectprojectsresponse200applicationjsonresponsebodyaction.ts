 ...
 */
export type TrustedOidcProviders = {
  projects?: Array<UpdateProjectProjects> | undefined;
...
export type UpdateProjectRequestBody = {
   ...
   * Trusted OIDC Providers
   */
  trustedOidcProviders?: TrustedOidcProviders | null | undefined;
  /**
   * Specify a list of paths that should not be protected by Deployment Protection to enable Cors preflight requests
   */
...
export type UpdateProjectProviders = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

export type UpdateProjectTrustedOidcProviders = {
  projects: { [k: string]: UpdateProjectProjectsProjects };
  providers: { [k: string]: UpdateProjectProviders };
};
...
> = z.object({
  issuer: z.string(),
  label: z.string().optional(),
  claims: z.array(z.lazy(() => Claims$outboundSchema)),
});
...
/** @internal */
export const TrustedOidcProviders$inboundSchema: z.ZodType<
  TrustedOidcProviders,
  z.ZodTypeDef,
  unknown
> = z.object({
  projects: types.optional(
    z.array(z.lazy(() => UpdateProjectProjects$inboundSchema)),
  ),
  providers: types.optional(z.array(z.lazy(() => Providers$inboundSchema))),
});
/** @internal */
export type TrustedOidcProviders$Outbound = {
  projects?: Array<UpdateProjectProjects$Outbound> | undefined;
  providers?: Array<Providers$Outbound> | undefined;
};

/** @internal */
export const TrustedOidcProviders$outboundSchema: z.ZodType<
  TrustedOidcProviders$Outbound,
  z.ZodTypeDef,
  TrustedOidcProviders
> = z.object({
  projects: z.array(z.lazy(() => UpdateProjectProjects$outboundSchema))
    .optional(),
  providers: z.array(z.lazy(() => Providers$outboundSchema)).optional(),
});

export function trustedOidcProvidersToJSON(
  trustedOidcProviders: TrustedOidcProviders,
): string {
  return JSON.stringify(
    TrustedOidcProviders$outboundSchema.parse(trustedOidcProviders),
  );
}
export function trustedOidcProvidersFromJSON(
  jsonString: string,
): SafeParseResult<TrustedOidcProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TrustedOidcProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TrustedOidcProviders' from JSON`,
  );
}
...
> = z.object({
  ...
  trustedOidcProviders: z.nullable(
    z.lazy(() => TrustedOidcProviders$inboundSchema),
  ).optional(),
...
export type UpdateProjectRequestBody$Outbound = {
  ...
  trustedOidcProviders?: TrustedOidcProviders$Outbound | null | undefined;
...
> = z.object({
  ...
  trustedIps: z.nullable(z.lazy(() => UpdateProjectTrustedIps$outboundSchema))
    .optional(),
  trustedOidcProviders: z.nullable(
    z.lazy(() => TrustedOidcProviders$outboundSchema),
  ).optional(),
  optionsAllowlist: z.nullable(
...
/** @internal */
export const UpdateProjectProviders$inboundSchema: z.ZodType<
...
/** @internal */
export type UpdateProjectProviders$Outbound = {
  label?: string | undefined;
  claims: { [k: string]: Array<string> };
};

/** @internal */
export const UpdateProjectProviders$outboundSchema: z.ZodType<
  UpdateProjectProviders$Outbound,
  z.ZodTypeDef,
  UpdateProjectProviders
> = z.object({
  label: z.string().optional(),
...
export function updateProjectProvidersToJSON(
  updateProjectProviders: UpdateProjectProviders,
): string {
  return JSON.stringify(
    UpdateProjectProviders$outboundSchema.parse(updateProjectProviders),
  );
}
export function updateProjectProvidersFromJSON(
  jsonString: string,
): SafeParseResult<UpdateProjectProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UpdateProjectProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdateProjectProviders' from JSON`,
  );
}

/** @internal */
export const UpdateProjectTrustedOidcProviders$inboundSchema: z.ZodType<
  UpdateProjectTrustedOidcProviders,
  z.ZodTypeDef,
  unknown
> = z.object({
  projects: z.record(z.lazy(() => UpdateProjectProjectsProjects$inboundSchema)),
  providers: z.record(z.lazy(() => UpdateProjectProviders$inboundSchema)),
});
/** @internal */
export type UpdateProjectTrustedOidcProviders$Outbound = {
  projects: { [k: string]: UpdateProjectProjectsProjects$Outbound };
  providers: { [k: string]: UpdateProjectProviders$Outbound };
};

/** @internal */
export const UpdateProjectTrustedOidcProviders$outboundSchema: z.ZodType<
  UpdateProjectTrustedOidcProviders$Outbound,
  z.ZodTypeDef,
  UpdateProjectTrustedOidcProviders
> = z.object({
  projects: z.record(
    z.lazy(() => UpdateProjectProjectsProjects$outboundSchema),
  ),
  providers: z.record(z.lazy(() => UpdateProjectProviders$outboundSchema)),
});

export function updateProjectTrustedOidcProvidersToJSON(
  updateProjectTrustedOidcProviders: UpdateProjectTrustedOidcProviders,
): string {
  return JSON.stringify(
    UpdateProjectTrustedOidcProviders$outboundSchema.parse(
      updateProjectTrustedOidcProviders,
    ),
  );
}
export function updateProjectTrustedOidcProvidersFromJSON(
  jsonString: string,
): SafeParseResult<UpdateProjectTrustedOidcProviders, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UpdateProjectTrustedOidcProviders$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdateProjectTrustedOidcProviders' from JSON`,
  );
}
