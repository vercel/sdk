...
import {
  ...
  UpdateProjectCreator2$inboundSchema,
  UpdateProjectCreator3,
  UpdateProjectCreator3$inboundSchema,
  UpdateProjectCreator4,
  UpdateProjectCreator4$inboundSchema,
  UpdateProjectCreatorUser,
  UpdateProjectCreatorUser$inboundSchema,
  UpdateProjectCreatorVia,
  UpdateProjectCreatorVia$inboundSchema,
} from "./updateprojectcreatoruser.js";

export type UpdateProjectCreator1 = {
  type: "user";
  via: UpdateProjectCreatorVia | null;
...
export const UpdateProjectProjectsDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type UpdateProjectProjectsDirection = ClosedEnum<
  typeof UpdateProjectProjectsDirection
>;

export type UpdateProjectProjectsBuildMachineElasticTransition = {
  algorithmVersion: string;
  at: number;
  direction: UpdateProjectProjectsDirection;
};
...
export type UpdateProjectDefaultResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | UpdateProjectProjectsBuildMachineElasticTransition
    | undefined;
...
export const UpdateProjectProjectsResponseDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type UpdateProjectProjectsResponseDirection = ClosedEnum<
  typeof UpdateProjectProjectsResponseDirection
>;
...
> = z.object({
  ...
  via: types.nullable(UpdateProjectCreatorVia$inboundSchema),
  user: UpdateProjectCreatorUser$inboundSchema,
});
...
/** @internal */
export const UpdateProjectProjectsDirection$inboundSchema: z.ZodNativeEnum<
  typeof UpdateProjectProjectsDirection
> = z.nativeEnum(UpdateProjectProjectsDirection);

/** @internal */
export const UpdateProjectProjectsBuildMachineElasticTransition$inboundSchema:
  z.ZodType<
    UpdateProjectProjectsBuildMachineElasticTransition,
    z.ZodTypeDef,
    unknown
  > = z.object({
    ...
    at: types.number(),
    direction: UpdateProjectProjectsDirection$inboundSchema,
  });

export function updateProjectProjectsBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  UpdateProjectProjectsBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UpdateProjectProjectsBuildMachineElasticTransition$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UpdateProjectProjectsBuildMachineElasticTransition' from JSON`,
  );
}
...
> = z.object({
  ...
  buildMachineElasticTransition: types.optional(
    z.lazy(() =>
      UpdateProjectProjectsBuildMachineElasticTransition$inboundSchema
    ),
  ),
...
/** @internal */
export const UpdateProjectProjectsResponseDirection$inboundSchema:
  z.ZodNativeEnum<typeof UpdateProjectProjectsResponseDirection> = z.nativeEnum(
