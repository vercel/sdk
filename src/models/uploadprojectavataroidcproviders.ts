...
export const UploadProjectAvatarProjectsDirection = {
  Downgrade: "downgrade",
  Upgrade: "upgrade",
} as const;
export type UploadProjectAvatarProjectsDirection = ClosedEnum<
  typeof UploadProjectAvatarProjectsDirection
>;

export type UploadProjectAvatarProjectsBuildMachineElasticTransition = {
  algorithmVersion: string;
  at: number;
  direction: UploadProjectAvatarProjectsDirection;
};
...
export type UploadProjectAvatarResourceConfig = {
  ...
  buildMachineElasticTransition?:
    | UploadProjectAvatarProjectsBuildMachineElasticTransition
    | undefined;
...
/** @internal */
export const UploadProjectAvatarProjectsDirection$inboundSchema:
  z.ZodNativeEnum<typeof UploadProjectAvatarProjectsDirection> = z.nativeEnum(
    UploadProjectAvatarProjectsDirection,
  );

/** @internal */
export const UploadProjectAvatarProjectsBuildMachineElasticTransition$inboundSchema:
  z.ZodType<
    UploadProjectAvatarProjectsBuildMachineElasticTransition,
    z.ZodTypeDef,
    unknown
  > = z.object({
    ...
    at: types.number(),
    direction: UploadProjectAvatarProjectsDirection$inboundSchema,
  });

export function uploadProjectAvatarProjectsBuildMachineElasticTransitionFromJSON(
  jsonString: string,
): SafeParseResult<
  UploadProjectAvatarProjectsBuildMachineElasticTransition,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UploadProjectAvatarProjectsBuildMachineElasticTransition$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UploadProjectAvatarProjectsBuildMachineElasticTransition' from JSON`,
  );
}
