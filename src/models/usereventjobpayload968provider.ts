...
export const UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
    typeof UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  >;
...
export type UserEventJobPayload969DeployHook = {
  createdAt: number;
  id: string;
  name: string;
  ref: string;
 ...
 */
export const UserEventJobPayload969GitHashtagVercel = {
 ...
 * Since February 2022 All the hashtag-vercel tags found in the commit message triggering the deploy. For example, #VERCEL_DO_SOMETHING
 */
export type UserEventJobPayload969GitHashtagVercel = ClosedEnum<
  typeof UserEventJobPayload969GitHashtagVercel
>;

/**
 * Since June 2023 Determines if comments should be posted to the git host. Replaces `github.silent` in the vercel.json.
 */
export type UserEventJobPayload969GitComments = {
 ...
 */
export const UserEventJobPayload969CommitVerification = {
  Unknown: "unknown",
 ...
 * Since 6 Nov 2025 The verification status of the commit. - 'verified' if the commit is verified - 'unverified' if the commit is not verified - 'unknown' if the commit verification status is unknown or not supported
 */
export type UserEventJobPayload969CommitVerification = ClosedEnum<
  typeof UserEventJobPayload969CommitVerification
>;

export const UserEventJobPayload969Action = {
  AutoApprovedMember: "auto-approved-member",
  AutoApprovedPendingInvite: "auto-approved-pending-invite",
} as const;
export type UserEventJobPayload969Action = ClosedEnum<
  typeof UserEventJobPayload969Action
>;
 ...
 */
export type UserEventJobPayload969NsnbSideEffect = {
  action: UserEventJobPayload969Action;
  gitUserLogin: string;
};
 ...
 * Cursor Origin
 */
export type UserEventJobPayload969HeadInfo = {
  /**
...
export const UserEventJobPayload969Provider = {
  CursorOrigin: "cursor-origin",
} as const;
export type UserEventJobPayload969Provider = ClosedEnum<
  typeof UserEventJobPayload969Provider
>;
...
export type Job9 = {
  ...
  deployHook?: UserEventJobPayload969DeployHook | undefined;
   ...
   * Since February 2022 All the hashtag-vercel tags found in the commit message triggering the deploy. For example, #VERCEL_DO_SOMETHING
   */
  gitHashtagVercel?: Array<UserEventJobPayload969GitHashtagVercel> | undefined;
  /**
   ...
   * Since June 2023 Determines if comments should be posted to the git host. Replaces `github.silent` in the vercel.json.
   */
  gitComments?: UserEventJobPayload969GitComments | undefined;
  /**
   ...
   * Since 6 Nov 2025 The verification status of the commit. - 'verified' if the commit is verified - 'unverified' if the commit is not verified - 'unknown' if the commit verification status is unknown or not supported
   */
  commitVerification?: UserEventJobPayload969CommitVerification | undefined;
  /**
   * Since March 2026 Records a successful NSNB auto-add result so later GitHub PR comments can deterministically explain why this SHA was allowed to deploy.
   */
  nsnbSideEffect?: UserEventJobPayload969NsnbSideEffect | undefined;
  /**
   * Cursor Origin
   */
  headInfo: UserEventJobPayload969HeadInfo;
  /**
  ...
  repo: string;
  repoId: string;
  provider: UserEventJobPayload969Provider;
...
/** @internal */
export const UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload155NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventJobPayload969DeployHook$inboundSchema: z.ZodType<
  UserEventJobPayload969DeployHook,
  z.ZodTypeDef,
  unknown
> = z.object({
  createdAt: types.number(),
...
export function userEventJobPayload969DeployHookFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload969DeployHook, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventJobPayload969DeployHook$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload969DeployHook' from JSON`,
  );
}

/** @internal */
export const UserEventJobPayload969GitHashtagVercel$inboundSchema:
  z.ZodNativeEnum<typeof UserEventJobPayload969GitHashtagVercel> = z.nativeEnum(
    UserEventJobPayload969GitHashtagVercel,
  );

/** @internal */
export const UserEventJobPayload969GitComments$inboundSchema: z.ZodType<
...
export function userEventJobPayload969GitCommentsFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload969GitComments, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventJobPayload969GitComments$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload969GitComments' from JSON`,
  );
}

/** @internal */
export const UserEventJobPayload969CommitVerification$inboundSchema:
  z.ZodNativeEnum<typeof UserEventJobPayload969CommitVerification> = z
    .nativeEnum(UserEventJobPayload969CommitVerification);

/** @internal */
export const UserEventJobPayload969Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventJobPayload969Action
> = z.nativeEnum(UserEventJobPayload969Action);

/** @internal */
export const UserEventJobPayload969NsnbSideEffect$inboundSchema: z.ZodType<
  UserEventJobPayload969NsnbSideEffect,
  z.ZodTypeDef,
  unknown
> = z.object({
  action: UserEventJobPayload969Action$inboundSchema,
  gitUserLogin: types.string(),
});

export function userEventJobPayload969NsnbSideEffectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload969NsnbSideEffect, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventJobPayload969NsnbSideEffect$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload969NsnbSideEffect' from JSON`,
  );
}

/** @internal */
export const UserEventJobPayload969HeadInfo$inboundSchema: z.ZodType<
...
export function userEventJobPayload969HeadInfoFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload969HeadInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventJobPayload969HeadInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload969HeadInfo' from JSON`,
  );
}

/** @internal */
export const UserEventJobPayload969Provider$inboundSchema: z.ZodNativeEnum<
  typeof UserEventJobPayload969Provider
> = z.nativeEnum(UserEventJobPayload969Provider);
...
export const Job9$inboundSchema: z.ZodType<Job9, z.ZodTypeDef, unknown> = z
  .object({
    ...
    deployHook: types.optional(
      z.lazy(() => UserEventJobPayload969DeployHook$inboundSchema),
    ),
    ...
    gitHashtagVercel: types.optional(
      z.array(UserEventJobPayload969GitHashtagVercel$inboundSchema),
    ),
    connectedProjectCount: types.optional(types.number()),
    prIdOrZero: types.optional(types.number()),
    gitComments: types.optional(
      z.lazy(() => UserEventJobPayload969GitComments$inboundSchema),
    ),
    isManualGitDeploy: types.optional(types.boolean()),
    commitVerification: types.optional(
      UserEventJobPayload969CommitVerification$inboundSchema,
    ),
    nsnbSideEffect: types.optional(
      z.lazy(() => UserEventJobPayload969NsnbSideEffect$inboundSchema),
    ),
    headInfo: z.lazy(() => UserEventJobPayload969HeadInfo$inboundSchema),
    installationId: types.string(),
    owner: types.string(),
    repo: types.string(),
    repoId: types.string(),
    provider: UserEventJobPayload969Provider$inboundSchema,
