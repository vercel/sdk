 ...
 * Cursor Origin
 */
export type UserEventJobPayload9810HeadInfo = {
  /**
...
/** @internal */
export const UserEventJobPayload9810HeadInfo$inboundSchema: z.ZodType<
...
export function userEventJobPayload9810HeadInfoFromJSON(
  jsonString: string,
): SafeParseResult<UserEventJobPayload9810HeadInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventJobPayload9810HeadInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventJobPayload9810HeadInfo' from JSON`,
  );
}
