...
export const UserEventPayload146Origin = {
...
export type UserEventPayload146Origin = ClosedEnum<
  typeof UserEventPayload146Origin
>;

export type UserEventPayloadGitUserId = string | number;

export type UserEventPayloadJoinedFrom = {
  origin: UserEventPayload146Origin;
...
export const UserEventPayload146BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload146BlockReason = ClosedEnum<
  typeof UserEventPayload146BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload146BlockReason;
};

export const UserEventPayload146NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload146NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload146NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload146NewOwnerBlockReason;
};

export const UserEventPayload146NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload146NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload146NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload146NewOwnerFeatureBlocksBlockReason;
};
...
export const UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason =
  ClosedEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  >;
...
export const UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason =
  ClosedEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  >;
...
export type WorkflowStorageWrite = {
  ...
  blockedUntil?: number | undefined;
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason;
};

export const UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason =
  ClosedEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason
  >;
...
export const UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  {
    AdminOverride: "admin_override",
    HardBlocked: "hard_blocked",
    LimitsExceeded: "limits_exceeded",
  } as const;
export type UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason =
  ClosedEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  >;
 ...
 */
export const UserEventPayload146NewOwnerAction = {
  Disabled: "disabled",
  Enabled: "enabled",
} as const;
/**
 * The action that occurred
 */
export type UserEventPayload146NewOwnerAction = ClosedEnum<
  typeof UserEventPayload146NewOwnerAction
>;
...
export type PayloadHistory = {
   ...
   * The action that occurred
   */
  action: UserEventPayload146NewOwnerAction;
  /**
...
export type OneHundredAndFortyTwo = {
  ...
  rulesetName: string;
  active: boolean;
  action?: UserEventPayload142Action | undefined;
};
...
export type RuleGroups = {
  active: boolean;
  action?: UserEventPayload141Action | undefined;
};
 ...
 */
export const UserEventPayload135Target = {
 ...
 * environments this env variable targets
 */
export type UserEventPayload135Target = ClosedEnum<
  typeof UserEventPayload135Target
>;
...
export type OldEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload135Type | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload135Target> | undefined;
  /**
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export const UserEventPayload135NewEnvVarType = {
  Encrypted: "encrypted",
  Plain: "plain",
  Sensitive: "sensitive",
  System: "system",
 ...
 * The type of this cosmos doc instance, if blank, assume secret.
 */
export type UserEventPayload135NewEnvVarType = ClosedEnum<
  typeof UserEventPayload135NewEnvVarType
>;

/**
 * environments this env variable targets
 */
export const UserEventPayload135NewEnvVarTarget = {
  Development: "development",
  Preview: "preview",
  Production: "production",
} as const;
 ...
 * environments this env variable targets
 */
export type UserEventPayload135NewEnvVarTarget = ClosedEnum<
  typeof UserEventPayload135NewEnvVarTarget
>;
...
export type NewEnvVar = {
   ...
   * The type of this cosmos doc instance, if blank, assume secret.
   */
  type?: UserEventPayload135NewEnvVarType | undefined;
  /**
   * environments this env variable targets
   */
  target?: Array<UserEventPayload135NewEnvVarTarget> | undefined;
  /**
   * whether or not this env varible applies to custom environments
   */
  applyToAllCustomEnvironments?: boolean | undefined;
...
export type UserEventPayload130Team = {
  id: string;
  name?: string | undefined;
};
...
export const UserEventPayload125Type = {
  Team: "team",
  User: "user",
} as const;
...
/** @internal */
export const UserEventPayload146Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload146Origin
> = z.nativeEnum(UserEventPayload146Origin);
...
export const UserEventPayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload146Origin$inboundSchema,
...
/** @internal */
export const UserEventPayload146BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload146BlockReason
> = z.nativeEnum(UserEventPayload146BlockReason);
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload146BlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload146NewOwnerBlockReason> = z.nativeEnum(
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload146NewOwnerBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerFeatureBlocksBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload146NewOwnerFeatureBlocksBlockReason> =
    z.nativeEnum(UserEventPayload146NewOwnerFeatureBlocksBlockReason);
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason
  > = z.nativeEnum(
    UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksMicrofrontendsRequestBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason
  > = z.nativeEnum(
    UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksWorkflowStorageWriteBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason
  > = z.nativeEnum(
    UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksWorkflowEventsBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema:
  z.ZodNativeEnum<
    typeof UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason
  > = z.nativeEnum(
    UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason,
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload146NewOwnerFeatureBlocksConnexTokenRequestsBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload146NewOwnerAction$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload146NewOwnerAction
> = z.nativeEnum(UserEventPayload146NewOwnerAction);
...
export const PayloadHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload146NewOwnerAction$inboundSchema,
...
> = z.object({
  ...
  type: UserEventPayload146Type$inboundSchema,
...
> = z.object({
  ...
  action: types.optional(UserEventPayload142Action$inboundSchema),
});
...
> = z.object({
  active: types.boolean(),
  action: types.optional(UserEventPayload141Action$inboundSchema),
});
...
/** @internal */
export const UserEventPayload135Target$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload135Target
> = z.nativeEnum(UserEventPayload135Target);
...
> = z.object({
  ...
  type: types.optional(UserEventPayload135Type$inboundSchema),
  target: types.optional(z.array(UserEventPayload135Target$inboundSchema)),
...
/** @internal */
export const UserEventPayload135NewEnvVarType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload135NewEnvVarType
> = z.nativeEnum(UserEventPayload135NewEnvVarType);

/** @internal */
export const UserEventPayload135NewEnvVarTarget$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload135NewEnvVarTarget
> = z.nativeEnum(UserEventPayload135NewEnvVarTarget);
...
> = z.object({
  ...
  value: types.optional(types.string()),
  projectId: types.optional(z.array(types.string())),
  type: types.optional(UserEventPayload135NewEnvVarType$inboundSchema),
  target: types.optional(
    z.array(UserEventPayload135NewEnvVarTarget$inboundSchema),
  ),
  applyToAllCustomEnvironments: types.optional(types.boolean()),
  customEnvironmentIds: types.optional(z.array(types.string())),
  decrypted: types.optional(types.boolean()),
...
/** @internal */
export const UserEventPayload130Team$inboundSchema: z.ZodType<
...
export function userEventPayload130TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload130Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload130Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload130Team' from JSON`,
  );
}
...
export const OneHundredAndThirty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload130Team$inboundSchema),
...
/** @internal */
export const UserEventPayload129Team$inboundSchema: z.ZodType<
...
export function userEventPayload129TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload129Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload129Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload129Team' from JSON`,
  );
}
...
export const OneHundredAndTwentyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload129Team$inboundSchema),
