...
export const UserEventPayload182DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload182DeploymentType = ClosedEnum<
  typeof UserEventPayload182DeploymentType
>;

export type UserEventPayload182Passport = {
  connectorId: string;
  deploymentType: UserEventPayload182DeploymentType;
};

export type UserEventPayloadNext = {
  passport?: UserEventPayload182Passport | null | undefined;
};
...
export const UserEventPayload181DeploymentType = {
  All: "all",
  AllExceptCustomDomains: "all_except_custom_domains",
  Preview: "preview",
  ProdDeploymentUrlsAndAllPreviews: "prod_deployment_urls_and_all_previews",
} as const;
export type UserEventPayload181DeploymentType = ClosedEnum<
  typeof UserEventPayload181DeploymentType
>;

export type Passport = {
  connectorId: string;
  deploymentType: UserEventPayload181DeploymentType;
};
...
export type UserEventPayload163Project = {
  id: string;
  name: string;
  microfrontends?:
    | Microfrontends1
...
export type UserEventPayload163PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload163PrevProject;
};
...
export type OneHundredAndSixtyThree = {
  project: UserEventPayload163Project;
  prev: PayloadPrev;
  group: PayloadGroup;
};

export type UserEventPayload162Project = {
  id: string;
  name: string;
};
...
export type OneHundredAndSixtyTwo = {
  project: UserEventPayload162Project;
  group: Group;
};
...
export const UserEventPayload146Action = {
  Blocked: "blocked",
  HardBlocked: "hard-blocked",
  SoftBlocked: "soft-blocked",
  Unblocked: "unblocked",
} as const;
export type UserEventPayload146Action = ClosedEnum<
  typeof UserEventPayload146Action
>;
...
export type BlockHistory = {
  action: UserEventPayload146Action;
  createdAt: number;
...
export const UserEventPayload146Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload146Configuration = ClosedEnum<
  typeof UserEventPayload146Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload146Configuration | undefined;
};
...
/** @internal */
export const UserEventPayload182DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload182DeploymentType
> = z.nativeEnum(UserEventPayload182DeploymentType);

/** @internal */
export const UserEventPayload182Passport$inboundSchema: z.ZodType<
  UserEventPayload182Passport,
  z.ZodTypeDef,
  unknown
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload182DeploymentType$inboundSchema,
});

export function userEventPayload182PassportFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload182Passport, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload182Passport$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload182Passport' from JSON`,
  );
}
...
export const UserEventPayloadNext$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  passport: z.nullable(z.lazy(() => UserEventPayload182Passport$inboundSchema))
    .optional(),
});
...
/** @internal */
export const UserEventPayload181DeploymentType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload181DeploymentType
> = z.nativeEnum(UserEventPayload181DeploymentType);
...
> = z.object({
  connectorId: types.string(),
  deploymentType: UserEventPayload181DeploymentType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload163Project$inboundSchema: z.ZodType<
  UserEventPayload163Project,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload163ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload163Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload163Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload163Project' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload163PrevProject$inboundSchema: z.ZodType<
  UserEventPayload163PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  microfrontends: types.optional(
...
export function userEventPayload163PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload163PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload163PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload163PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload163PrevProject$inboundSchema),
});
...
export const OneHundredAndSixtyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload163Project$inboundSchema),
...
/** @internal */
export const UserEventPayload162Project$inboundSchema: z.ZodType<
...
export function userEventPayload162ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload162Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload162Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload162Project' from JSON`,
  );
}
...
export const OneHundredAndSixtyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload162Project$inboundSchema),
...
/** @internal */
export const UserEventPayload146Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload146Action
> = z.nativeEnum(UserEventPayload146Action);
...
export const BlockHistory$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload146Action$inboundSchema,
...
/** @internal */
export const UserEventPayload146Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload146Configuration
> = z.nativeEnum(UserEventPayload146Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload146Configuration$inboundSchema),
});
