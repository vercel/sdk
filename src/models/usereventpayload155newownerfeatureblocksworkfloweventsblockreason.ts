...
import { QueryType, QueryType$inboundSchema } from "./querytype.js";
...
export const UserEventPayload155Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload155Configuration = ClosedEnum<
  typeof UserEventPayload155Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload155Configuration | undefined;
};
...
export const UserEventPayload155Role = {
  Billing: "BILLING",
...
export type UserEventPayload155Role = ClosedEnum<
  typeof UserEventPayload155Role
>;
...
export const UserEventPayload155Origin = {
...
export type UserEventPayload155Origin = ClosedEnum<
  typeof UserEventPayload155Origin
>;

export type UserEventPayloadGitUserId = string | number;

export type UserEventPayloadJoinedFrom = {
  origin: UserEventPayload155Origin;
...
export const UserEventPayload155BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload155BlockReason = ClosedEnum<
  typeof UserEventPayload155BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload155BlockReason;
};

export const UserEventPayload155NewOwnerBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload155NewOwnerBlockReason = ClosedEnum<
  typeof UserEventPayload155NewOwnerBlockReason
>;
...
export type PayloadImageOptimizationTransformation = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload155NewOwnerBlockReason;
};

export const UserEventPayload155NewOwnerFeatureBlocksBlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload155NewOwnerFeatureBlocksBlockReason = ClosedEnum<
  typeof UserEventPayload155NewOwnerFeatureBlocksBlockReason
>;
...
export type PayloadSourceImages = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload155NewOwnerFeatureBlocksBlockReason;
};
...
/** @internal */
export const UserEventPayload155Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload155Configuration
> = z.nativeEnum(UserEventPayload155Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload155Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload155Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload155Role
> = z.nativeEnum(UserEventPayload155Role);
...
/** @internal */
export const UserEventPayload155Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload155Origin
> = z.nativeEnum(UserEventPayload155Origin);
...
export const UserEventPayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload155Origin$inboundSchema,
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    teamId: types.string(),
    createdAt: types.number(),
    role: UserEventPayload155Role$inboundSchema,
...
/** @internal */
export const UserEventPayload155BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload155BlockReason
> = z.nativeEnum(UserEventPayload155BlockReason);
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload155BlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload155NewOwnerBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload155NewOwnerBlockReason> = z.nativeEnum(
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload155NewOwnerBlockReason$inboundSchema,
});
...
/** @internal */
export const UserEventPayload155NewOwnerFeatureBlocksBlockReason$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload155NewOwnerFeatureBlocksBlockReason> =
    z.nativeEnum(UserEventPayload155NewOwnerFeatureBlocksBlockReason);
...
> = z.object({
  ...
  blockedUntil: types.optional(types.number()),
  blockReason:
    UserEventPayload155NewOwnerFeatureBlocksBlockReason$inboundSchema,
});
