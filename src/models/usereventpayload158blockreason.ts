...
export const UserEventPayload169RequestKind = {
  GetKeyData: "get_key_data",
} as const;
export type UserEventPayload169RequestKind = ClosedEnum<
  typeof UserEventPayload169RequestKind
>;
...
export type OneHundredAndSixtyNine = {
  ...
  requestKind: UserEventPayload169RequestKind;
  key: string;
};
...
export const UserEventPayload158Plan = {
  Enterprise: "enterprise",
  Hobby: "hobby",
  Pro: "pro",
} as const;
export type UserEventPayload158Plan = ClosedEnum<
  typeof UserEventPayload158Plan
>;

export type PayloadBilling = {
  plan: UserEventPayload158Plan;
};
...
export const UserEventPayload158Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload158Configuration = ClosedEnum<
  typeof UserEventPayload158Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload158Configuration | undefined;
};
...
export const UserEventPayload158Role = {
  Billing: "BILLING",
...
export type UserEventPayload158Role = ClosedEnum<
  typeof UserEventPayload158Role
>;
...
export const UserEventPayload158Origin = {
...
export type UserEventPayload158Origin = ClosedEnum<
  typeof UserEventPayload158Origin
>;

export type UserEventPayloadGitUserId = string | number;

export type UserEventPayloadJoinedFrom = {
  origin: UserEventPayload158Origin;
...
export const UserEventPayload158BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload158BlockReason = ClosedEnum<
  typeof UserEventPayload158BlockReason
>;
...
export const Factors$inboundSchema: z.ZodType<Factors, z.ZodTypeDef, unknown> =
  smartUnion([
    ...
    z.array(Factors2$inboundSchema),
  ]);
...
/** @internal */
export const UserEventPayload169RequestKind$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload169RequestKind
> = z.nativeEnum(UserEventPayload169RequestKind);
...
> = z.object({
  ...
  requestKind: UserEventPayload169RequestKind$inboundSchema,
  key: types.string(),
});
...
/** @internal */
export const UserEventPayload158Plan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158Plan
> = z.nativeEnum(UserEventPayload158Plan);
...
export const PayloadBilling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  plan: UserEventPayload158Plan$inboundSchema,
});
...
/** @internal */
export const UserEventPayload158Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158Configuration
> = z.nativeEnum(UserEventPayload158Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload158Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload158Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158Role
> = z.nativeEnum(UserEventPayload158Role);
...
/** @internal */
export const UserEventPayload158Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158Origin
> = z.nativeEnum(UserEventPayload158Origin);
...
export const UserEventPayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload158Origin$inboundSchema,
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    teamId: types.string(),
    createdAt: types.number(),
    role: UserEventPayload158Role$inboundSchema,
...
/** @internal */
export const UserEventPayload158BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload158BlockReason
> = z.nativeEnum(UserEventPayload158BlockReason);
