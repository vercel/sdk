...
export type UserEventPayload204PrevProject = {
  microfrontends?:
    | UserEventMicrofrontends1
    | UserEventMicrofrontends2
    | UserEventMicrofrontends3
...
export type PayloadPrev = {
  project: UserEventPayload204PrevProject;
};
...
/** @internal */
export const UserEventPayload204PrevProject$inboundSchema: z.ZodType<
  UserEventPayload204PrevProject,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload204PrevProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload204PrevProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload204PrevProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload204PrevProject' from JSON`,
  );
}
...
export const PayloadPrev$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload204PrevProject$inboundSchema),
});
