...
export type ThreeHundredAndNinetyOne = {
  ...
  actorType?: UserEventPayload391ActorType | undefined;
  /**
...
export const UserEventPayload389Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload389Type = ClosedEnum<
  typeof UserEventPayload389Type
>;
...
export type UserEventPayload382Previous = Previous1 | Previous2;
...
export type UserEventPayload382Next = Next1 | Next2;
...
export const UserEventPayload375ActorType = {
  Admin: "admin",
} as const;
export type UserEventPayload375ActorType = ClosedEnum<
  typeof UserEventPayload375ActorType
>;
...
export type ThreeHundredAndSeventyFive = {
   ...
   */
  actorId: string;
  actorType: UserEventPayload375ActorType;
  actorName?: string | undefined;
};
...
export type UserEventPayload362User = {
  id: string;
  username: string;
};
...
export type UserEventPayload351Next = {};

/**
 * The payload of the event, if requested.
 */
export type ThreeHundredAndFiftyOne = {
  previous: UserEventPayload351Previous | null;
  next: UserEventPayload351Next | null;
};
...
export const UserEventPayload350Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload350Role = ClosedEnum<
  typeof UserEventPayload350Role
>;

export type UserEventPayloadRemovedUsers = {
  role: UserEventPayload350Role;
  confirmed: boolean;
...
export type ThreeHundredAndFortyNine = {
  ...
  next?: UserEventPayload349Next | undefined;
  isSystemInitiated?: boolean | undefined;
  reason?: PayloadReason | undefined;
};

export const UserEventPayload348Previous = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload348Previous = ClosedEnum<
  typeof UserEventPayload348Previous
>;

export const UserEventPayload348Next = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload348Next = ClosedEnum<
  typeof UserEventPayload348Next
>;
...
export type UserEventPayload344Previous = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload344Scope;
  /**
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload344NextScope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload344NextScope = ClosedEnum<
  typeof UserEventPayload344NextScope
>;
...
export type UserEventPayload344Next = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload344NextScope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export type ThreeHundredAndFortyFour = {
   ...
   * Automatic code review settings
   */
  previous?: UserEventPayload344Previous | undefined;
  /**
   * Automatic code review settings
   */
...
export const UserEventPayload342ActorType = {
  Admin: "admin",
  User: "user",
} as const;
export type UserEventPayload342ActorType = ClosedEnum<
  typeof UserEventPayload342ActorType
>;
...
export type ThreeHundredAndFortyTwo = {
  actorId?: string | undefined;
  actorType?: UserEventPayload342ActorType | undefined;
  reason?: string | undefined;
...
export type UserEventPayload340Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndForty = {
  store: UserEventPayload340Store;
...
export type UserEventPayload331Budget = {
  /**
   * Represents a budget for tracking and notifying teams on their spending.
   */
...
export type ThreeHundredAndThirtyOne = {
  budget: UserEventPayload331Budget;
};

export type UserEventPayload330Previous = {
...
export type ThreeHundredAndThirty = {
  ...
  sampleRatePercent: number | null;
  spendLimitInDollars: number | null;
  previous: UserEventPayload330Previous;
};
...
> = z.object({
  ...
  actorType: types.optional(UserEventPayload391ActorType$inboundSchema),
  actorName: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload389Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload389Type
> = z.nativeEnum(UserEventPayload389Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload389Type$inboundSchema,
  rate: types.number(),
...
/** @internal */
export const UserEventPayload375ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload375ActorType
> = z.nativeEnum(UserEventPayload375ActorType);
...
> = z.object({
  ...
  actorId: types.string(),
  actorType: UserEventPayload375ActorType$inboundSchema,
  actorName: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload362User$inboundSchema: z.ZodType<
  UserEventPayload362User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload362UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload362User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload362User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload362User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload362User$inboundSchema),
...
/** @internal */
export const UserEventPayload351Next$inboundSchema: z.ZodType<
  UserEventPayload351Next,
  z.ZodTypeDef,
  unknown
> = z.object({});

export function userEventPayload351NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload351Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload351Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload351Next' from JSON`,
  );
}
...
> = z.object({
  previous: types.nullable(
    z.lazy(() => UserEventPayload351Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload351Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload350Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload350Role
> = z.nativeEnum(UserEventPayload350Role);
...
export const UserEventPayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload350Role$inboundSchema,
...
export const ThreeHundredAndFortyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload349Previous$inboundSchema),
  next: types.optional(UserEventPayload349Next$inboundSchema),
...
/** @internal */
export const UserEventPayload348Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload348Previous
> = z.nativeEnum(UserEventPayload348Previous);

/** @internal */
export const UserEventPayload348Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload348Next
> = z.nativeEnum(UserEventPayload348Next);
...
export const ThreeHundredAndFortyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload348Previous$inboundSchema),
  next: types.nullable(UserEventPayload348Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload344Scope$inboundSchema,
...
/** @internal */
export const UserEventPayload344NextScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload344NextScope
> = z.nativeEnum(UserEventPayload344NextScope);
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload344NextScope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});
...
> = z.object({
  previous: types.optional(
    z.lazy(() => UserEventPayload344Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload342ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload342ActorType
> = z.nativeEnum(UserEventPayload342ActorType);
...
> = z.object({
  actorId: types.optional(types.string()),
  actorType: types.optional(UserEventPayload342ActorType$inboundSchema),
  reason: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload340Store$inboundSchema: z.ZodType<
  UserEventPayload340Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload340StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload340Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload340Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload340Store' from JSON`,
  );
}
...
export const ThreeHundredAndForty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload340Store$inboundSchema),
...
/** @internal */
export const UserEventPayload331Budget$inboundSchema: z.ZodType<
...
export function userEventPayload331BudgetFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload331Budget, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload331Budget$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload331Budget' from JSON`,
  );
}
...
export const ThreeHundredAndThirtyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  budget: z.lazy(() => UserEventPayload331Budget$inboundSchema),
});
...
> = z.object({
  ...
  sampleRatePercent: types.nullable(types.number()),
  spendLimitInDollars: types.nullable(types.number()),
  previous: z.lazy(() => UserEventPayload330Previous$inboundSchema),
});
