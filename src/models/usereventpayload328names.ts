...
export type ThreeHundredAndNinetyFour = {
  ...
  actorType?: UserEventPayload394ActorType | undefined;
  /**
...
export const UserEventPayload391Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload391Type = ClosedEnum<
  typeof UserEventPayload391Type
>;
...
export type UserEventPayload384Previous = Previous1 | Previous2;
...
export type UserEventPayload384Next = Next1 | Next2;
...
export const UserEventPayload377ActorType = {
  Admin: "admin",
} as const;
export type UserEventPayload377ActorType = ClosedEnum<
  typeof UserEventPayload377ActorType
>;
...
export type ThreeHundredAndSeventySeven = {
   ...
   */
  actorId: string;
  actorType: UserEventPayload377ActorType;
  actorName?: string | undefined;
};
...
export type UserEventPayload364User = {
  id: string;
  username: string;
};
...
export const UserEventPayload352Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload352Role = ClosedEnum<
  typeof UserEventPayload352Role
>;

export type UserEventPayloadRemovedUsers = {
  role: UserEventPayload352Role;
  confirmed: boolean;
...
export type ThreeHundredAndFiftyOne = {
  previous?: UserEventPayload351Previous | undefined;
  next?: UserEventPayload351Next | undefined;
...
export type ThreeHundredAndFifty = {
  previous: UserEventPayload350Previous | null;
  next: UserEventPayload350Next | null;
  teamSlug?: string | undefined;
};
...
export type UserEventPayload346Previous = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload346Scope;
  /**
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload346NextScope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload346NextScope = ClosedEnum<
  typeof UserEventPayload346NextScope
>;
...
export type UserEventPayload346Next = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload346NextScope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export const UserEventPayload344ActorType = {
  Admin: "admin",
  User: "user",
} as const;
export type UserEventPayload344ActorType = ClosedEnum<
  typeof UserEventPayload344ActorType
>;
...
export type ThreeHundredAndFortyFour = {
  actorId?: string | undefined;
  actorType?: UserEventPayload344ActorType | undefined;
  reason?: string | undefined;
...
export type UserEventPayload342Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndFortyTwo = {
  store: UserEventPayload342Store;
...
export type UserEventPayload332Previous = {
...
export type ThreeHundredAndThirtyTwo = {
  ...
  sampleRatePercent: number | null;
  spendLimitInDollars: number | null;
  previous: UserEventPayload332Previous;
};
...
> = z.object({
  ...
  actorType: types.optional(UserEventPayload394ActorType$inboundSchema),
  actorName: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload391Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload391Type
> = z.nativeEnum(UserEventPayload391Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload391Type$inboundSchema,
  rate: types.number(),
...
/** @internal */
export const UserEventPayload384Previous$inboundSchema: z.ZodType<
...
export function userEventPayload384PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload384Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload384Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload384Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload384Next$inboundSchema: z.ZodType<
  UserEventPayload384Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload384NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload384Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload384Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload384Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload377ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload377ActorType
> = z.nativeEnum(UserEventPayload377ActorType);
...
> = z.object({
  ...
  actorId: types.string(),
  actorType: UserEventPayload377ActorType$inboundSchema,
  actorName: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload364User$inboundSchema: z.ZodType<
  UserEventPayload364User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload364UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload364User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload364User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload364User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload364User$inboundSchema),
...
> = z.object({
  ...
  next: types.nullable(z.lazy(() => UserEventPayload353Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload352Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload352Role
> = z.nativeEnum(UserEventPayload352Role);
...
export const UserEventPayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload352Role$inboundSchema,
...
export const ThreeHundredAndFiftyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload351Previous$inboundSchema),
  next: types.optional(UserEventPayload351Next$inboundSchema),
...
export const ThreeHundredAndFifty$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload350Previous$inboundSchema),
  next: types.nullable(UserEventPayload350Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload346Scope$inboundSchema,
...
/** @internal */
export const UserEventPayload346NextScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload346NextScope
> = z.nativeEnum(UserEventPayload346NextScope);
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload346NextScope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});
...
> = z.object({
  previous: types.optional(
    z.lazy(() => UserEventPayload346Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload344ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload344ActorType
> = z.nativeEnum(UserEventPayload344ActorType);
...
> = z.object({
  actorId: types.optional(types.string()),
  actorType: types.optional(UserEventPayload344ActorType$inboundSchema),
  reason: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload342Store$inboundSchema: z.ZodType<
  UserEventPayload342Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload342StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload342Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload342Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload342Store' from JSON`,
  );
}
...
export const ThreeHundredAndFortyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload342Store$inboundSchema),
...
/** @internal */
export const UserEventPayload332Previous$inboundSchema: z.ZodType<
...
export function userEventPayload332PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload332Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload332Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload332Previous' from JSON`,
  );
}
...
> = z.object({
  ...
  sampleRatePercent: types.nullable(types.number()),
  spendLimitInDollars: types.nullable(types.number()),
  previous: z.lazy(() => UserEventPayload332Previous$inboundSchema),
});
