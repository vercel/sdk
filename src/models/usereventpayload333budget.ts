...
export type ThreeHundredAndNinetyFive = {
  ...
  actorType?: UserEventPayload395ActorType | undefined;
  /**
...
export const UserEventPayload392Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload392Type = ClosedEnum<
  typeof UserEventPayload392Type
>;
...
export type UserEventPayload385Previous = Previous1 | Previous2;
...
export type UserEventPayload385Next = Next1 | Next2;
...
export const UserEventPayload378ActorType = {
  Admin: "admin",
} as const;
export type UserEventPayload378ActorType = ClosedEnum<
  typeof UserEventPayload378ActorType
>;
...
export type ThreeHundredAndSeventyEight = {
   ...
   */
  actorId: string;
  actorType: UserEventPayload378ActorType;
  actorName?: string | undefined;
};
...
export type UserEventPayload365User = {
  id: string;
  username: string;
};
...
export type ThreeHundredAndFiftyFour = {
  previous: UserEventPayload354Previous | null;
  next: UserEventPayload354Next | null;
};
...
export const UserEventPayload353Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload353Role = ClosedEnum<
  typeof UserEventPayload353Role
>;

export type UserEventPayloadRemovedUsers = {
  role: UserEventPayload353Role;
  confirmed: boolean;
...
export type ThreeHundredAndFiftyTwo = {
  ...
  next?: UserEventPayload352Next | undefined;
  isSystemInitiated?: boolean | undefined;
  reason?: PayloadReason | undefined;
};

export const UserEventPayload351Previous = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload351Previous = ClosedEnum<
  typeof UserEventPayload351Previous
>;

export const UserEventPayload351Next = {
  AutoApproval: "auto-approval",
  Block: "block",
  ManualApproval: "manual-approval",
} as const;
export type UserEventPayload351Next = ClosedEnum<
  typeof UserEventPayload351Next
>;
...
export type UserEventPayload347Previous = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload347Scope;
  /**
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload347NextScope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload347NextScope = ClosedEnum<
  typeof UserEventPayload347NextScope
>;
...
export type UserEventPayload347Next = {
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload347NextScope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export type ThreeHundredAndFortySeven = {
   ...
   * Automatic code review settings
   */
  previous?: UserEventPayload347Previous | undefined;
  /**
   * Automatic code review settings
   */
...
export const UserEventPayload345ActorType = {
  Admin: "admin",
  User: "user",
} as const;
export type UserEventPayload345ActorType = ClosedEnum<
  typeof UserEventPayload345ActorType
>;
...
export type ThreeHundredAndFortyFive = {
  actorId?: string | undefined;
  actorType?: UserEventPayload345ActorType | undefined;
  reason?: string | undefined;
...
export type UserEventPayload343Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndFortyThree = {
  store: UserEventPayload343Store;
 ...
 * The budget type
 */
export const UserEventPayload336PrevBudgetType = {
  Fixed: "fixed",
} as const;
/**
 * The budget type
 */
export type UserEventPayload336PrevBudgetType = ClosedEnum<
  typeof UserEventPayload336PrevBudgetType
>;

/**
 * The acive pricing plan the team is billed with
 */
export const UserEventPayload336PricingPlan = {
  Flex: "flex",
  Legacy: "legacy",
  Platform: "platform",
  Plus: "plus",
 ...
 * The acive pricing plan the team is billed with
 */
export type UserEventPayload336PricingPlan = ClosedEnum<
  typeof UserEventPayload336PricingPlan
>;
...
export type PrevBudget = {
   ...
   * The budget type
   */
  type: UserEventPayload336PrevBudgetType;
  /**
   * Budget amount (USD / dollars)
   */
  fixedBudget: number;
   ...
   * The acive pricing plan the team is billed with
   */
  pricingPlan?: UserEventPayload336PricingPlan | undefined;
  /**
   * Partition key
   */
  teamId: string;
 ...
 * The acive pricing plan the team is billed with
 */
export const UserEventPayload333PricingPlan = {
  Flex: "flex",
  Legacy: "legacy",
  Platform: "platform",
  Plus: "plus",
 ...
 * The acive pricing plan the team is billed with
 */
export type UserEventPayload333PricingPlan = ClosedEnum<
  typeof UserEventPayload333PricingPlan
>;
...
export type BudgetItem = {
   ...
   * The acive pricing plan the team is billed with
   */
  pricingPlan?: UserEventPayload333PricingPlan | undefined;
  /**
   * Partition key
   */
  teamId: string;
...
> = z.object({
  ...
  actorType: types.optional(UserEventPayload395ActorType$inboundSchema),
  actorName: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload392Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload392Type
> = z.nativeEnum(UserEventPayload392Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload392Type$inboundSchema,
  rate: types.number(),
...
/** @internal */
export const UserEventPayload385Previous$inboundSchema: z.ZodType<
...
export function userEventPayload385PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload385Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload385Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload385Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload385Next$inboundSchema: z.ZodType<
  UserEventPayload385Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload385NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload385Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload385Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload385Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload378ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload378ActorType
> = z.nativeEnum(UserEventPayload378ActorType);
...
> = z.object({
  ...
  actorId: types.string(),
  actorType: UserEventPayload378ActorType$inboundSchema,
  actorName: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload365User$inboundSchema: z.ZodType<
  UserEventPayload365User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload365UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload365User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload365User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload365User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload365User$inboundSchema),
...
> = z.object({
  ...
  next: types.nullable(z.lazy(() => UserEventPayload354Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload353Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload353Role
> = z.nativeEnum(UserEventPayload353Role);
...
export const UserEventPayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload353Role$inboundSchema,
...
export const ThreeHundredAndFiftyTwo$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload352Previous$inboundSchema),
  next: types.optional(UserEventPayload352Next$inboundSchema),
...
/** @internal */
export const UserEventPayload351Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload351Previous
> = z.nativeEnum(UserEventPayload351Previous);

/** @internal */
export const UserEventPayload351Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload351Next
> = z.nativeEnum(UserEventPayload351Next);
...
export const ThreeHundredAndFiftyOne$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload351Previous$inboundSchema),
  next: types.nullable(UserEventPayload351Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload347Scope$inboundSchema,
...
/** @internal */
export const UserEventPayload347NextScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload347NextScope
> = z.nativeEnum(UserEventPayload347NextScope);
...
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload347NextScope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});
...
> = z.object({
  previous: types.optional(
    z.lazy(() => UserEventPayload347Previous$inboundSchema),
  ),
...
/** @internal */
export const UserEventPayload345ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload345ActorType
> = z.nativeEnum(UserEventPayload345ActorType);
...
> = z.object({
  actorId: types.optional(types.string()),
  actorType: types.optional(UserEventPayload345ActorType$inboundSchema),
  reason: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload343Store$inboundSchema: z.ZodType<
  UserEventPayload343Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload343StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload343Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload343Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload343Store' from JSON`,
  );
}
...
export const ThreeHundredAndFortyThree$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload343Store$inboundSchema),
...
/** @internal */
export const UserEventPayload336PrevBudgetType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload336PrevBudgetType
> = z.nativeEnum(UserEventPayload336PrevBudgetType);

/** @internal */
export const UserEventPayload336PricingPlan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload336PricingPlan
> = z.nativeEnum(UserEventPayload336PricingPlan);
...
export const PrevBudget$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload336PrevBudgetType$inboundSchema,
  fixedBudget: types.number(),
  previousSpend: z.array(types.number()),
  notifiedAt: z.array(types.number()),
  webhookId: types.optional(types.string()),
  ...
  isActive: types.boolean(),
  pauseProjects: types.optional(types.boolean()),
  pricingPlan: types.optional(UserEventPayload336PricingPlan$inboundSchema),
  teamId: types.string(),
  id: types.string(),
});
...
/** @internal */
export const UserEventPayload333PricingPlan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload333PricingPlan
> = z.nativeEnum(UserEventPayload333PricingPlan);
...
> = z.object({
  ...
  isActive: types.boolean(),
  pauseProjects: types.optional(types.boolean()),
  pricingPlan: types.optional(UserEventPayload333PricingPlan$inboundSchema),
  teamId: types.string(),
  id: types.string(),
});
