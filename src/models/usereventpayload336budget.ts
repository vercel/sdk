...
export type ThreeHundredAndNinetyEight = {
  ...
  actorType?: UserEventPayload398ActorType | undefined;
  /**
...
export const UserEventPayload395Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload395Type = ClosedEnum<
  typeof UserEventPayload395Type
>;
...
export type UserEventPayload388Previous = Previous1 | Previous2;
...
export type UserEventPayload388Next = Next1 | Next2;
...
export const UserEventPayload381ActorType = {
  Admin: "admin",
} as const;
export type UserEventPayload381ActorType = ClosedEnum<
  typeof UserEventPayload381ActorType
>;
...
export type ThreeHundredAndEightyOne = {
   ...
   */
  actorId: string;
  actorType: UserEventPayload381ActorType;
  actorName?: string | undefined;
};
...
export type UserEventPayload368User = {
  id: string;
  username: string;
};
...
export type UserEventPayload357Previous = {};

export type UserEventPayload357Next = {};
...
export const UserEventPayload356Role = {
  Billing: "BILLING",
  Contributor: "CONTRIBUTOR",
  Developer: "DEVELOPER",
  Member: "MEMBER",
...
export type UserEventPayload356Role = ClosedEnum<
  typeof UserEventPayload356Role
>;

export type UserEventPayloadRemovedUsers = {
  role: UserEventPayload356Role;
  confirmed: boolean;
...
export const UserEventPayload355Previous = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload355Previous = ClosedEnum<
  typeof UserEventPayload355Previous
>;

export const UserEventPayload355Next = {
  Basic: "basic",
  Elastic: "elastic",
  Enhanced: "enhanced",
  Standard: "standard",
...
export type UserEventPayload355Next = ClosedEnum<
  typeof UserEventPayload355Next
>;
...
export type ThreeHundredAndFiftyFive = {
  ...
  next?: UserEventPayload355Next | undefined;
 ...
 */
export type UserEventPayload350Previous = {
  /**
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload350Scope;
  /**
 ...
 * Which repository visibilities get automatic reviews
 */
export const UserEventPayload350NextScope = {
  All: "all",
  Private: "private",
  Public: "public",
  SelectedRepos: "selected_repos",
 ...
 * Which repository visibilities get automatic reviews
 */
export type UserEventPayload350NextScope = ClosedEnum<
  typeof UserEventPayload350NextScope
>;

/**
 * Automatic code review settings
 */
export type UserEventPayload350Next = {
  /**
   * Whether automatic code reviews are enabled
   */
  enabled: boolean;
   ...
   * Which repository visibilities get automatic reviews
   */
  scope: UserEventPayload350NextScope;
  /**
   * Whether to include draft pull requests in automatic reviews
   */
  includeDrafts: boolean;
...
export const UserEventPayload348ActorType = {
  Admin: "admin",
  User: "user",
} as const;
export type UserEventPayload348ActorType = ClosedEnum<
  typeof UserEventPayload348ActorType
>;
...
export type ThreeHundredAndFortyEight = {
  actorId?: string | undefined;
  actorType?: UserEventPayload348ActorType | undefined;
  reason?: string | undefined;
...
export type UserEventPayload346Store = {
  name: string;
  id: string;
};
...
export type ThreeHundredAndFortySix = {
  store: UserEventPayload346Store;
 ...
 * The budget type
 */
export const UserEventPayload339PrevBudgetType = {
  Fixed: "fixed",
} as const;
/**
 * The budget type
 */
export type UserEventPayload339PrevBudgetType = ClosedEnum<
  typeof UserEventPayload339PrevBudgetType
>;
...
export type PrevBudget = {
   ...
   * The budget type
   */
  type: UserEventPayload339PrevBudgetType;
  /**
   * Budget amount (USD / dollars)
   */
  fixedBudget: number;
...
> = z.object({
  ...
  actorType: types.optional(UserEventPayload398ActorType$inboundSchema),
  actorName: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload395Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload395Type
> = z.nativeEnum(UserEventPayload395Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload395Type$inboundSchema,
  rate: types.number(),
...
/** @internal */
export const UserEventPayload388Previous$inboundSchema: z.ZodType<
...
export function userEventPayload388PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388Previous' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload388Next$inboundSchema: z.ZodType<
  UserEventPayload388Next,
  z.ZodTypeDef,
  unknown
> = smartUnion([z.lazy(() => Next1$inboundSchema), Next2$inboundSchema]);

export function userEventPayload388NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload388Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload388Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload388Next' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload381ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload381ActorType
> = z.nativeEnum(UserEventPayload381ActorType);
...
> = z.object({
  ...
  actorId: types.string(),
  actorType: UserEventPayload381ActorType$inboundSchema,
  actorName: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload368User$inboundSchema: z.ZodType<
  UserEventPayload368User,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload368UserFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload368User, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload368User$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload368User' from JSON`,
  );
}
...
> = z.object({
  ...
  user: z.lazy(() => UserEventPayload368User$inboundSchema),
...
> = z.object({
  previous: types.nullable(
    z.lazy(() => UserEventPayload357Previous$inboundSchema),
  ),
  next: types.nullable(z.lazy(() => UserEventPayload357Next$inboundSchema)),
});
...
/** @internal */
export const UserEventPayload356Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload356Role
> = z.nativeEnum(UserEventPayload356Role);
...
export const UserEventPayloadRemovedUsers$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  role: UserEventPayload356Role$inboundSchema,
...
/** @internal */
export const UserEventPayload355Previous$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload355Previous
> = z.nativeEnum(UserEventPayload355Previous);

/** @internal */
export const UserEventPayload355Next$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload355Next
> = z.nativeEnum(UserEventPayload355Next);
...
export const ThreeHundredAndFiftyFive$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.optional(UserEventPayload355Previous$inboundSchema),
  next: types.optional(UserEventPayload355Next$inboundSchema),
...
export const ThreeHundredAndFiftyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: types.nullable(UserEventPayload354Previous$inboundSchema),
  next: types.nullable(UserEventPayload354Next$inboundSchema),
  teamSlug: types.optional(types.string()),
});
...
/** @internal */
export const UserEventPayload350Previous$inboundSchema: z.ZodType<
  UserEventPayload350Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload350Scope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});

export function userEventPayload350PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload350Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload350Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload350Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload350NextScope$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload350NextScope
> = z.nativeEnum(UserEventPayload350NextScope);

/** @internal */
export const UserEventPayload350Next$inboundSchema: z.ZodType<
  UserEventPayload350Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
  scope: UserEventPayload350NextScope$inboundSchema,
  includeDrafts: types.boolean(),
  selectedRepos: z.nullable(z.array(types.string())).optional(),
});

export function userEventPayload350NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload350Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload350Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload350Next' from JSON`,
  );
}
...
> = z.object({
  previous: types.optional(
    z.lazy(() => UserEventPayload350Previous$inboundSchema),
  ),
  next: z.lazy(() => UserEventPayload350Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload348ActorType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload348ActorType
> = z.nativeEnum(UserEventPayload348ActorType);
...
> = z.object({
  actorId: types.optional(types.string()),
  actorType: types.optional(UserEventPayload348ActorType$inboundSchema),
  reason: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload346Store$inboundSchema: z.ZodType<
  UserEventPayload346Store,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: types.string(),
...
export function userEventPayload346StoreFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload346Store, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload346Store$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload346Store' from JSON`,
  );
}
...
export const ThreeHundredAndFortySix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  store: z.lazy(() => UserEventPayload346Store$inboundSchema),
...
/** @internal */
export const UserEventPayload339PrevBudgetType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload339PrevBudgetType
> = z.nativeEnum(UserEventPayload339PrevBudgetType);
...
export const PrevBudget$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload339PrevBudgetType$inboundSchema,
  fixedBudget: types.number(),
  previousSpend: z.array(types.number()),
  notifiedAt: z.array(types.number()),
  webhookId: types.optional(types.string()),
