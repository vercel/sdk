...
export type UserEventPayload418City = {
...
export type UserEventPayload418Country = {
...
export type UserEventPayload418MostSpecificSubdivision = {
  names: UserEventPayload418GeolocationMostSpecificSubdivisionNames;
};

export type UserEventPayload418Geolocation = {
  city?: UserEventPayload418City | undefined;
  country: UserEventPayload418Country;
  mostSpecificSubdivision?:
    | UserEventPayload418MostSpecificSubdivision
    | undefined;
  regionName?: string | undefined;
};
...
export type FourHundredAndEighteen = {
  ...
  ip?: string | null | undefined;
  geolocation?: UserEventPayload418Geolocation | null | undefined;
  userAgent?: string | undefined;
  reqId?: string | undefined;
  reqUrl?: string | undefined;
};
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload417AfterResources = {
  projectIds: Array<string>;
};
...
export type PayloadAfter = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload417AfterResources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
 ...
 * Resource boundary, or `null` when the policy has none.
 */
export type UserEventPayload416Resources = {
  projectIds: Array<string>;
};
...
export type Policy = {
   ...
   * Resource boundary, or `null` when the policy has none.
   */
  resources: UserEventPayload416Resources | null;
  /**
   * Creation time (epoch ms).
   */
  createdAt: number;
...
export type UserEventPayload415Names = {
  en: string;
};

export type UserEventPayloadCity = {
  names: UserEventPayload415Names;
};

export type UserEventPayload415GeolocationNames = {
  en: string;
};

export type UserEventPayloadCountry = {
  names: UserEventPayload415GeolocationNames;
};

export type UserEventPayload415GeolocationMostSpecificSubdivisionNames = {
  en: string;
};

export type UserEventPayloadMostSpecificSubdivision = {
  names: UserEventPayload415GeolocationMostSpecificSubdivisionNames;
};
...
export type UserEventPayload406Team = {
  id: string;
  name: string;
};

export type UserEventPayload406Configuration = {
  id: string;
  name?: string | undefined;
};
...
export type FourHundredAndSix = {
  team: UserEventPayload406Team;
  configuration: UserEventPayload406Configuration;
  peering: Peering;
};
...
export type UserEventPayload389Previous = {
  enabled: boolean;
  totpVerified: boolean;
};

export type UserEventPayload389Next = {
  enabled: boolean;
  totpVerified: boolean;
};
...
export type ThreeHundredAndEightyNine = {
  previous: UserEventPayload389Previous;
  next: UserEventPayload389Next;
};

export const UserEventPayload388Action = {
...
export type UserEventPayload388Action = ClosedEnum<
  typeof UserEventPayload388Action
>;
...
export type ThreeHundredAndEightyEight = {
  action: UserEventPayload388Action;
  reason: string;
};
...
export const UserEventPayload378Type = {
  HeadSampling: "head_sampling",
} as const;
export type UserEventPayload378Type = ClosedEnum<
  typeof UserEventPayload378Type
>;
...
export type UserEventPayload372Previous = Previous1 | Previous2;
...
/** @internal */
export const UserEventPayload418City$inboundSchema: z.ZodType<
  UserEventPayload418City,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload418CityFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload418City, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload418City$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload418City' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload418Country$inboundSchema: z.ZodType<
  UserEventPayload418Country,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload418CountryFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload418Country, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload418Country$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload418Country' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload418MostSpecificSubdivision$inboundSchema:
  z.ZodType<UserEventPayload418MostSpecificSubdivision, z.ZodTypeDef, unknown> =
    z.object({
      names: z.lazy(() =>
        UserEventPayload418GeolocationMostSpecificSubdivisionNames$inboundSchema
      ),
...
export function userEventPayload418MostSpecificSubdivisionFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload418MostSpecificSubdivision,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload418MostSpecificSubdivision$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'UserEventPayload418MostSpecificSubdivision' from JSON`,
  );
}

/** @internal */
export const UserEventPayload418Geolocation$inboundSchema: z.ZodType<
  UserEventPayload418Geolocation,
  z.ZodTypeDef,
  unknown
> = z.object({
  city: types.optional(z.lazy(() => UserEventPayload418City$inboundSchema)),
  country: z.lazy(() => UserEventPayload418Country$inboundSchema),
  most_specific_subdivision: types.optional(
    z.lazy(() => UserEventPayload418MostSpecificSubdivision$inboundSchema),
  ),
  regionName: types.optional(types.string()),
}).transform((v) => {
  return remap$(v, {
...
export function userEventPayload418GeolocationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload418Geolocation, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload418Geolocation$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload418Geolocation' from JSON`,
  );
}
...
> = z.object({
  ...
  ip: z.nullable(types.string()).optional(),
  geolocation: z.nullable(
    z.lazy(() => UserEventPayload418Geolocation$inboundSchema),
  ).optional(),
  userAgent: types.optional(types.string()),
  reqId: types.optional(types.string()),
  reqUrl: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload417AfterResources$inboundSchema: z.ZodType<
  UserEventPayload417AfterResources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload417AfterResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload417AfterResources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload417AfterResources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload417AfterResources' from JSON`,
  );
}
...
> = z.object({
  ...
  permissions: z.array(types.string()),
  resources: types.nullable(
    z.lazy(() => UserEventPayload417AfterResources$inboundSchema),
  ),
  createdAt: types.number(),
  updatedAt: types.number(),
});
...
/** @internal */
export const UserEventPayload416Resources$inboundSchema: z.ZodType<
  UserEventPayload416Resources,
  z.ZodTypeDef,
  unknown
> = z.object({
  projectIds: z.array(types.string()),
...
export function userEventPayload416ResourcesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload416Resources, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload416Resources$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload416Resources' from JSON`,
  );
}
...
export const Policy$inboundSchema: z.ZodType<Policy, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: z.array(types.string()),
    resources: types.nullable(
      z.lazy(() => UserEventPayload416Resources$inboundSchema),
    ),
    createdAt: types.number(),
    updatedAt: types.number(),
  });
...
/** @internal */
export const UserEventPayload415Names$inboundSchema: z.ZodType<
  UserEventPayload415Names,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload415NamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload415Names, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload415Names$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload415Names' from JSON`,
  );
}
...
export const UserEventPayloadCity$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload415Names$inboundSchema),
});
...
/** @internal */
export const UserEventPayload415GeolocationNames$inboundSchema: z.ZodType<
  UserEventPayload415GeolocationNames,
  z.ZodTypeDef,
  unknown
> = z.object({
  en: types.string(),
...
export function userEventPayload415GeolocationNamesFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload415GeolocationNames, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload415GeolocationNames$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload415GeolocationNames' from JSON`,
  );
}
...
export const UserEventPayloadCountry$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  names: z.lazy(() => UserEventPayload415GeolocationNames$inboundSchema),
});
...
/** @internal */
export const UserEventPayload415GeolocationMostSpecificSubdivisionNames$inboundSchema:
  z.ZodType<
    UserEventPayload415GeolocationMostSpecificSubdivisionNames,
    z.ZodTypeDef,
    unknown
  > = z.object({
    en: types.string(),
...
export function userEventPayload415GeolocationMostSpecificSubdivisionNamesFromJSON(
  jsonString: string,
): SafeParseResult<
  UserEventPayload415GeolocationMostSpecificSubdivisionNames,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload415GeolocationMostSpecificSubdivisionNames$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload415GeolocationMostSpecificSubdivisionNames' from JSON`,
  );
}
...
/** @internal */
export const UserEventPayload406Team$inboundSchema: z.ZodType<
  UserEventPayload406Team,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload406TeamFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload406Team, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload406Team$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload406Team' from JSON`,
  );
}

/** @internal */
export const UserEventPayload406Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload406ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload406Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload406Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload406Configuration' from JSON`,
  );
}
...
export const FourHundredAndSix$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  team: z.lazy(() => UserEventPayload406Team$inboundSchema),
  configuration: z.lazy(() => UserEventPayload406Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload389Previous$inboundSchema: z.ZodType<
  UserEventPayload389Previous,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload389PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389Previous' from JSON`,
  );
}

/** @internal */
export const UserEventPayload389Next$inboundSchema: z.ZodType<
  UserEventPayload389Next,
  z.ZodTypeDef,
  unknown
> = z.object({
  enabled: types.boolean(),
...
export function userEventPayload389NextFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload389Next, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload389Next$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload389Next' from JSON`,
  );
}
...
export const ThreeHundredAndEightyNine$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  previous: z.lazy(() => UserEventPayload389Previous$inboundSchema),
  next: z.lazy(() => UserEventPayload389Next$inboundSchema),
});
...
/** @internal */
export const UserEventPayload388Action$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload388Action
> = z.nativeEnum(UserEventPayload388Action);
...
export const ThreeHundredAndEightyEight$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  action: UserEventPayload388Action$inboundSchema,
  reason: types.string(),
});
...
/** @internal */
export const UserEventPayload378Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload378Type
> = z.nativeEnum(UserEventPayload378Type);
...
export const Sampling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload378Type$inboundSchema,
  rate: types.number(),
...
/** @internal */
export const UserEventPayload372Previous$inboundSchema: z.ZodType<
...
export function userEventPayload372PreviousFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload372Previous, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload372Previous$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload372Previous' from JSON`,
  );
}
