...
import {
  ...
  UserEventJobPayload965Provider$inboundSchema,
  UserEventJobPayload96GitComments,
  UserEventJobPayload96GitComments$inboundSchema,
  UserEventJobPayload96HeadInfo,
  UserEventJobPayload96HeadInfo$inboundSchema,
...
export const Job5$inboundSchema: z.ZodType<Job5, z.ZodTypeDef, unknown> = z
  .object({
    ...
    headInfo: UserEventJobPayload96HeadInfo$inboundSchema,
    ...
    gitComments: types.optional(UserEventJobPayload96GitComments$inboundSchema),
