...
export type UserEventPayload84Configuration = {
  id: string;
  name?: string | undefined;
};
...
/** @internal */
export const UserEventPayload84Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload84ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload84Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload84Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload84Configuration' from JSON`,
  );
}
