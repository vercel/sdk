...
export const UserEventPayload167RequestKind = {
  GetKeyData: "get_key_data",
} as const;
export type UserEventPayload167RequestKind = ClosedEnum<
  typeof UserEventPayload167RequestKind
>;
...
export type OneHundredAndSixtySeven = {
  ...
  requestKind: UserEventPayload167RequestKind;
  key: string;
};
...
export const UserEventPayload156Plan = {
  Enterprise: "enterprise",
  Hobby: "hobby",
  Pro: "pro",
} as const;
export type UserEventPayload156Plan = ClosedEnum<
  typeof UserEventPayload156Plan
>;

export type PayloadBilling = {
  plan: UserEventPayload156Plan;
};
...
export const UserEventPayload156Configuration = {
  SkipNamespaceQueue: "SKIP_NAMESPACE_QUEUE",
  WaitForNamespaceQueue: "WAIT_FOR_NAMESPACE_QUEUE",
} as const;
export type UserEventPayload156Configuration = ClosedEnum<
  typeof UserEventPayload156Configuration
>;

export type PayloadBuildQueue = {
  configuration?: UserEventPayload156Configuration | undefined;
};
...
export const UserEventPayload156Role = {
  Billing: "BILLING",
...
export type UserEventPayload156Role = ClosedEnum<
  typeof UserEventPayload156Role
>;
...
export const UserEventPayload156Origin = {
...
export type UserEventPayload156Origin = ClosedEnum<
  typeof UserEventPayload156Origin
>;

export type UserEventPayloadGitUserId = string | number;

export type UserEventPayloadJoinedFrom = {
  origin: UserEventPayload156Origin;
...
export const UserEventPayload156BlockReason = {
  AdminOverride: "admin_override",
  HardBlocked: "hard_blocked",
  LimitsExceeded: "limits_exceeded",
} as const;
export type UserEventPayload156BlockReason = ClosedEnum<
  typeof UserEventPayload156BlockReason
>;
...
export type UserEventPayloadDataCache = {
  ...
  blockedFrom?: number | undefined;
  blockedUntil?: number | undefined;
  blockReason: UserEventPayload156BlockReason;
};
...
/** @internal */
export const UserEventPayload167RequestKind$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload167RequestKind
> = z.nativeEnum(UserEventPayload167RequestKind);
...
> = z.object({
  ...
  requestKind: UserEventPayload167RequestKind$inboundSchema,
  key: types.string(),
});
...
/** @internal */
export const UserEventPayload156Plan$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156Plan
> = z.nativeEnum(UserEventPayload156Plan);
...
export const PayloadBilling$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  plan: UserEventPayload156Plan$inboundSchema,
});
...
/** @internal */
export const UserEventPayload156Configuration$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156Configuration
> = z.nativeEnum(UserEventPayload156Configuration);
...
export const PayloadBuildQueue$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  configuration: types.optional(UserEventPayload156Configuration$inboundSchema),
});
...
/** @internal */
export const UserEventPayload156Role$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156Role
> = z.nativeEnum(UserEventPayload156Role);
...
/** @internal */
export const UserEventPayload156Origin$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156Origin
> = z.nativeEnum(UserEventPayload156Origin);
...
export const UserEventPayloadJoinedFrom$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  origin: UserEventPayload156Origin$inboundSchema,
...
export const Teams$inboundSchema: z.ZodType<Teams, z.ZodTypeDef, unknown> = z
  .object({
    teamId: types.string(),
    createdAt: types.number(),
    role: UserEventPayload156Role$inboundSchema,
...
/** @internal */
export const UserEventPayload156BlockReason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload156BlockReason
> = z.nativeEnum(UserEventPayload156BlockReason);
...
> = z.object({
  ...
  blockedFrom: types.optional(types.number()),
  blockedUntil: types.optional(types.number()),
  blockReason: UserEventPayload156BlockReason$inboundSchema,
});
