...
export type UserEventPayload320Project = {
  id?: string | undefined;
  staticIps: StaticIps;
};

export type UserEventPayload320Next = {
  project: UserEventPayload320Project;
};
...
export type UserEventPayload320PreviousProject = {
  id?: string | undefined;
  staticIps: PayloadStaticIps;
};

export type UserEventPayload320Previous = {
  project: UserEventPayload320PreviousProject;
};
...
export type PayloadProjectMembership = {
  ...
  role?: UserEventPayload291Role | undefined;
  uid?: string | undefined;
...
/** @internal */
export const UserEventPayload320Project$inboundSchema: z.ZodType<
  UserEventPayload320Project,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function userEventPayload320ProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload320Project, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload320Project$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload320Project' from JSON`,
  );
}
...
export const UserEventPayload320Next$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload320Project$inboundSchema),
});
...
/** @internal */
export const UserEventPayload320PreviousProject$inboundSchema: z.ZodType<
  UserEventPayload320PreviousProject,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.optional(types.string()),
...
export function userEventPayload320PreviousProjectFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload320PreviousProject, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      UserEventPayload320PreviousProject$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload320PreviousProject' from JSON`,
  );
}
...
export const UserEventPayload320Previous$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  project: z.lazy(() => UserEventPayload320PreviousProject$inboundSchema),
});
...
> = z.object({
  ...
  role: types.optional(UserEventPayload291Role$inboundSchema),
  uid: types.optional(types.string()),
...
> = z.object({
  createdAt: types.number(),
  role: UserEventPayload288Role$inboundSchema,
  uid: types.string(),
  username: types.optional(types.string()),
});
