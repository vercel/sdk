...
export type UserEventPayload82Configuration = {
  id: string;
...
export type EightyTwo = {
  ...
  configuration: UserEventPayload82Configuration;
...
export const UserEventPayload63Reason = {
  NonPayment: "non-payment",
} as const;
export type UserEventPayload63Reason = ClosedEnum<
  typeof UserEventPayload63Reason
>;

export type UserEventPayloadData = {
  planSlug: PlanSlug;
  reason?: UserEventPayload63Reason | undefined;
};
...
export const UserEventPayload53ResourcesType = {
  String: "string",
} as const;
export type UserEventPayload53ResourcesType = ClosedEnum<
  typeof UserEventPayload53ResourcesType
>;

export type Items = {
  type: UserEventPayload53ResourcesType;
};
...
export const UserEventPayload52Type = {
  List: "list",
} as const;
export type UserEventPayload52Type = ClosedEnum<typeof UserEventPayload52Type>;

export const UserEventPayload52BeforeType = {
  String: "string",
} as const;
export type UserEventPayload52BeforeType = ClosedEnum<
  typeof UserEventPayload52BeforeType
>;

export type UserEventPayloadItems = {
  type: UserEventPayload52BeforeType;
};
...
export const UserEventPayload52Permissions = {
  ManageSpeedInsights: "manage:speed-insights",
  ManageWebAnalytics: "manage:web-analytics",
  ReadWriteAiGatewayApiKey: "read-write:ai-gateway-api-key",
  ReadWriteAiGatewayGuardrails: "read-write:ai-gateway-guardrails",
...
export type UserEventPayload52Permissions = ClosedEnum<
  typeof UserEventPayload52Permissions
>;

export type Before = {
  resources?: UserEventPayloadResources | undefined;
  permissions?: Array<UserEventPayload52Permissions> | undefined;
};

export const UserEventPayload52AfterType = {
  List: "list",
} as const;
export type UserEventPayload52AfterType = ClosedEnum<
  typeof UserEventPayload52AfterType
>;

export const UserEventPayload52AfterResourcesType = {
  String: "string",
} as const;
export type UserEventPayload52AfterResourcesType = ClosedEnum<
  typeof UserEventPayload52AfterResourcesType
>;

export type PayloadItems = {
  type: UserEventPayload52AfterResourcesType;
};

/**
 * Specific project IDs or all projects on the team (`['*']`).
 */
export type UserEventPayload52ProjectIds = {
  type: UserEventPayload52AfterType;
  required: true;
  items: PayloadItems;
};
...
export type PayloadResources = {
   ...
   * Specific project IDs or all projects on the team (`['*']`).
   */
  projectIds: UserEventPayload52ProjectIds;
};
...
export type UserEventPayload34AccessGroup = {
  id: string;
  name: string;
};
...
export type ThirtyFour = {
  accessGroup: UserEventPayload34AccessGroup;
  name?: string | undefined;
...
export const UserEventPayload17RefreshPeriod = {
  Daily: "daily",
  Monthly: "monthly",
  None: "none",
  Weekly: "weekly",
} as const;
export type UserEventPayload17RefreshPeriod = ClosedEnum<
  typeof UserEventPayload17RefreshPeriod
>;
 ...
 */
export type UserEventPayload17Budget = {
  /**
   * Spend cap, in dollars.
   */
  limitAmount: number;
  refreshPeriod: UserEventPayload17RefreshPeriod;
};

export const UserEventPayload17Change = {
  Disable: "disable",
  Enable: "enable",
  Remove: "remove",
  Set: "set",
} as const;
export type UserEventPayload17Change = ClosedEnum<
  typeof UserEventPayload17Change
>;
...
export type Seventeen = {
   ...
   * Spend budget on an AI Gateway API key, as surfaced in activity messages. Defined locally (rather than imported from `@api/pubsub-types`) because `@api/pubsub-types` already depends on `@api/events`; importing it here would create a circular dependency. Must stay structurally aligned with `APIKeyBudget` in `@api/pubsub-types/event-payloads/api-keys`.
   */
  budget?: UserEventPayload17Budget | null | undefined;
  change: UserEventPayload17Change;
};
...
/** @internal */
export const UserEventPayload82Configuration$inboundSchema: z.ZodType<
...
export function userEventPayload82ConfigurationFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload82Configuration, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload82Configuration$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload82Configuration' from JSON`,
  );
}
...
> = z.object({
  ...
  configuration: z.lazy(() => UserEventPayload82Configuration$inboundSchema),
...
/** @internal */
export const UserEventPayload63Reason$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload63Reason
> = z.nativeEnum(UserEventPayload63Reason);
...
> = z.object({
  ...
  reason: types.optional(UserEventPayload63Reason$inboundSchema),
});
...
/** @internal */
export const UserEventPayload53ResourcesType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload53ResourcesType
> = z.nativeEnum(UserEventPayload53ResourcesType);

/** @internal */
export const Items$inboundSchema: z.ZodType<Items, z.ZodTypeDef, unknown> = z
  .object({
    type: UserEventPayload53ResourcesType$inboundSchema,
  });
...
/** @internal */
export const UserEventPayload52Type$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload52Type
> = z.nativeEnum(UserEventPayload52Type);

/** @internal */
export const UserEventPayload52BeforeType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload52BeforeType
> = z.nativeEnum(UserEventPayload52BeforeType);
...
export const UserEventPayloadItems$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload52BeforeType$inboundSchema,
});
...
export const UserEventPayloadProjectIds$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload52Type$inboundSchema,
  required: types.literal(true),
...
/** @internal */
export const UserEventPayload52Permissions$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload52Permissions
> = z.nativeEnum(UserEventPayload52Permissions);
...
export const Before$inboundSchema: z.ZodType<Before, z.ZodTypeDef, unknown> = z
  .object({
    ...
    permissions: types.optional(
      z.array(UserEventPayload52Permissions$inboundSchema),
    ),
  });
...
/** @internal */
export const UserEventPayload52AfterType$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload52AfterType
> = z.nativeEnum(UserEventPayload52AfterType);

/** @internal */
export const UserEventPayload52AfterResourcesType$inboundSchema:
  z.ZodNativeEnum<typeof UserEventPayload52AfterResourcesType> = z.nativeEnum(
    UserEventPayload52AfterResourcesType,
  );
...
export const PayloadItems$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  type: UserEventPayload52AfterResourcesType$inboundSchema,
});
...
/** @internal */
export const UserEventPayload52ProjectIds$inboundSchema: z.ZodType<
  UserEventPayload52ProjectIds,
  z.ZodTypeDef,
  unknown
> = z.object({
  type: UserEventPayload52AfterType$inboundSchema,
  required: types.literal(true),
  items: z.lazy(() => PayloadItems$inboundSchema),
});

export function userEventPayload52ProjectIdsFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload52ProjectIds, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload52ProjectIds$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload52ProjectIds' from JSON`,
  );
}
...
export const PayloadResources$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  projectIds: z.lazy(() => UserEventPayload52ProjectIds$inboundSchema),
});
...
/** @internal */
export const UserEventPayload34AccessGroup$inboundSchema: z.ZodType<
  UserEventPayload34AccessGroup,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: types.string(),
...
export function userEventPayload34AccessGroupFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload34AccessGroup, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload34AccessGroup$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload34AccessGroup' from JSON`,
  );
}
...
export const ThirtyFour$inboundSchema: z.ZodType<
  ...
  unknown
> = z.object({
  accessGroup: z.lazy(() => UserEventPayload34AccessGroup$inboundSchema),
  name: types.optional(types.string()),
...
/** @internal */
export const UserEventPayload17RefreshPeriod$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload17RefreshPeriod
> = z.nativeEnum(UserEventPayload17RefreshPeriod);

/** @internal */
export const UserEventPayload17Budget$inboundSchema: z.ZodType<
  UserEventPayload17Budget,
  z.ZodTypeDef,
  unknown
> = z.object({
  limitAmount: types.number(),
  refreshPeriod: UserEventPayload17RefreshPeriod$inboundSchema,
});

export function userEventPayload17BudgetFromJSON(
  jsonString: string,
): SafeParseResult<UserEventPayload17Budget, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserEventPayload17Budget$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserEventPayload17Budget' from JSON`,
  );
}

/** @internal */
export const UserEventPayload17Change$inboundSchema: z.ZodNativeEnum<
  typeof UserEventPayload17Change
> = z.nativeEnum(UserEventPayload17Change);
...
> = z.object({
  ...
  projectId: types.optional(types.string()),
  projectName: types.optional(types.string()),
  budget: z.nullable(z.lazy(() => UserEventPayload17Budget$inboundSchema))
    .optional(),
  change: UserEventPayload17Change$inboundSchema,
});
