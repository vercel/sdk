...
import { sandboxesCreateSandboxesSessionsBySessionIdSnapshotV2 } from "../funcs/sandboxesCreateSandboxesSessionsBySessionIdSnapshotV2.js";
import { sandboxesCreateSandboxesSessionsBySessionIdSnapshotV3 } from "../funcs/sandboxesCreateSandboxesSessionsBySessionIdSnapshotV3.js";
...
} from "../models/createsandboxessessionsbysessionidsnapshotv2op.js";
import {
  CreateSandboxesSessionsBySessionIdSnapshotV3Request,
  CreateSandboxesSessionsBySessionIdSnapshotV3ResponseBody,
} from "../models/createsandboxessessionsbysessionidsnapshotv3op.js";
import {
...
export class Sandboxes extends ClientSDK {
   ...
   */
  async createSandboxesSessionsBySessionIdSnapshotV2(
    request: CreateSandboxesSessionsBySessionIdSnapshotV2Request,
    options?: RequestOptions,
  ): Promise<CreateSandboxesSessionsBySessionIdSnapshotV2ResponseBody> {
    return unwrapAsync(sandboxesCreateSandboxesSessionsBySessionIdSnapshotV2(
      this,
      request,
      options,
    ));
   ...
   */
  async createSandboxesSessionsBySessionIdSnapshotV3(
    request: CreateSandboxesSessionsBySessionIdSnapshotV3Request,
    options?: RequestOptions,
  ): Promise<CreateSandboxesSessionsBySessionIdSnapshotV3ResponseBody> {
    return unwrapAsync(sandboxesCreateSandboxesSessionsBySessionIdSnapshotV3(
      this,
      request,
      options,
    ));
